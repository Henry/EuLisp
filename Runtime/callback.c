...
void initialize_module_callback()
{
  ...
  static const void *G001071[] = {I(ab,1b,34,00),I(00,00,00,16),I(23,00,00,00),B(callback ,5),I(32,00,00,00),I(00,00,00,10),I(23,00,00,00),B(callback ,6),I(1d,24,00,00),B(boot1 ,26),I(3c,01,1c,24),B(condition ,5),I(23,00,00,00),B(callback ,7),I(1f,03,24,00),B(boot ,22),I(3d,04,04,00)};
