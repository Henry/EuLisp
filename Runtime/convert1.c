...
void initialize_module_convert1()
{
  ...
  static const void *G008542[] = {I(a9,47,00,01),I(82,1a,1b,34),I(00,00,00,0d),I(47,00,02,32),I(00,00,00,38),I(47,00,00,47),I(00,01,02,24),B(table ,3),I(24,00,00,00),B(boot1 ,41),I(3c,01,47,00),I(02,47,00,01),I(1f,03,1f,03),I(3c,03,2a,47),I(00,01,2c,1b),I(48,00,01,47),I(00,03,3d,00),I(04,22,03,45),I(01,00,00,00)};
  ...
  static const void *G008547[] = {I(aa,1b,12,1b),I(34,00,00,00),I(00,00,00,10),I(47,00,00,32),I(00,00,00,37),I(1c,10,24,00),B(table ,3),I(24,00,00,00),B(boot1 ,41),I(3c,01,47,00),I(00,47,00,01),I(1f,03,1f,03),I(3c,03,2a,47),I(00,01,2b,1b),I(48,00,01,1f),I(04,11,47,00),I(02,3d,01,05),I(22,03,45,02)};
  ...
  static const void *G008557[] = {I(aa,46,06,1b),I(48,00,00,47),I(00,00,06,1b),I(48,00,03,47),I(00,03,24,00),B(boot1 ,39),I(3c,01,1b,48),I(00,04,47,00),I(03,2c,1b,48),I(00,03,86,1b),I(48,00,01,23),B(convert1 ,11),I(23,00,00,00),B(convert1 ,17),I(3b,00,48,00),I(01,47,00,01),I(3d,00,05,45),I(05,00,00,00)};

  /* Byte-vector with size: 6 is_init: 0 index: 19 binding: (method-(converter <vector>)) */
  static const void *G008559[] = {I(aa,1b,24,00),B(boot ,8),I(3c,01,1b,1d),I(41,00,00,00),B(boot1 ,54),I(45,04,00,00)};
