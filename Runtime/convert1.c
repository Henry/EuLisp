...
void initialize_module_convert1()
{
  ...
  {
  /* Declarations */
  LispRef sym_8607, G008606, sym_8604, sym_8603, sym_8602, sym_8601, sym_8600, sym_8599, G008598, G008596, G008594, G008592, G008590, G008588, G008586, G008584, G008582, key_8580, G008579, G008576, G008574, G008572, G008570, G008568, G008566, G008564, G008562, G008560, sym_8558, G008557, G008555, G008553, G008551, G008549, G008547, G008545, G008543, G008541, G008539;

  /* Code vector and literal definitions */
  /* Byte-vector with size: 1 is_init: 0 index: 2 binding: (method-(converter <character>)) */
  static const void *G008538[] = {I(aa,63,45,00)};
  ...
  static const void *G008542[] = {I(aa,62,45,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 5 binding: (method-(converter <int>)) */
  static const void *G008544[] = {I(aa,41,00,00),B(string ,23),I(45,01,00,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 6 binding: (method-(converter <string>)) */
  static const void *G008546[] = {I(aa,24,00,00),B(collect ,8),I(3d,01,00,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 7 binding: (method-(converter <string>)) */
  static const void *G008548[] = {I(aa,24,00,00),B(character ,11),I(3d,01,00,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 8 binding: (method-(converter <string>)) */
  static const void *G008550[] = {I(aa,41,00,00),B(fpi ,8),I(45,01,00,00)};

  /* Byte-vector with size: 1 is_init: 0 index: 9 binding: (method-(converter <table>)) */
  static const void *G008552[] = {I(aa,1b,45,01)};

  /* Byte-vector with size: 19 is_init: 0 index: 10 binding: anonymous */
  static const void *G008554[] = {I(a9,47,00,01),I(82,1a,1b,34),I(00,00,00,0d),I(47,00,02,32),I(00,00,00,38),I(47,00,00,47),I(00,01,02,24),B(table ,3),I(24,00,00,00),B(boot1 ,41),I(3c,01,47,00),I(02,47,00,01),I(1f,03,1f,03),I(3c,03,2a,47),I(00,01,2c,1b),I(48,00,01,47),I(00,03,3d,00),I(04,22,03,45),I(01,00,00,00)};

  /* Byte-vector with size: 19 is_init: 0 index: 12 binding: (method-(converter <table>)) */
  static const void *G008556[] = {I(aa,46,05,1b),I(48,00,00,47),I(00,00,06,24),B(table1 ,4),I(24,00,00,00),B(mop_gf ,2),I(3c,01,1c,48),I(00,01,1b,48),I(00,02,47,00),I(01,2c,1b,48),I(00,01,86,1b),I(48,00,03,23),B(convert1 ,11),I(23,00,00,00),B(convert1 ,10),I(3b,00,48,00),I(03,47,00,03),I(3d,00,05,45),I(05,00,00,00)};

  /* Byte-vector with size: 18 is_init: 0 index: 13 binding: anonymous */
  static const void *G008559[] = {I(aa,1b,12,1b),I(34,00,00,00),I(00,00,00,10),I(47,00,00,32),I(00,00,00,37),I(1c,10,24,00),B(table ,3),I(24,00,00,00),B(boot1 ,41),I(3c,01,47,00),I(00,47,00,01),I(1f,03,1f,03),I(3c,03,2a,47),I(00,01,2b,1b),I(48,00,01,1f),I(04,11,47,00),I(02,3d,01,05),I(22,03,45,02)};

  /* Byte-vector with size: 16 is_init: 0 index: 14 binding: (method-(converter <table>)) */
  static const void *G008561[] = {I(aa,46,03,24),B(table1 ,4),I(24,00,00,00),B(mop_gf ,2),I(3c,01,82,1c),I(48,00,00,1b),I(48,00,01,86),I(1b,48,00,02),I(23,00,00,00),B(convert1 ,11),I(23,00,00,00),B(convert1 ,13),I(3b,01,48,00),I(02,1f,03,47),I(00,02,3d,01),I(04,45,04,00)};

  /* Byte-vector with size: 7 is_init: 0 index: 15 binding: (method-(converter <vector>)) */
  static const void *G008563[] = {I(aa,24,00,00),B(table1 ,16),I(3c,01,24,00),B(vector ,8),I(24,00,00,00),B(convert ,2),I(3d,02,00,00)};
  ...
  eul_intern_symbol(sym_8558,"anonymous");
  ...
  eul_intern_keyword(key_8580,"size");
  ...
  eul_intern_symbol(sym_8599,"(method (converter <list>))");
  eul_intern_symbol(sym_8600,"(method (converter <string>))");
  eul_intern_symbol(sym_8601,"(method (converter <vector>))");
  eul_intern_symbol(sym_8602,"(method (converter <table>))");
  eul_intern_symbol(sym_8603,"(method (converter <int>))");
  eul_intern_symbol(sym_8604,"(method (converter <character>))");
  eul_allocate_bytevector( G008598,G008597);
  eul_intern_symbol(sym_8607,"top-level");
  eul_allocate_bytevector( G008606,G008605);

  /* Set local bindings */
  convert1_bindings[ 2] = G008539;
  convert1_bindings[ 3] = G008541;
  convert1_bindings[ 4] = G008543;
  convert1_bindings[ 5] = G008545;
  convert1_bindings[ 6] = G008547;
  convert1_bindings[ 7] = G008549;
  convert1_bindings[ 8] = G008551;
  convert1_bindings[ 9] = G008553;
  convert1_bindings[ 10] = G008555;
  convert1_bindings[ 11] = sym_8558;
  convert1_bindings[ 12] = G008557;
  convert1_bindings[ 13] = G008560;
  convert1_bindings[ 14] = G008562;
  convert1_bindings[ 15] = G008564;
  convert1_bindings[ 16] = G008566;
  convert1_bindings[ 17] = G008568;
  convert1_bindings[ 18] = G008570;
  convert1_bindings[ 19] = G008572;
  convert1_bindings[ 20] = G008574;
  convert1_bindings[ 21] = str_8577;
  convert1_bindings[ 22] = G008576;
  convert1_bindings[ 23] = key_8580;
  convert1_bindings[ 24] = G008579;
  convert1_bindings[ 25] = G008582;
  convert1_bindings[ 26] = G008584;
  convert1_bindings[ 27] = G008586;
  convert1_bindings[ 28] = G008588;
  convert1_bindings[ 29] = G008590;
  convert1_bindings[ 30] = G008592;
  convert1_bindings[ 31] = G008594;
  convert1_bindings[ 32] = G008596;
  convert1_bindings[ 33] = sym_8599;
  convert1_bindings[ 34] = sym_8600;
  convert1_bindings[ 35] = sym_8601;
  convert1_bindings[ 36] = sym_8602;
  convert1_bindings[ 37] = sym_8603;
  convert1_bindings[ 38] = sym_8604;
  convert1_bindings[ 39] = G008598;
  convert1_bindings[ 1] = eul_nil;
  convert1_bindings[ 40] = sym_8607;
  eul_allocate_lambda( convert1_bindings[0], "initialize-convert1", 0, G008606);
