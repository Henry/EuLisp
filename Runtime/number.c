...
void initialize_module_number()
{
  ...
  static const void *G002080[] = {I(a9,24,00,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,23),I(3c,01,24,00),B(boot1 ,23),I(3c,00,24,00),B(mop_class ,70),I(23,00,00,00),B(number ,31),I(23,00,00,00),B(number ,32),I(23,00,00,00),B(number ,33),I(1f,05,23,00),B(number ,34),I(1f,06,23,00),B(number ,35),I(86,23,00,00),B(number ,36),I(87,24,00,00),B(mop_gf ,2),I(3c,0b,1b,89),B(number ,5),I(2a,83,24,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,37),I(3c,02,24,00),B(boot1 ,23),I(3c,00,24,00),B(boot1 ,23),I(3c,00,23,00),B(number ,37),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,54),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(number ,23),I(2a,83,24,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,37),I(3c,02,24,00),B(boot1 ,23),I(3c,00,24,00),B(boot1 ,23),I(3c,00,23,00),B(number ,38),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,54),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(number ,8),I(2a,83,24,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,37),I(3c,02,24,00),B(boot1 ,23),I(3c,00,24,00),B(boot1 ,23),I(3c,00,23,00),B(number ,39),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,54),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(number ,12),I(2a,84,24,00),B(mop_class ,20),I(24,00,00,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,37),I(3c,03,24,00),B(boot1 ,23),I(3c,00,24,00),B(boot1 ,23),I(3c,00,23,00),B(number ,40),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,54),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(number ,13),I(2a,84,24,00),B(mop_class ,20),I(24,00,00,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,37),I(3c,03,24,00),B(boot1 ,23),I(3c,00,24,00),B(boot1 ,23),I(3c,00,23,00),B(number ,41),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,54),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(number ,7),I(2a,84,24,00),B(mop_class ,20),I(24,00,00,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,37),I(3c,03,24,00),B(boot1 ,23),I(3c,00,24,00),B(boot1 ,23),I(3c,00,23,00),B(number ,42),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,54),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(number ,11),I(2a,84,24,00),B(mop_class ,20),I(24,00,00,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,37),I(3c,03,24,00),B(boot1 ,23),I(3c,00,24,00),B(boot1 ,23),I(3c,00,23,00),B(number ,43),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,54),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(number ,16),I(2a,84,24,00),B(mop_class ,20),I(24,00,00,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,37),I(3c,03,24,00),B(boot1 ,23),I(3c,00,24,00),B(boot1 ,23),I(3c,00,23,00),B(number ,44),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,54),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(number ,4),I(2a,84,24,00),B(number ,5),I(24,00,00,00),B(number ,5),I(24,00,00,00),B(boot1 ,37),I(3c,03,24,00),B(boot1 ,23),I(3c,00,24,00),B(boot1 ,23),I(3c,00,23,00),B(number ,45),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,54),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(number ,6),I(2a,84,24,00),B(number ,5),I(24,00,00,00),B(number ,5),I(24,00,00,00),B(boot1 ,37),I(3c,03,24,00),B(boot1 ,23),I(3c,00,24,00),B(boot1 ,23),I(3c,00,23,00),B(number ,46),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,54),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(number ,25),I(2a,84,24,00),B(number ,5),I(24,00,00,00),B(number ,5),I(24,00,00,00),B(boot1 ,37),I(3c,03,24,00),B(boot1 ,23),I(3c,00,24,00),B(boot1 ,23),I(3c,00,23,00),B(number ,47),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,54),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(number ,18),I(2a,24,00,00),B(number ,23),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,37),I(3c,02,24,00),B(boot1 ,23),I(3c,00,24,00),B(number ,23),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(number ,48),I(23,00,00,00),B(number ,30),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(number ,23),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(number ,23),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(number ,5),I(24,00,00,00),B(boot1 ,37),I(3c,02,24,00),B(boot1 ,23),I(3c,00,24,00),B(number ,23),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(number ,48),I(23,00,00,00),B(number ,29),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(number ,23),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(number ,23),I(2a,24,00,00),B(number ,5),I(2a,24,00,00),B(number ,8),I(2a,24,00,00),B(number ,12),I(2a,24,00,00),B(number ,12),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(number ,5),I(24,00,00,00),B(boot1 ,37),I(3c,02,24,00),B(boot1 ,23),I(3c,00,24,00),B(number ,12),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(number ,49),I(23,00,00,00),B(number ,28),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(number ,12),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(number ,13),I(2a,24,00,00),B(number ,7),I(2a,24,00,00),B(number ,11),I(2a,24,00,00),B(number ,16),I(2a,24,00,00),B(number ,4),I(2a,24,00,00),B(number ,6),I(2a,24,00,00),B(number ,25),I(2a,24,00,00),B(number ,18),I(2a,83,82,14),I(24,00,00,00),B(number ,13),I(24,00,00,00),B(callback ,4),I(3c,02,2a,83),I(2b,24,00,00),B(number ,7),I(24,00,00,00),B(callback ,4),I(3c,02,2a,83),I(84,14,24,00),B(number ,11),I(24,00,00,00),B(callback ,4),I(3c,02,2a,83),I(26,00,00,00),I(00,00,00,03),I(14,24,00,00),B(number ,16),I(24,00,00,00),B(callback ,4),I(3c,02,2a,83),I(26,00,00,00),I(00,00,00,04),I(14,24,00,00),B(number ,4),I(24,00,00,00),B(callback ,4),I(3c,02,2a,24),B(copy ,2),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(number ,5),I(24,00,00,00),B(boot1 ,37),I(3c,02,24,00),B(boot1 ,23),I(3c,00,24,00),B(copy ,2),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(number ,50),I(23,00,00,00),B(number ,27),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(copy ,2),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(copy ,3),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(number ,5),I(24,00,00,00),B(boot1 ,37),I(3c,02,24,00),B(boot1 ,23),I(3c,00,24,00),B(copy ,3),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(number ,51),I(23,00,00,00),B(number ,26),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(copy ,3),I(1c,24,00,00),B(mop_meth ,5),I(3d,02,4d,45),I(4d,00,00,00)};

  /* Byte-vector with size: 13 is_init: 0 index: 53 binding: anonymous */
  static const void *G002103[] = {I(ab,1c,12,1b),I(34,00,00,00),I(00,00,00,10),I(1c,32,00,00),I(00,00,00,23),I(1d,11,1f,03),I(10,1f,03,1c),I(24,00,00,00),B(number ,7),I(3c,02,1d,1c),I(47,00,00,3d),I(02,06,22,03),I(45,03,00,00)};

  /* Byte-vector with size: 17 is_init: 0 index: 55 binding: - */
  static const void *G002105[] = {I(43,fe,46,01),I(1b,12,1b,34),I(00,00,00,15),I(82,1f,03,24),B(number ,7),I(3d,02,03,32),I(00,00,00,29),I(86,1b,48,00),I(00,23,00,00),B(number ,54),I(23,00,00,00),B(number ,53),I(3b,02,48,00),I(00,1d,1f,04),I(47,00,00,3d),I(02,04,22,01),I(45,03,00,00)};

  /* Byte-vector with size: 13 is_init: 0 index: 56 binding: signum */
  static const void *G002108[] = {I(aa,1b,2d,1b),I(34,00,00,00),I(00,00,00,10),I(1b,32,00,00),I(00,00,00,23),I(1c,1b,82,1a),I(1b,34,00,00),I(00,00,00,0f),I(82,1d,15,32),I(00,00,00,06),I(1c,22,02,1d),I(1c,17,22,01),I(45,02,00,00)};

  /* Byte-vector with size: 13 is_init: 0 index: 57 binding: anonymous */
  static const void *G002110[] = {I(ab,1c,12,1b),I(34,00,00,00),I(00,00,00,10),I(1c,32,00,00),I(00,00,00,23),I(1d,11,1f,03),I(10,1f,03,1c),I(24,00,00,00),B(number ,16),I(3c,02,1d,1c),I(47,00,00,3d),I(02,06,22,03),I(45,03,00,00)};

  /* Byte-vector with size: 10 is_init: 0 index: 58 binding: / */
  static const void *G002112[] = {I(43,fe,46,01),I(86,1b,48,00),I(00,23,00,00),B(number ,54),I(23,00,00,00),B(number ,57),I(3b,02,48,00),I(00,1c,1f,03),I(47,00,00,3d),I(02,03,45,03)};

  /* Byte-vector with size: 13 is_init: 0 index: 59 binding: anonymous */
  static const void *G002114[] = {I(ab,1c,12,1b),I(34,00,00,00),I(00,00,00,10),I(1c,32,00,00),I(00,00,00,23),I(1d,11,1f,03),I(10,1b,1f,04),I(24,00,00,00),B(number ,13),I(3c,02,1d,1c),I(47,00,00,3d),I(02,06,22,03),I(45,03,00,00)};

  /* Byte-vector with size: 10 is_init: 0 index: 60 binding: + */
  static const void *G002116[] = {I(a8,46,01,86),I(1b,48,00,00),I(23,00,00,00),B(number ,54),I(23,00,00,00),B(number ,59),I(3b,02,48,00),I(00,1c,82,47),I(00,00,3d,02),I(02,45,02,00)};

  /* Byte-vector with size: 13 is_init: 0 index: 61 binding: anonymous */
  static const void *G002118[] = {I(ab,1c,12,1b),I(34,00,00,00),I(00,00,00,10),I(1c,32,00,00),I(00,00,00,23),I(1d,11,1f,03),I(10,1f,03,1c),I(24,00,00,00),B(number ,4),I(3c,02,1d,1c),I(47,00,00,3d),I(02,06,22,03),I(45,03,00,00)};

  /* Byte-vector with size: 10 is_init: 0 index: 62 binding: % */
  static const void *G002120[] = {I(43,fe,46,01),I(86,1b,48,00),I(00,23,00,00),B(number ,54),I(23,00,00,00),B(number ,61),I(3b,02,48,00),I(00,1c,1f,03),I(47,00,00,3d),I(02,03,45,03)};

  /* Byte-vector with size: 2 is_init: 0 index: 63 binding: positivep */
  static const void *G002122[] = {I(aa,82,1c,1a),I(45,01,00,00)};

  /* Byte-vector with size: 13 is_init: 0 index: 64 binding: anonymous */
  static const void *G002124[] = {I(ab,1c,12,1b),I(34,00,00,00),I(00,00,00,10),I(1c,32,00,00),I(00,00,00,23),I(1d,11,1f,03),I(10,1f,03,1c),I(24,00,00,00),B(number ,6),I(3c,02,1d,1c),I(47,00,00,3d),I(02,06,22,03),I(45,03,00,00)};

  /* Byte-vector with size: 10 is_init: 0 index: 65 binding: mod */
  static const void *G002126[] = {I(43,fe,46,01),I(86,1b,48,00),I(00,23,00,00),B(number ,54),I(23,00,00,00),B(number ,64),I(3b,02,48,00),I(00,1c,1f,03),I(47,00,00,3d),I(02,03,45,03)};

  /* Byte-vector with size: 6 is_init: 0 index: 66 binding: abs */
  static const void *G002128[] = {I(aa,1b,82,1a),I(1b,34,00,00),I(00,00,00,0f),I(82,1d,15,32),I(00,00,00,06),I(1c,45,02,00)};

  /* Byte-vector with size: 2 is_init: 0 index: 67 binding: negativep */
  static const void *G002130[] = {I(aa,82,1a,45),I(00,00,00,00)};
  ...
  eul_intern_symbol(sym_2088,"numberp");
  eul_intern_symbol(sym_2089,"zerop");
  ...
  eul_intern_symbol(sym_2099,"(method numberp)");
  ...
  eul_intern_symbol(sym_2107,"anonymous");
  ...
  eul_intern_symbol(sym_2149,"negativep");
  eul_intern_symbol(sym_2150,"abs");
  eul_intern_symbol(sym_2151,"mod");
  eul_intern_symbol(sym_2152,"positivep");
  eul_intern_symbol(sym_2153,"%");
  eul_intern_symbol(sym_2154,"+");
  eul_intern_symbol(sym_2155,"/");
  eul_intern_symbol(sym_2156,"signum");
  eul_intern_symbol(sym_2157,"-");
  ...
  number_bindings[ 54] = sym_2107;
  number_bindings[ 55] = G002106;
  number_bindings[ 56] = G002109;
  number_bindings[ 57] = G002111;
