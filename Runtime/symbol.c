...
/* Foreign functions */
static LispRef ff_stub_eul_init_symbol10179 (Stack *reg_value_stack, LispRef *sreg_value_sp, LispRef *sreg_value_sb)
{
  LispRef G0010224, res;

  POPVAL1(G0010224);
  FF_RES_CONVERT6(res,eul_init_symbol(FF_ARG_CONVERT8(G0010224)));
  return res;
}

static LispRef ff_stub_eul_init_keyword10180 (Stack *reg_value_stack, LispRef *sreg_value_sp, LispRef *sreg_value_sb)
{
  LispRef G0010225, res;

  POPVAL1(G0010225);
  FF_RES_CONVERT6(res,eul_init_keyword(FF_ARG_CONVERT8(G0010225)));
  return res;
}
...
void initialize_module_symbol()
{
  ...
  eul_intern_symbol(sym_10201,"namep");
  eul_intern_symbol(sym_10202,"(method initialize)");
  eul_intern_symbol(sym_10203,"(method namep)");
  eul_intern_symbol(sym_10204,"(method binary<)");
  eul_intern_symbol(sym_10205,"(method concatenate)");
  eul_intern_symbol(sym_10207,"converter");
  eul_intern_symbol(sym_10209,"<symbol>");
  object_class(cons_10208) = eul_static_cons_class;
  eul_car(cons_10208) = sym_10209;
  eul_cdr(cons_10208) = eul_nil;
  object_class(cons_10206) = eul_static_cons_class;
  eul_car(cons_10206) = sym_10207;
  eul_intern_symbol(sym_10210,"(method (converter <symbol>))");
  ...
  object_class(str_10217) = eul_static_string_class;
  eul_allocate_bytevector( G0010216,G0010215);
  eul_intern_symbol(sym_10220,"gensym");
  eul_intern_symbol(sym_10221,"keywordp");
  eul_intern_symbol(sym_10222,"symbol-exists-p");
  eul_intern_symbol(sym_10223,"top-level");
  ...
  symbol_bindings[ 7] = (LispRef) (LispRef (*) (Stack *, LispRef *, LispRef *)) ff_stub_eul_init_symbol10179;
  symbol_bindings[ 8] = (LispRef) (LispRef (*) (Stack *, LispRef *, LispRef *)) ff_stub_eul_init_keyword10180;
  symbol_bindings[ 9] = key_10183;
  symbol_bindings[ 10] = G0010182;
  symbol_bindings[ 11] = G0010185;
  symbol_bindings[ 12] = sym_10188;
  symbol_bindings[ 13] = G0010187;
  symbol_bindings[ 14] = G0010190;
  symbol_bindings[ 15] = G0010192;
  symbol_bindings[ 16] = G0010194;
  symbol_bindings[ 17] = G0010196;
  symbol_bindings[ 18] = G0010198;
  symbol_bindings[ 19] = sym_10201;
  symbol_bindings[ 20] = sym_10202;
  symbol_bindings[ 21] = sym_10203;
  symbol_bindings[ 22] = sym_10204;
  symbol_bindings[ 23] = sym_10205;
  symbol_bindings[ 24] = sym_10207;
  symbol_bindings[ 25] = sym_10209;
  symbol_bindings[ 26] = cons_10206;
  symbol_bindings[ 27] = sym_10210;
  symbol_bindings[ 28] = G0010200;
  symbol_bindings[ 29] = G0010212;
  symbol_bindings[ 30] = G0010214;
  symbol_bindings[ 31] = str_10217;
  symbol_bindings[ 32] = G0010216;
  symbol_bindings[ 1] = eul_nil;
  symbol_bindings[ 33] = sym_10220;
  symbol_bindings[ 34] = sym_10221;
  symbol_bindings[ 35] = sym_10222;
  symbol_bindings[ 36] = sym_10223;
  eul_allocate_lambda( symbol_bindings[0], "initialize-symbol", 0, G0010219);
