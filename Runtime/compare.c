...
void initialize_module_compare()
{
  ...
  static const void *G001237[] = {I(a9,84,24,00),B(mop_class ,20),I(24,00,00,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,37),I(3c,03,24,00),B(boot1 ,23),I(3c,00,24,00),B(boot1 ,23),I(3c,00,23,00),B(compare ,13),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,54),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(compare ,9),I(2a,84,24,00),B(mop_class ,20),I(24,00,00,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,37),I(3c,03,24,00),B(boot1 ,23),I(3c,00,24,00),B(boot1 ,23),I(3c,00,23,00),B(compare ,14),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,54),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(compare ,6),I(2a,24,00,00),B(compare ,9),I(2a,24,00,00),B(compare ,9),I(26,00,00,00),I(00,00,00,03),I(02,84,86,86),I(24,00,00,00),B(boot1 ,37),I(3c,03,24,00),B(boot1 ,23),I(3c,00,24,00),B(compare ,9),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(compare ,15),I(23,00,00,00),B(compare ,12),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(compare ,9),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(compare ,6),I(2a,83,26,00),I(00,00,00,05),I(14,24,00,00),B(compare ,9),I(24,00,00,00),B(callback ,4),I(3c,02,2a,83),I(26,00,00,00),I(00,00,00,06),I(14,24,00,00),B(compare ,6),I(24,00,00,00),B(callback ,4),I(3d,02,0e,45),I(0e,00,00,00)};
  ...
  static const void *G001251[] = {I(a8,24,00,00),B(boot ,24),I(3c,01,24,00),B(compare ,3),I(1c,24,00,00),B(boot ,9),I(3d,02,01,00)};
  ...
  static const void *G001257[] = {I(43,fe,24,00),B(compare ,2),I(1d,1d,24,00),B(boot ,9),I(3c,03,12,45),I(02,00,00,00)};
