...
void initialize_module_float()
{
  ...
  eul_intern_keyword(key_3153,"name");
  eul_intern_symbol(sym_3154,"float");
  eul_intern_keyword(key_3155,"direct-superclasses");
  eul_intern_keyword(key_3156,"direct-slots");
  eul_intern_keyword(key_3157,"direct-keywords");
  eul_intern_keyword(key_3158,"abstractp");
  eul_intern_symbol(sym_3159,"floatp");
  eul_intern_symbol(sym_3160,"doublep");
  eul_intern_symbol(sym_3161,"ceiling");
  eul_intern_symbol(sym_3162,"floor");
  eul_intern_symbol(sym_3163,"round");
  eul_intern_symbol(sym_3164,"truncate");
  eul_intern_symbol(sym_3165,"(method floatp)");
  eul_intern_symbol(sym_3166,"double");
  eul_intern_symbol(sym_3167,"(method doublep)");
  eul_intern_symbol(sym_3169,"converter");
  eul_intern_symbol(sym_3171,"<double>");
  object_class(cons_3170) = eul_static_cons_class;
  eul_car(cons_3170) = sym_3171;
  eul_cdr(cons_3170) = eul_nil;
  object_class(cons_3168) = eul_static_cons_class;
  eul_car(cons_3168) = sym_3169;
  eul_allocate_bytevector( G003152,G003151);
  eul_intern_symbol(sym_3174,"top-level");
  ...
  float_bindings[ 11] = G003144;
  float_bindings[ 12] = G003146;
  float_bindings[ 13] = G003148;
  float_bindings[ 14] = G003150;
  float_bindings[ 15] = key_3153;
  float_bindings[ 16] = sym_3154;
  float_bindings[ 17] = key_3155;
  float_bindings[ 18] = key_3156;
  float_bindings[ 19] = key_3157;
  float_bindings[ 20] = key_3158;
  float_bindings[ 21] = sym_3159;
  float_bindings[ 22] = sym_3160;
  float_bindings[ 23] = sym_3161;
  float_bindings[ 24] = sym_3162;
  float_bindings[ 25] = sym_3163;
  float_bindings[ 26] = sym_3164;
  float_bindings[ 27] = sym_3165;
  float_bindings[ 28] = sym_3166;
  float_bindings[ 29] = sym_3167;
  float_bindings[ 30] = sym_3169;
  float_bindings[ 31] = sym_3171;
  float_bindings[ 32] = cons_3168;
  float_bindings[ 33] = G003152;
  float_bindings[ 1] = eul_nil;
  float_bindings[ 34] = sym_3174;
  eul_allocate_lambda( float_bindings[0], "initialize-float", 0, G003173);
