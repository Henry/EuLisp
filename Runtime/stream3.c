...
void initialize_module_stream3()
{
  ...
  eul_allocate_bytevector( G007376,G007375);
  object_class(str_7379) = eul_static_string_class;
  eul_allocate_bytevector( G007378,G007377);
  eul_allocate_bytevector( G007381,G007380);
  object_class(str_7384) = eul_static_string_class;
  object_class(str_7385) = eul_static_string_class;
  object_class(str_7386) = eul_static_string_class;
  ...
  object_class(str_7395) = eul_static_string_class;
  eul_allocate_bytevector( G007394,G007393);
  eul_allocate_bytevector( G007397,G007396);
  eul_allocate_bytevector( G007399,G007398);
  object_class(str_7402) = eul_static_string_class;
  eul_allocate_bytevector( G007401,G007400);
  object_class(str_7405) = eul_static_string_class;
  object_class(str_7406) = eul_static_string_class;
  eul_allocate_bytevector( G007404,G007403);
  eul_allocate_bytevector( G007408,G007407);
  eul_allocate_bytevector( G007410,G007409);
  eul_intern_symbol(sym_7413,"(method generic-write)");
  eul_intern_symbol(sym_7414,"(method generic-prin)");
  eul_allocate_bytevector( G007412,G007411);
  eul_intern_symbol(sym_7417,"top-level");
  eul_allocate_bytevector( G007416,G007415);

  /* Set local bindings */
  stream3_bindings[ 2] = sym_7344;
  stream3_bindings[ 3] = G007343;
  stream3_bindings[ 4] = G007346;
  stream3_bindings[ 5] = G007348;
  stream3_bindings[ 6] = G007350;
  stream3_bindings[ 7] = str_7353;
  stream3_bindings[ 8] = G007352;
  stream3_bindings[ 9] = G007355;
  stream3_bindings[ 10] = str_7358;
  stream3_bindings[ 11] = str_7359;
  stream3_bindings[ 12] = str_7360;
  stream3_bindings[ 13] = G007357;
  stream3_bindings[ 14] = str_7363;
  stream3_bindings[ 15] = G007362;
  stream3_bindings[ 16] = str_7366;
  stream3_bindings[ 17] = G007365;
  stream3_bindings[ 18] = sym_7369;
  stream3_bindings[ 19] = str_7370;
  stream3_bindings[ 20] = str_7371;
  stream3_bindings[ 21] = str_7372;
  stream3_bindings[ 22] = G007368;
  stream3_bindings[ 23] = G007374;
  stream3_bindings[ 24] = G007376;
  stream3_bindings[ 25] = str_7379;
  stream3_bindings[ 26] = G007378;
  stream3_bindings[ 27] = G007381;
  stream3_bindings[ 28] = str_7384;
  stream3_bindings[ 29] = str_7385;
  stream3_bindings[ 30] = str_7386;
  stream3_bindings[ 31] = G007383;
  stream3_bindings[ 32] = str_7389;
  stream3_bindings[ 33] = G007388;
  stream3_bindings[ 34] = str_7392;
  stream3_bindings[ 35] = G007391;
  stream3_bindings[ 36] = str_7395;
  stream3_bindings[ 37] = G007394;
  stream3_bindings[ 38] = G007397;
  stream3_bindings[ 39] = G007399;
  stream3_bindings[ 40] = str_7402;
  stream3_bindings[ 41] = G007401;
  stream3_bindings[ 42] = str_7405;
  stream3_bindings[ 43] = str_7406;
  stream3_bindings[ 44] = G007404;
  stream3_bindings[ 45] = G007408;
  stream3_bindings[ 46] = G007410;
  stream3_bindings[ 47] = sym_7413;
  stream3_bindings[ 48] = sym_7414;
  stream3_bindings[ 49] = G007412;
  stream3_bindings[ 1] = eul_nil;
  stream3_bindings[ 50] = sym_7417;
  eul_allocate_lambda( stream3_bindings[0], "initialize-stream3", 0, G007416);
