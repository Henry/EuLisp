...
void initialize_module_stream3()
{
  ...
  {
  /* Declarations */
  LispRef sym_10035, G0010034, sym_10032, sym_10031, G0010030, G0010028, G0010026, G0010022, G0010019, G0010017, G0010015, G0010012, G0010009, G0010006, G0010001, G009999, G009996, G009994, G009992, sym_9987, G009986, G009983, G009980, G009975, G009973, G009970, G009968, G009966, G009964, sym_9962, G009961;

  /* Code vector and literal definitions */
  /* Byte-vector with size: 19 is_init: 0 index: 3 binding: (method-generic-prin) */
  static const void *G009960[] = {I(ab,1c,82,02),I(1b,34,00,00),I(00,00,00,0f),I(1b,32,00,00),I(00,00,00,0f),I(23,00,00,00),B(stream3 ,2),I(82,02,27,3c),I(1f,03,24,00),B(stream ,3),I(3c,02,2a,1b),I(06,1c,1c,1f),I(05,24,00,00),B(stream ,4),I(3c,03,2a,27),I(3e,1f,04,24),B(stream ,3),I(3c,02,2a,1f),I(04,45,05,00)};

  /* Byte-vector with size: 5 is_init: 0 index: 4 binding: (method-generic-prin) */
  static const void *G009963[] = {I(ab,1c,06,1d),I(1c,1f,03,24),B(stream ,4),I(3c,03,2a,1d),I(45,03,00,00)};

  /* Byte-vector with size: 5 is_init: 0 index: 5 binding: (method-generic-prin) */
  static const void *G009965[] = {I(ab,1c,82,02),I(1b,1d,24,00),B(stream2 ,2),I(3c,02,2a,1d),I(45,03,00,00)};

  /* Byte-vector with size: 4 is_init: 0 index: 6 binding: (method-generic-prin) */
  static const void *G009967[] = {I(ab,1c,1c,24),B(stream ,3),I(3c,02,2a,1c),I(45,02,00,00)};

  eul_allocate_static_string(str_9971, " . ", 3);
  /* Byte-vector with size: 27 is_init: 0 index: 8 binding: (method-generic-prin) */
  static const void *G009969[] = {I(ab,27,28,1c),I(24,00,00,00),B(stream ,3),I(3c,02,2a,1c),I(24,00,00,00),B(stream2 ,2),I(1d,24,00,00),B(stream ,11),I(3c,03,1b,12),I(1b,34,00,00),I(00,00,00,0f),I(86,32,00,00),I(00,00,00,2d),I(23,00,00,00),B(stream3 ,7),I(26,00,00,00),I(00,00,00,03),I(1f,04,24,00),B(stream ,4),I(3c,03,2a,1c),I(1f,03,24,00),B(stream ,13),I(3c,02,2a,27),I(29,1f,03,24),B(stream ,3),I(3c,02,2a,1f),I(03,45,04,00)};

  /* Byte-vector with size: 19 is_init: 0 index: 9 binding: anonymous */
  static const void *G009972[] = {I(a9,47,00,03),I(47,00,02,1a),I(1b,34,00,00),I(00,00,00,3f),I(47,00,00,47),I(00,03,02,1b),I(47,00,01,24),B(stream ,13),I(3c,02,2a,27),I(20,47,00,01),I(24,00,00,00),B(stream ,3),I(3c,02,2a,47),I(00,03,2b,1b),I(48,00,03,47),I(00,04,3d,00),I(03,22,02,32),I(00,00,00,06),I(86,45,01,00)};

  eul_allocate_static_string(str_9976, "#()", 3);
  eul_allocate_static_string(str_9977, "#(", 2);
  eul_allocate_static_string(str_9978, "#(", 2);
  /* Byte-vector with size: 61 is_init: 0 index: 13 binding: (method-generic-prin) */
  static const void *G009974[] = {I(ab,46,06,1c),I(48,00,00,1b),I(48,00,01,47),I(00,00,06,1b),I(2d,1b,34,00),I(00,00,00,26),I(23,00,00,00),B(stream3 ,10),I(26,00,00,00),I(00,00,00,03),I(47,00,01,24),B(stream ,4),I(3c,03,32,00),I(00,00,00,bc),I(1c,83,19,1b),I(34,00,00,00),I(00,00,00,4c),I(23,00,00,00),B(stream3 ,11),I(84,47,00,01),I(24,00,00,00),B(stream ,4),I(3c,03,2a,47),I(00,00,82,02),I(1b,47,00,01),I(24,00,00,00),B(stream ,13),I(3c,02,2a,27),I(29,47,00,01),I(24,00,00,00),B(stream ,3),I(3c,02,22,01),I(32,00,00,00),I(00,00,00,6c),I(1d,2c,82,1c),I(48,00,02,1b),I(48,00,03,23),B(stream3 ,12),I(84,47,00,01),I(24,00,00,00),B(stream ,4),I(3c,03,2a,86),I(1b,48,00,04),I(23,00,00,00),B(stream3 ,2),I(23,00,00,00),B(stream3 ,9),I(3b,00,48,00),I(04,47,00,04),I(3c,00,2a,47),I(00,00,47,00),I(02,02,1b,47),I(00,01,24,00),B(stream ,13),I(3c,02,2a,27),I(29,47,00,01),I(24,00,00,00),B(stream ,3),I(3c,02,22,04),I(22,01,2a,47),I(00,00,45,04)};

  eul_allocate_static_string(str_9981, "#<~a: ~a:~a>", 12);
  /* Byte-vector with size: 15 is_init: 0 index: 15 binding: (method-generic-write) */
  static const void *G009979[] = {I(ab,1c,04,1b),I(82,02,1f,03),I(84,24,00,00),B(socket ,7),I(08,1f,04,26),I(00,00,00,03),I(24,00,00,00),B(socket ,7),I(08,1f,04,23),B(stream3 ,14),I(1f,04,1f,04),I(1f,04,24,00),B(mop_gf ,17),I(3c,05,2a,1f),I(05,45,06,00)};

  eul_allocate_static_string(str_9984, "#<~a: ~a:~a>", 12);
  /* Byte-vector with size: 14 is_init: 0 index: 17 binding: (method-generic-write) */
  static const void *G009982[] = {I(ab,1c,04,1b),I(82,02,1f,03),I(83,24,00,00),B(socket ,2),I(08,1f,04,82),I(24,00,00,00),B(socket ,2),I(08,1f,04,23),B(stream3 ,16),I(1f,04,1f,04),I(1f,04,24,00),B(mop_gf ,17),I(3c,05,2a,1f),I(05,45,06,00)};

  eul_allocate_static_string(str_9988, "*unconnected*", 13);
  eul_allocate_static_string(str_9989, "*unconnected*", 13);
  eul_allocate_static_string(str_9990, "#<~a: ~a>", 9);
  /* Byte-vector with size: 47 is_init: 0 index: 22 binding: (method-generic-write) */
  static const void *G009985[] = {I(ab,1c,26,00),I(00,00,00,05),I(24,00,00,00),B(stream2 ,21),I(08,1d,26,00),I(00,00,00,04),I(24,00,00,00),B(stream2 ,21),I(08,1f,03,82),I(24,00,00,00),B(stream2 ,21),I(08,1f,04,04),I(1b,82,02,1d),I(23,00,00,00),B(stream3 ,18),I(50,1b,34,00),I(00,00,00,36),I(1f,04,24,00),B(stream2 ,13),I(3c,01,1b,34),I(00,00,00,15),I(1f,05,84,24),B(stream2 ,4),I(08,32,00,00),I(00,00,00,0f),I(23,00,00,00),B(stream3 ,19),I(22,01,32,00),I(00,00,00,30),I(1f,05,24,00),B(stream2 ,13),I(3c,01,1b,34),I(00,00,00,15),I(1f,06,84,24),B(stream2 ,4),I(08,32,00,00),I(00,00,00,0f),I(23,00,00,00),B(stream3 ,20),I(22,01,1f,07),I(23,00,00,00),B(stream3 ,21),I(1f,04,1f,03),I(24,00,00,00),B(mop_gf ,17),I(3c,04,2a,1f),I(08,45,09,00)};

  /* Byte-vector with size: 12 is_init: 0 index: 23 binding: (method-generic-write) */
  static const void *G009991[] = {I(ab,27,22,1c),I(24,00,00,00),B(stream ,3),I(3c,02,2a,1c),I(06,1d,1c,1f),I(03,24,00,00),B(stream ,4),I(3c,03,2a,27),I(22,1d,24,00),B(stream ,3),I(3c,02,2a,1d),I(45,03,00,00)};

  /* Byte-vector with size: 11 is_init: 0 index: 24 binding: (method-generic-write) */
  static const void *G009993[] = {I(ab,27,23,1c),I(24,00,00,00),B(stream ,3),I(3c,02,2a,27),I(5c,1c,24,00),B(stream ,3),I(3c,02,2a,1c),I(1c,24,00,00),B(stream ,3),I(3c,02,2a,1c),I(45,02,00,00)};

  eul_allocate_static_string(str_9997, " . ", 3);
  /* Byte-vector with size: 27 is_init: 0 index: 26 binding: (method-generic-write) */
  static const void *G009995[] = {I(ab,27,28,1c),I(24,00,00,00),B(stream ,3),I(3c,02,2a,1c),I(24,00,00,00),B(stream2 ,29),I(1d,24,00,00),B(stream ,11),I(3c,03,1b,12),I(1b,34,00,00),I(00,00,00,0f),I(86,32,00,00),I(00,00,00,2d),I(23,00,00,00),B(stream3 ,25),I(26,00,00,00),I(00,00,00,03),I(1f,04,24,00),B(stream ,4),I(3c,03,2a,1c),I(1f,03,24,00),B(stream ,10),I(3c,02,2a,27),I(29,1f,03,24),B(stream ,3),I(3c,02,2a,1f),I(03,45,04,00)};

  /* Byte-vector with size: 19 is_init: 0 index: 27 binding: anonymous */
  static const void *G009998[] = {I(a9,47,00,03),I(47,00,02,1a),I(1b,34,00,00),I(00,00,00,3f),I(47,00,00,47),I(00,03,02,1b),I(47,00,01,24),B(stream ,10),I(3c,02,2a,27),I(20,47,00,01),I(24,00,00,00),B(stream ,3),I(3c,02,2a,47),I(00,03,2b,1b),I(48,00,03,47),I(00,04,3d,00),I(03,22,02,32),I(00,00,00,06),I(86,45,01,00)};
  ...
  object_class(str_9981) = eul_static_string_class;
  ...
  eul_intern_symbol(sym_9987,"r");
  object_class(str_9988) = eul_static_string_class;
  object_class(str_9989) = eul_static_string_class;
  ...
  object_class(str_10020) = eul_static_string_class;
  ...
  eul_intern_symbol(sym_10031,"(method generic-write)");
  eul_intern_symbol(sym_10032,"(method generic-prin)");
  eul_allocate_bytevector( G0010030,G0010029);
  eul_intern_symbol(sym_10035,"top-level");
  eul_allocate_bytevector( G0010034,G0010033);

  /* Set local bindings */
  stream3_bindings[ 2] = sym_9962;
  stream3_bindings[ 3] = G009961;
  stream3_bindings[ 4] = G009964;
  stream3_bindings[ 5] = G009966;
  stream3_bindings[ 6] = G009968;
  stream3_bindings[ 7] = str_9971;
  stream3_bindings[ 8] = G009970;
  stream3_bindings[ 9] = G009973;
  stream3_bindings[ 10] = str_9976;
  stream3_bindings[ 11] = str_9977;
  stream3_bindings[ 12] = str_9978;
  stream3_bindings[ 13] = G009975;
  stream3_bindings[ 14] = str_9981;
  stream3_bindings[ 15] = G009980;
  stream3_bindings[ 16] = str_9984;
  stream3_bindings[ 17] = G009983;
  stream3_bindings[ 18] = sym_9987;
  stream3_bindings[ 19] = str_9988;
  stream3_bindings[ 20] = str_9989;
  stream3_bindings[ 21] = str_9990;
  stream3_bindings[ 22] = G009986;
  stream3_bindings[ 23] = G009992;
  stream3_bindings[ 24] = G009994;
  stream3_bindings[ 25] = str_9997;
  stream3_bindings[ 26] = G009996;
  stream3_bindings[ 27] = G009999;
  stream3_bindings[ 28] = str_10002;
  stream3_bindings[ 29] = str_10003;
  stream3_bindings[ 30] = str_10004;
  stream3_bindings[ 31] = G0010001;
  stream3_bindings[ 32] = str_10007;
  stream3_bindings[ 33] = G0010006;
  stream3_bindings[ 34] = str_10010;
  stream3_bindings[ 35] = G0010009;
  stream3_bindings[ 36] = str_10013;
  stream3_bindings[ 37] = G0010012;
  stream3_bindings[ 38] = G0010015;
  stream3_bindings[ 39] = G0010017;
  stream3_bindings[ 40] = str_10020;
  stream3_bindings[ 41] = G0010019;
  stream3_bindings[ 42] = str_10023;
  stream3_bindings[ 43] = str_10024;
  stream3_bindings[ 44] = G0010022;
  stream3_bindings[ 45] = G0010026;
  stream3_bindings[ 46] = G0010028;
  stream3_bindings[ 47] = sym_10031;
  stream3_bindings[ 48] = sym_10032;
  stream3_bindings[ 49] = G0010030;
  stream3_bindings[ 1] = eul_nil;
  stream3_bindings[ 50] = sym_10035;
  eul_allocate_lambda( stream3_bindings[0], "initialize-stream3", 0, G0010034);
