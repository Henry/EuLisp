...
/* Foreign functions */
static LispRef ff_stub_eul_hash_object7461 (Stack *reg_value_stack, LispRef *sreg_value_sp, LispRef *sreg_value_sb)
{
  LispRef G007581, res;

  POPVAL1(G007581);
  FF_RES_CONVERT0(res,eul_hash_object(FF_ARG_CONVERT8(G007581)));
  return res;
}
...
void initialize_module_table1()
{
  ...
  {
  /* Declarations */
  LispRef sym_7580, sym_7579, sym_7578, sym_7577, sym_7576, sym_7575, sym_7574, G007573, G007571, G007569, G007567, G007565, G007563, G007561, sym_7559, sym_7558, sym_7557, sym_7556, sym_7555, sym_7554, sym_7553, sym_7552, sym_7551, sym_7550, sym_7549, sym_7548, sym_7547, sym_7546, sym_7545, sym_7544, sym_7543, sym_7542, sym_7541, sym_7540, sym_7539, sym_7536, sym_7535, sym_7534, key_7532, key_7531, key_7530, sym_7529, sym_7528, key_7527, sym_7526, key_7525, key_7524, sym_7523, sym_7522, key_7521, G007520, G007518, G007516, G007514, G007512, G007510, G007508, G007506, G007504, G007502, G007500, G007498, G007496, G007494, G007492, G007490, G007488, key_7483, key_7482, G007481, G007479, G007477, G007475, G007473, G007471, sym_7469, G007468, G007466, G007463;

  /* Code vector and literal definitions */
  eul_allocate_static_string(str_7464, "keys of table ~a not accessable", 31);
  /* Byte-vector with size: 5 is_init: 0 index: 20 binding: (method-table-keys) */
  static const void *G007462[] = {I(aa,23,00,00),B(table1 ,19),I(1c,24,00,00),B(boot ,21),I(3d,02,01,00)};

  /* Byte-vector with size: 10 is_init: 0 index: 21 binding: anonymous */
  static const void *G007465[] = {I(aa,1b,12,1b),I(34,00,00,00),I(00,00,00,10),I(86,32,00,00),I(00,00,00,17),I(1c,10,1b,47),I(00,00,0f,1b),I(48,00,00,47),I(00,00,22,02),I(45,02,00,00)};

  /* Byte-vector with size: 20 is_init: 0 index: 23 binding: (method-table-keys) */
  static const void *G007467[] = {I(aa,46,01,26),I(00,00,00,03),I(24,00,00,00),B(table1 ,4),I(08,86,1b,48),I(00,00,1c,24),B(vector ,5),I(3c,01,1b,34),I(00,00,00,2d),I(23,00,00,00),B(table1 ,22),I(23,00,00,00),B(table1 ,21),I(3b,01,1f,03),I(24,00,00,00),B(vector ,13),I(3c,02,2a,47),I(00,00,32,00),I(00,00,00,07),I(86,45,03,00)};

  /* Byte-vector with size: 10 is_init: 0 index: 24 binding: anonymous */
  static const void *G007470[] = {I(aa,1b,12,1b),I(34,00,00,00),I(00,00,00,10),I(86,32,00,00),I(00,00,00,17),I(1c,11,1b,47),I(00,00,0f,1b),I(48,00,00,47),I(00,00,22,02),I(45,02,00,00)};

  /* Byte-vector with size: 20 is_init: 0 index: 25 binding: (method-table-values) */
  static const void *G007472[] = {I(aa,46,01,26),I(00,00,00,03),I(24,00,00,00),B(table1 ,4),I(08,86,1b,48),I(00,00,1c,24),B(vector ,5),I(3c,01,1b,34),I(00,00,00,2d),I(23,00,00,00),B(table1 ,22),I(23,00,00,00),B(table1 ,24),I(3b,01,1f,03),I(24,00,00,00),B(vector ,13),I(3c,02,2a,47),I(00,00,32,00),I(00,00,00,07),I(86,45,03,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 26 binding: (method-size) */
  static const void *G007474[] = {I(aa,83,24,00),B(table1 ,4),I(08,45,00,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 27 binding: (method-reset) */
  static const void *G007476[] = {I(aa,24,00,00),B(table1 ,9),I(3d,01,00,00)};

  /* Byte-vector with size: 19 is_init: 0 index: 28 binding: (method-clear-table) */
  static const void *G007478[] = {I(aa,1b,86,1c),I(26,00,00,00),I(00,00,00,03),I(1d,24,00,00),B(table1 ,4),I(09,22,02,2a),I(1b,82,1c,83),I(1d,24,00,00),B(table1 ,4),I(09,22,02,2a),I(26,00,00,00),I(00,00,00,10),I(26,00,00,00),I(00,00,00,04),I(15,1c,1c,1c),I(82,1d,24,00),B(table1 ,4),I(09,22,02,2a),I(1c,45,02,00)};

  eul_allocate_static_cons(cons_7485, NULL, NULL);
  eul_allocate_static_cons(cons_7484, NULL, eul_as_static(cons_7485));
  eul_allocate_static_string(str_7486, "table initialization of ~a without hash function", 48);
  /* Byte-vector with size: 69 is_init: 0 index: 33 binding: (method-initialize) */
  static const void *G007480[] = {I(ab,1c,04,24),B(table1 ,4),I(50,1b,34,00),I(00,00,01,02),I(1c,23,00,00),B(table1 ,29),I(24,00,00,00),B(boot ,27),I(3c,02,1d,23),B(table1 ,30),I(24,00,00,00),B(boot ,27),I(3c,02,24,00),B(mop_inspect ,6),I(3c,01,1b,34),I(00,00,00,25),I(24,00,00,00),B(mop_gf ,2),I(24,00,00,00),B(table1 ,8),I(1f,05,24,00),B(boot ,9),I(3d,03,05,32),I(00,00,00,a8),I(1c,24,00,00),B(compare ,7),I(50,1b,34,00),I(00,00,00,26),I(24,00,00,00),B(mop_gf ,2),I(24,00,00,00),B(table1 ,8),I(1f,06,24,00),B(boot ,9),I(3d,03,06,32),I(00,00,00,76),I(86,24,00,00),B(boot1 ,24),I(24,00,00,00),B(boot1 ,44),I(24,00,00,00),B(boot1 ,26),I(3c,03,1f,03),I(1c,86,6c,1b),I(34,00,00,00),I(00,00,00,3c),I(1f,06,23,00),B(table1 ,31),I(24,00,00,00),B(mop_key ,3),I(3c,02,24,00),B(mop_gf ,2),I(24,00,00,00),B(table1 ,14),I(1d,24,00,00),B(boot ,9),I(3d,03,09,22),I(01,32,00,00),I(00,00,00,1a),I(23,00,00,00),B(table1 ,32),I(1f,08,24,00),B(boot ,21),I(3d,02,08,22),I(02,22,01,22),I(02,32,00,00),I(00,00,00,0a),I(38,02,01,45),I(03,00,00,00)};
  ...
  static const void *G007491[] = {I(ab,1c,83,1d),I(24,00,00,00),B(table1 ,8),I(09,45,02,00)};

  /* Byte-vector with size: 4 is_init: 0 index: 37 binding: (setter-table-hash-function) */
  static const void *G007493[] = {I(ab,1c,82,1d),I(24,00,00,00),B(table1 ,8),I(09,45,02,00)};

  /* Byte-vector with size: 1 is_init: 0 index: 38 binding: (method-simple-hash-table-p) */
  static const void *G007495[] = {I(aa,1b,45,01)};

  /* Byte-vector with size: 1 is_init: 0 index: 39 binding: (method-simple-hash-table-p) */
  static const void *G007497[] = {I(aa,86,45,01)};

  /* Byte-vector with size: 1 is_init: 0 index: 40 binding: (method-tablep) */
  static const void *G007499[] = {I(aa,1b,45,01)};

  /* Byte-vector with size: 1 is_init: 0 index: 41 binding: (method-tablep) */
  static const void *G007501[] = {I(aa,86,45,01)};

  /* Byte-vector with size: 5 is_init: 0 index: 42 binding: (setter-table-entries) */
  static const void *G007503[] = {I(ab,1c,26,00),I(00,00,00,03),I(1d,24,00,00),B(table1 ,4),I(09,45,02,00)};

  /* Byte-vector with size: 4 is_init: 0 index: 43 binding: (setter-table-size) */
  static const void *G007505[] = {I(ab,1c,83,1d),I(24,00,00,00),B(table1 ,4),I(09,45,02,00)};

  /* Byte-vector with size: 4 is_init: 0 index: 44 binding: (setter-table-threshold) */
  static const void *G007507[] = {I(ab,1c,82,1d),I(24,00,00,00),B(table1 ,4),I(09,45,02,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 45 binding: anonymous */
  static const void *G007509[] = {I(a9,24,00,00),B(table1 ,3),I(45,00,00,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 46 binding: anonymous */
  static const void *G007511[] = {I(a9,24,00,00),B(boot1 ,44),I(45,00,00,00)};

  /* Byte-vector with size: 5 is_init: 0 index: 47 binding: anonymous */
  static const void *G007513[] = {I(a9,26,00,00),I(00,00,00,10),I(26,00,00,00),I(00,00,00,04),I(15,45,00,00)};

  /* Byte-vector with size: 1 is_init: 0 index: 48 binding: anonymous */
  static const void *G007515[] = {I(a9,82,45,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 49 binding: anonymous */
  static const void *G007517[] = {I(aa,41,00,00),B(table1 ,18),I(45,01,00,00)};

  eul_allocate_static_cons(cons_7533, NULL, NULL);
  ...
  eul_intern_keyword(key_7482,"comparator");
  eul_intern_keyword(key_7483,"hash-function");
  object_class(cons_7485) = eul_static_cons_class;
  eul_car(cons_7485) = key_7483;
  eul_cdr(cons_7485) = eul_nil;
  object_class(cons_7484) = eul_static_cons_class;
  eul_car(cons_7484) = key_7482;
  ...
  eul_intern_keyword(key_7521,"name");
  eul_intern_symbol(sym_7522,"entries");
  eul_intern_symbol(sym_7523,"fill-value");
  eul_intern_keyword(key_7524,"keyword");
  eul_intern_keyword(key_7525,"fill-value");
  eul_intern_symbol(sym_7526,"size");
  eul_intern_keyword(key_7527,"default");
  eul_intern_symbol(sym_7528,"threshold");
  eul_intern_symbol(sym_7529,"table");
  eul_intern_keyword(key_7530,"direct-superclasses");
  eul_intern_keyword(key_7531,"direct-slots");
  eul_intern_keyword(key_7532,"direct-keywords");
  object_class(cons_7533) = eul_static_cons_class;
  eul_car(cons_7533) = key_7525;
  eul_cdr(cons_7533) = eul_nil;
  eul_intern_symbol(sym_7534,"comparator");
  eul_intern_symbol(sym_7535,"hash-function");
  eul_intern_symbol(sym_7536,"hash-table");
  object_class(cons_7538) = eul_static_cons_class;
  eul_car(cons_7538) = key_7482;
  eul_cdr(cons_7538) = eul_nil;
  object_class(cons_7537) = eul_static_cons_class;
  eul_car(cons_7537) = key_7483;
  eul_intern_symbol(sym_7539,"tablep");
  eul_intern_symbol(sym_7540,"simple-hash-table-p");
  eul_intern_symbol(sym_7541,"hash-table-p");
  eul_intern_symbol(sym_7542,"clear-table");
  eul_intern_symbol(sym_7543,"table-values");
  eul_intern_symbol(sym_7544,"table-keys");
  eul_intern_symbol(sym_7545,"(setter table-threshold)");
  eul_intern_symbol(sym_7546,"(setter table-size)");
  eul_intern_symbol(sym_7547,"(setter table-entries)");
  eul_intern_symbol(sym_7548,"(method tablep)");
  eul_intern_symbol(sym_7549,"simple-hash-table");
  eul_intern_symbol(sym_7550,"(method simple-hash-table-p)");
  eul_intern_symbol(sym_7551,"(setter table-hash-function)");
  eul_intern_symbol(sym_7552,"(setter table-comparator)");
  eul_intern_symbol(sym_7553,"(method hash-table-p)");
  eul_intern_symbol(sym_7554,"(method initialize)");
  eul_intern_symbol(sym_7555,"(method clear-table)");
  eul_intern_symbol(sym_7556,"(method reset)");
  eul_intern_symbol(sym_7557,"(method size)");
  eul_intern_symbol(sym_7558,"(method table-values)");
  eul_intern_symbol(sym_7559,"(method table-keys)");
  ...
  eul_intern_symbol(sym_7574,"table-fill-value");
  eul_intern_symbol(sym_7575,"table-entries");
  eul_intern_symbol(sym_7576,"table-threshold");
  eul_intern_symbol(sym_7577,"table-hash-function");
  eul_intern_symbol(sym_7578,"table-comparator");
  eul_intern_symbol(sym_7579,"table-size");
  eul_intern_symbol(sym_7580,"top-level");
  ...
  table1_bindings[ 18] = (LispRef) (LispRef (*) (Stack *, LispRef *, LispRef *)) ff_stub_eul_hash_object7461;
  table1_bindings[ 19] = str_7464;
  table1_bindings[ 20] = G007463;
  table1_bindings[ 21] = G007466;
  table1_bindings[ 22] = sym_7469;
  table1_bindings[ 23] = G007468;
  table1_bindings[ 24] = G007471;
  table1_bindings[ 25] = G007473;
  table1_bindings[ 26] = G007475;
  table1_bindings[ 27] = G007477;
  table1_bindings[ 28] = G007479;
  table1_bindings[ 29] = key_7482;
  table1_bindings[ 30] = key_7483;
  table1_bindings[ 31] = cons_7484;
  table1_bindings[ 32] = str_7486;
  table1_bindings[ 33] = G007481;
  table1_bindings[ 34] = G007488;
  table1_bindings[ 35] = G007490;
  table1_bindings[ 36] = G007492;
  table1_bindings[ 37] = G007494;
  table1_bindings[ 38] = G007496;
  table1_bindings[ 39] = G007498;
  table1_bindings[ 40] = G007500;
  table1_bindings[ 41] = G007502;
  table1_bindings[ 42] = G007504;
  table1_bindings[ 43] = G007506;
  table1_bindings[ 44] = G007508;
  table1_bindings[ 45] = G007510;
  table1_bindings[ 46] = G007512;
  table1_bindings[ 47] = G007514;
  table1_bindings[ 48] = G007516;
  table1_bindings[ 49] = G007518;
  table1_bindings[ 50] = key_7521;
  table1_bindings[ 51] = sym_7522;
  table1_bindings[ 52] = sym_7523;
  table1_bindings[ 53] = key_7524;
  table1_bindings[ 54] = key_7525;
  table1_bindings[ 55] = sym_7526;
  table1_bindings[ 56] = key_7527;
  table1_bindings[ 57] = sym_7528;
  table1_bindings[ 58] = sym_7529;
  table1_bindings[ 59] = key_7530;
  table1_bindings[ 60] = key_7531;
  table1_bindings[ 61] = key_7532;
  table1_bindings[ 62] = cons_7533;
  table1_bindings[ 63] = sym_7534;
  table1_bindings[ 64] = sym_7535;
  table1_bindings[ 65] = sym_7536;
  table1_bindings[ 66] = cons_7537;
  table1_bindings[ 67] = sym_7539;
  table1_bindings[ 68] = sym_7540;
  table1_bindings[ 69] = sym_7541;
  table1_bindings[ 70] = sym_7542;
  table1_bindings[ 71] = sym_7543;
  table1_bindings[ 72] = sym_7544;
  table1_bindings[ 73] = sym_7545;
  table1_bindings[ 74] = sym_7546;
  table1_bindings[ 75] = sym_7547;
  table1_bindings[ 76] = sym_7548;
  table1_bindings[ 77] = sym_7549;
  table1_bindings[ 78] = sym_7550;
  table1_bindings[ 79] = sym_7551;
  table1_bindings[ 80] = sym_7552;
  table1_bindings[ 81] = sym_7553;
  table1_bindings[ 82] = sym_7554;
  table1_bindings[ 83] = sym_7555;
  table1_bindings[ 84] = sym_7556;
  table1_bindings[ 85] = sym_7557;
  table1_bindings[ 86] = sym_7558;
  table1_bindings[ 87] = sym_7559;
  table1_bindings[ 88] = G007520;
  table1_bindings[ 89] = G007561;
  table1_bindings[ 90] = G007563;
  table1_bindings[ 91] = G007565;
  table1_bindings[ 92] = G007567;
  table1_bindings[ 93] = G007569;
  table1_bindings[ 94] = G007571;
  table1_bindings[ 1] = eul_nil;
  table1_bindings[ 95] = sym_7574;
  table1_bindings[ 96] = sym_7575;
  table1_bindings[ 97] = sym_7576;
  table1_bindings[ 98] = sym_7577;
  table1_bindings[ 99] = sym_7578;
  table1_bindings[ 100] = sym_7579;
  table1_bindings[ 101] = sym_7580;
  eul_allocate_lambda( table1_bindings[0], "initialize-table1", 0, G007573);
