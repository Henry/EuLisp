...
(definterface level1
  (import (bit callback character collect compare condition convert copy dynamic event float fpi format handler integer let-cc list lock number random stream stream3 string symbol read telos thread table vector)
   syntax (_telos0)
   full-import (telos boot1 boot mop-defcl mop-meth mop-gf mop-inspect mop-init mop-class mop-key mop-prim mop-access mop-alloc condition event thread dynamic let-cc string convert copy integer number fpi collect compare callback bit stream3 character vector float stream stream1 lock stream2 socket list convert1 table1 table)
   export (
    ...
    ((name . table-fill-value) (pos . 17) (origin table1 . table-fill-value) (inline (G00358 (static-ref2) (binding-ref ? <table>) (primitive-relative-ref))))
    ((name . primitive-metaclass-p) (pos . 14) (origin mop-inspect . primitive-metaclass-p))
    ((name . string-stream-string-list) (pos . 49) (origin stream2 . string-stream-string-list) (inline (G004689 (static-ref0) (binding-ref ? <string-stream>) (primitive-relative-ref))) (setter (G004715 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <string-stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . socket-host) (pos . 11) (origin socket . socket-host) (inline (G005256 (static-ref2) (binding-ref ? <socket>) (primitive-relative-ref))) (setter (G005268 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <socket>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . eul_make_socket) (pos . 21) (origin stream1 . eul_make_socket) (class . ff) (arity . 3) (ff (3 3 0) 0 (eul_make_socket . ff_stub_eul_make_socket4199)))
    ...
    ((name . table-entries) (pos . 15) (origin table1 . table-entries) (inline (G00360 (static-fpi-ref 3) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G00370 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-sink) (pos . 37) (origin stream2 . stream-sink) (inline (G004687 (static-fpi-ref 5) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G004713 (stack-ref 1) (static-fpi-ref 5) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . control-block-buffer) (pos . 33) (origin stream2 . control-block-buffer) (inline (G004669 (static-fpi-ref 3) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G004699 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ((name . filter-keywords) (pos . 3) (origin mop-key . filter-keywords))
    ((name . primitive-prin) (pos . 38) (origin boot1 . prin))
    ((name . stream-lock) (pos . 32) (origin stream2 . stream-lock) (inline (G004679 (static-ref1) (binding-ref ? <stream>) (primitive-relative-ref))))
    ...
    ((name . eul_close) (pos . 16) (origin stream1 . eul_close) (class . ff) (arity . 1) (ff (0) 0 (close . ff_stub_close4194)))
    ((name . <method>) (pos . 23) (origin mop-class . <method>) (class . constant))
    ((name . do1-table) (pos . 7) (origin table . do1-table))
    ((name . control-block-mode) (pos . 30) (origin stream2 . control-block-mode) (inline (G004673 (static-ref1) (binding-ref ? <file-control-block>) (primitive-relative-ref))) (setter (G004703 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <file-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . output-condition-contents) (pos . 5) (origin condition . output-condition-contents))
    ...
    ((name . eul_read) (pos . 17) (origin stream1 . eul_read) (class . ff) (arity . 3) (ff (0 3 0) 0 (read . ff_stub_read4195)))
    ((name . socket-port) (pos . 8) (origin socket . socket-port) (inline (G005258 (static-fpi-ref 3) (binding-ref ? <socket>) (primitive-relative-ref))) (setter (G005270 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <socket>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . <system-condition>) (pos . 2) (origin condition . <system-condition>) (class . constant))
    ...
    ((name . table-threshold) (pos . 11) (origin table1 . table-threshold) (inline (G00354 (static-ref0) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G00366 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ((name . table-hash-function) (pos . 10) (origin table1 . table-hash-function) (inline (G00362 (static-ref0) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G00372 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-comparator) (pos . 7) (origin table1 . table-comparator) (inline (G00364 (static-ref1) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G00374 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . ntok) (pos . 26) (origin stream1 . ntok) (class . ff) (arity . 2) (ff (8 8) 6 (ntok . ff_stub_ntok4204)))
    ...
    ((name . connection-port) (pos . 6) (origin socket . connection-port) (inline (G005260 (static-ref0) (binding-ref ? <connection>) (primitive-relative-ref))) (setter (G005272 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <connection>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-write-action) (pos . 14) (origin stream2 . stream-write-action) (inline (G004681 (static-ref2) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G004707 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . control-block-buffer-size) (pos . 9) (origin stream2 . control-block-buffer-size) (inline (G004667 (static-ref2) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G004697 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-read-action) (pos . 8) (origin stream2 . stream-read-action) (inline (G004683 (static-fpi-ref 3) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G004709 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . set-dispatch-macro-character) (pos . 14) (origin read . set-dispatch-macro-character))
    ...
    ((name . eul_open) (pos . 15) (origin stream1 . eul_open) (class . ff) (arity . 3) (ff (3 0 0) 0 (open . ff_stub_open4193)))
    ...
    ((name . read-line) (pos . 13) (origin read . read-line))
    ...
    ((name . list-start) (pos . 12) (origin read . list-start) (class . constant))
    ...
    ((name . control-block-buffer-cnt) (pos . 48) (origin stream2 . control-block-buffer-cnt) (inline (G004663 (static-ref0) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G004693 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . eul_socket_strerror) (pos . 24) (origin stream1 . eul_socket_strerror) (class . ff) (arity . 1) (ff (0) 3 (eul_socket_strerror . ff_stub_eul_socket_strerror4202)))
    ...
    ((name . control-block-descriptor) (pos . 42) (origin stream2 . control-block-descriptor) (inline (G004671 (static-ref0) (binding-ref ? <file-control-block>) (primitive-relative-ref))) (setter (G004701 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <file-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . lispin) (pos . 10) (origin read . lispin) (class . constant))
    ...
    ((name . read-s-expression) (pos . 9) (origin read . read-s-expression))
    ...
    ((name . eul_write) (pos . 18) (origin stream1 . eul_write) (class . ff) (arity . 3) (ff (0 3 0) 0 (write . ff_stub_write4196)))
    ...
    ((name . control-block-file-name) (pos . 34) (origin stream2 . control-block-file-name) (inline (G004675 (static-ref2) (binding-ref ? <file-control-block>) (primitive-relative-ref))) (setter (G004705 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <file-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . semaphore-counter) (pos . 5) (origin lock . semaphore-counter) (inline (G004320 (static-ref0) (binding-ref ? <semaphore>) (primitive-relative-ref))) (setter (G004322 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <semaphore>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . eul_make_connection) (pos . 23) (origin stream1 . eul_make_connection) (class . ff) (arity . 3) (ff (3 3 3) 0 (eul_make_connection . ff_stub_eul_make_connection4201)))
    ...
    ((name . *default-error-handler*) (pos . 4) (origin condition . *default-error-handler*))
    ...
    ((name . signal) (pos . 3) (origin condition . signal))
    ...
    ((name . sread) (pos . 8) (origin read . sread))
    ...
    ((name . stream-source) (pos . 23) (origin stream2 . stream-source) (inline (G004685 (static-fpi-ref 4) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G004711 (stack-ref 1) (static-fpi-ref 4) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ((name . class-slot-defaults) (pos . 68) (origin mop-class . class-slot-defaults) (class . constant))
    ((name . eul_sprintf_string) (pos . 20) (origin stream1 . eul_sprintf_string) (class . ff) (arity . 6) (ff (3 0 0 0 3 3) 0 (eul_sprintf_string . ff_stub_eul_sprintf_string4198)))
    ...
    ((name . eul_socket_accept) (pos . 22) (origin stream1 . eul_socket_accept) (class . ff) (arity . 1) (ff (0) 0 (eul_socket_accept . ff_stub_eul_socket_accept4200)))
    ((name . unquote-mark) (pos . 7) (origin read . unquote-mark) (class . constant))
    ...
    ((name . list-stop) (pos . 6) (origin read . list-stop) (class . constant))
    ((name . handle) (pos . 4) (origin handler . handle) (inline (G001785 (static-ref0) (binding-ref ? <handler>) (primitive-relative-ref))) (setter (G001787 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <handler>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . read-into-buffer) (pos . 27) (origin stream1 . read-into-buffer) (class . ff) (arity . 3) (ff (0 3 0) 0 (read_into_buffer . ff_stub_read_into_buffer4205)))
    ((name . stream-mode) (pos . 17) (origin stream2 . stream-mode) (inline (G004677 (static-ref0) (binding-ref ? <stream>) (primitive-relative-ref))))
    ((name . sprintf) (pos . 5) (origin stream . sprintf))
    ((name . eos) (pos . 5) (origin read . eos) (class . constant))
    ...
    ((name . eul_sprintf) (pos . 19) (origin stream1 . eul_sprintf) (class . ff) (arity . 4) (ff (3 0 3 8) 0 (eul_sprintf . ff_stub_eul_sprintf4197)))
    ...
    ((name . connection-host) (pos . 4) (origin socket . connection-host) (inline (G005262 (static-ref1) (binding-ref ? <connection>) (primitive-relative-ref))) (setter (G005274 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <connection>) (set-primitive-relative-ref) (nobble 2))))
    ((name . keywordp) (pos . 3) (origin symbol . keywordp))
    ((name . socket-queue-size) (pos . 5) (origin socket . socket-queue-size) (inline (G005252 (static-ref0) (binding-ref ? <socket>) (primitive-relative-ref))) (setter (G005264 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <socket>) (set-primitive-relative-ref) (nobble 2))))
    ((name . read-char) (pos . 4) (origin read . read-char))
    ((name . hostname) (pos . 3) (origin stream1 . hostname))
    ((name . table-size) (pos . 5) (origin table1 . table-size) (inline (G00356 (static-ref1) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G00368 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . control-block-buffer-pos) (pos . 11) (origin stream2 . control-block-buffer-pos) (inline (G004665 (static-ref1) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G004695 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . sread-s-expression) (pos . 3) (origin read . sread-s-expression))
    ...
    ((name . socket-descriptor) (pos . 3) (origin socket . socket-descriptor) (inline (G005254 (static-ref1) (binding-ref ? <socket>) (primitive-relative-ref))) (setter (G005266 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <socket>) (set-primitive-relative-ref) (nobble 2))))
