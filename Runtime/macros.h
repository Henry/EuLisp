 ...
 ** ----------------------------------------------------------------------- **
 **  Description: C include file of EuLisp module macros
...
#define defcondition_fn_index 15 
#define defglobal_fn_index 6 
