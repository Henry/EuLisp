...
void initialize_module_thread()
{
  ...
  static const void *G00440[] = {I(aa,23,00,00),B(thread ,47),I(1c,84,1d,24),B(thread ,36),I(09,22,02,2a),I(24,00,00,00),B(thread ,17),I(3d,00,00,00)};

  /* Byte-vector with size: 15 is_init: 0 index: 49 binding: (method-thread-value) */
  static const void *G00443[] = {I(aa,1b,83,24),B(thread ,36),I(08,1b,34,00),I(00,00,00,16),I(1c,82,24,00),B(thread ,36),I(08,32,00,00),I(00,00,00,1e),I(24,00,00,00),B(thread ,6),I(3c,00,2a,1c),I(24,00,00,00),B(thread ,4),I(3d,01,02,45),I(02,00,00,00)};
  ...
  static const void *G00447[] = {I(aa,47,01,00),I(1c,1c,26,00),I(00,00,00,03),I(1d,24,00,00),B(thread ,36),I(09,22,02,2a),I(47,01,00,23),B(thread ,51),I(1c,84,1d,24),B(thread ,36),I(09,22,02,2a),I(47,01,00,47),I(00,00,3d,01),I(01,00,00,00)};

  /* Byte-vector with size: 16 is_init: 0 index: 54 binding: anonymous */
  static const void *G00450[] = {I(aa,46,01,1b),I(48,00,00,23),B(thread ,53),I(23,00,00,00),B(thread ,52),I(3b,01,24,00),B(thread ,18),I(3c,01,47,01),I(01,1c,24,00),B(boot ,9),I(3c,02,24,00),B(thread ,19),I(1c,24,00,00),B(thread ,11),I(3d,02,03,45),I(03,00,00,00)};
  ...
  /* Byte-vector with size: 1 is_init: 0 index: 59 binding: (method-simple-thread-p) */
  static const void *G00459[] = {I(aa,86,45,01)};

  /* Byte-vector with size: 5 is_init: 0 index: 60 binding: (setter-thread-continuation) */
  static const void *G00461[] = {I(ab,1c,26,00),I(00,00,00,03),I(1d,24,00,00),B(thread ,36),I(09,45,02,00)};

  /* Byte-vector with size: 4 is_init: 0 index: 61 binding: (setter-thread-state) */
  static const void *G00463[] = {I(ab,1c,84,1d),I(24,00,00,00),B(thread ,36),I(09,45,02,00)};

  /* Byte-vector with size: 4 is_init: 0 index: 62 binding: (setter-thread-returned-p) */
  static const void *G00465[] = {I(ab,1c,83,1d),I(24,00,00,00),B(thread ,36),I(09,45,02,00)};

  /* Byte-vector with size: 4 is_init: 0 index: 63 binding: (setter-thread-return-value) */
  static const void *G00467[] = {I(ab,1c,82,1d),I(24,00,00,00),B(thread ,36),I(09,45,02,00)};
  ...
  static const void *G00473[] = {I(ab,1c,26,00),I(00,00,00,03),I(1d,24,00,00),B(thread ,29),I(09,45,02,00)};

  /* Byte-vector with size: 4 is_init: 0 index: 67 binding: (setter-thread-dynamic-variables) */
  static const void *G00475[] = {I(ab,1c,84,1d),I(24,00,00,00),B(thread ,29),I(09,45,02,00)};
  ...
  static const void *G00479[] = {I(a8,1b,34,00),I(00,00,00,36),I(1b,10,1b,23),B(thread ,69),I(1c,84,1d,24),B(thread ,36),I(09,22,02,2a),I(1b,24,00,00),B(thread ,38),I(3c,01,2a,24),B(thread ,17),I(3d,00,02,22),I(01,32,00,00),I(00,00,00,1a),I(24,00,00,00),B(thread ,6),I(24,00,00,00),B(thread ,11),I(3d,01,01,45),I(01,00,00,00)};

  /* Byte-vector with size: 17 is_init: 0 index: 71 binding: anonymous */
  static const void *G00482[] = {I(a8,1b,34,00),I(00,00,00,2a),I(1b,10,23,00),B(thread ,51),I(1c,84,1d,24),B(thread ,36),I(09,22,02,2a),I(24,00,00,00),B(thread ,17),I(3d,00,01,32),I(00,00,00,18),I(24,00,00,00),B(thread ,3),I(24,00,00,00),B(thread ,11),I(3d,01,01,45),I(01,00,00,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 72 binding: anonymous */
  static const void *G00484[] = {I(a9,24,00,00),B(thread ,35),I(45,00,00,00)};

  /* Byte-vector with size: 5 is_init: 0 index: 74 binding: anonymous */
  static const void *G00486[] = {I(a9,23,00,00),B(thread ,73),I(86,24,00,00),B(boot1 ,27),I(3d,02,00,00)};
  ...
  static const void *G00489[] = {I(a9,24,00,00),B(mop_class ,21),I(24,00,00,00),B(boot1 ,27),I(3c,01,23,00),B(thread ,75),I(23,00,00,00),B(thread ,76),I(23,00,00,00),B(thread ,77),I(23,00,00,00),B(thread ,78),I(24,00,00,00),B(boot1 ,27),I(3c,04,23,00),B(thread ,75),I(23,00,00,00),B(thread ,79),I(23,00,00,00),B(thread ,80),I(23,00,00,00),B(thread ,53),I(23,00,00,00),B(thread ,74),I(3b,00,24,00),B(boot1 ,27),I(3c,04,23,00),B(thread ,75),I(23,00,00,00),B(thread ,77),I(24,00,00,00),B(boot1 ,27),I(3c,02,23,00),B(thread ,75),I(23,00,00,00),B(thread ,81),I(24,00,00,00),B(boot1 ,27),I(3c,02,1f,03),I(1f,03,1f,03),I(1f,03,24,00),B(boot1 ,27),I(3c,04,24,00),B(mop_class ,71),I(23,00,00,00),B(thread ,75),I(23,00,00,00),B(thread ,82),I(23,00,00,00),B(thread ,83),I(1f,09,23,00),B(thread ,84),I(1f,06,23,00),B(thread ,85),I(23,00,00,00),B(thread ,86),I(23,00,00,00),B(thread ,87),I(87,24,00,00),B(mop_gf ,2),I(3c,0b,1b,89),B(thread ,29),I(2a,24,00,00),B(thread ,29),I(24,00,00,00),B(boot1 ,27),I(3c,01,23,00),B(thread ,75),I(23,00,00,00),B(thread ,88),I(24,00,00,00),B(boot1 ,27),I(3c,02,23,00),B(thread ,75),I(23,00,00,00),B(thread ,89),I(24,00,00,00),B(boot1 ,27),I(3c,02,23,00),B(thread ,75),I(23,00,00,00),B(thread ,90),I(24,00,00,00),B(boot1 ,27),I(3c,02,23,00),B(thread ,75),I(23,00,00,00),B(thread ,91),I(24,00,00,00),B(boot1 ,27),I(3c,02,1f,03),I(1f,03,1f,03),I(1f,03,24,00),B(boot1 ,27),I(3c,04,24,00),B(mop_class ,71),I(23,00,00,00),B(thread ,75),I(23,00,00,00),B(thread ,92),I(23,00,00,00),B(thread ,83),I(1f,09,23,00),B(thread ,84),I(1f,06,23,00),B(thread ,85),I(86,24,00,00),B(mop_gf ,2),I(3c,09,1b,89),B(thread ,36),I(2a,24,00,00),B(mop_class ,21),I(24,00,00,00),B(boot1 ,27),I(3c,01,23,00),B(thread ,75),I(23,00,00,00),B(thread ,93),I(23,00,00,00),B(thread ,77),I(23,00,00,00),B(thread ,94),I(24,00,00,00),B(boot1 ,27),I(3c,04,23,00),B(thread ,75),I(23,00,00,00),B(thread ,95),I(23,00,00,00),B(thread ,77),I(23,00,00,00),B(thread ,96),I(24,00,00,00),B(boot1 ,27),I(3c,04,23,00),B(thread ,75),I(23,00,00,00),B(thread ,97),I(23,00,00,00),B(thread ,77),I(23,00,00,00),B(thread ,98),I(24,00,00,00),B(boot1 ,27),I(3c,04,23,00),B(thread ,75),I(23,00,00,00),B(thread ,99),I(23,00,00,00),B(thread ,77),I(23,00,00,00),B(thread ,100),I(24,00,00,00),B(boot1 ,27),I(3c,04,1f,03),I(1f,03,1f,03),I(1f,03,24,00),B(boot1 ,27),I(3c,04,24,00),B(mop_class ,71),I(23,00,00,00),B(thread ,75),I(23,00,00,00),B(thread ,89),I(23,00,00,00),B(thread ,83),I(1f,09,23,00),B(thread ,84),I(1f,06,23,00),B(thread ,85),I(23,00,00,00),B(thread ,101),I(24,00,00,00),B(mop_gf ,2),I(3c,09,1b,89),B(thread ,25),I(2a,83,24,00),B(mop_class ,21),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,27),I(3c,00,24,00),B(boot1 ,27),I(3c,00,23,00),B(thread ,102),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,55),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(thread ,31),I(2a,83,24,00),B(mop_class ,21),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,27),I(3c,00,24,00),B(boot1 ,27),I(3c,00,23,00),B(thread ,103),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,55),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(thread ,16),I(2a,24,00,00),B(thread ,36),I(89,00,00,00),B(thread ,7),I(2a,86,89,00),B(thread ,35),I(2a,23,00,00),B(thread ,53),I(23,00,00,00),B(thread ,72),I(3b,00,89,00),B(thread ,22),I(2a,83,24,00),B(mop_class ,21),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,27),I(3c,00,24,00),B(boot1 ,27),I(3c,00,23,00),B(thread ,104),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,55),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(thread ,26),I(2a,83,24,00),B(mop_class ,21),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,27),I(3c,00,24,00),B(boot1 ,27),I(3c,00,23,00),B(thread ,105),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,55),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(thread ,4),I(2a,23,00,00),B(thread ,53),I(23,00,00,00),B(thread ,71),I(3b,ff,89,00),B(thread ,3),I(2a,23,00,00),B(thread ,53),I(23,00,00,00),B(thread ,70),I(3b,ff,89,00),B(thread ,6),I(2a,83,24,00),B(mop_class ,21),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,27),I(3c,00,24,00),B(boot1 ,27),I(3c,00,23,00),B(thread ,106),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,55),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(thread ,2),I(2a,84,24,00),B(mop_class ,21),I(24,00,00,00),B(mop_class ,21),I(24,00,00,00),B(boot1 ,40),I(3c,03,24,00),B(boot1 ,27),I(3c,00,24,00),B(boot1 ,27),I(3c,00,23,00),B(thread ,107),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,55),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(thread ,5),I(2a,86,89,00),B(thread ,9),I(2a,23,00,00),B(thread ,53),I(23,00,00,00),B(thread ,68),I(3b,00,89,00),B(thread ,24),I(2a,83,24,00),B(mop_class ,21),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,27),I(3c,00,24,00),B(boot1 ,27),I(3c,00,23,00),B(thread ,108),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,55),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(thread ,10),I(2a,24,00,00),B(boot1 ,42),I(24,00,00,00),B(boot1 ,42),I(3c,01,24,00),B(thread ,27),I(23,00,00,00),B(thread ,109),I(23,00,00,00),B(thread ,67),I(3b,02,1d,3c),I(02,2a,24,00),B(boot1 ,42),I(24,00,00,00),B(boot1 ,42),I(3c,01,24,00),B(thread ,15),I(23,00,00,00),B(thread ,110),I(23,00,00,00),B(thread ,66),I(3b,02,1d,3c),I(02,2a,24,00),B(thread ,31),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(mop_class ,21),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,27),I(3c,00,24,00),B(thread ,31),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(thread ,111),I(23,00,00,00),B(thread ,65),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(thread ,31),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(thread ,31),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(thread ,29),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,27),I(3c,00,24,00),B(thread ,31),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(thread ,111),I(23,00,00,00),B(thread ,64),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(thread ,31),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(thread ,31),I(2a,24,00,00),B(thread ,29),I(2a,24,00,00),B(boot1 ,42),I(24,00,00,00),B(boot1 ,42),I(3c,01,24,00),B(thread ,20),I(23,00,00,00),B(thread ,112),I(23,00,00,00),B(thread ,63),I(3b,02,1d,3c),I(02,2a,24,00),B(boot1 ,42),I(24,00,00,00),B(boot1 ,42),I(3c,01,24,00),B(thread ,30),I(23,00,00,00),B(thread ,113),I(23,00,00,00),B(thread ,62),I(3b,02,1d,3c),I(02,2a,24,00),B(boot1 ,42),I(24,00,00,00),B(boot1 ,42),I(3c,01,24,00),B(thread ,23),I(23,00,00,00),B(thread ,114),I(23,00,00,00),B(thread ,61),I(3b,02,1d,3c),I(02,2a,24,00),B(boot1 ,42),I(24,00,00,00),B(boot1 ,42),I(3c,01,24,00),B(thread ,32),I(23,00,00,00),B(thread ,115),I(23,00,00,00),B(thread ,60),I(3b,02,1d,3c),I(02,2a,24,00),B(thread ,16),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(mop_class ,21),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,27),I(3c,00,24,00),B(thread ,16),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(thread ,116),I(23,00,00,00),B(thread ,59),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(thread ,16),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(thread ,16),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(thread ,36),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,27),I(3c,00,24,00),B(thread ,16),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(thread ,116),I(23,00,00,00),B(thread ,58),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(thread ,16),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(thread ,16),I(2a,24,00,00),B(thread ,36),I(2a,24,00,00),B(thread ,36),I(24,00,00,00),B(mop_gf ,2),I(3c,01,1b,23),B(thread ,117),I(1c,84,1d,24),B(thread ,36),I(09,22,02,2a),I(1b,89,00,00),B(thread ,35),I(2a,24,00,00),B(mop_gf ,12),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(thread ,36),I(86,24,00,00),B(boot1 ,40),I(3c,03,24,00),B(boot1 ,27),I(3c,00,24,00),B(mop_gf ,12),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(thread ,118),I(23,00,00,00),B(thread ,57),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(mop_gf ,12),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(thread ,26),I(2a,24,00,00),B(thread ,26),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(thread ,36),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,27),I(3c,00,24,00),B(thread ,26),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(thread ,119),I(23,00,00,00),B(thread ,50),I(3b,fe,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(thread ,26),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(thread ,4),I(2a,24,00,00),B(thread ,4),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(thread ,36),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,27),I(3c,00,24,00),B(thread ,4),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(thread ,120),I(23,00,00,00),B(thread ,49),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(thread ,4),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(thread ,2),I(2a,24,00,00),B(thread ,2),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(thread ,36),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,27),I(3c,00,24,00),B(thread ,2),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(thread ,121),I(23,00,00,00),B(thread ,48),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(thread ,2),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(thread ,5),I(2a,24,00,00),B(thread ,5),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(thread ,36),I(86,24,00,00),B(boot1 ,40),I(3c,03,24,00),B(boot1 ,27),I(3c,00,24,00),B(thread ,5),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(thread ,122),I(23,00,00,00),B(thread ,46),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(thread ,5),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(boot1 ,42),I(24,00,00,00),B(boot1 ,42),I(3c,01,24,00),B(thread ,12),I(23,00,00,00),B(thread ,123),I(23,00,00,00),B(thread ,45),I(3b,02,1d,3c),I(02,2a,24,00),B(boot1 ,42),I(24,00,00,00),B(boot1 ,42),I(3c,01,24,00),B(thread ,39),I(23,00,00,00),B(thread ,124),I(23,00,00,00),B(thread ,44),I(3b,02,1d,3c),I(02,2a,24,00),B(boot1 ,42),I(24,00,00,00),B(boot1 ,42),I(3c,01,24,00),B(thread ,37),I(23,00,00,00),B(thread ,125),I(23,00,00,00),B(thread ,43),I(3b,02,1d,3c),I(02,2a,24,00),B(boot1 ,42),I(24,00,00,00),B(boot1 ,42),I(3c,01,24,00),B(thread ,14),I(23,00,00,00),B(thread ,126),I(23,00,00,00),B(thread ,42),I(3b,02,1d,3c),I(02,2a,24,00),B(thread ,10),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(mop_class ,21),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,27),I(3c,00,24,00),B(thread ,10),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(thread ,127),I(23,00,00,00),B(thread ,41),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(thread ,10),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(thread ,10),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(thread ,25),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,27),I(3c,00,24,00),B(thread ,10),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(thread ,127),I(23,00,00,00),B(thread ,40),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(thread ,10),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(thread ,10),I(2a,24,00,00),B(thread ,25),I(45,7e,00,00)};

  /* Byte-vector with size: 8 is_init: 0 index: 129 binding: thread-enable */
  static const void *G00548[] = {I(aa,1b,23,00),B(thread ,69),I(1c,84,1d,24),B(thread ,36),I(09,22,02,2a),I(1b,24,00,00),B(thread ,38),I(3d,01,01,00)};

  /* Byte-vector with size: 17 is_init: 0 index: 130 binding: anonymous */
  static const void *G00550[] = {I(aa,24,00,00),B(thread ,35),I(1b,1d,1c,26),I(00,00,00,03),I(1d,24,00,00),B(thread ,36),I(09,22,02,2a),I(86,89,00,00),B(thread ,35),I(2a,47,00,00),I(1c,47,00,01),I(24,00,00,00),B(boot ,9),I(3c,03,24,00),B(thread ,21),I(3d,01,02,45),I(02,00,00,00)};
  ...
  static const void *G00556[] = {I(aa,47,01,00),I(1c,1c,26,00),I(00,00,00,03),I(1d,24,00,00),B(thread ,36),I(09,22,02,2a),I(47,01,00,47),I(00,00,3d,01),I(01,00,00,00)};

  /* Byte-vector with size: 15 is_init: 0 index: 134 binding: anonymous */
  static const void *G00558[] = {I(aa,46,01,1b),I(48,00,00,47),I(01,00,26,00),I(00,00,00,03),I(24,00,00,00),B(thread ,36),I(08,23,00,00),B(thread ,53),I(23,00,00,00),B(thread ,133),I(3b,01,24,00),B(thread ,18),I(3c,01,2a,47),I(01,01,1c,3d),I(01,02,45,02)};
  ...
  static const void *G00564[] = {I(aa,26,00,00),I(00,00,00,03),I(24,00,00,00),B(thread ,29),I(08,45,00,00)};
  ...
  static const void *G00571[] = {I(ab,1c,1c,1c),I(82,1d,24,00),B(thread ,36),I(09,22,02,2a),I(1c,87,1c,83),I(1d,24,00,00),B(thread ,36),I(09,22,02,2a),I(1c,23,00,00),B(thread ,90),I(1c,84,1d,24),B(thread ,36),I(09,22,02,2a),I(24,00,00,00),B(thread ,17),I(3d,00,02,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 142 binding: thread-return-value */
  static const void *G00573[] = {I(aa,82,24,00),B(thread ,36),I(08,45,00,00)};

  /* Byte-vector with size: 13 is_init: 0 index: 143 binding: thread-run */
  static const void *G00575[] = {I(aa,1b,89,00),B(thread ,35),I(2a,1b,23,00),B(thread ,117),I(1c,84,1d,24),B(thread ,36),I(09,22,02,2a),I(1b,26,00,00),I(00,00,00,03),I(24,00,00,00),B(thread ,36),I(08,1c,1c,3d),I(01,02,45,02)};

  /* Byte-vector with size: 3 is_init: 0 index: 144 binding: thread-state */
  static const void *G00577[] = {I(aa,84,24,00),B(thread ,36),I(08,45,00,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 145 binding: thread-dynamic-variables */
  static const void *G00579[] = {I(aa,84,24,00),B(thread ,29),I(08,45,00,00)};
  ...
  /* Byte-vector with size: 3 is_init: 0 index: 148 binding: thread-returned-p */
  static const void *G00585[] = {I(aa,83,24,00),B(thread ,36),I(08,45,00,00)};

  /* Byte-vector with size: 5 is_init: 0 index: 149 binding: thread-continuation */
  static const void *G00587[] = {I(aa,26,00,00),I(00,00,00,03),I(24,00,00,00),B(thread ,36),I(08,45,00,00)};

  /* Byte-vector with size: 2 is_init: 0 index: 150 binding: anonymous */
  static const void *G00589[] = {I(aa,47,00,00),I(1c,5b,45,01)};

  /* Byte-vector with size: 13 is_init: 0 index: 151 binding: call1/cc-aux */
  static const void *G00591[] = {I(ab,46,01,1b),I(48,00,00,47),I(00,00,5a,2a),I(23,00,00,00),B(thread ,53),I(23,00,00,00),B(thread ,150),I(3b,01,1d,3c),I(01,1b,34,00),I(00,00,00,0e),I(1b,32,00,00),I(00,00,00,08),I(86,45,03,00)};
  ...
  /* Byte-vector with size: 15 is_init: 0 index: 155 binding: thread-queue-append */
  static const void *G00598[] = {I(aa,24,00,00),B(thread ,9),I(12,1b,34,00),I(00,00,00,1a),I(1c,86,0f,1b),I(89,00,00,00),B(thread ,9),I(22,01,32,00),I(00,00,00,19),I(24,00,00,00),B(thread ,9),I(1d,24,00,00),B(thread ,28),I(3d,02,02,45),I(02,00,00,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 156 binding: state-context-stack */
  static const void *G00600[] = {I(aa,83,24,00),B(thread ,25),I(08,45,00,00)};

  /* Byte-vector with size: 178 is_init: 1 index: 0 binding: initialize-thread */
  static const void *G00602[] = {I(87,25,00,00),B(thread ,1),I(24,00,00,00),B(event ,1),I(3e,0b,24,00),B(event ,0),I(3c,00,21,01),I(24,00,00,00),B(telos ,1),I(3e,0b,24,00),B(telos ,0),I(3c,00,21,01),I(23,00,00,00),B(thread ,157),I(23,00,00,00),B(thread ,156),I(3b,01,25,00),B(thread ,39),I(23,00,00,00),B(thread ,158),I(23,00,00,00),B(thread ,155),I(3b,01,25,00),B(thread ,38),I(23,00,00,00),B(thread ,159),I(23,00,00,00),B(thread ,154),I(3b,01,25,00),B(thread ,37),I(86,25,00,00),B(thread ,36),I(86,25,00,00),B(thread ,35),I(23,00,00,00),B(thread ,160),I(23,00,00,00),B(thread ,153),I(3b,00,25,00),B(thread ,34),I(23,00,00,00),B(thread ,161),I(23,00,00,00),B(thread ,151),I(3b,02,25,00),B(thread ,33),I(23,00,00,00),B(thread ,162),I(23,00,00,00),B(thread ,149),I(3b,01,25,00),B(thread ,32),I(86,25,00,00),B(thread ,31),I(23,00,00,00),B(thread ,163),I(23,00,00,00),B(thread ,148),I(3b,01,25,00),B(thread ,30),I(86,25,00,00),B(thread ,29),I(23,00,00,00),B(thread ,164),I(23,00,00,00),B(thread ,147),I(3b,02,25,00),B(thread ,28),I(23,00,00,00),B(thread ,165),I(23,00,00,00),B(thread ,145),I(3b,01,25,00),B(thread ,27),I(86,25,00,00),B(thread ,26),I(86,25,00,00),B(thread ,25),I(86,25,00,00),B(thread ,24),I(23,00,00,00),B(thread ,166),I(23,00,00,00),B(thread ,144),I(3b,01,25,00),B(thread ,23),I(86,25,00,00),B(thread ,22),I(23,00,00,00),B(thread ,167),I(23,00,00,00),B(thread ,143),I(3b,01,25,00),B(thread ,21),I(23,00,00,00),B(thread ,168),I(23,00,00,00),B(thread ,142),I(3b,01,25,00),B(thread ,20),I(23,00,00,00),B(thread ,169),I(23,00,00,00),B(thread ,141),I(3b,02,25,00),B(thread ,19),I(23,00,00,00),B(thread ,170),I(23,00,00,00),B(thread ,140),I(3b,01,25,00),B(thread ,18),I(23,00,00,00),B(thread ,171),I(23,00,00,00),B(thread ,139),I(3b,00,25,00),B(thread ,17),I(86,25,00,00),B(thread ,16),I(23,00,00,00),B(thread ,172),I(23,00,00,00),B(thread ,137),I(3b,01,25,00),B(thread ,15),I(23,00,00,00),B(thread ,173),I(23,00,00,00),B(thread ,136),I(3b,01,25,00),B(thread ,14),I(23,00,00,00),B(thread ,174),I(23,00,00,00),B(thread ,135),I(3b,02,25,00),B(thread ,13),I(23,00,00,00),B(thread ,175),I(23,00,00,00),B(thread ,132),I(3b,01,25,00),B(thread ,12),I(23,00,00,00),B(thread ,176),I(23,00,00,00),B(thread ,131),I(3b,fe,25,00),B(thread ,11),I(86,25,00,00),B(thread ,10),I(86,25,00,00),B(thread ,9),I(23,00,00,00),B(thread ,177),I(23,00,00,00),B(thread ,129),I(3b,01,25,00),B(thread ,8),I(86,25,00,00),B(thread ,7),I(86,25,00,00),B(thread ,6),I(86,25,00,00),B(thread ,5),I(86,25,00,00),B(thread ,4),I(86,25,00,00),B(thread ,3),I(86,25,00,00),B(thread ,2),I(23,00,00,00),B(thread ,178),I(23,00,00,00),B(thread ,128),I(3b,00,3d,00),I(00,ac,00,00)};
  ...
  eul_intern_symbol(sym_523,"simple-thread-p");
  ...
  eul_intern_symbol(sym_533,"(setter thread-returned-p)");
  eul_intern_symbol(sym_534,"(setter thread-state)");
  eul_intern_symbol(sym_535,"(setter thread-continuation)");
  eul_intern_symbol(sym_536,"(method simple-thread-p)");
  ...
  eul_intern_symbol(sym_604,"state-context-stack");
  eul_intern_symbol(sym_605,"thread-queue-append");
  eul_intern_symbol(sym_606,"state-value-stack-size");
  eul_intern_symbol(sym_607,"thread-queue-remove-last");
  eul_intern_symbol(sym_608,"call1/cc-aux");
  eul_intern_symbol(sym_609,"thread-continuation");
  eul_intern_symbol(sym_610,"thread-returned-p");
  ...
  thread_bindings[ 151] = G00592;
  thread_bindings[ 152] = str_595;
  thread_bindings[ 153] = G00594;
