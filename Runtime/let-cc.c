...
void initialize_module_let_cc()
{
  ...
  static const void *G00800[] = {I(aa,46,02,86),I(1b,48,00,00),I(23,00,00,00),B(let_cc ,4),I(23,00,00,00),B(let_cc ,3),I(3b,02,48,00),I(00,23,00,00),B(let_cc ,5),I(24,00,00,00),B(dynamic ,3),I(3c,01,1b,24),B(boot ,18),I(3c,01,1b,1d),I(47,00,00,3c),I(02,2a,24,00),B(dynamic ,4),I(47,01,02,15),I(24,00,00,00),B(dynamic ,6),I(3c,01,2a,24),B(dynamic ,7),I(47,01,03,15),I(24,00,00,00),B(dynamic ,8),I(3c,01,2a,47),I(01,00,1f,04),I(5d,45,04,00)};

  /* Byte-vector with size: 30 is_init: 0 index: 8 binding: call/ep */
  static const void *G00804[] = {I(aa,46,04,24),B(thread ,24),I(24,00,00,00),B(mop_gf ,2),I(3c,01,23,00),B(let_cc ,5),I(24,00,00,00),B(dynamic ,3),I(3c,01,1b,24),B(boot ,18),I(3c,01,1d,1c),I(24,00,00,00),B(dynamic ,4),I(24,00,00,00),B(dynamic ,7),I(1f,03,48,00),I(00,1d,48,00),I(01,1c,48,00),I(02,1b,48,00),I(03,47,00,00),I(5c,2a,23,00),B(let_cc ,7),I(23,00,00,00),B(let_cc ,6),I(3b,01,1f,08),I(3c,01,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,08),I(86,45,09,00)};
