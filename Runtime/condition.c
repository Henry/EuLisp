...
void initialize_module_condition()
{
  ...
  static const void *G00936[] = {I(43,fd,1c,24),B(mop_inspect ,2),I(3c,01,1b,34),I(00,00,00,1d),I(1d,24,00,00),B(condition ,9),I(24,00,00,00),B(mop_inspect ,9),I(3c,02,32,00),I(00,00,00,07),I(86,1b,34,00),I(00,00,00,32),I(24,00,00,00),B(mop_gf ,2),I(1f,04,23,00),B(condition ,10),I(1f,07,1f,06),I(24,00,00,00),B(boot ,9),I(3c,05,86,24),B(condition ,2),I(3d,02,05,32),I(00,00,00,3e),I(24,00,00,00),B(mop_gf ,17),I(86,1f,06,1f),I(06,1f,06,24),B(boot ,9),I(3c,05,24,00),B(condition ,9),I(23,00,00,00),B(condition ,10),I(1d,24,00,00),B(mop_gf ,2),I(3c,03,86,24),B(condition ,2),I(3d,02,06,22),I(01,45,05,00)};
  ...
  static const void *G00945[] = {I(ab,1c,24,00),B(condition ,4),I(3c,01,2a,1b),I(12,1b,34,00),I(00,00,00,0e),I(86,32,00,00),I(00,00,00,3a),I(84,23,00,00),B(condition ,15),I(24,00,00,00),B(mop_gf ,17),I(3c,02,2a,41),B(boot ,31),I(27,79,50,1b),I(34,00,00,00),I(00,00,00,14),I(1f,03,1f,03),I(3c,01,32,00),I(00,00,00,07),I(86,22,01,2a),I(84,23,00,00),B(condition ,16),I(24,00,00,00),B(mop_gf ,17),I(3c,02,2a,41),B(boot ,31),I(27,79,50,1b),I(34,00,00,00),I(00,00,00,18),I(24,00,00,00),B(boot ,13),I(3c,00,32,00),I(00,00,00,07),I(86,2a,85,24),B(boot1 ,22),I(3d,01,04,00)};
  ...
  static const void *G00949[] = {I(a9,24,00,00),B(mop_class ,21),I(24,00,00,00),B(boot1 ,26),I(3c,01,23,00),B(condition ,18),I(23,00,00,00),B(condition ,19),I(23,00,00,00),B(condition ,20),I(23,00,00,00),B(condition ,10),I(24,00,00,00),B(boot1 ,26),I(3c,04,1b,24),B(boot1 ,26),I(3c,01,24,00),B(mop_class ,71),I(23,00,00,00),B(condition ,18),I(23,00,00,00),B(condition ,21),I(23,00,00,00),B(condition ,22),I(1f,06,23,00),B(condition ,23),I(1f,06,23,00),B(condition ,24),I(23,00,00,00),B(condition ,25),I(24,00,00,00),B(mop_gf ,2),I(3c,09,1b,89),B(condition ,9),I(2a,24,00,00),B(condition ,9),I(24,00,00,00),B(boot1 ,26),I(3c,01,23,00),B(condition ,18),I(23,00,00,00),B(condition ,26),I(23,00,00,00),B(condition ,20),I(23,00,00,00),B(condition ,27),I(24,00,00,00),B(boot1 ,26),I(3c,04,1b,24),B(boot1 ,26),I(3c,01,24,00),B(mop_class ,71),I(23,00,00,00),B(condition ,18),I(23,00,00,00),B(condition ,28),I(23,00,00,00),B(condition ,22),I(1f,06,23,00),B(condition ,23),I(1f,06,23,00),B(condition ,24),I(23,00,00,00),B(condition ,29),I(24,00,00,00),B(mop_gf ,2),I(3c,09,1b,89),B(condition ,5),I(2a,83,24,00),B(mop_class ,21),I(24,00,00,00),B(boot1 ,39),I(3c,02,24,00),B(boot1 ,26),I(3c,00,24,00),B(boot1 ,26),I(3c,00,23,00),B(condition ,30),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,55),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(condition ,6),I(2a,23,00,00),B(condition ,31),I(23,00,00,00),B(condition ,17),I(3b,02,89,00),B(condition ,3),I(2a,24,00,00),B(boot1 ,41),I(24,00,00,00),B(boot1 ,41),I(3c,01,24,00),B(condition ,8),I(23,00,00,00),B(condition ,32),I(23,00,00,00),B(condition ,14),I(3b,02,1d,3c),I(02,2a,24,00),B(condition ,6),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(mop_class ,21),I(24,00,00,00),B(boot1 ,39),I(3c,02,24,00),B(boot1 ,26),I(3c,00,24,00),B(condition ,6),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(condition ,33),I(23,00,00,00),B(condition ,13),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(condition ,6),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(condition ,6),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(condition ,9),I(24,00,00,00),B(boot1 ,39),I(3c,02,24,00),B(boot1 ,26),I(3c,00,24,00),B(condition ,6),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(condition ,33),I(23,00,00,00),B(condition ,12),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(condition ,6),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(condition ,6),I(2a,24,00,00),B(condition ,9),I(2a,24,00,00),B(condition ,5),I(2a,23,00,00),B(condition ,34),I(23,00,00,00),B(condition ,11),I(3b,fd,89,00),B(boot ,22),I(45,19,00,00)};
  ...
  static const void *G00976[] = {I(43,fd,46,04),I(1d,48,00,00),I(1c,48,00,01),I(1b,34,00,00),I(00,00,00,0f),I(1b,10,32,00),I(00,00,00,07),I(86,1b,34,00),I(00,00,00,0e),I(1b,32,00,00),I(00,00,00,11),I(24,00,00,00),B(thread ,22),I(3c,00,26,00),I(00,00,00,03),I(24,00,00,00),B(thread ,29),I(08,86,1b,48),I(00,02,23,00),B(condition ,37),I(23,00,00,00),B(condition ,40),I(3b,01,48,00),I(02,1c,47,00),I(02,3d,01,06)};
  ...
  static const void *G00988[] = {I(43,fd,46,03),I(1d,48,00,00),I(1c,48,00,01),I(1b,48,00,02),I(47,00,01,24),B(mop_inspect ,2),I(3c,01,1b,34),I(00,00,00,1d),I(47,00,01,24),B(condition ,9),I(24,00,00,00),B(mop_inspect ,9),I(3c,02,32,00),I(00,00,00,07),I(86,1b,34,00),I(00,00,00,2a),I(23,00,00,00),B(condition ,39),I(23,00,00,00),B(condition ,47),I(3b,01,24,00),B(let_cc ,2),I(3c,01,1b,22),I(01,32,00,00),I(00,00,00,24),I(23,00,00,00),B(condition ,39),I(23,00,00,00),B(condition ,46),I(3b,01,24,00),B(let_cc ,2),I(3c,01,1b,22),I(01,45,05,00)};
