...
void initialize_module_condition()
{
  ...
  static const void *G00949[] = {I(a9,24,00,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,23),I(3c,01,23,00),B(condition ,18),I(23,00,00,00),B(condition ,19),I(23,00,00,00),B(condition ,20),I(23,00,00,00),B(condition ,10),I(24,00,00,00),B(boot1 ,23),I(3c,04,1b,24),B(boot1 ,23),I(3c,01,24,00),B(mop_class ,70),I(23,00,00,00),B(condition ,18),I(23,00,00,00),B(condition ,21),I(23,00,00,00),B(condition ,22),I(1f,06,23,00),B(condition ,23),I(1f,06,23,00),B(condition ,24),I(23,00,00,00),B(condition ,25),I(24,00,00,00),B(mop_gf ,2),I(3c,09,1b,89),B(condition ,9),I(2a,24,00,00),B(condition ,9),I(24,00,00,00),B(boot1 ,23),I(3c,01,23,00),B(condition ,18),I(23,00,00,00),B(condition ,26),I(23,00,00,00),B(condition ,20),I(23,00,00,00),B(condition ,27),I(24,00,00,00),B(boot1 ,23),I(3c,04,1b,24),B(boot1 ,23),I(3c,01,24,00),B(mop_class ,70),I(23,00,00,00),B(condition ,18),I(23,00,00,00),B(condition ,28),I(23,00,00,00),B(condition ,22),I(1f,06,23,00),B(condition ,23),I(1f,06,23,00),B(condition ,24),I(23,00,00,00),B(condition ,29),I(24,00,00,00),B(mop_gf ,2),I(3c,09,1b,89),B(condition ,5),I(2a,83,24,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,37),I(3c,02,24,00),B(boot1 ,23),I(3c,00,24,00),B(boot1 ,23),I(3c,00,23,00),B(condition ,30),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,54),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(condition ,6),I(2a,23,00,00),B(condition ,31),I(23,00,00,00),B(condition ,17),I(3b,02,89,00),B(condition ,3),I(2a,24,00,00),B(boot1 ,39),I(24,00,00,00),B(boot1 ,39),I(3c,01,24,00),B(condition ,8),I(23,00,00,00),B(condition ,32),I(23,00,00,00),B(condition ,14),I(3b,02,1d,3c),I(02,2a,24,00),B(condition ,6),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,37),I(3c,02,24,00),B(boot1 ,23),I(3c,00,24,00),B(condition ,6),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(condition ,33),I(23,00,00,00),B(condition ,13),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(condition ,6),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(condition ,6),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(condition ,9),I(24,00,00,00),B(boot1 ,37),I(3c,02,24,00),B(boot1 ,23),I(3c,00,24,00),B(condition ,6),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(condition ,33),I(23,00,00,00),B(condition ,12),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(condition ,6),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(condition ,6),I(2a,24,00,00),B(condition ,9),I(2a,24,00,00),B(condition ,5),I(2a,23,00,00),B(condition ,34),I(23,00,00,00),B(condition ,11),I(3b,fd,89,00),B(boot ,23),I(45,19,00,00)};
