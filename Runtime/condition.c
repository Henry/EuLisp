...
void initialize_module_condition()
{
  ...
  static const void *G00936[] = {I(43,fd,1c,24),B(mop_inspect ,2),I(3c,01,1b,34),I(00,00,00,1d),I(1d,24,00,00),B(condition ,9),I(24,00,00,00),B(mop_inspect ,11),I(3c,02,32,00),I(00,00,00,07),I(86,1b,34,00),I(00,00,00,32),I(24,00,00,00),B(mop_gf ,2),I(1f,04,23,00),B(condition ,10),I(1f,07,1f,06),I(24,00,00,00),B(boot ,5),I(3c,05,86,24),B(condition ,2),I(3d,02,05,32),I(00,00,00,3e),I(24,00,00,00),B(mop_gf ,17),I(86,1f,06,1f),I(06,1f,06,24),B(boot ,5),I(3c,05,24,00),B(condition ,9),I(23,00,00,00),B(condition ,10),I(1d,24,00,00),B(mop_gf ,2),I(3c,03,86,24),B(condition ,2),I(3d,02,06,22),I(01,45,05,00)};
  ...
  static const void *G00949[] = {I(a9,24,00,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,25),I(3c,01,23,00),B(condition ,18),I(23,00,00,00),B(condition ,19),I(23,00,00,00),B(condition ,20),I(23,00,00,00),B(condition ,10),I(24,00,00,00),B(boot1 ,25),I(3c,04,1b,24),B(boot1 ,25),I(3c,01,24,00),B(mop_class ,70),I(23,00,00,00),B(condition ,18),I(23,00,00,00),B(condition ,21),I(23,00,00,00),B(condition ,22),I(1f,06,23,00),B(condition ,23),I(1f,06,23,00),B(condition ,24),I(23,00,00,00),B(condition ,25),I(24,00,00,00),B(mop_gf ,2),I(3c,09,1b,89),B(condition ,9),I(2a,24,00,00),B(condition ,9),I(24,00,00,00),B(boot1 ,25),I(3c,01,23,00),B(condition ,18),I(23,00,00,00),B(condition ,26),I(23,00,00,00),B(condition ,20),I(23,00,00,00),B(condition ,27),I(24,00,00,00),B(boot1 ,25),I(3c,04,1b,24),B(boot1 ,25),I(3c,01,24,00),B(mop_class ,70),I(23,00,00,00),B(condition ,18),I(23,00,00,00),B(condition ,28),I(23,00,00,00),B(condition ,22),I(1f,06,23,00),B(condition ,23),I(1f,06,23,00),B(condition ,24),I(23,00,00,00),B(condition ,29),I(24,00,00,00),B(mop_gf ,2),I(3c,09,1b,89),B(condition ,5),I(2a,83,24,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,39),I(3c,02,24,00),B(boot1 ,25),I(3c,00,24,00),B(boot1 ,25),I(3c,00,23,00),B(condition ,30),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,54),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(condition ,6),I(2a,23,00,00),B(condition ,31),I(23,00,00,00),B(condition ,17),I(3b,02,89,00),B(condition ,3),I(2a,24,00,00),B(boot1 ,41),I(24,00,00,00),B(boot1 ,41),I(3c,01,24,00),B(condition ,8),I(23,00,00,00),B(condition ,32),I(23,00,00,00),B(condition ,14),I(3b,02,1d,3c),I(02,2a,24,00),B(condition ,6),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,39),I(3c,02,24,00),B(boot1 ,25),I(3c,00,24,00),B(condition ,6),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,7),I(3c,02,1f,04),I(1f,04,23,00),B(condition ,33),I(23,00,00,00),B(condition ,13),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(condition ,6),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(condition ,6),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(condition ,9),I(24,00,00,00),B(boot1 ,39),I(3c,02,24,00),B(boot1 ,25),I(3c,00,24,00),B(condition ,6),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,7),I(3c,02,1f,04),I(1f,04,23,00),B(condition ,33),I(23,00,00,00),B(condition ,12),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(condition ,6),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(condition ,6),I(2a,24,00,00),B(condition ,9),I(2a,24,00,00),B(condition ,5),I(2a,23,00,00),B(condition ,34),I(23,00,00,00),B(condition ,11),I(3b,fd,89,00),B(boot ,13),I(45,19,00,00)};
  ...
  static const void *G00984[] = {I(aa,24,00,00),B(mop_gf ,17),I(86,47,00,00),I(47,00,01,47),I(00,02,24,00),B(boot ,5),I(3c,05,24,00),B(condition ,9),I(23,00,00,00),B(condition ,10),I(1d,24,00,00),B(mop_gf ,2),I(3c,03,1b,1f),I(03,24,00,00),B(condition ,2),I(3d,02,03,45),I(03,00,00,00)};

  /* Byte-vector with size: 12 is_init: 0 index: 47 binding: call/ep-lambda */
  static const void *G00986[] = {I(aa,24,00,00),B(mop_gf ,2),I(47,00,01,23),B(condition ,10),I(47,00,00,47),I(00,02,24,00),B(boot ,5),I(3c,05,1b,1d),I(24,00,00,00),B(condition ,2),I(3d,02,02,45),I(02,00,00,00)};
