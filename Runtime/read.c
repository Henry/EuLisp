...
void initialize_module_read()
{
  ...
  eul_allocate_static_string(str_9170, "misplaced unquote", 17);
  eul_allocate_static_string(str_9172, "misplaced unquote-splicing", 26);
  eul_allocate_static_string(str_9173, "unexpected token ~a", 19);
  /* Byte-vector with size: 204 is_init: 0 index: 96 binding: anonymous */
  static const void *G009166[] = {I(ab,46,04,1c),I(48,00,00,1b),I(48,00,01,47),I(00,00,24,00),B(read ,13),I(3c,01,1b,34),I(00,00,02,c1),I(47,00,00,24),B(read ,14),I(50,1b,34,00),I(00,00,00,2e),I(86,1b,48,00),I(02,23,00,00),B(read ,38),I(23,00,00,00),B(read ,88),I(3b,01,48,00),I(02,86,47,00),I(02,3d,01,05),I(22,01,32,00),I(00,00,02,82),I(47,00,00,24),B(read ,18),I(50,1b,34,00),I(00,00,00,2e),I(86,1b,48,00),I(03,23,00,00),B(read ,38),I(23,00,00,00),B(read ,82),I(3b,01,48,00),I(03,86,47,00),I(03,3d,01,06),I(22,01,32,00),I(00,00,02,48),I(47,00,00,24),B(read ,20),I(50,1b,34,00),I(00,00,00,3e),I(47,01,00,24),B(read ,30),I(41,00,00,00),B(stream1 ,26),I(22,02,1b,47),I(00,01,47,01),I(03,3c,02,1b),I(24,00,00,00),B(boot1 ,26),I(3c,01,23,00),B(read ,89),I(1c,0f,22,03),I(32,00,00,00),I(00,00,02,00),I(47,00,00,24),B(read ,21),I(50,1b,34,00),I(00,00,00,3a),I(47,01,00,24),B(read ,30),I(41,00,00,00),B(stream1 ,26),I(22,02,1b,87),I(47,01,03,3c),I(02,1b,24,00),B(boot1 ,26),I(3c,01,23,00),B(read ,90),I(1c,0f,22,03),I(32,00,00,00),I(00,00,01,ba),I(47,00,00,24),B(read ,8),I(50,1b,34,00),I(00,00,00,7a),I(47,00,01,34),I(00,00,00,39),I(47,01,00,24),B(read ,30),I(41,00,00,00),B(stream1 ,26),I(22,02,1b,86),I(47,01,03,3c),I(02,1b,24,00),B(boot1 ,26),I(3c,01,23,00),B(read ,83),I(1c,0f,22,03),I(32,00,00,00),I(00,00,00,3a),I(47,01,00,23),B(read ,91),I(24,00,00,00),B(read ,3),I(3c,02,2a,47),I(01,00,24,00),B(read ,30),I(41,00,00,00),B(stream1 ,26),I(22,02,1b,47),I(00,01,47,01),I(03,3d,02,09),I(22,01,32,00),I(00,00,01,32),I(47,00,00,24),B(read ,26),I(50,1b,34,00),I(00,00,00,7a),I(47,00,01,34),I(00,00,00,39),I(47,01,00,24),B(read ,30),I(41,00,00,00),B(stream1 ,26),I(22,02,1b,86),I(47,01,03,3c),I(02,1b,24,00),B(boot1 ,26),I(3c,01,23,00),B(read ,92),I(1c,0f,22,03),I(32,00,00,00),I(00,00,00,3a),I(47,01,00,23),B(read ,93),I(24,00,00,00),B(read ,3),I(3c,02,2a,47),I(01,00,24,00),B(read ,30),I(41,00,00,00),B(stream1 ,26),I(22,02,1b,47),I(00,01,47,01),I(03,3d,02,0a),I(22,01,32,00),I(00,00,00,ac),I(47,00,00,24),B(read ,25),I(50,1b,34,00),I(00,00,00,42),I(47,01,00,24),B(read ,30),I(41,00,00,00),B(stream1 ,26),I(22,02,86,47),I(01,03,3c,02),I(2a,47,01,00),I(24,00,00,00),B(read ,30),I(41,00,00,00),B(stream1 ,26),I(22,02,86,47),I(01,03,3d,02),I(0a,32,00,00),I(00,00,00,5f),I(47,00,00,24),B(read ,6),I(50,1b,34,00),I(00,00,00,26),I(47,01,01,34),I(00,00,00,15),I(47,01,00,24),B(stream2 ,19),I(3d,01,0b,32),I(00,00,00,08),I(47,01,02,32),I(00,00,00,2b),I(47,00,00,82),I(24,00,00,00),B(read ,31),I(08,47,01,00),I(23,00,00,00),B(read ,94),I(1d,24,00,00),B(read ,3),I(3c,03,2a,86),I(22,01,22,01),I(22,01,22,01),I(22,01,22,01),I(22,01,22,01),I(22,01,32,00),I(00,00,00,59),I(24,00,00,00),B(read ,17),I(47,00,00,24),B(table ,3),I(3c,02,1b,24),B(mop_inspect ,6),I(3c,01,1b,34),I(00,00,00,19),I(47,01,00,47),I(00,00,86,1f),I(04,3d,03,05),I(32,00,00,00),I(00,00,00,25),I(47,00,00,23),B(read ,95),I(50,1b,34,00),I(00,00,00,0e),I(86,32,00,00),I(00,00,00,0a),I(47,00,00,22),I(01,22,02,45),I(03,00,00,00)};

  /* Byte-vector with size: 18 is_init: 0 index: 97 binding: parse */
  static const void *G009175[] = {I(43,03,46,04),I(1d,48,00,00),I(1c,48,00,01),I(1b,48,00,02),I(86,1b,48,00),I(03,23,00,00),B(read ,38),I(23,00,00,00),B(read ,96),I(3b,02,48,00),I(03,47,00,00),I(24,00,00,00),B(read ,30),I(41,00,00,00),B(stream1 ,26),I(22,02,86,47),I(00,03,3d,02),I(04,45,04,00)};

  /* Byte-vector with size: 11 is_init: 0 index: 98 binding: reverse-onto */
  static const void *G009177[] = {I(ab,1c,12,1b),I(34,00,00,00),I(00,00,00,10),I(1c,32,00,00),I(00,00,00,1c),I(1d,11,1f,03),I(10,1b,1f,04),I(0f,1d,1c,24),B(read ,29),I(3d,02,06,22),I(03,45,03,00)};

  /* Byte-vector with size: 166 is_init: 1 index: 0 binding: initialize-read */
  static const void *G009179[] = {I(87,25,00,00),B(read ,1),I(24,00,00,00),B(stream ,1),I(3e,0b,24,00),B(stream ,0),I(3c,00,21,01),I(24,00,00,00),B(table ,1),I(3e,0b,24,00),B(table ,0),I(3c,00,21,01),I(24,00,00,00),B(dynamic ,1),I(3e,0b,24,00),B(dynamic ,0),I(3c,00,21,01),I(24,00,00,00),B(lock ,1),I(3e,0b,24,00),B(lock ,0),I(3c,00,21,01),I(24,00,00,00),B(string ,1),I(3e,0b,24,00),B(string ,0),I(3c,00,21,01),I(24,00,00,00),B(vector ,1),I(3e,0b,24,00),B(vector ,0),I(3c,00,21,01),I(24,00,00,00),B(convert1 ,1),I(3e,0b,24,00),B(convert1 ,0),I(3c,00,21,01),I(24,00,00,00),B(convert ,1),I(3e,0b,24,00),B(convert ,0),I(3c,00,21,01),I(24,00,00,00),B(condition ,1),I(3e,0b,24,00),B(condition ,0),I(3c,00,21,01),I(24,00,00,00),B(telos ,1),I(3e,0b,24,00),B(telos ,0),I(3c,00,21,01),I(86,25,00,00),B(read ,31),I(86,25,00,00),B(read ,30),I(23,00,00,00),B(read ,99),I(23,00,00,00),B(read ,98),I(3b,02,25,00),B(read ,29),I(23,00,00,00),B(read ,100),I(23,00,00,00),B(read ,97),I(3b,03,25,00),B(read ,28),I(23,00,00,00),B(read ,101),I(23,00,00,00),B(read ,80),I(3b,ff,25,00),B(read ,27),I(86,25,00,00),B(read ,26),I(86,25,00,00),B(read ,25),I(23,00,00,00),B(read ,102),I(23,00,00,00),B(read ,79),I(3b,ff,25,00),B(read ,24),I(86,25,00,00),B(read ,23),I(23,00,00,00),B(read ,44),I(23,00,00,00),B(read ,78),I(3b,01,25,00),B(read ,22),I(86,25,00,00),B(read ,21),I(86,25,00,00),B(read ,20),I(86,25,00,00),B(read ,19),I(86,25,00,00),B(read ,18),I(86,25,00,00),B(read ,17),I(23,00,00,00),B(read ,103),I(23,00,00,00),B(read ,77),I(3b,03,25,00),B(read ,16),I(23,00,00,00),B(read ,104),I(23,00,00,00),B(read ,76),I(3b,ff,25,00),B(read ,15),I(86,25,00,00),B(read ,14),I(86,25,00,00),B(read ,13),I(86,25,00,00),B(read ,12),I(23,00,00,00),B(read ,105),I(23,00,00,00),B(read ,74),I(3b,ff,25,00),B(read ,11),I(23,00,00,00),B(read ,106),I(23,00,00,00),B(read ,73),I(3b,fe,25,00),B(read ,10),I(86,25,00,00),B(read ,9),I(86,25,00,00),B(read ,8),I(86,25,00,00),B(read ,7),I(86,25,00,00),B(read ,6),I(23,00,00,00),B(read ,107),I(23,00,00,00),B(read ,71),I(3b,ff,25,00),B(read ,5),I(23,00,00,00),B(read ,108),I(23,00,00,00),B(read ,70),I(3b,fe,25,00),B(read ,4),I(23,00,00,00),B(read ,40),I(23,00,00,00),B(read ,66),I(3b,fd,25,00),B(read ,3),I(86,25,00,00),B(read ,2),I(23,00,00,00),B(read ,109),I(23,00,00,00),B(read ,64),I(3b,00,3d,00),I(00,ac,00,00)};
  ...
  eul_intern_keyword(key_9099,"source");
  eul_intern_keyword(key_9100,"read-action");
  eul_intern_symbol(sym_9101,"anonymous");
  eul_intern_keyword(key_9102,"name");
  eul_intern_symbol(sym_9103,"read-error");
  eul_intern_keyword(key_9104,"direct-superclasses");
  eul_intern_keyword(key_9105,"direct-slots");
  eul_intern_keyword(key_9106,"direct-keywords");
  eul_intern_symbol(sym_9107,"tag");
  eul_intern_keyword(key_9108,"keyword");
  eul_intern_keyword(key_9109,"tag");
  eul_intern_symbol(sym_9110,"special");
  object_class(cons_9111) = eul_static_cons_class;
  eul_car(cons_9111) = key_9109;
  eul_cdr(cons_9111) = eul_nil;
  ...
  eul_intern_keyword(key_9122,"string");
  object_class(str_9123) = eul_static_string_class;
  eul_intern_symbol(sym_9124,"specialp");
  eul_intern_symbol(sym_9125,"(setter tag)");
  eul_intern_symbol(sym_9126,"(method specialp)");
  eul_allocate_bytevector( G009098,G009097);
  eul_intern_keyword(key_9129,"value");
  eul_allocate_bytevector( G009128,G009127);
  eul_allocate_bytevector( G009131,G009130);
  eul_intern_symbol(sym_9134,"*clean-ups*");
  eul_intern_keyword(key_9135,"buffer");
  ...
  eul_intern_symbol(sym_9161,"unquote");
  ...
  eul_intern_symbol(sym_9168,"quote");
  eul_intern_symbol(sym_9169,"quasiquote");
  object_class(str_9170) = eul_static_string_class;
  eul_intern_symbol(sym_9171,"unquote-splicing");
  object_class(str_9172) = eul_static_string_class;
  object_class(str_9173) = eul_static_string_class;
  eul_intern_symbol(sym_9174,"nil");
  eul_allocate_bytevector( G009167,G009166);
  eul_allocate_bytevector( G009176,G009175);
  eul_allocate_bytevector( G009178,G009177);
  eul_intern_symbol(sym_9181,"reverse-onto");
  eul_intern_symbol(sym_9182,"parse");
  eul_intern_symbol(sym_9183,"read-token");
  eul_intern_symbol(sym_9184,"read");
  eul_intern_symbol(sym_9185,"set-dispatch-macro-character");
  eul_intern_symbol(sym_9186,"read-line");
  eul_intern_symbol(sym_9187,"read-s-expression");
  eul_intern_symbol(sym_9188,"sread");
  eul_intern_symbol(sym_9189,"read-char");
  eul_intern_symbol(sym_9190,"sread-s-expression");
  ...
  read_bindings[ 32] = G009090;
  read_bindings[ 33] = G009092;
  read_bindings[ 34] = G009094;
  read_bindings[ 35] = G009096;
  read_bindings[ 36] = key_9099;
  read_bindings[ 37] = key_9100;
  read_bindings[ 38] = sym_9101;
  read_bindings[ 39] = key_9102;
  read_bindings[ 40] = sym_9103;
  read_bindings[ 41] = key_9104;
  read_bindings[ 42] = key_9105;
  read_bindings[ 43] = key_9106;
  read_bindings[ 44] = sym_9107;
  read_bindings[ 45] = key_9108;
  read_bindings[ 46] = key_9109;
  read_bindings[ 47] = sym_9110;
  read_bindings[ 48] = cons_9111;
  read_bindings[ 49] = str_9112;
  read_bindings[ 50] = str_9113;
  read_bindings[ 51] = str_9114;
  read_bindings[ 52] = str_9115;
  read_bindings[ 53] = str_9116;
  read_bindings[ 54] = str_9117;
  read_bindings[ 55] = str_9118;
  read_bindings[ 56] = str_9119;
  read_bindings[ 57] = str_9120;
  read_bindings[ 58] = str_9121;
  read_bindings[ 59] = key_9122;
  read_bindings[ 60] = str_9123;
  read_bindings[ 61] = sym_9124;
  read_bindings[ 62] = sym_9125;
  read_bindings[ 63] = sym_9126;
  read_bindings[ 64] = G009098;
  read_bindings[ 65] = key_9129;
  read_bindings[ 66] = G009128;
  read_bindings[ 67] = G009131;
  read_bindings[ 68] = sym_9134;
  read_bindings[ 69] = key_9135;
  read_bindings[ 70] = G009133;
  read_bindings[ 71] = G009137;
  read_bindings[ 72] = G009139;
  read_bindings[ 73] = G009141;
  read_bindings[ 74] = G009143;
  read_bindings[ 75] = G009145;
  read_bindings[ 76] = G009147;
  read_bindings[ 77] = G009149;
  read_bindings[ 78] = G009151;
  read_bindings[ 79] = G009153;
  read_bindings[ 80] = G009155;
  read_bindings[ 81] = str_9158;
  read_bindings[ 82] = G009157;
  read_bindings[ 83] = sym_9161;
  read_bindings[ 84] = str_9162;
  read_bindings[ 85] = str_9163;
  read_bindings[ 86] = str_9164;
  read_bindings[ 87] = str_9165;
  read_bindings[ 88] = G009160;
  read_bindings[ 89] = sym_9168;
  read_bindings[ 90] = sym_9169;
  read_bindings[ 91] = str_9170;
  read_bindings[ 92] = sym_9171;
  read_bindings[ 93] = str_9172;
  read_bindings[ 94] = str_9173;
  read_bindings[ 95] = sym_9174;
  read_bindings[ 96] = G009167;
  read_bindings[ 97] = G009176;
  read_bindings[ 98] = G009178;
  read_bindings[ 1] = eul_nil;
  read_bindings[ 99] = sym_9181;
  read_bindings[ 100] = sym_9182;
  read_bindings[ 101] = sym_9183;
  read_bindings[ 102] = sym_9184;
  read_bindings[ 103] = sym_9185;
  read_bindings[ 104] = sym_9186;
  read_bindings[ 105] = sym_9187;
  read_bindings[ 106] = sym_9188;
  read_bindings[ 107] = sym_9189;
  read_bindings[ 108] = sym_9190;
  read_bindings[ 109] = sym_9191;
  eul_allocate_lambda( read_bindings[0], "initialize-read", 0, G009180);
