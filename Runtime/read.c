...
void initialize_module_read()
{
  ...
  {
  /* Declarations */
  LispRef sym_9186, sym_9185, sym_9184, sym_9183, sym_9182, sym_9181, sym_9180, sym_9179, sym_9178, sym_9177, sym_9176, G009175, G009173, G009171, sym_9167, sym_9165, sym_9164, G009163, sym_9157, G009156, G009153, G009151, G009149, G009147, G009145, G009143, G009141, G009139, G009137, G009135, G009133, key_9131, sym_9130, G009129, G009127, key_9125, G009124, sym_9122, sym_9121, sym_9120, key_9118, sym_9106, key_9105, key_9104, sym_9103, key_9102, key_9101, key_9100, sym_9099, key_9098, sym_9097, key_9096, key_9095, G009094, G009092, G009090, G009088, G009086;

  /* Code vector and literal definitions */
  /* Byte-vector with size: 1 is_init: 0 index: 32 binding: (method-specialp) */
  static const void *G009085[] = {I(aa,1b,45,01)};

  /* Byte-vector with size: 1 is_init: 0 index: 33 binding: (method-specialp) */
  static const void *G009087[] = {I(aa,86,45,01)};

  /* Byte-vector with size: 4 is_init: 0 index: 34 binding: (setter-tag) */
  static const void *G009089[] = {I(ab,1c,82,1d),I(24,00,00,00),B(read ,31),I(09,45,02,00)};

  /* Byte-vector with size: 9 is_init: 0 index: 35 binding: anonymous */
  static const void *G009091[] = {I(43,03,1d,26),I(00,00,00,04),I(24,00,00,00),B(stream2 ,21),I(08,1b,1f,03),I(1f,03,24,00),B(read ,28),I(3d,03,04,45),I(04,00,00,00)};

  eul_allocate_static_cons(cons_9107, NULL, NULL);
  eul_allocate_static_string(str_9108, "(", 1);
  eul_allocate_static_string(str_9109, ")", 1);
  eul_allocate_static_string(str_9110, "#(", 2);
  eul_allocate_static_string(str_9111, "'", 1);
  ...
  eul_intern_keyword(key_9095,"source");
  eul_intern_keyword(key_9096,"read-action");
  eul_intern_symbol(sym_9097,"anonymous");
  eul_intern_keyword(key_9098,"name");
  eul_intern_symbol(sym_9099,"read-error");
  eul_intern_keyword(key_9100,"direct-superclasses");
  eul_intern_keyword(key_9101,"direct-slots");
  eul_intern_keyword(key_9102,"direct-keywords");
  eul_intern_symbol(sym_9103,"tag");
  eul_intern_keyword(key_9104,"keyword");
  eul_intern_keyword(key_9105,"tag");
  eul_intern_symbol(sym_9106,"special");
  object_class(cons_9107) = eul_static_cons_class;
  eul_car(cons_9107) = key_9105;
  eul_cdr(cons_9107) = eul_nil;
  ...
  eul_intern_keyword(key_9118,"string");
  object_class(str_9119) = eul_static_string_class;
  eul_intern_symbol(sym_9120,"specialp");
  eul_intern_symbol(sym_9121,"(setter tag)");
  eul_intern_symbol(sym_9122,"(method specialp)");
  eul_allocate_bytevector( G009094,G009093);
  eul_intern_keyword(key_9125,"value");
  eul_allocate_bytevector( G009124,G009123);
  eul_allocate_bytevector( G009127,G009126);
  eul_intern_symbol(sym_9130,"*clean-ups*");
  eul_intern_keyword(key_9131,"buffer");
  ...
  eul_intern_symbol(sym_9157,"unquote");
  ...
  eul_intern_symbol(sym_9164,"quote");
  eul_intern_symbol(sym_9165,"quasiquote");
  object_class(str_9166) = eul_static_string_class;
  eul_intern_symbol(sym_9167,"unquote-splicing");
  ...
  eul_intern_symbol(sym_9176,"reverse-onto");
  eul_intern_symbol(sym_9177,"parse");
  eul_intern_symbol(sym_9178,"read-token");
  eul_intern_symbol(sym_9179,"read");
  eul_intern_symbol(sym_9180,"set-dispatch-macro-character");
  eul_intern_symbol(sym_9181,"read-line");
  eul_intern_symbol(sym_9182,"read-s-expression");
  eul_intern_symbol(sym_9183,"sread");
  eul_intern_symbol(sym_9184,"read-char");
  eul_intern_symbol(sym_9185,"sread-s-expression");
  eul_intern_symbol(sym_9186,"top-level");
  ...
  read_bindings[ 32] = G009086;
  read_bindings[ 33] = G009088;
  read_bindings[ 34] = G009090;
  read_bindings[ 35] = G009092;
  read_bindings[ 36] = key_9095;
  read_bindings[ 37] = key_9096;
  read_bindings[ 38] = sym_9097;
  read_bindings[ 39] = key_9098;
  read_bindings[ 40] = sym_9099;
  read_bindings[ 41] = key_9100;
  read_bindings[ 42] = key_9101;
  read_bindings[ 43] = key_9102;
  read_bindings[ 44] = sym_9103;
  read_bindings[ 45] = key_9104;
  read_bindings[ 46] = key_9105;
  read_bindings[ 47] = sym_9106;
  read_bindings[ 48] = cons_9107;
  read_bindings[ 49] = str_9108;
  read_bindings[ 50] = str_9109;
  read_bindings[ 51] = str_9110;
  read_bindings[ 52] = str_9111;
  read_bindings[ 53] = str_9112;
  read_bindings[ 54] = str_9113;
  read_bindings[ 55] = str_9114;
  read_bindings[ 56] = str_9115;
  read_bindings[ 57] = str_9116;
  read_bindings[ 58] = str_9117;
  read_bindings[ 59] = key_9118;
  read_bindings[ 60] = str_9119;
  read_bindings[ 61] = sym_9120;
  read_bindings[ 62] = sym_9121;
  read_bindings[ 63] = sym_9122;
  read_bindings[ 64] = G009094;
  read_bindings[ 65] = key_9125;
  read_bindings[ 66] = G009124;
  read_bindings[ 67] = G009127;
  read_bindings[ 68] = sym_9130;
  read_bindings[ 69] = key_9131;
  read_bindings[ 70] = G009129;
  read_bindings[ 71] = G009133;
  read_bindings[ 72] = G009135;
  read_bindings[ 73] = G009137;
  read_bindings[ 74] = G009139;
  read_bindings[ 75] = G009141;
  read_bindings[ 76] = G009143;
  read_bindings[ 77] = G009145;
  read_bindings[ 78] = G009147;
  read_bindings[ 79] = G009149;
  read_bindings[ 80] = G009151;
  read_bindings[ 81] = str_9154;
  read_bindings[ 82] = G009153;
  read_bindings[ 83] = sym_9157;
  read_bindings[ 84] = str_9158;
  read_bindings[ 85] = str_9159;
  read_bindings[ 86] = str_9160;
  read_bindings[ 87] = str_9161;
  read_bindings[ 88] = G009156;
  read_bindings[ 89] = sym_9164;
  read_bindings[ 90] = sym_9165;
  read_bindings[ 91] = str_9166;
  read_bindings[ 92] = sym_9167;
  read_bindings[ 93] = str_9168;
  read_bindings[ 94] = str_9169;
  read_bindings[ 95] = G009163;
  read_bindings[ 96] = G009171;
  read_bindings[ 97] = G009173;
  read_bindings[ 1] = eul_nil;
  read_bindings[ 98] = sym_9176;
  read_bindings[ 99] = sym_9177;
  read_bindings[ 100] = sym_9178;
  read_bindings[ 101] = sym_9179;
  read_bindings[ 102] = sym_9180;
  read_bindings[ 103] = sym_9181;
  read_bindings[ 104] = sym_9182;
  read_bindings[ 105] = sym_9183;
  read_bindings[ 106] = sym_9184;
  read_bindings[ 107] = sym_9185;
  read_bindings[ 108] = sym_9186;
  eul_allocate_lambda( read_bindings[0], "initialize-read", 0, G009175);
