...
void initialize_module_lock()
{
  ...
  eul_intern_keyword(key_4506,"name");
  eul_intern_symbol(sym_4507,"counter");
  eul_intern_keyword(key_4508,"default");
  eul_intern_keyword(key_4509,"keyword");
  eul_intern_keyword(key_4510,"counter");
  eul_intern_symbol(sym_4511,"semaphore");
  eul_intern_keyword(key_4512,"direct-superclasses");
  eul_intern_keyword(key_4513,"direct-slots");
  eul_intern_keyword(key_4514,"direct-keywords");
  object_class(cons_4515) = eul_static_cons_class;
  eul_car(cons_4515) = key_4510;
  eul_cdr(cons_4515) = eul_nil;
  eul_intern_symbol(sym_4516,"semaphorep");
  eul_intern_symbol(sym_4517,"lockp");
  eul_intern_symbol(sym_4518,"lock");
  eul_intern_symbol(sym_4519,"unlock");
  eul_intern_symbol(sym_4520,"(setter semaphore-counter)");
  eul_intern_symbol(sym_4521,"(method semaphorep)");
  eul_intern_symbol(sym_4522,"(method lockp)");
  eul_intern_symbol(sym_4523,"(method lock)");
  eul_intern_symbol(sym_4524,"(method unlock)");
  eul_allocate_bytevector( G004505,G004504);
  eul_allocate_bytevector( G004526,G004525);
  eul_intern_symbol(sym_4529,"semaphore-counter");
  eul_intern_symbol(sym_4530,"top-level");
  ...
  lock_bindings[ 9] = G004486;
  lock_bindings[ 10] = G004488;
  lock_bindings[ 11] = sym_4491;
  lock_bindings[ 12] = G004490;
  lock_bindings[ 13] = G004493;
  lock_bindings[ 14] = G004495;
  lock_bindings[ 15] = G004497;
  lock_bindings[ 16] = G004499;
  lock_bindings[ 17] = G004501;
  lock_bindings[ 18] = G004503;
  lock_bindings[ 19] = key_4506;
  lock_bindings[ 20] = sym_4507;
  lock_bindings[ 21] = key_4508;
  lock_bindings[ 22] = key_4509;
  lock_bindings[ 23] = key_4510;
  lock_bindings[ 24] = sym_4511;
  lock_bindings[ 25] = key_4512;
  lock_bindings[ 26] = key_4513;
  lock_bindings[ 27] = key_4514;
  lock_bindings[ 28] = cons_4515;
  lock_bindings[ 29] = sym_4516;
  lock_bindings[ 30] = sym_4517;
  lock_bindings[ 31] = sym_4518;
  lock_bindings[ 32] = sym_4519;
  lock_bindings[ 33] = sym_4520;
  lock_bindings[ 34] = sym_4521;
  lock_bindings[ 35] = sym_4522;
  lock_bindings[ 36] = sym_4523;
  lock_bindings[ 37] = sym_4524;
  lock_bindings[ 38] = G004505;
  lock_bindings[ 39] = G004526;
  lock_bindings[ 1] = eul_nil;
  lock_bindings[ 40] = sym_4529;
  lock_bindings[ 41] = sym_4530;
  eul_allocate_lambda( lock_bindings[0], "initialize-lock", 0, G004528);
