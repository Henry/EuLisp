...
/* Foreign functions */
static LispRef ff_stub_eul_table_ref8052 (Stack *reg_value_stack, LispRef *sreg_value_sp, LispRef *sreg_value_sb)
{
  LispRef G008165, G008166, res;

  POPVAL1(G008166);
  POPVAL1(G008165);
  FF_RES_CONVERT6(res,eul_table_ref(FF_ARG_CONVERT8(G008165), FF_ARG_CONVERT3(G008166)));
  return res;
}

static LispRef ff_stub_eul_addr_str8053 (Stack *reg_value_stack, LispRef *sreg_value_sp, LispRef *sreg_value_sb)
{
  LispRef G008167, res;

  POPVAL1(G008167);
  FF_RES_CONVERT3(res,eul_addr_str(FF_ARG_CONVERT8(G008167)));
  return res;
}

static LispRef ff_stub_eul_table_set8054 (Stack *reg_value_stack, LispRef *sreg_value_sp, LispRef *sreg_value_sb)
{
  LispRef G008168, G008169, G008170, res;

  POPVAL1(G008170);
  POPVAL1(G008169);
  POPVAL1(G008168);
  FF_RES_CONVERT6(res,eul_table_set(FF_ARG_CONVERT8(G008168), FF_ARG_CONVERT3(G008169), FF_ARG_CONVERT8(G008170)));
  return res;
}
...
void initialize_module_table()
{
  ...
  {
  /* Declarations */
  LispRef sym_8164, sym_8163, sym_8162, sym_8161, sym_8160, sym_8159, sym_8158, sym_8157, sym_8156, G008155, G008153, G008151, G008149, G008147, G008145, G008143, G008141, G008139, G008137, G008135, G008133, G008131, G008129, G008127, sym_8125, sym_8123, sym_8121, sym_8120, sym_8119, sym_8118, sym_8117, sym_8116, sym_8115, sym_8114, sym_8113, sym_8111, sym_8109, sym_8108, sym_8107, sym_8106, G008105, G008103, G008101, G008098, G008096, G008094, G008092, G008090, G008088, G008085, G008083, G008081, G008079, G008077, G008074, G008071, G008068, G008065, sym_8063, G008062, G008060, G008058, G008056;

  /* Code vector and literal definitions */
  /* Byte-vector with size: 3 is_init: 0 index: 14 binding: (method-accumulate1) */
  static const void *G008055[] = {I(ab,24,00,00),B(table ,8),I(3d,02,00,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 15 binding: (method-accumulate) */
  static const void *G008057[] = {I(43,03,24,00),B(table ,2),I(3d,03,00,00)};

  /* Byte-vector with size: 10 is_init: 0 index: 16 binding: anonymous */
  static const void *G008059[] = {I(aa,1b,7a,1b),I(34,00,00,00),I(00,00,00,20),I(1c,10,1d,11),I(47,00,00,1d),I(1d,47,00,01),I(3d,03,04,22),I(02,32,00,00),I(00,00,00,08),I(86,45,02,00)};

  /* Byte-vector with size: 24 is_init: 0 index: 18 binding: (method-member) */
  static const void *G008061[] = {I(43,fd,46,02),I(1d,48,00,00),I(1b,12,1b,34),I(00,00,00,19),I(1d,47,00,00),I(24,00,00,00),B(table ,3),I(3d,02,04,32),I(00,00,00,3e),I(1c,10,1b,48),I(00,01,1f,03),I(26,00,00,00),I(00,00,00,03),I(24,00,00,00),B(table1 ,4),I(08,47,00,00),I(1c,23,00,00),B(table ,17),I(23,00,00,00),B(table ,16),I(3b,01,24,00),B(collect ,12),I(3d,03,06,22),I(02,45,04,00)};

  eul_allocate_static_string(str_8066, "allp on multiple tables not yet implemented", 43);
  /* Byte-vector with size: 13 is_init: 0 index: 20 binding: (method-allp) */
  static const void *G008064[] = {I(43,fd,12,1b),I(34,00,00,00),I(00,00,00,18),I(1d,1d,24,00),B(table ,9),I(3d,02,03,32),I(00,00,00,18),I(23,00,00,00),B(table ,19),I(24,00,00,00),B(boot ,22),I(3d,01,03,45),I(03,00,00,00)};

  eul_allocate_static_string(str_8069, "anyp on multiple tables not yet implemented", 43);
  /* Byte-vector with size: 13 is_init: 0 index: 22 binding: (method-anyp) */
  static const void *G008067[] = {I(43,fd,12,1b),I(34,00,00,00),I(00,00,00,18),I(1d,1d,24,00),B(table ,6),I(3d,02,03,32),I(00,00,00,18),I(23,00,00,00),B(table ,21),I(24,00,00,00),B(boot ,22),I(3d,01,03,45),I(03,00,00,00)};

  eul_allocate_static_string(str_8072, "map on multiple tables not yet implemented", 42);
  /* Byte-vector with size: 13 is_init: 0 index: 24 binding: (method-map) */
  static const void *G008070[] = {I(43,fd,12,1b),I(34,00,00,00),I(00,00,00,18),I(1d,1d,24,00),B(table ,4),I(3d,02,03,32),I(00,00,00,18),I(23,00,00,00),B(table ,23),I(24,00,00,00),B(boot ,22),I(3d,01,03,45),I(03,00,00,00)};

  eul_allocate_static_string(str_8075, "do on multiple tables not yet implemented", 41);
  /* Byte-vector with size: 13 is_init: 0 index: 26 binding: (method-do) */
  static const void *G008073[] = {I(43,fd,12,1b),I(34,00,00,00),I(00,00,00,18),I(1d,1d,24,00),B(table ,7),I(3d,02,03,32),I(00,00,00,18),I(23,00,00,00),B(table ,25),I(24,00,00,00),B(boot ,22),I(3d,01,03,45),I(03,00,00,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 27 binding: (method-emptyp) */
  static const void *G008076[] = {I(aa,24,00,00),B(table ,10),I(3d,01,00,00)};

  /* Byte-vector with size: 52 is_init: 0 index: 28 binding: anonymous */
  static const void *G008078[] = {I(aa,47,00,03),I(1c,02,1b,7a),I(1b,34,00,00),I(00,00,00,5b),I(1c,10,1b,47),I(00,01,47,00),I(04,3c,02,1b),I(34,00,00,00),I(00,00,00,1c),I(1f,03,11,1f),I(04,47,00,02),I(90,2a,1b,22),I(01,32,00,00),I(00,00,00,2c),I(1f,04,2b,1b),I(47,00,06,1a),I(1b,34,00,00),I(00,00,00,13),I(1c,47,00,05),I(3d,01,07,32),I(00,00,00,0c),I(82,47,00,05),I(3d,01,07,22),I(02,22,02,32),I(00,00,00,6c),I(47,00,00,83),I(24,00,00,00),B(table1 ,4),I(08,2b,47,00),I(01,47,00,02),I(0f,47,00,03),I(1f,05,1d,03),I(2a,47,00,00),I(1d,1c,83,1d),I(24,00,00,00),B(table1 ,4),I(09,22,02,2a),I(47,00,00,82),I(24,00,00,00),B(table1 ,4),I(08,1d,1c,1a),I(1b,34,00,00),I(00,00,00,0f),I(86,32,00,00),I(00,00,00,11),I(47,00,00,24),B(table ,5),I(3c,01,2a,47),I(00,00,84,24),B(table1 ,4),I(08,22,04,45),I(03,00,00,00)};

  /* Byte-vector with size: 48 is_init: 0 index: 29 binding: (method-(setter table-ref)) */
  static const void *G008080[] = {I(43,03,46,0a),I(1d,48,00,00),I(1c,48,00,01),I(1b,48,00,02),I(47,00,00,26),I(00,00,00,03),I(24,00,00,00),B(table1 ,4),I(08,47,00,00),I(83,24,00,00),B(table1 ,8),I(08,47,00,00),I(82,24,00,00),B(table1 ,8),I(08,1d,48,00),I(03,1c,48,00),I(04,47,00,03),I(24,00,00,00),B(vector ,5),I(3c,01,1b,34),I(00,00,00,0d),I(86,32,00,00),I(00,00,00,36),I(26,00,00,00),I(00,00,00,10),I(24,00,00,00),B(boot1 ,39),I(3c,01,1b,48),I(00,03,47,00),I(03,47,00,00),I(1c,1c,26,00),I(00,00,00,03),I(1d,24,00,00),B(table1 ,4),I(09,22,04,2a),I(47,00,03,06),I(1b,48,00,06),I(47,00,01,1f),I(03,3c,01,1b),I(47,00,06,18),I(86,1b,48,00),I(05,23,00,00),B(table ,17),I(23,00,00,00),B(table ,28),I(3b,01,48,00),I(05,1c,47,00),I(05,3d,01,0b)};

  /* Byte-vector with size: 6 is_init: 0 index: 30 binding: (method-(setter table-ref)) */
  static const void *G008082[] = {I(43,03,1c,24),B(collect ,8),I(3c,01,1f,03),I(1c,1f,03,41),B(table ,13),I(45,07,00,00)};

  eul_allocate_static_string(str_8086, "", 1);
  /* Byte-vector with size: 8 is_init: 0 index: 32 binding: (method-(setter table-ref)) */
  static const void *G008084[] = {I(43,03,1c,23),B(table ,31),I(24,00,00,00),B(string ,11),I(3c,02,1f,03),I(1c,1f,03,41),B(table ,13),I(45,07,00,00)};

  /* Byte-vector with size: 6 is_init: 0 index: 33 binding: (method-(setter table-ref)) */
  static const void *G008087[] = {I(43,03,1c,41),B(table ,12),I(22,01,1f,03),I(1c,1f,03,41),B(table ,13),I(45,07,00,00)};

  /* Byte-vector with size: 8 is_init: 0 index: 34 binding: (method-(setter element)) */
  static const void *G008089[] = {I(43,03,24,00),B(table ,3),I(24,00,00,00),B(boot1 ,41),I(3c,01,1f,03),I(1f,03,1f,03),I(1f,03,3d,03),I(04,45,04,00)};

  /* Byte-vector with size: 26 is_init: 0 index: 35 binding: anonymous */
  static const void *G008091[] = {I(aa,47,00,02),I(1c,02,1b,7a),I(1b,34,00,00),I(00,00,00,4f),I(1c,10,1b,47),I(00,01,47,00),I(03,3c,02,1b),I(34,00,00,00),I(00,00,00,10),I(1f,03,11,32),I(00,00,00,2a),I(1f,04,2b,1b),I(47,00,05,1a),I(1b,34,00,00),I(00,00,00,13),I(1c,47,00,04),I(3d,01,07,32),I(00,00,00,0c),I(82,47,00,04),I(3d,01,07,22),I(02,22,02,32),I(00,00,00,12),I(47,00,00,84),I(24,00,00,00),B(table1 ,4),I(08,45,03,00)};

  /* Byte-vector with size: 39 is_init: 0 index: 36 binding: (method-table-ref) */
  static const void *G008093[] = {I(ab,46,07,1c),I(48,00,00,1b),I(48,00,01,47),I(00,00,26,00),I(00,00,00,03),I(24,00,00,00),B(table1 ,4),I(08,47,00,00),I(83,24,00,00),B(table1 ,8),I(08,47,00,00),I(82,24,00,00),B(table1 ,8),I(08,1d,48,00),I(02,1c,48,00),I(03,47,00,02),I(24,00,00,00),B(vector ,5),I(3c,01,1b,34),I(00,00,00,41),I(47,00,02,06),I(1b,48,00,05),I(47,00,01,1f),I(03,3c,01,1b),I(47,00,05,18),I(86,1b,48,00),I(04,23,00,00),B(table ,17),I(23,00,00,00),B(table ,35),I(3b,01,48,00),I(04,1c,47,00),I(04,3d,01,0a),I(22,04,32,00),I(00,00,00,13),I(47,00,00,84),I(24,00,00,00),B(table1 ,4),I(08,45,06,00)};

  /* Byte-vector with size: 5 is_init: 0 index: 37 binding: (method-table-ref) */
  static const void *G008095[] = {I(ab,24,00,00),B(collect ,8),I(3c,01,41,00),B(table ,11),I(45,02,00,00)};

  eul_allocate_static_string(str_8099, "", 1);
  /* Byte-vector with size: 7 is_init: 0 index: 39 binding: (method-table-ref) */
  static const void *G008097[] = {I(ab,23,00,00),B(table ,38),I(24,00,00,00),B(string ,11),I(3c,02,41,00),B(table ,11),I(45,02,00,00)};

  /* Byte-vector with size: 5 is_init: 0 index: 40 binding: (method-table-ref) */
  static const void *G008100[] = {I(ab,41,00,00),B(table ,12),I(22,01,41,00),B(table ,11),I(45,02,00,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 41 binding: (method-element) */
  static const void *G008102[] = {I(ab,24,00,00),B(table ,3),I(3d,02,00,00)};

  eul_allocate_static_cons(cons_8112, NULL, NULL);
  eul_allocate_static_cons(cons_8110, NULL, eul_as_static(cons_8112));
  eul_allocate_static_cons(cons_8124, NULL, NULL);
  ...
  eul_intern_symbol(sym_8063,"anonymous");
  ...
  object_class(str_8086) = eul_static_string_class;
  ...
  eul_intern_symbol(sym_8106,"table-ref");
  eul_intern_symbol(sym_8107,"(method element)");
  eul_intern_symbol(sym_8108,"(method table-ref)");
  eul_intern_symbol(sym_8109,"(method (setter element))");
  eul_intern_symbol(sym_8111,"setter");
  object_class(cons_8112) = eul_static_cons_class;
  eul_car(cons_8112) = sym_8106;
  eul_cdr(cons_8112) = eul_nil;
  object_class(cons_8110) = eul_static_cons_class;
  eul_car(cons_8110) = sym_8111;
  eul_intern_symbol(sym_8113,"(method (setter table-ref))");
  eul_intern_symbol(sym_8114,"(method emptyp)");
  eul_intern_symbol(sym_8115,"(method do)");
  eul_intern_symbol(sym_8116,"(method map)");
  eul_intern_symbol(sym_8117,"(method anyp)");
  eul_intern_symbol(sym_8118,"(method allp)");
  eul_intern_symbol(sym_8119,"(method member)");
  eul_intern_symbol(sym_8120,"(method accumulate)");
  eul_intern_symbol(sym_8121,"(method accumulate1)");
  eul_intern_symbol(sym_8123,"converter");
  eul_intern_symbol(sym_8125,"<table>");
  object_class(cons_8124) = eul_static_cons_class;
  eul_car(cons_8124) = sym_8125;
  eul_cdr(cons_8124) = eul_nil;
  ...
  eul_intern_symbol(sym_8156,"table-empty-p");
  eul_intern_symbol(sym_8157,"allp1-table");
  eul_intern_symbol(sym_8158,"accumulate1-table");
  eul_intern_symbol(sym_8159,"do1-table");
  eul_intern_symbol(sym_8160,"anyp1-table");
  eul_intern_symbol(sym_8161,"table-rehash");
  eul_intern_symbol(sym_8162,"map1-table");
  eul_intern_symbol(sym_8163,"accumulate-table");
  eul_intern_symbol(sym_8164,"top-level");
  ...
  table_bindings[ 11] = (LispRef) (LispRef (*) (Stack *, LispRef *, LispRef *)) ff_stub_eul_table_ref8052;
  table_bindings[ 12] = (LispRef) (LispRef (*) (Stack *, LispRef *, LispRef *)) ff_stub_eul_addr_str8053;
  table_bindings[ 13] = (LispRef) (LispRef (*) (Stack *, LispRef *, LispRef *)) ff_stub_eul_table_set8054;
  table_bindings[ 14] = G008056;
  table_bindings[ 15] = G008058;
  table_bindings[ 16] = G008060;
  table_bindings[ 17] = sym_8063;
  table_bindings[ 18] = G008062;
  table_bindings[ 19] = str_8066;
  table_bindings[ 20] = G008065;
  table_bindings[ 21] = str_8069;
  table_bindings[ 22] = G008068;
  table_bindings[ 23] = str_8072;
  table_bindings[ 24] = G008071;
  table_bindings[ 25] = str_8075;
  table_bindings[ 26] = G008074;
  table_bindings[ 27] = G008077;
  table_bindings[ 28] = G008079;
  table_bindings[ 29] = G008081;
  table_bindings[ 30] = G008083;
  table_bindings[ 31] = str_8086;
  table_bindings[ 32] = G008085;
  table_bindings[ 33] = G008088;
  table_bindings[ 34] = G008090;
  table_bindings[ 35] = G008092;
  table_bindings[ 36] = G008094;
  table_bindings[ 37] = G008096;
  table_bindings[ 38] = str_8099;
  table_bindings[ 39] = G008098;
  table_bindings[ 40] = G008101;
  table_bindings[ 41] = G008103;
  table_bindings[ 42] = sym_8106;
  table_bindings[ 43] = sym_8107;
  table_bindings[ 44] = sym_8108;
  table_bindings[ 45] = sym_8109;
  table_bindings[ 46] = sym_8111;
  table_bindings[ 47] = cons_8110;
  table_bindings[ 48] = sym_8113;
  table_bindings[ 49] = sym_8114;
  table_bindings[ 50] = sym_8115;
  table_bindings[ 51] = sym_8116;
  table_bindings[ 52] = sym_8117;
  table_bindings[ 53] = sym_8118;
  table_bindings[ 54] = sym_8119;
  table_bindings[ 55] = sym_8120;
  table_bindings[ 56] = sym_8121;
  table_bindings[ 57] = sym_8123;
  table_bindings[ 58] = sym_8125;
  table_bindings[ 59] = cons_8122;
  table_bindings[ 60] = G008105;
  table_bindings[ 61] = G008127;
  table_bindings[ 62] = G008129;
  table_bindings[ 63] = G008131;
  table_bindings[ 64] = G008133;
  table_bindings[ 65] = G008135;
  table_bindings[ 66] = G008137;
  table_bindings[ 67] = G008139;
  table_bindings[ 68] = G008141;
  table_bindings[ 69] = G008143;
  table_bindings[ 70] = G008145;
  table_bindings[ 71] = G008147;
  table_bindings[ 72] = G008149;
  table_bindings[ 73] = G008151;
  table_bindings[ 74] = G008153;
  table_bindings[ 1] = eul_nil;
  table_bindings[ 75] = sym_8156;
  table_bindings[ 76] = sym_8157;
  table_bindings[ 77] = sym_8158;
  table_bindings[ 78] = sym_8159;
  table_bindings[ 79] = sym_8160;
  table_bindings[ 80] = sym_8161;
  table_bindings[ 81] = sym_8162;
  table_bindings[ 82] = sym_8163;
  table_bindings[ 83] = sym_8164;
  eul_allocate_lambda( table_bindings[0], "initialize-table", 0, G008155);
