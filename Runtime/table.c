...
void initialize_module_table()
{
  ...
  static const void *G008077[] = {I(43,03,24,00),B(table ,3),I(24,00,00,00),B(boot1 ,41),I(3c,01,1f,03),I(1f,03,1f,03),I(1f,03,3d,03),I(04,45,04,00)};
