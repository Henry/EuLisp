...
* Extras
*** [[http://henry.github.com/EuLisp/Extras/Bignum/README.html][GNU Bignum]]: /Extras/Bignum/
    Danius Michaelides wrote a port to the GNU bignum library (gmp).
*** [[http://henry.github.com/EuLisp/Extras/MPI/README.html][MPI]]: /Extras/MPI/

*** [[http://henry.github.com/EuLisp/Extras/TclTk/README.html][Tcl/Tk]]: /Extras/TclTk/

*** [[http://henry.github.com/EuLisp/Extras/Fthread/README.html][Foreign thread libraries]]: /Extras/Fthread/

*** [[http://henry.github.com/EuLisp/Extras/Scheme/README.html][Scheme]]: /Extras/Scheme/
    Modules /./Extras/Scheme/scheme0.em/ and /./Extras/Scheme/scheme.em/
    provide support for writing Scheme programs with youtoo.

*** [[http://henry.github.com/EuLisp/Extras/Matching/README.html][Matching]]: /Extras/Match/
    Modulized version of match-slib.scm badly hacked for EuLisp.

*** [[http://henry.github.com/EuLisp/Extras/OS/README.html][Object serialisation]]: /Extras/OS/
Julian Padget\    includes support for closures and threads.

*** [[http://henry.github.com/EuLisp/Extras/OPS5/README.html][OPS5 rule-based system]] : /Extras/OPS5/
    An object-oriented version of the OPS5 rule-based system.

***  [[http://henry.github.com/EuLisp/Extras/Pipe/README.html][Pipes and forked child processes]]:  /Extras/Pipe/
...
*** EuLisp definition
    ...
    + [[http://henry.github.com/EuLisp/Doc/EuLisp-0.991/html1/eulisp.html][EuLisp Definition Version 0.991 (HTML single page)]]
...
* [[http://henry.github.com/EuLisp/TODO.html][To Do]]
