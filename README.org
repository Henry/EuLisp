...
* [[http://henry.github.com/EuLisp/blob/master/COPYING][Copyright]]
    ...
    Youtoo in the file [[http://henry.github.com/EuLisp/blob/master/COPYING][COPYING]].  If not, see <http://www.gnu.org/licenses/>.
...
*** Youtoo original sources
    ...
    available from the original [[http://henry.github.com/EuLisp/blob/master/README.orig][README]] file and
...
*** EuLisp definition
    ...
    + [[http://henry.github.com/EuLisp/blob/master/Doc/EuLisp-0.991/html/eulisp.html][EuLisp Definition Version 0.991 (HTML)]]
    + [[http://henry.github.com/EuLisp/blob/master/Doc/EuLisp-0.991/eulisp.pdf][EuLisp Definition Version 0.991 (PDF)]]
*** EuLisp-1.0 Proposals
    are in the folowing
    [[http://henry.github.com/EuLisp/blob/master/Doc/EuLisp-0.991/Proposals/Proposals.txt][proposal document]] and
    discussed in the minutes of the
    [[http://henry.github.com/EuLisp/blob/master/Doc/EuLisp-0.991/Proposals/Meeting_19_11_93.txt][meeting on
    19/11/93]] and in the
    [[http://henry.github.com/EuLisp/blob/master/Doc/EuLisp-0.991/Proposals/nov93.txt][preceding]] and
    [[http://henry.github.com/EuLisp/blob/master/Doc/EuLisp-0.991/Proposals/dec93.txt][subsequent]] Email correspondence.
    The following reports are discussed in the above:
    + [[http://henry.github.com/EuLisp/blob/master/Doc/EuLisp-0.991/Proposals/Reports/eulisp-proposals.ps][eulisp-proposals.ps]]
    + [[http://henry.github.com/EuLisp/blob/master/Doc/EuLisp-0.991/Proposals/Reports/genarith.ps][genarith.ps]]
    + [[http://henry.github.com/EuLisp/blob/master/Doc/EuLisp-0.991/Proposals/Reports/adv-genarith.ps][adv-genarith.ps]]
    + [[http://henry.github.com/EuLisp/blob/master/Doc/EuLisp-0.991/Proposals/Reports/eulisp-ffi.ps][eulisp-ffi.ps]]
...
*** Bindings
    ...
    [[http://henry.github.com/EuLisp/blob/master/Doc/bindings.txt][bindings.txt]]

* Extras
*** [[http://henry.github.com/EuLisp/blob/master/Extras/Bignum/README.org][GNU Bignum]]: /Extras/Bignum/
    Danius Michaelides wrote a port to the GNU bignum library (gmp).
*** [[http://henry.github.com/EuLisp/blob/master/Extras/MPI/README.org][MPI]]: /Extras/MPI/

*** [[http://henry.github.com/EuLisp/blob/master/Extras/TclTk/README.org][Tcl/Tk]]: /Extras/TclTk/

*** [[http://henry.github.com/EuLisp/blob/master/Extras/Fthread/README.org][Foreign thread libraries]]: /Extras/Fthread/

*** [[http://henry.github.com/EuLisp/blob/master/Extras/Scheme/README.org][Scheme]]: /Extras/Scheme/
    Modules /./Extras/Scheme/scheme0.em/ and /./Extras/Scheme/scheme.em/
    provide support for writing Scheme programs with Youtoo.

*** [[http://henry.github.com/EuLisp/blob/master/Extras/Matching/README.org][Matching]]: /Extras/Match/
    Modulized version of match-slib.scm badly hacked for EuLisp.

*** [[http://henry.github.com/EuLisp/blob/master/Extras/OS/README.org][Object serialisation]]: /Extras/OS/
    includes support for closures and threads.

*** [[http://henry.github.com/EuLisp/blob/master/Extras/OPS5/README.org][OPS5 rule-based system]] : /Extras/OPS5/
    An object-oriented version of the OPS5 rule-based system.

***  [[http://henry.github.com/EuLisp/blob/master/Extras/Pipe/README.org][Pipes and forked child processes]]:  /Extras/Pipe/
...
* [[http://henry.github.com/EuLisp/blob/master/TODO.org][To Do]]
