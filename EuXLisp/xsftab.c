...
FUNDEF funtab[] = {
    ...
    {"stream?", xportp},
    {"input-stream?", xinputportp},
    {"output-stream?", xoutputportp},
    {"object?", xobjectp},
    ...
    {"socket-convert-to-stream", socket_convert_to_port},
    {"stream-fd", port_fd,},
    {"stream-unbuffered", port_unbuffered,},
    {"stream-block-buffered", port_block_buffered,},
    {"stream-line-buffered", port_line_buffered,},
    ...
    {"stream-xdr-send-int", port_xdr_send_int},
    {"stream-xdr-recv-int", port_xdr_recv_int},
    {"stream-xdr-send-float", port_xdr_send_float},
    {"stream-xdr-recv-float", port_xdr_recv_float},
    {"stream-xdr-send-string", port_xdr_send_string},
    {"stream-xdr-recv-string", port_xdr_recv_string},
    #endif
