...
\rewriterules
%
\savesyntax\defunRewrite\vbox{\tt%
\begin{tabular}{lll}%
...
\end{minipage}%
\end{tabular}}%
\rewritetable{defun}{\defunRewrite}
%
...
\rewriterules
%
\savesyntax\blockRewrite\vbox{\tt%
\begin{tabular}{lll}%
    ...
    \tts\forms)                    && \tts\forms)
\end{tabular}}%
\rewritetable{block}{\blockRewrite}
...
\rewriterules
%
\savesyntax\returnFromRewrite\vbox{\tt%
\begin{tabular}{lll}%
...
\end{tabular}}%
\rewritetable{return-from}{\returnFromRewrite}
%
\seealso%
\macroref{block}.
...
\rewriterules
%
\savesyntax\letStarRewrite\vbox{\tt%
\begin{tabular}{lll}%
...
\end{minipage}%
\end{tabular}}%
\rewritetable{let*}{\letStarRewrite}
