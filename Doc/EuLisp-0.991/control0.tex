...
%
\remarks%
The symbol {\tt nil} is defined to be equivalent to the empty list, which is
represented as \nil{}, \ie {\tt (\functionref{eq} 'nil '\nil{})} $\Rightarrow$
\true{}.  The empty list is used to denote the abstract boolean value
\sc{false}.
