...
\begin{syntax}
    ...
    \>  ( \macroref{and} \scseqref{consequent} )
\end{syntax}}%
\showSyntaxBox{and}
%
\remarks%
...
evaluates to \true{} is the result of the \macroref{or} form and none of the
...
\begin{syntax}
    ...
    \>  ( \macroref{block} \scref{identifier} \scref{body} )
\end{syntax}}%
\showSyntaxBox{block}
%
\remarks%
...
\begin{RewriteTable}{let}{lll}
    (\macroref{let} () \scref{body}) &\rewrite& (\specopref{progn} \scref{body}) \\
\begin{minipage}[t]{\columnwidth}
\begin{tabbing}
    (\macroref{let} (\=(\scref{variable}$_1$ \scref{form}$_1$) \\
    \>(\scref{variable}$_2$ \scref{form}$_2$) \\
    \>\scref{variable}$_3$ \\
    \>\ldots)\\
    00\= \kill
    \>\scref{body})
...
\begin{tabbing}
    00\=00\=00\= \kill
    ((\specopref{lambda} (\scref{variable}$_1$ \scref{variable}$_2$ \scref{variable}$_3$ \ldots) \\
    \>\>\scref{body}) \\
...
\begin{minipage}[t]{\columnwidth}
\begin{tabbing}
    (\macroref{let} \= \scref{variable}$_0$ \\
    \>(\=(\scref{variable}$_1$ \scref{form}$_1$) \\
    \>\>\scref{variable}$_2$ \\
    \>\>\ldots)\\
    00\= \kill
    \>\scref{body})
...
\begin{tabbing}
    00\= \kill
    (\specopref{labels}\\
    \>(\=(\scref{variable}$_0$ (\scref{variable}$_1$ \scref{variable}$_2$ \ldots) \\
    \>\>\scref{body})) \\
    \>(\scref{variable}$_0$ \scref{form}$_1$ () \ldots))
\end{tabbing}%
\end{minipage}%
\end{RewriteTable}
...
%
\begin{RewriteTable}{let*}{lll}
    (\macroref{let*} () \scref{body}) &\rewrite& (progn \scref{body}) \\
\begin{minipage}[t]{\columnwidth}
\begin{tabbing}
    (\macroref{let*} (\=(\scref{variable}$_1$ \scref{form}$_1$) \\
    \>(\scref{variable}$_2$ \scref{form}$_2$) \\
...
\begin{tabbing}%
    00\= \kill
    (\macroref{let} ((\scref{variable}$_1$ \scref{form}$_1$)) \\
    \>(\macroref{let*} (\=(\scref{variable}$_2$ \scref{form}$_2$) \\
    \>\>\scref{variable}$_3$\\
    \>\>\ldots) \\
    00\=00\= \kill
    \>\>\scref{body}))
...
\raggedbottom
%
This section gives the syntax of all level-0 forms starting with modules.  The
syntax of data objects is given in the section pertaining to the class and is
summarized in section~\ref{object-syntax-summary}.
