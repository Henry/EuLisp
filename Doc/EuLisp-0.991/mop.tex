...
\begin{tabular*}{\linewidth}{l}
    ...
    \tts\tts\tts\tts{\em cl direct-superclasses\/}
    $\rightarrow$ {\em boolean}\\
    \tts{\tt compatible-superclass-p}\\
    \tts\tts\tts\tts\tts {\em cl superclass\/}
    $\rightarrow$ {\em boolean}\\
    \hline
    ...
    \hline
    {\tt compute-initargs}\\
    \tts\tts\tts\tts{\em cl direct-initargs inherited-initargs\/}
    $\rightarrow$ ({\em initarg\/}$^*$)\\
    \hline
    ...
    \hline
    {\tt compute-slots}\\
    \tts\tts\tts\tts{\em cl slot-specs inherited-sds\/}
    $\rightarrow$ ({\em sd\/}$^*$)\\
    \tts{\em either}\\
    \tts\tts{\tt compute-defined-slot}\\
    \tts\tts\tts\tts\tts\tts{\em cl slot-spec\/}
    $\rightarrow$ {\em sd}\\
    \tts\tts\tts{\tt compute-defined-slot-description-class}\\
    \tts\tts\tts\tts\tts\tts\tts{\em cl slot-spec\/}
    $\rightarrow$ {\em sd-class}\\
    \tts{\em or}\\
    \tts\tts{\tt compute-specialized-slot}\\
    \tts\tts\tts\tts\tts\tts{\em cl inherited-sds slot-spec\/}
    $\rightarrow$ {\em sd}\\
    \tts\tts\tts{\tt compute-specialized-slot-class}\\
    \tts\tts\tts\tts\tts\tts\tts{\em cl inherited-sds slot-spec\/}
    $\rightarrow$ {\em sd-class}\\
    \hline
    {\tt compute-instance-size}\\
    \tts\tts\tts\tts{\em cl effective-sds\/}
    $\rightarrow$ {\em integer}\\
    \hline
    {\tt compute-and-ensure-slot-accessors}\\
    \tts\tts\tts\tts{\em cl effective-sds inherited-sds\/}
    $\rightarrow$ ({\em sd\/}$^*$)\\
    \tts{\tt compute-slot-reader}\\
    \tts\tts\tts\tts\tts{\em cl sd effective-sds\/}
    $\rightarrow$ {\em function}\\
    \tts{\tt compute-slot-writer}\\
    \tts\tts\tts\tts\tts{\em cl sd effective-sds\/}
    $\rightarrow$ {\em function}\\
    \tts{\tt ensure-slot-reader}\\
    \tts\tts\tts\tts\tts{\em cl sd effective-sds reader\/}
    $\rightarrow$ {\em function}\\
    \tts\tts{\tt compute-primitive-reader-using-slot}\\
    \tts\tts\tts\tts\tts\tts{\em sd cl effective-sds\/}
    $\rightarrow$ {\em function}\\
    \tts\tts\tts{\tt compute-primitive-reader-using-class}\\
    \tts\tts\tts\tts\tts\tts\tts{\em cl sd effective-sds\/}
    $\rightarrow$ {\em function}\\
    \tts{\tt ensure-slot-writer}\\
    \tts\tts\tts\tts\tts{\em cl sd effective-sds writer\/}
    $\rightarrow$ {\em function}\\
    \tts\tts{\tt compute-primitive-writer-using-slot}\\
    \tts\tts\tts\tts\tts\tts{\em sd cl effective-sds\/}
    $\rightarrow$ {\em function}\\
    \tts\tts\tts{\tt compute-primitive-writer-using-class}\\
    \tts\tts\tts\tts\tts\tts\tts{\em cl sd effective-sds\/}
    $\rightarrow$ {\em function}
\end{tabular*}
}
...
\tts\tts(new-value \classref{object}))\\
\tts(primitive-writer obj new-value))
}
%
