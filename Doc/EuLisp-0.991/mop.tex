...
\macroref{method-lambda}, or by using the \genericref{method} generic function
...
is \classref{metaclass}.

\method{compatible-superclass-p}
%
\begin{specargs}
    \item[subclass, \classref{class}] A class.
    \item[superclass, \classref{cabstract-class}] A potential direct superclass.
\end{specargs}
%
\result%
Always returns \true.
...
%
\begin{specargs}
    \item[subclass, \classref{abstract-class}] A class.
    \item[superclass, \classref{class}] A potential direct superclass.
\end{specargs}
%
\result%
...
\begin{specargs}
    \item[subclass, \classref{abstract-class}] A class.
    \item[superclass, \classref{abstract-class}] A potential direct superclass.
\end{specargs}
%
\result%
Always returns \true.
...
\conditionref{methods-exists}\indexcondition{method-exists}). If no error
