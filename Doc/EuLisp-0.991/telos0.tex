...
\rewriterules
%
\savesyntax\defgenericRewrite\vbox{\tt
\begin{tabular}{l}%
\begin{minipage}[t]{9cm}
    \begin{tabbing}
        00\=00\= \kill
        (\defformref{defgeneric} \identifier \\
...
\begin{minipage}[t]{9cm}
    \begin{tabbing}
        00\=00\= \kill
        ((\functionref{setter} \functionref{setter}) \identifier\\
        \>(\macroref{generic-lambda} \\
        \>\> {\em gf-lambda-list} {\em level-0-init-option$^*$}))
    \end{tabbing}
\end{minipage}\\
...
\begin{minipage}[t]{9cm}
    \begin{tabbing}
        00\=00\= \kill
        (\defformref{defgeneric} \\
        \>(\functionref{converter} \identifier) \\
        \>{\em gf-lambda-list} {\em level-0-init-option$^*$})
    \end{tabbing}
\end{minipage}\\
\hspace{1cm}$\equiv$
...
\rewritetable{defgeneric}{\defgenericRewrite}
%
\examples
