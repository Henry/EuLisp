...
\defSyntax{defmodule-0}{
    \begin{syntaxx}
        ...
        \>  \keywordref{export} ( \scseqref{indentifier} ) \\
        ...
        \>  \scref{module-filter} \\
        \scdef{module-filter}: \\
        \>  ( \keywordref{except} ( \scseqref{indentifier} ) \scref{module-descriptor} ) \\
        \>  ( \keywordref{only} ( \scseqref{indentifier} ) \scref{module-descriptor} ) \\
...
\scref{module0name} and a \scref{local-name}.  Intuitively, a namelist of such
