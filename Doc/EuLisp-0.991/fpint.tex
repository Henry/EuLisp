...
\classref{int} are defined by methods on the generic
...
\derivedclass{int}{integer}
\index{general}{level-0 classes!\theclass{int}}
...
\constant{most-positive-int}{int}
...
\constant{most-negative-int}{int}
