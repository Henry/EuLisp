...
%
\seealso%
\instanceref{stdout}, \genericref{sprin}.
...
%
\seealso%
\instanceref{stdout}, \genericref{sprint}.
...
\begin{syntax}
    ...
    \>  ( \macroref{with-input-file} \scref{path} \\
    \>\>  \scref{body} ) \\
    \scdef{path}: \\
    \>  \scref{string}
\end{syntax}}%
...
\begin{syntax}
    ...
    \>  ( \macroref{with-output-file} \scref{path} \\
    \>\>  \scref{body} )
\end{syntax}}%
...
\begin{syntax}
    ...
    \>  ( \macroref{with-source} ( \scref{identifier} \scref{form} ) \\
    \>\>  \scref{body} )
\end{syntax}}%
...
\begin{syntax}
    ...
    \>  ( \macroref{with-sink} ( \scref{identifier} \scref{form} ) \\
    \>\>  \scref{body} )
\end{syntax}}%
