...
is defined as an instance of one of \classref{list}, \classref{string}, \classref{vector},
\classref{table}\ or any user-defined class for which a method is added to any of
...
the cases of \classref{list}, \classref{string}\ and \classref{vector}, since there is an
...
\condition{collection-condition}{condition} This is the condition class for all
...
result is true, the result of \genericref{anyp} is true and there are no further
...
result of \genericref{find-key} is the key associated with that element.
%
\remarks%
...
true.  If {\em test\/} is not supplied, \genericref{eql} is used by default.  Note that
...
%
\remarks%
The test function defaults to \genericref{eql}.
