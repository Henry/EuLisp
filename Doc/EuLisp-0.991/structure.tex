...
\begin{references}
    ...
    %
    \bibitem[ISO/IEC 14977 : 1996] {iso14977} Information technology ---
...
clause, coupled with its classification.  The syntax descriptions are presented
in extended Backus–Naur form (EBNF) \cite{iso14977}.  Examples of several kinds
of entry are now given.  Some subsections of entries are optional and are only
given where it is felt necessary.
%
...
\endsyntax}
\syntaxtable{a-function}{\aFunctionSyntax}
%
\begin{arguments}
