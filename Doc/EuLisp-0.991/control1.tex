...
%
\Syntax
\savesyntax\defglobalSyntax\vbox{\small\syntax
defglobal form
...
%
\Syntax
\savesyntax\catchSyntax\vbox{\small\syntax
catch macro
   = '(', 'catch', tag, {form}, ')';
tag
   = symbol; (* \[\S\ref{symbol}\] *)
...
\macroref{catch} are:
%
\savesyntax\catchRewrites\vbox{\begin{center}
{\small\tt
\begin{tabular}{lll}
...
\Syntax
\savesyntax\throwSyntax\vbox{\small\syntax
throw macro
   = '(', 'throw', tag, {form}, ')';
\endsyntax}
...
%
\savesyntax\throwRewrites\vbox{\begin{center}
{\small\tt
\begin{tabular}{lll}
