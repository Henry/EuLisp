...
A boolean value is either {\em false} \index{general}{false}, which is
represented by the empty list---written \nil{}\/ and is also the value of
\constantref{nil}---or {\em true} \index{general}{true}, which is represented by
...
is abused for convenience and \scref{boolean} \index{general}{boolean} is
