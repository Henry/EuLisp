...
\begin{definitions}
    ...
    \sc{syntax expression} expanding into a form whose operator is a
    \sc{defining operator}.
    ...
    \defopref{defgeneric}, \defopref{deflocal}, \defopref{defsyntax},
    ...
    \definition{syntax operator}\index{general}{syntax operator} A syntax
    ...
    \sc{syntax expression} expanding into a form whose operator is a \sc{special
