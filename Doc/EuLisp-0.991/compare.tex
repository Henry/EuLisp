...
\begin{tabular*}{\linewidth}{ll}
    ...
    & \classref{int} \\
    & \classref{double-float}$\times$\classref{double-float} \\
    & \classref{double-float}$\times$\classref{int} \\
    & \classref{int}$\times$\classref{double-float} \\
...
for \classref{int} and \classref{double-float}),
...
\seealso%
Class specific methods on \genericref{binary<} are defined for
\classref{character}, \classref{string}, \classref{int} and
