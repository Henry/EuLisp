...
by \defformref{defmethod} or \genericref{add-method}.  An {\em init-option} is a
identifier followed by its initial value.  The syntax of \defformref{defgeneric}
is an extension of the level-0 syntax.  The rewrite rules for the
\defformref{defgeneric} form are identical to those given in
...
%
\remarks%
The \defformref{defmethod} form of level-1 extends that of level-0 to accept
