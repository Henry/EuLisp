...
%
\Syntax
\savesyntax\genericLambdaOneSyntax\vbox{\syntax
generic lambda form
...
%
\Syntax
\savesyntax\defgenericOneSyntax\vbox{\syntax
defgeneric form
   = '(', 'defgeneric',
...
\macro{method-lambda}
\Syntax
\savesyntax\methodLambdaOneSyntax\vbox{\syntax
method lambda form
   = '(', 'method-lambda',
...
\macro{defmethod}
\Syntax
\savesyntax\defmethodOneSyntax\vbox{\syntax
defmethod form
   = '(', 'defmethod', gf name,
     {method init option}, (* \[\S\ref{generic-lambda-1}\] *)
     specialized lambda list,
