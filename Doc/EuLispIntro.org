...
*** Format
    ...
    which is somewhat akin to C's =printf=.
    #+BEGIN_SRC eulisp
    (sformat stream format-string arg arg ...)
    #+END_SRC
    The variants
    [[file:EuLisp-0.991/html/eulispcl17.html#dx21-577002][=format=]] and
    [[file:EuLisp-0.991/html/eulispcl17.html#dx21-579002][=fmt=]]
    do not take a stream argument and the former prints to standard output and
    the latter returns the formatted output as a string.
