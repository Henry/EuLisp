     ...
     ((loop (i)
            (if (< i *no-meals*)
                (progn
                  ...
                  (reschedule-check)
                  (cwait *dining-room*)
                  (format t "    ~a entered room for meal ~a\n" id i)
                  (take-chopsticks id)
                  (reschedule-check)
                  (eat id i)
                  (reschedule-check)
                  (drop-chopsticks id)
                  (format t "    ~a leaving room after meal ~a\n" id i)
                  (csignal *dining-room*)
                  (reschedule-check)
                  (loop (+ i 1)))
              ())))
...
;;     (thread-join-all)
     ...
     (format t "Philosophers 1 to ~a had each ~a meals.\n"
