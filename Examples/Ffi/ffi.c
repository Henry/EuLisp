...
void initialize_module_ffi()
{
  ...
  static const void *G0019[] = {I(aa,1b,26,00),I(00,00,00,32),I(1a,1b,34,00),I(00,00,00,7e),I(41,00,00,00),B(ffi ,3),I(23,00,00,00),B(ffi ,6),I(1f,03,24,00),B(mop_gf ,17),I(3c,02,2a,23),B(ffi ,7),I(24,00,00,00),B(stream ,17),I(3c,01,2a,1b),I(41,00,00,00),B(ffi ,4),I(22,01,2a,23),B(ffi ,8),I(24,00,00,00),B(stream ,17),I(3c,01,2a,1b),I(24,00,00,00),B(stream ,13),I(3c,01,2a,1b),I(24,00,00,00),B(ffi ,2),I(0f,1b,89,00),B(ffi ,2),I(2a,1f,03,2b),I(47,00,00,3d),I(01,04,22,02),I(32,00,00,00),I(00,00,00,1b),I(23,00,00,00),B(ffi ,9),I(24,00,00,00),B(stream ,11),I(3d,01,02,45),I(02,00,00,00)};
