...
*** TODO Correct the echoing of complex characters
      ...
      \
      - #\\
*** DONE Do not add =binary= for <character> <character>
    CLOSED: [2010-05-09 Sun 21:43]
    Needed by =vmeta=.  Not necessary if =equal= is used in the definitions of
    =binary<== and =binary>== methods.
...
*** DONE Do not add =binary= for <character> <character>
    CLOSED: [2010-05-09 Sun 21:42]
    Not necessary if =equal= is used in the definitions of =binary<== and
    =binary>== methods.
