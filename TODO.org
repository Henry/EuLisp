...
*** DONE Add =spprint= and change =pprint= to use stdout
...
*** TODO Change all destructive functions to =setters=
*** TODO Set the readline prompt rather than printing it directly
    This should avoid some of the command-line editing problems when the prompt
    is not printed.
* Youtoo
...
*** TODO Rename predicate =namep= -> =name?=
* EuXLisp
...
* Other
*** TODO Complete emacs mode eulisp-mode.el for EuLisp
