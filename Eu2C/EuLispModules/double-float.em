...
(defmethod binary-mod ((f <fixed-precision-integer>)
                       (d <double-float>))
...
(defmethod truncate ((d <double-float>))
  ...
  (make-fpint (%cdtoi (dble double-float-buffer))))
...
(defmethod (converter <fixed-precision-integer>)
  ((object <double-float>))
...
(%annotate-function
  ...
  (((var0 var1 var2)
    ...
    ((var var1) (atom (or <fixed-precision-integer> <double-float>)))
    ((var var2) (atom <double-float>)))
   ((var0 var1 var2)
    ((var var0) (atom <double-float>))
    ((var var1) (atom <double-float>))
    ((var var2) (atom (or <fixed-precision-integer> <double-float>))))
   ((var0 var1 var2)
    ((var var0) (atom <fixed-precision-integer>))
    ((var var1) (atom <fixed-precision-integer>))
    ((var var2) (atom <fixed-precision-integer>)))
   ((var0 var1 var2)
    ((var var0) (atom (and <number> (and (not <fixed-precision-integer>)
                                         (not <double-float>)))))
    ((var var1) (atom (and <number> (and (not <fixed-precision-integer>)
                                         (not <double-float>)))))
   ...
   ((var0 var1 var2)
    ...
    ((var var2) (atom (and <number> (and (not <fixed-precision-integer>)
                                         (not <double-float>))))))))
