...
(%annotate-function
  ...
  (((var0 var1 var2)
    ...
    ((var var1) (atom? (or <int> <double-float>)))
    ((var var2) (atom? <double-float>)))
   ((var0 var1 var2)
    ((var var0) (atom? <double-float>))
    ((var var1) (atom? <double-float>))
    ((var var2) (atom? (or <int> <double-float>))))
   ((var0 var1 var2)
    ((var var0) (atom? <int>))
    ((var var1) (atom? <int>))
    ((var var2) (atom? <int>)))
   ((var0 var1 var2)
    ((var var0) (atom? (and <number> (and (not <int>)
                                         (not <double-float>)))))
    ((var var1) (atom? (and <number> (and (not <int>)
                                         (not <double-float>)))))
