...
void initialize_module_mop_defcl0()
{
  ...
  static const void *G001291[] = {I(43,04,23,00),B(mop_defcl0 ,28),I(86,0f,23,00),B(mop_defcl0 ,29),I(86,0f,23,00),B(mop_defcl0 ,30),I(1c,0f,1f,05),I(86,0f,23,00),B(mop_defcl0 ,31),I(1c,0f,23,00),B(mop_defcl0 ,32),I(1c,0f,23,00),B(mop_defcl0 ,33),I(86,0f,1b,86),I(0f,1d,1c,0f),I(1f,06,1c,0f),I(23,00,00,00),B(mop_defcl0 ,34),I(1c,0f,1f,0b),I(86,0f,23,00),B(mop_defcl0 ,28),I(1c,0f,1d,1c),I(0f,1b,86,0f),I(1f,0e,1c,0f),I(1f,13,1c,0f),I(23,00,00,00),B(mop_defcl0 ,35),I(1c,0f,1f,15),I(86,0f,23,00),B(mop_defcl0 ,36),I(1c,0f,1b,86),I(0f,1f,03,1c),I(0f,45,19,00)};
  ...
  static const void *G001328[] = {I(aa,46,01,86),I(1b,48,00,00),I(23,00,00,00),B(mop_defcl0 ,58),I(23,00,00,00),B(mop_defcl0 ,57),I(3b,02,48,00),I(00,1c,86,47),I(00,00,3d,02),I(02,45,02,00)};
  ...
  static const void *G001360[] = {I(ab,46,02,1c),I(48,00,00,86),I(1b,48,00,01),I(23,00,00,00),B(mop_defcl0 ,58),I(23,00,00,00),B(mop_defcl0 ,76),I(3b,03,48,00),I(01,1c,24,00),B(boot ,8),I(3c,01,1b,2c),I(1f,03,86,1d),I(47,00,01,3d),I(03,05,45,05)};

  /* Byte-vector with size: 28 is_init: 0 index: 82 binding: do-printfn */
  static const void *G001362[] = {I(ab,23,00,00),B(mop_defcl0 ,49),I(1c,86,24,00),B(mop_key ,2),I(3c,03,1b,12),I(1b,34,00,00),I(00,00,00,0f),I(86,32,00,00),I(00,00,00,51),I(1f,03,86,0f),I(23,00,00,00),B(mop_defcl0 ,78),I(1c,0f,23,00),B(mop_defcl0 ,79),I(86,0f,1c,1c),I(0f,23,00,00),B(mop_defcl0 ,79),I(86,0f,23,00),B(mop_defcl0 ,78),I(1c,0f,1f,07),I(1c,0f,1b,86),I(0f,1f,04,1c),I(0f,23,00,00),B(mop_defcl0 ,80),I(1c,0f,23,00),B(mop_defcl0 ,81),I(1c,0f,86,0f),I(22,0a,45,04)};

  /* Byte-vector with size: 80 is_init: 1 index: 0 binding: initialize-mop-defcl0 */
  static const void *G001368[] = {I(87,25,00,00),B(mop_defcl0 ,1),I(24,00,00,00),B(level1 ,1),I(3e,0b,24,00),B(level1 ,0),I(3c,00,21,01),I(23,00,00,00),B(mop_defcl0 ,83),I(23,00,00,00),B(mop_defcl0 ,82),I(3b,02,25,00),B(mop_defcl0 ,13),I(23,00,00,00),B(mop_defcl0 ,84),I(23,00,00,00),B(mop_defcl0 ,77),I(3b,02,25,00),B(mop_defcl0 ,12),I(23,00,00,00),B(mop_defcl0 ,85),I(23,00,00,00),B(mop_defcl0 ,75),I(3b,fc,25,00),B(mop_defcl0 ,11),I(23,00,00,00),B(mop_defcl0 ,86),I(23,00,00,00),B(mop_defcl0 ,72),I(3b,01,25,00),B(mop_defcl0 ,10),I(23,00,00,00),B(mop_defcl0 ,87),I(23,00,00,00),B(mop_defcl0 ,71),I(3b,02,25,00),B(mop_defcl0 ,9),I(23,00,00,00),B(mop_defcl0 ,88),I(23,00,00,00),B(mop_defcl0 ,65),I(3b,02,25,00),B(mop_defcl0 ,8),I(23,00,00,00),B(mop_defcl0 ,89),I(23,00,00,00),B(mop_defcl0 ,62),I(3b,fb,25,00),B(mop_defcl0 ,7),I(23,00,00,00),B(mop_defcl0 ,90),I(23,00,00,00),B(mop_defcl0 ,59),I(3b,01,25,00),B(mop_defcl0 ,6),I(23,00,00,00),B(mop_defcl0 ,91),I(23,00,00,00),B(mop_defcl0 ,56),I(3b,fb,25,00),B(mop_defcl0 ,5),I(23,00,00,00),B(mop_defcl0 ,92),I(23,00,00,00),B(mop_defcl0 ,37),I(3b,04,25,00),B(mop_defcl0 ,4),I(23,00,00,00),B(mop_defcl0 ,93),I(23,00,00,00),B(mop_defcl0 ,27),I(3b,04,25,00),B(mop_defcl0 ,3),I(23,00,00,00),B(mop_defcl0 ,94),I(23,00,00,00),B(mop_defcl0 ,26),I(3b,01,25,00),B(mop_defcl0 ,2),I(86,ac,00,00)};
  ...
  mop_defcl0_bindings[ 14] = sym_1273;
  mop_defcl0_bindings[ 15] = key_1274;
  mop_defcl0_bindings[ 16] = sym_1275;
  mop_defcl0_bindings[ 17] = sym_1277;
  mop_defcl0_bindings[ 18] = cons_1276;
  mop_defcl0_bindings[ 19] = key_1278;
  mop_defcl0_bindings[ 20] = key_1279;
  mop_defcl0_bindings[ 21] = sym_1280;
  mop_defcl0_bindings[ 22] = key_1283;
  mop_defcl0_bindings[ 23] = key_1286;
  mop_defcl0_bindings[ 24] = key_1288;
  mop_defcl0_bindings[ 25] = cons_1281;
  mop_defcl0_bindings[ 26] = G001272;
  mop_defcl0_bindings[ 27] = G001290;
  mop_defcl0_bindings[ 28] = sym_1293;
  mop_defcl0_bindings[ 29] = sym_1294;
  mop_defcl0_bindings[ 30] = sym_1295;
  mop_defcl0_bindings[ 31] = sym_1296;
  mop_defcl0_bindings[ 32] = sym_1297;
  mop_defcl0_bindings[ 33] = sym_1298;
  mop_defcl0_bindings[ 34] = sym_1299;
  mop_defcl0_bindings[ 35] = sym_1300;
  mop_defcl0_bindings[ 36] = sym_1301;
  mop_defcl0_bindings[ 37] = G001292;
  mop_defcl0_bindings[ 38] = sym_1304;
  mop_defcl0_bindings[ 39] = sym_1305;
  mop_defcl0_bindings[ 40] = sym_1306;
  mop_defcl0_bindings[ 41] = sym_1307;
  mop_defcl0_bindings[ 42] = sym_1308;
  mop_defcl0_bindings[ 43] = sym_1310;
  mop_defcl0_bindings[ 44] = cons_1309;
  mop_defcl0_bindings[ 45] = key_1311;
  mop_defcl0_bindings[ 46] = key_1314;
  mop_defcl0_bindings[ 47] = key_1316;
  mop_defcl0_bindings[ 48] = key_1318;
  mop_defcl0_bindings[ 49] = key_1320;
  mop_defcl0_bindings[ 50] = cons_1312;
  mop_defcl0_bindings[ 51] = key_1321;
  mop_defcl0_bindings[ 52] = key_1322;
  mop_defcl0_bindings[ 53] = key_1323;
  mop_defcl0_bindings[ 54] = sym_1324;
  mop_defcl0_bindings[ 55] = sym_1325;
  mop_defcl0_bindings[ 56] = G001303;
  mop_defcl0_bindings[ 57] = G001327;
  mop_defcl0_bindings[ 58] = sym_1330;
  mop_defcl0_bindings[ 59] = G001329;
  mop_defcl0_bindings[ 60] = sym_1333;
  mop_defcl0_bindings[ 61] = sym_1334;
  mop_defcl0_bindings[ 62] = G001332;
  mop_defcl0_bindings[ 63] = key_1337;
  mop_defcl0_bindings[ 64] = sym_1338;
  mop_defcl0_bindings[ 65] = G001336;
  mop_defcl0_bindings[ 66] = G001340;
  mop_defcl0_bindings[ 67] = G001342;
  mop_defcl0_bindings[ 68] = sym_1345;
  mop_defcl0_bindings[ 69] = sym_1346;
  mop_defcl0_bindings[ 70] = sym_1347;
  mop_defcl0_bindings[ 71] = G001344;
  mop_defcl0_bindings[ 72] = G001349;
  mop_defcl0_bindings[ 73] = cons_1352;
  mop_defcl0_bindings[ 74] = cons_1353;
  mop_defcl0_bindings[ 75] = G001351;
  mop_defcl0_bindings[ 76] = G001359;
  mop_defcl0_bindings[ 77] = G001361;
  mop_defcl0_bindings[ 78] = sym_1364;
  mop_defcl0_bindings[ 79] = sym_1365;
  mop_defcl0_bindings[ 80] = sym_1366;
  mop_defcl0_bindings[ 81] = sym_1367;
  mop_defcl0_bindings[ 82] = G001363;
  mop_defcl0_bindings[ 1] = eul_nil;
  mop_defcl0_bindings[ 83] = sym_1370;
  mop_defcl0_bindings[ 84] = sym_1371;
  mop_defcl0_bindings[ 85] = sym_1372;
  mop_defcl0_bindings[ 86] = sym_1373;
  mop_defcl0_bindings[ 87] = sym_1374;
  mop_defcl0_bindings[ 88] = sym_1375;
  mop_defcl0_bindings[ 89] = sym_1376;
  mop_defcl0_bindings[ 90] = sym_1377;
  mop_defcl0_bindings[ 91] = sym_1378;
  mop_defcl0_bindings[ 92] = sym_1379;
  mop_defcl0_bindings[ 93] = sym_1380;
  mop_defcl0_bindings[ 94] = sym_1381;
  eul_allocate_lambda( mop_defcl0_bindings[0], "initialize-mop-defcl0", 0, G001369);
