...
void initialize_module_mop_alloc()
{
  ...
  static const void *G003416[] = {I(aa,23,00,00),B(mop_alloc ,17),I(1c,23,00,00),B(mop_alloc ,18),I(24,00,00,00),B(mop_key ,2),I(3c,03,1b,47),I(00,01,86,6c),I(1b,34,00,00),I(00,00,00,0f),I(86,32,00,00),I(00,00,00,1e),I(47,00,00,1f),I(03,24,00,00),B(mop_alloc ,7),I(3c,02,24,00),B(boot1 ,26),I(3d,01,03,45),I(03,00,00,00)};

  /* Byte-vector with size: 12 is_init: 0 index: 25 binding: anonymous */
  static const void *G003418[] = {I(aa,1b,24,00),B(boot1 ,26),I(3c,01,1c,84),I(02,47,00,02),I(1c,24,00,00),B(boot ,28),I(3c,02,47,00),I(00,1f,03,1d),I(24,00,00,00),B(mop_alloc ,15),I(3d,03,04,45),I(04,00,00,00)};

  /* Byte-vector with size: 11 is_init: 0 index: 26 binding: anonymous */
  static const void *G003420[] = {I(aa,23,00,00),B(mop_alloc ,17),I(1c,23,00,00),B(mop_alloc ,18),I(24,00,00,00),B(mop_key ,2),I(3c,03,1b,1d),I(24,00,00,00),B(boot1 ,26),I(3d,02,02,45),I(02,00,00,00)};
  ...
  static const void *G003425[] = {I(ab,10,1b,26),I(00,00,00,04),I(02,24,00,00),B(boot1 ,26),I(3d,01,02,00)};
  ...
  static const void *G003429[] = {I(ab,10,1b,26),I(00,00,00,05),I(02,24,00,00),B(boot1 ,26),I(3d,01,02,00)};
