...
void initialize_module_mop_defcl()
{
  ...
  static const void *G002620[] = {I(43,03,1d,04),I(1b,04,24,00),B(mop_inspect ,6),I(3c,01,1b,34),I(00,00,00,29),I(24,00,00,00),B(mop_inspect ,8),I(24,00,00,00),B(boot1 ,41),I(3c,01,1f,05),I(1f,05,1f,05),I(1f,03,3d,03),I(06,22,01,32),I(00,00,00,33),I(24,00,00,00),B(mop_defcl ,10),I(24,00,00,00),B(boot1 ,41),I(3c,01,1f,05),I(04,1b,1f,06),I(24,00,00,00),B(mop_defcl ,8),I(3c,02,1b,1f),I(08,1f,07,1f),I(05,3d,03,08),I(22,03,45,05)};
  ...
  static const void *G002653[] = {I(ab,1c,04,1b),I(04,24,00,00),B(mop_inspect ,6),I(3c,01,1b,34),I(00,00,00,19),I(1f,03,1f,03),I(24,00,00,00),B(mop_inspect ,8),I(3d,02,04,32),I(00,00,00,22),I(1f,03,04,1b),I(1f,04,24,00),B(mop_defcl ,8),I(3c,02,1b,1f),I(06,24,00,00),B(mop_defcl ,10),I(3d,02,06,22),I(02,45,04,00)};
