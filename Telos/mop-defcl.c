...
void initialize_module_mop_defcl()
{
  ...
  static const void *G002622[] = {I(43,03,1d,82),I(02,1b,24,00),B(boot1 ,41),I(3c,01,1f,03),I(1f,03,1d,3d),I(02,05,45,05)};
