...
void initialize_module_mop_gf()
{
  ...
  static const void *G001847[] = {I(43,fe,84,23),B(mop_gf ,21),I(24,00,00,00),B(mop_gf ,17),I(3c,02,2a,24),B(mop_gf ,17),I(84,1f,03,1f),I(03,24,00,00),B(boot ,9),I(3c,04,2a,84),I(23,00,00,00),B(mop_gf ,22),I(24,00,00,00),B(mop_gf ,17),I(3c,02,2a,84),I(23,00,00,00),B(mop_gf ,23),I(24,00,00,00),B(mop_gf ,17),I(3c,02,2a,41),B(boot ,32),I(27,79,50,1b),I(34,00,00,00),I(00,00,00,18),I(24,00,00,00),B(boot ,13),I(3c,00,32,00),I(00,00,00,07),I(86,2a,24,00),B(boot1 ,23),I(3d,00,03,00)};

  /* Byte-vector with size: 112 is_init: 0 index: 31 binding: top-level */
  static const void *G001852[] = {I(a9,84,24,00),B(mop_class ,21),I(24,00,00,00),B(mop_class ,21),I(24,00,00,00),B(boot1 ,40),I(3c,03,24,00),B(boot1 ,27),I(3c,00,24,00),B(boot1 ,27),I(3c,00,23,00),B(mop_gf ,25),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,55),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(mop_gf ,12),I(2a,83,24,00),B(mop_class ,21),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,27),I(3c,00,24,00),B(boot1 ,27),I(3c,00,23,00),B(mop_gf ,26),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,55),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(mop_gf ,14),I(2a,84,24,00),B(mop_class ,75),I(24,00,00,00),B(mop_class ,21),I(24,00,00,00),B(boot1 ,40),I(3c,03,24,00),B(boot1 ,27),I(3c,00,24,00),B(boot1 ,27),I(3c,00,23,00),B(mop_gf ,27),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,55),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(mop_gf ,9),I(2a,84,24,00),B(mop_class ,21),I(24,00,00,00),B(mop_class ,21),I(24,00,00,00),B(boot1 ,40),I(3c,03,24,00),B(boot1 ,27),I(3c,00,24,00),B(boot1 ,27),I(3c,00,23,00),B(mop_gf ,28),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,55),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(mop_gf ,17),I(2a,24,00,00),B(mop_gf ,12),I(2a,26,00,00),I(00,00,00,22),I(24,00,00,00),B(boot1 ,40),I(3c,01,24,00),B(mop_gf ,12),I(1c,1c,26,00),I(00,00,00,08),I(1d,03,22,02),I(2a,24,00,00),B(mop_gf ,14),I(2a,24,00,00),B(mop_gf ,9),I(2a,24,00,00),B(mop_gf ,17),I(2a,23,00,00),B(mop_gf ,29),I(23,00,00,00),B(mop_gf ,24),I(3b,fe,89,00),B(boot ,23),I(2a,23,00,00),B(mop_gf ,30),I(23,00,00,00),B(mop_gf ,20),I(3b,fe,89,00),B(boot ,6),I(45,11,00,00)};

  /* Byte-vector with size: 8 is_init: 0 index: 32 binding: make */
  static const void *G001860[] = {I(43,fe,1c,1c),I(24,00,00,00),B(mop_gf ,9),I(3c,02,1b,1d),I(24,00,00,00),B(mop_gf ,12),I(3d,02,03,45),I(03,00,00,00)};
  ...
  static const void *G001883[] = {I(43,03,46,01),I(1d,26,00,00),I(00,00,00,08),I(02,82,02,1b),I(48,00,00,1f),I(03,26,00,00),I(00,00,00,05),I(02,47,00,00),I(1c,24,00,00),B(mop_gf ,10),I(3c,02,1b,23),B(mop_gf ,34),I(23,00,00,00),B(mop_gf ,44),I(3b,02,24,00),B(boot ,3),I(3d,02,06,45),I(06,00,00,00)};

  /* Byte-vector with size: 23 is_init: 0 index: 46 binding: anonymous */
  static const void *G001885[] = {I(aa,1b,47,00),I(03,1a,1b,34),I(00,00,00,51),I(47,00,01,1d),I(02,1b,34,00),I(00,00,00,36),I(47,00,00,1f),I(03,02,1b,1d),I(24,00,00,00),B(mop_inspect ,10),I(3c,02,1b,34),I(00,00,00,15),I(1f,04,83,14),I(47,00,02,3d),I(01,05,32,00),I(00,00,00,07),I(86,22,02,32),I(00,00,00,0e),I(1d,83,14,47),I(00,02,3d,01),I(03,22,01,32),I(00,00,00,06),I(87,45,02,00)};

  /* Byte-vector with size: 14 is_init: 0 index: 47 binding: sig-applicable-p */
  static const void *G001887[] = {I(ab,46,05,1c),I(48,00,00,1b),I(48,00,01,47),I(00,01,06,1b),I(48,00,03,86),I(1b,48,00,02),I(23,00,00,00),B(mop_gf ,34),I(23,00,00,00),B(mop_gf ,46),I(3b,01,48,00),I(02,82,47,00),I(02,3c,01,1b),I(45,05,00,00)};

  /* Byte-vector with size: 21 is_init: 0 index: 48 binding: anonymous */
  static const void *G001889[] = {I(ab,1c,12,1b),I(34,00,00,00),I(00,00,00,10),I(1c,32,00,00),I(00,00,00,43),I(1d,10,1b,83),I(02,47,00,00),I(1c,24,00,00),B(mop_gf ,8),I(3c,02,1b,34),I(00,00,00,19),I(1f,05,11,1f),I(03,1f,06,0f),I(47,00,01,3d),I(02,06,32,00),I(00,00,00,14),I(1f,05,11,1b),I(1f,06,47,00),I(01,3d,02,07),I(22,01,22,03),I(45,03,00,00)};

  /* Byte-vector with size: 11 is_init: 0 index: 49 binding: select-methods */
  static const void *G001891[] = {I(ab,46,02,1c),I(48,00,00,86),I(1b,48,00,01),I(23,00,00,00),B(mop_gf ,34),I(23,00,00,00),B(mop_gf ,48),I(3b,02,48,00),I(01,1c,86,47),I(00,01,3d,02),I(03,45,03,00)};

  /* Byte-vector with size: 15 is_init: 0 index: 50 binding: anonymous */
  static const void *G001893[] = {I(aa,1b,47,00),I(03,1a,1b,34),I(00,00,00,31),I(47,00,00,1d),I(02,47,00,01),I(1f,03,02,50),I(1b,34,00,00),I(00,00,00,17),I(1d,83,14,47),I(00,02,3d,01),I(03,32,00,00),I(00,00,00,08),I(86,22,01,32),I(00,00,00,06),I(87,45,02,00)};

  /* Byte-vector with size: 14 is_init: 0 index: 51 binding: sig= */
  static const void *G001895[] = {I(ab,46,05,1c),I(48,00,00,1b),I(48,00,01,47),I(00,00,06,1b),I(48,00,03,86),I(1b,48,00,02),I(23,00,00,00),B(mop_gf ,34),I(23,00,00,00),B(mop_gf ,50),I(3b,01,48,00),I(02,82,47,00),I(02,3d,01,04),I(45,04,00,00)};
  ...
  eul_intern_symbol(sym_1919,"sig-applicable-p");
