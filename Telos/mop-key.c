...
void initialize_module_mop_key()
{
  ...
  static const void *G00623[] = {I(43,03,1c,1f),I(03,24,00,00),B(boot1 ,44),I(24,00,00,00),B(boot ,28),I(3c,03,1b,24),B(boot1 ,44),I(50,1b,34,00),I(00,00,00,3e),I(1d,23,00,00),B(mop_key ,4),I(50,1b,34,00),I(00,00,00,22),I(23,00,00,00),B(mop_key ,5),I(1f,06,24,00),B(boot ,19),I(3c,02,2a,1d),I(32,00,00,00),I(00,00,00,0a),I(1f,03,22,01),I(32,00,00,00),I(00,00,00,09),I(1c,45,05,00)};
