 ...
 ** ----------------------------------------------------------------------- **
 **  Description: C source file of EuLisp module boot0
 **  Copyright: See file boot0.em
 ** ----------------------------------------------------------------------- **/
...
/* Initialize module boot0 */
void initialize_module_boot0()
{
