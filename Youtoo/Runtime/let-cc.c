...
void initialize_module_let_cc()
{
  ...
  static const void *G00804[] = {I(aa,46,04,24),B(thread ,24),I(24,00,00,00),B(mop_gf ,2),I(3c,01,23,00),B(let_cc ,5),I(24,00,00,00),B(dynamic ,3),I(3c,01,1b,24),B(boot ,8),I(3c,01,1d,1c),I(24,00,00,00),B(dynamic ,4),I(24,00,00,00),B(dynamic ,7),I(1f,03,48,00),I(00,1d,48,00),I(01,1c,48,00),I(02,1b,48,00),I(03,47,00,00),I(5c,2a,23,00),B(let_cc ,7),I(23,00,00,00),B(let_cc ,6),I(3b,01,1f,08),I(3c,01,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,08),I(86,45,09,00)};
