...
void initialize_module_condition()
{
  ...
  static const void *G00922[] = {I(a9,24,00,00),B(mop_class ,22),I(24,00,00,00),B(boot1 ,25),I(3c,01,23,00),B(condition ,15),I(23,00,00,00),B(condition ,16),I(23,00,00,00),B(condition ,17),I(23,00,00,00),B(condition ,18),I(24,00,00,00),B(boot1 ,25),I(3c,04,1b,24),B(boot1 ,25),I(3c,01,24,00),B(mop_class ,81),I(23,00,00,00),B(condition ,15),I(23,00,00,00),B(condition ,19),I(23,00,00,00),B(condition ,20),I(1f,06,23,00),B(condition ,21),I(1f,06,23,00),B(condition ,22),I(23,00,00,00),B(condition ,23),I(24,00,00,00),B(mop_gf ,2),I(3c,09,1b,89),B(condition ,8),I(2a,24,00,00),B(condition ,8),I(24,00,00,00),B(boot1 ,25),I(3c,01,23,00),B(condition ,15),I(23,00,00,00),B(condition ,24),I(23,00,00,00),B(condition ,17),I(23,00,00,00),B(condition ,25),I(24,00,00,00),B(boot1 ,25),I(3c,04,1b,24),B(boot1 ,25),I(3c,01,24,00),B(mop_class ,81),I(23,00,00,00),B(condition ,15),I(23,00,00,00),B(condition ,26),I(23,00,00,00),B(condition ,20),I(1f,06,23,00),B(condition ,21),I(1f,06,23,00),B(condition ,22),I(23,00,00,00),B(condition ,27),I(24,00,00,00),B(mop_gf ,2),I(3c,09,1b,89),B(condition ,5),I(2a,83,24,00),B(mop_class ,22),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,25),I(3c,00,24,00),B(boot1 ,25),I(3c,00,23,00),B(condition ,28),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,63),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(condition ,7),I(2a,23,00,00),B(condition ,29),I(23,00,00,00),B(condition ,14),I(3b,02,89,00),B(condition ,3),I(2a,24,00,00),B(boot1 ,42),I(24,00,00,00),B(boot1 ,42),I(3c,01,24,00),B(condition ,6),I(23,00,00,00),B(condition ,30),I(23,00,00,00),B(condition ,11),I(3b,02,1d,3c),I(02,2a,24,00),B(condition ,7),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(mop_class ,22),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,25),I(3c,00,24,00),B(condition ,7),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,8),I(3c,02,1f,04),I(1f,04,23,00),B(condition ,31),I(23,00,00,00),B(condition ,10),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(condition ,7),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(condition ,7),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(condition ,8),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,25),I(3c,00,24,00),B(condition ,7),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,8),I(3c,02,1f,04),I(1f,04,23,00),B(condition ,31),I(23,00,00,00),B(condition ,9),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(condition ,7),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(condition ,7),I(2a,24,00,00),B(condition ,8),I(2a,24,00,00),B(condition ,5),I(45,19,00,00)};
  ...
  static const void *G00951[] = {I(aa,1b,34,00),I(00,00,00,3e),I(1b,10,1b,84),I(02,1c,47,00),I(00,24,00,00),B(mop_defcl ,11),I(3c,02,84,23),B(condition ,39),I(1f,03,1f,03),I(24,00,00,00),B(boot1 ,48),I(3c,04,2a,1f),I(03,11,47,00),I(01,3d,01,04),I(22,03,32,00),I(00,00,00,07),I(86,45,01,00)};
