...
void initialize_module_list()
{
  ...
  static const void *G004623[] = {I(ab,1c,11,12),I(1b,34,00,00),I(00,00,00,27),I(1d,10,1b,47),I(00,01,3c,01),I(1b,1f,04,0f),I(24,00,00,00),B(boot ,28),I(3d,01,05,22),I(02,32,00,00),I(00,00,00,21),I(1d,11,1f,03),I(10,1b,47,00),I(00,3c,01,1b),I(1f,05,0f,1f),I(03,1c,47,00),I(02,3d,02,07),I(22,04,45,03)};

  /* Byte-vector with size: 16 is_init: 0 index: 199 binding: map1-list-last-special */
  static const void *G004625[] = {I(43,03,46,03),I(1d,48,00,00),I(1c,48,00,01),I(86,1b,48,00),I(02,23,00,00),B(list ,47),I(23,00,00,00),B(list ,198),I(3b,02,48,00),I(02,1c,34,00),I(00,00,00,16),I(1c,86,47,00),I(02,3d,02,04),I(32,00,00,00),I(00,00,00,09),I(86,45,04,00)};
