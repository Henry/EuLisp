...
void initialize_module_table1()
{
  ...
  static const void *G007923[] = {I(aa,1b,12,1b),I(44,04,86,36),I(11,1c,10,1b),I(47,00,00,0f),I(1b,48,00,00),I(47,00,00,22),I(02,45,02,00)};

  /* Byte-vector with size: 17 is_init: 0 index: 26 binding: (method-table-keys) */
  static const void *G007925[] = {I(aa,46,01,8a),I(03,24,00,00),B(table1 ,3),I(08,86,1b,48),I(00,00,1c,24),B(vector ,6),I(3c,01,1b,44),I(24,23,00,00),B(table1 ,25),I(23,00,00,00),B(table1 ,24),I(3b,01,1f,03),I(24,00,00,00),B(vector ,16),I(3c,02,2a,47),I(00,00,36,02),I(86,45,03,00)};

  /* Byte-vector with size: 7 is_init: 0 index: 27 binding: anonymous */
  static const void *G007928[] = {I(aa,1b,12,1b),I(44,04,86,36),I(11,1c,11,1b),I(47,00,00,0f),I(1b,48,00,00),I(47,00,00,22),I(02,45,02,00)};

  /* Byte-vector with size: 17 is_init: 0 index: 28 binding: (method-table-values) */
  static const void *G007930[] = {I(aa,46,01,8a),I(03,24,00,00),B(table1 ,3),I(08,86,1b,48),I(00,00,1c,24),B(vector ,6),I(3c,01,1b,44),I(24,23,00,00),B(table1 ,25),I(23,00,00,00),B(table1 ,27),I(3b,01,1f,03),I(24,00,00,00),B(vector ,16),I(3c,02,2a,47),I(00,00,36,02),I(86,45,03,00)};
  ...
  static const void *G007936[] = {I(aa,1b,86,1c),I(8a,03,1d,24),B(table1 ,3),I(09,22,02,2a),I(1b,82,1c,83),I(1d,24,00,00),B(table1 ,3),I(09,22,02,2a),I(8a,10,8a,04),I(15,1c,1c,1c),I(82,1d,24,00),B(table1 ,3),I(09,22,02,2a),I(1c,45,02,00)};
  ...
  static const void *G007961[] = {I(ab,1c,8a,03),I(1d,24,00,00),B(table1 ,3),I(09,45,02,00)};
  ...
  static const void *G007971[] = {I(a9,8a,10,8a),I(04,15,45,00)};
  ...
  static const void *G008026[] = {I(aa,8a,03,24),B(table1 ,3),I(08,45,00,00)};
