...
void initialize_module_stream3()
{
  ...
  {
  /* Declarations */
  LispRef sym_10067, G0010066, sym_10064, sym_10063, G0010062, G0010060, G0010058, G0010054, G0010051, G0010049, G0010047, G0010044, G0010041, G0010038, G0010033, G0010031, G0010028, G0010026, G0010024, sym_10019, G0010018, G0010015, G0010012, G0010007, G0010005, G0010002, G0010000, G009998, G009996, sym_9994, G009993;

  /* Code vector and literal definitions */
  /* Byte-vector with size: 19 is_init: 0 index: 3 binding: (method-generic-prin) */
  static const void *G009992[] = {I(ab,1c,82,02),I(1b,34,00,00),I(00,00,00,0f),I(1b,32,00,00),I(00,00,00,0f),I(23,00,00,00),B(stream3 ,2),I(82,02,27,3c),I(1f,03,24,00),B(stream ,3),I(3c,02,2a,1b),I(06,1c,1c,1f),I(05,24,00,00),B(stream ,5),I(3c,03,2a,27),I(3e,1f,04,24),B(stream ,3),I(3c,02,2a,1f),I(04,45,05,00)};

  /* Byte-vector with size: 5 is_init: 0 index: 4 binding: (method-generic-prin) */
  static const void *G009995[] = {I(ab,1c,06,1d),I(1c,1f,03,24),B(stream ,5),I(3c,03,2a,1d),I(45,03,00,00)};

  /* Byte-vector with size: 5 is_init: 0 index: 5 binding: (method-generic-prin) */
  static const void *G009997[] = {I(ab,1c,82,02),I(1b,1d,24,00),B(stream2 ,2),I(3c,02,2a,1d),I(45,03,00,00)};

  /* Byte-vector with size: 4 is_init: 0 index: 6 binding: (method-generic-prin) */
  static const void *G009999[] = {I(ab,1c,1c,24),B(stream ,3),I(3c,02,2a,1c),I(45,02,00,00)};

  eul_allocate_static_string(str_10003, " . ", 3);
  /* Byte-vector with size: 27 is_init: 0 index: 8 binding: (method-generic-prin) */
  static const void *G0010001[] = {I(ab,27,28,1c),I(24,00,00,00),B(stream ,3),I(3c,02,2a,1c),I(24,00,00,00),B(stream2 ,2),I(1d,24,00,00),B(stream ,14),I(3c,03,1b,12),I(1b,34,00,00),I(00,00,00,0f),I(86,32,00,00),I(00,00,00,2d),I(23,00,00,00),B(stream3 ,7),I(26,00,00,00),I(00,00,00,03),I(1f,04,24,00),B(stream ,5),I(3c,03,2a,1d),I(1d,24,00,00),B(stream ,21),I(3c,02,2a,27),I(29,1f,03,24),B(stream ,3),I(3c,02,2a,1f),I(03,45,04,00)};

  /* Byte-vector with size: 19 is_init: 0 index: 9 binding: anonymous */
  static const void *G0010004[] = {I(a9,47,00,03),I(47,00,02,1a),I(1b,34,00,00),I(00,00,00,3f),I(47,00,00,47),I(00,03,02,47),I(00,01,1c,24),B(stream ,21),I(3c,02,2a,27),I(20,47,00,01),I(24,00,00,00),B(stream ,3),I(3c,02,2a,47),I(00,03,2b,1b),I(48,00,03,47),I(00,04,3d,00),I(03,22,02,32),I(00,00,00,06),I(86,45,01,00)};

  eul_allocate_static_string(str_10008, "#()", 3);
  eul_allocate_static_string(str_10009, "#(", 2);
  eul_allocate_static_string(str_10010, "#(", 2);
  /* Byte-vector with size: 61 is_init: 0 index: 13 binding: (method-generic-prin) */
  static const void *G0010006[] = {I(ab,46,06,1c),I(48,00,00,1b),I(48,00,01,47),I(00,00,06,1b),I(2d,1b,34,00),I(00,00,00,26),I(23,00,00,00),B(stream3 ,10),I(26,00,00,00),I(00,00,00,03),I(47,00,01,24),B(stream ,5),I(3c,03,32,00),I(00,00,00,bc),I(1c,83,19,1b),I(34,00,00,00),I(00,00,00,4c),I(23,00,00,00),B(stream3 ,11),I(84,47,00,01),I(24,00,00,00),B(stream ,5),I(3c,03,2a,47),I(00,00,82,02),I(47,00,01,1c),I(24,00,00,00),B(stream ,21),I(3c,02,2a,27),I(29,47,00,01),I(24,00,00,00),B(stream ,3),I(3c,02,22,01),I(32,00,00,00),I(00,00,00,6c),I(1d,2c,82,1c),I(48,00,02,1b),I(48,00,03,23),B(stream3 ,12),I(84,47,00,01),I(24,00,00,00),B(stream ,5),I(3c,03,2a,86),I(1b,48,00,04),I(23,00,00,00),B(stream3 ,2),I(23,00,00,00),B(stream3 ,9),I(3b,00,48,00),I(04,47,00,04),I(3c,00,2a,47),I(00,00,47,00),I(02,02,47,00),I(01,1c,24,00),B(stream ,21),I(3c,02,2a,27),I(29,47,00,01),I(24,00,00,00),B(stream ,3),I(3c,02,22,04),I(22,01,2a,47),I(00,00,45,04)};

  eul_allocate_static_string(str_10013, "#<~a: ~a:~a>", 12);
  /* Byte-vector with size: 15 is_init: 0 index: 15 binding: (method-generic-write) */
  static const void *G0010011[] = {I(ab,1c,04,1b),I(82,02,1f,03),I(84,24,00,00),B(socket ,7),I(08,1f,04,26),I(00,00,00,03),I(24,00,00,00),B(socket ,7),I(08,1f,04,23),B(stream3 ,14),I(1f,04,1f,04),I(1f,04,24,00),B(mop_gf ,17),I(3c,05,2a,1f),I(05,45,06,00)};

  eul_allocate_static_string(str_10016, "#<~a: ~a:~a>", 12);
  /* Byte-vector with size: 14 is_init: 0 index: 17 binding: (method-generic-write) */
  static const void *G0010014[] = {I(ab,1c,04,1b),I(82,02,1f,03),I(83,24,00,00),B(socket ,2),I(08,1f,04,82),I(24,00,00,00),B(socket ,2),I(08,1f,04,23),B(stream3 ,16),I(1f,04,1f,04),I(1f,04,24,00),B(mop_gf ,17),I(3c,05,2a,1f),I(05,45,06,00)};

  eul_allocate_static_string(str_10020, "*unconnected*", 13);
  eul_allocate_static_string(str_10021, "*unconnected*", 13);
  eul_allocate_static_string(str_10022, "#<~a: ~a>", 9);
  /* Byte-vector with size: 47 is_init: 0 index: 22 binding: (method-generic-write) */
  static const void *G0010017[] = {I(ab,1c,26,00),I(00,00,00,05),I(24,00,00,00),B(stream2 ,21),I(08,1d,26,00),I(00,00,00,04),I(24,00,00,00),B(stream2 ,21),I(08,1f,03,82),I(24,00,00,00),B(stream2 ,21),I(08,1f,04,04),I(1b,82,02,1d),I(23,00,00,00),B(stream3 ,18),I(50,1b,34,00),I(00,00,00,36),I(1f,04,24,00),B(stream2 ,25),I(3c,01,1b,34),I(00,00,00,15),I(1f,05,84,24),B(stream2 ,4),I(08,32,00,00),I(00,00,00,0f),I(23,00,00,00),B(stream3 ,19),I(22,01,32,00),I(00,00,00,30),I(1f,05,24,00),B(stream2 ,25),I(3c,01,1b,34),I(00,00,00,15),I(1f,06,84,24),B(stream2 ,4),I(08,32,00,00),I(00,00,00,0f),I(23,00,00,00),B(stream3 ,20),I(22,01,1f,07),I(23,00,00,00),B(stream3 ,21),I(1f,04,1f,03),I(24,00,00,00),B(mop_gf ,17),I(3c,04,2a,1f),I(08,45,09,00)};

  /* Byte-vector with size: 12 is_init: 0 index: 23 binding: (method-generic-write) */
  static const void *G0010023[] = {I(ab,27,22,1c),I(24,00,00,00),B(stream ,3),I(3c,02,2a,1c),I(06,1d,1c,1f),I(03,24,00,00),B(stream ,5),I(3c,03,2a,27),I(22,1d,24,00),B(stream ,3),I(3c,02,2a,1d),I(45,03,00,00)};

  /* Byte-vector with size: 11 is_init: 0 index: 24 binding: (method-generic-write) */
  static const void *G0010025[] = {I(ab,27,23,1c),I(24,00,00,00),B(stream ,3),I(3c,02,2a,27),I(5c,1c,24,00),B(stream ,3),I(3c,02,2a,1c),I(1c,24,00,00),B(stream ,3),I(3c,02,2a,1c),I(45,02,00,00)};

  eul_allocate_static_string(str_10029, " . ", 3);
  /* Byte-vector with size: 27 is_init: 0 index: 26 binding: (method-generic-write) */
  static const void *G0010027[] = {I(ab,27,28,1c),I(24,00,00,00),B(stream ,3),I(3c,02,2a,1c),I(24,00,00,00),B(stream2 ,28),I(1d,24,00,00),B(stream ,14),I(3c,03,1b,12),I(1b,34,00,00),I(00,00,00,0f),I(86,32,00,00),I(00,00,00,2d),I(23,00,00,00),B(stream3 ,25),I(26,00,00,00),I(00,00,00,03),I(1f,04,24,00),B(stream ,5),I(3c,03,2a,1d),I(1d,24,00,00),B(stream ,4),I(3c,02,2a,27),I(29,1f,03,24),B(stream ,3),I(3c,02,2a,1f),I(03,45,04,00)};

  /* Byte-vector with size: 19 is_init: 0 index: 27 binding: anonymous */
  static const void *G0010030[] = {I(a9,47,00,03),I(47,00,02,1a),I(1b,34,00,00),I(00,00,00,3f),I(47,00,00,47),I(00,03,02,47),I(00,01,1c,24),B(stream ,4),I(3c,02,2a,27),I(20,47,00,01),I(24,00,00,00),B(stream ,3),I(3c,02,2a,47),I(00,03,2b,1b),I(48,00,03,47),I(00,04,3d,00),I(03,22,02,32),I(00,00,00,06),I(86,45,01,00)};

  eul_allocate_static_string(str_10034, "#()", 3);
  eul_allocate_static_string(str_10035, "#(", 2);
  eul_allocate_static_string(str_10036, "#(", 2);
  /* Byte-vector with size: 61 is_init: 0 index: 31 binding: (method-generic-write) */
  static const void *G0010032[] = {I(ab,46,06,1c),I(48,00,00,1b),I(48,00,01,47),I(00,00,06,1b),I(2d,1b,34,00),I(00,00,00,26),I(23,00,00,00),B(stream3 ,28),I(26,00,00,00),I(00,00,00,03),I(47,00,01,24),B(stream ,5),I(3c,03,32,00),I(00,00,00,bc),I(1c,83,19,1b),I(34,00,00,00),I(00,00,00,4c),I(23,00,00,00),B(stream3 ,29),I(84,47,00,01),I(24,00,00,00),B(stream ,5),I(3c,03,2a,47),I(00,00,82,02),I(47,00,01,1c),I(24,00,00,00),B(stream ,4),I(3c,02,2a,27),I(29,47,00,01),I(24,00,00,00),B(stream ,3),I(3c,02,22,01),I(32,00,00,00),I(00,00,00,6c),I(1d,2c,82,1c),I(48,00,02,1b),I(48,00,03,23),B(stream3 ,30),I(84,47,00,01),I(24,00,00,00),B(stream ,5),I(3c,03,2a,86),I(1b,48,00,04),I(23,00,00,00),B(stream3 ,2),I(23,00,00,00),B(stream3 ,27),I(3b,00,48,00),I(04,47,00,04),I(3c,00,2a,47),I(00,00,47,00),I(02,02,47,00),I(01,1c,24,00),B(stream ,4),I(3c,02,2a,27),I(29,47,00,01),I(24,00,00,00),B(stream ,3),I(3c,02,22,04),I(22,01,2a,47),I(00,00,45,04)};

  eul_allocate_static_string(str_10039, "#<~a: ~a>", 9);
  /* Byte-vector with size: 10 is_init: 0 index: 33 binding: (method-generic-write) */
  static const void *G0010037[] = {I(ab,1c,04,1b),I(82,02,1f,03),I(82,02,1f,03),I(23,00,00,00),B(stream3 ,32),I(1f,03,1f,03),I(24,00,00,00),B(mop_gf ,17),I(3d,04,05,45),I(05,00,00,00)};

  eul_allocate_static_string(str_10042, "%f", 2);
  /* Byte-vector with size: 6 is_init: 0 index: 35 binding: (method-generic-write) */
  static const void *G0010040[] = {I(ab,1b,23,00),B(stream3 ,34),I(1f,03,24,00),B(stream ,20),I(3c,03,2a,1b),I(45,02,00,00)};

  eul_allocate_static_string(str_10045, "%i", 2);
  /* Byte-vector with size: 6 is_init: 0 index: 37 binding: (method-generic-write) */
  static const void *G0010043[] = {I(ab,1b,23,00),B(stream3 ,36),I(1f,03,24,00),B(stream ,20),I(3c,03,2a,1b),I(45,02,00,00)};

  /* Byte-vector with size: 9 is_init: 0 index: 38 binding: (method-generic-write) */
  static const void *G0010046[] = {I(ab,1c,82,02),I(1b,06,1c,1c),I(1f,04,24,00),B(stream ,5),I(3c,03,2a,27),I(3a,1f,03,24),B(stream ,3),I(3c,02,2a,1f),I(03,45,04,00)};

  /* Byte-vector with size: 22 is_init: 0 index: 39 binding: (method-generic-write) */
  static const void *G0010048[] = {I(ab,1c,82,02),I(24,00,00,00),B(character ,10),I(1c,24,00,00),B(collect ,18),I(3c,02,1b,34),I(00,00,00,15),I(1c,1f,03,24),B(stream2 ,2),I(3c,02,32,00),I(00,00,00,2c),I(27,7c,1f,03),I(24,00,00,00),B(stream ,3),I(3c,02,2a,1c),I(1f,03,24,00),B(stream2 ,2),I(3c,02,2a,27),I(7c,1f,03,24),B(stream ,3),I(3c,02,2a,1f),I(03,45,04,00)};

  eul_allocate_static_string(str_10052, "()", 2);
  /* Byte-vector with size: 6 is_init: 0 index: 41 binding: (method-generic-write) */
  static const void *G0010050[] = {I(ab,23,00,00),B(stream3 ,40),I(84,1d,24,00),B(stream ,5),I(3c,03,2a,86),I(45,02,00,00)};

  eul_allocate_static_string(str_10055, "#<", 2);
  ...
  eul_allocate_bytevector( G0010044,G0010043);
  ...
  eul_intern_symbol(sym_10063,"(method generic-write)");
  eul_intern_symbol(sym_10064,"(method generic-prin)");
  eul_allocate_bytevector( G0010062,G0010061);
  eul_intern_symbol(sym_10067,"top-level");
  eul_allocate_bytevector( G0010066,G0010065);

  /* Set local bindings */
  stream3_bindings[ 2] = sym_9994;
  stream3_bindings[ 3] = G009993;
  stream3_bindings[ 4] = G009996;
  stream3_bindings[ 5] = G009998;
  stream3_bindings[ 6] = G0010000;
  stream3_bindings[ 7] = str_10003;
  stream3_bindings[ 8] = G0010002;
  stream3_bindings[ 9] = G0010005;
  stream3_bindings[ 10] = str_10008;
  stream3_bindings[ 11] = str_10009;
  stream3_bindings[ 12] = str_10010;
  stream3_bindings[ 13] = G0010007;
  stream3_bindings[ 14] = str_10013;
  stream3_bindings[ 15] = G0010012;
  stream3_bindings[ 16] = str_10016;
  stream3_bindings[ 17] = G0010015;
  stream3_bindings[ 18] = sym_10019;
  stream3_bindings[ 19] = str_10020;
  stream3_bindings[ 20] = str_10021;
  stream3_bindings[ 21] = str_10022;
  stream3_bindings[ 22] = G0010018;
  stream3_bindings[ 23] = G0010024;
  stream3_bindings[ 24] = G0010026;
  stream3_bindings[ 25] = str_10029;
  stream3_bindings[ 26] = G0010028;
  stream3_bindings[ 27] = G0010031;
  stream3_bindings[ 28] = str_10034;
  stream3_bindings[ 29] = str_10035;
  stream3_bindings[ 30] = str_10036;
  stream3_bindings[ 31] = G0010033;
  stream3_bindings[ 32] = str_10039;
  stream3_bindings[ 33] = G0010038;
  stream3_bindings[ 34] = str_10042;
  stream3_bindings[ 35] = G0010041;
  stream3_bindings[ 36] = str_10045;
  stream3_bindings[ 37] = G0010044;
  stream3_bindings[ 38] = G0010047;
  stream3_bindings[ 39] = G0010049;
  stream3_bindings[ 40] = str_10052;
  stream3_bindings[ 41] = G0010051;
  stream3_bindings[ 42] = str_10055;
  stream3_bindings[ 43] = str_10056;
  stream3_bindings[ 44] = G0010054;
  stream3_bindings[ 45] = G0010058;
  stream3_bindings[ 46] = G0010060;
  stream3_bindings[ 47] = sym_10063;
  stream3_bindings[ 48] = sym_10064;
  stream3_bindings[ 49] = G0010062;
  stream3_bindings[ 1] = eul_nil;
  stream3_bindings[ 50] = sym_10067;
  eul_allocate_lambda( stream3_bindings[0], "initialize-stream3", 0, G0010066);
