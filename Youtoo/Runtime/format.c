...
void initialize_module_format()
{
  ...
  static const void *G006461[] = {I(ab,1c,10,1d),I(11,1b,20,04),I(1f,03,10,1f),I(04,11,1b,20),I(06,1f,05,10),I(47,00,00,1f),I(03,24,00,00),B(stream ,21),I(3c,02,2a,47),I(00,03,83,24),B(stream2 ,23),I(08,47,00,03),I(26,00,00,00),I(00,00,00,03),I(24,00,00,00),B(stream2 ,23),I(08,1b,1d,1f),I(06,1f,09,23),B(format ,3),I(47,00,01,41),B(stream1 ,20),I(22,06,2a,1c),I(1f,05,14,47),I(00,03,1c,1c),I(83,1d,24,00),B(stream2 ,23),I(09,22,05,2a),I(1b,27,00,50),I(1b,34,00,00),I(00,00,00,0f),I(1f,06,32,00),I(00,00,02,44),I(1c,27,61,50),I(1b,34,00,00),I(00,00,00,0f),I(1b,32,00,00),I(00,00,00,0b),I(1d,27,64,50),I(1b,34,00,00),I(00,00,00,77),I(1f,08,12,1b),I(34,00,00,00),I(00,00,00,20),I(23,00,00,00),B(format ,4),I(47,00,01,24),B(boot ,22),I(3d,02,0b,32),I(00,00,00,4a),I(1f,09,10,1b),I(24,00,00,00),B(boot1 ,37),I(3c,01,1b,34),I(00,00,00,19),I(1c,47,00,00),I(24,00,00,00),B(stream2 ,2),I(3c,02,32,00),I(00,00,00,14),I(1c,47,00,00),I(24,00,00,00),B(stream ,16),I(3c,02,2a,1f),I(0c,11,1f,0c),I(11,47,00,02),I(3d,02,0d,22),I(02,22,01,32),I(00,00,01,b1),I(1f,03,27,73),I(50,1b,34,00),I(00,00,00,76),I(1f,09,12,1b),I(34,00,00,00),I(00,00,00,20),I(23,00,00,00),B(format ,5),I(47,00,01,24),B(boot ,22),I(3d,02,0c,32),I(00,00,00,4a),I(1f,0a,10,1b),I(24,00,00,00),B(boot1 ,37),I(3c,01,1b,34),I(00,00,00,19),I(1c,47,00,00),I(24,00,00,00),B(stream2 ,28),I(3c,02,32,00),I(00,00,00,14),I(1c,47,00,00),I(24,00,00,00),B(stream ,12),I(3c,02,2a,1f),I(0d,11,1f,0d),I(11,47,00,02),I(3d,02,0e,22),I(02,22,01,32),I(00,00,01,33),I(1f,04,27,25),I(50,1b,34,00),I(00,00,00,2a),I(27,0a,47,00),I(00,24,00,00),B(stream ,3),I(3c,02,2a,1f),I(0b,11,1b,1f),I(0c,47,00,02),I(3d,02,0d,22),I(01,32,00,00),I(00,00,01,03),I(1f,05,27,78),I(50,1b,34,00),I(00,00,00,56),I(1f,0b,12,1b),I(34,00,00,00),I(00,00,00,20),I(23,00,00,00),B(format ,6),I(47,00,01,24),B(boot ,22),I(3d,02,0e,32),I(00,00,00,2a),I(1f,0c,10,47),I(00,00,23,00),B(format ,7),I(1d,24,00,00),B(stream ,19),I(3c,03,2a,1f),I(0e,11,1f,0e),I(11,47,00,02),I(3d,02,0f,22),I(01,22,01,32),I(00,00,00,a3),I(1f,06,27,6f),I(50,1b,34,00),I(00,00,00,56),I(1f,0c,12,1b),I(34,00,00,00),I(00,00,00,20),I(23,00,00,00),B(format ,8),I(47,00,01,24),B(boot ,22),I(3d,02,0f,32),I(00,00,00,2a),I(1f,0d,10,47),I(00,00,23,00),B(format ,9),I(1d,24,00,00),B(stream ,19),I(3c,03,2a,1f),I(0f,11,1f,0f),I(11,47,00,02),I(3d,02,10,22),I(01,22,01,32),I(00,00,00,45),I(1f,07,27,7e),I(50,1b,34,00),I(00,00,00,2a),I(27,7e,47,00),I(00,24,00,00),B(stream ,16),I(3c,02,2a,1f),I(0e,11,1b,1f),I(0f,47,00,02),I(3d,02,10,22),I(01,32,00,00),I(00,00,00,15),I(1f,0e,11,1b),I(1f,0f,47,00),I(02,3d,02,10),I(22,01,22,01),I(22,01,22,01),I(22,01,22,01),I(22,02,45,08)};
  ...
  static const void *G006473[] = {I(43,fd,1d,84),I(19,1b,34,00),I(00,00,00,16),I(24,00,00,00),B(stream2 ,10),I(32,00,00,00),I(00,00,00,10),I(24,00,00,00),B(stream2 ,34),I(24,00,00,00),B(mop_gf ,17),I(1c,1f,05,1f),I(05,24,00,00),B(boot ,9),I(3d,04,05,00)};

  /* Byte-vector with size: 8 is_init: 0 index: 14 binding: (method-format) */
  static const void *G006475[] = {I(43,fd,24,00),B(mop_gf ,17),I(24,00,00,00),B(stream2 ,34),I(1f,03,1f,03),I(24,00,00,00),B(boot ,9),I(3d,04,03,00)};
  ...
  static const void *G006479[] = {I(43,fd,46,03),I(24,00,00,00),B(stream2 ,45),I(24,00,00,00),B(mop_gf ,2),I(3c,01,1b,26),I(00,00,00,05),I(24,00,00,00),B(stream2 ,21),I(08,24,00,00),B(mop_gf ,17),I(1d,1f,05,1f),I(05,24,00,00),B(boot ,9),I(3c,04,2a,86),I(1b,48,00,00),I(23,00,00,00),B(format ,11),I(23,00,00,00),B(format ,15),I(3b,02,48,00),I(00,1d,82,24),B(stream2 ,45),I(08,1b,23,00),B(format ,16),I(47,00,00,3c),I(02,1f,03,26),I(00,00,00,03),I(24,00,00,00),B(stream2 ,23),I(08,1f,04,83),I(24,00,00,00),B(stream2 ,23),I(08,1c,82,1d),I(24,00,00,00),B(string ,6),I(3c,03,1f,03),I(1c,24,00,00),B(string ,11),I(3d,02,0b,45),I(0b,00,00,00)};

  /* Byte-vector with size: 122 is_init: 0 index: 19 binding: top-level */
  static const void *G006482[] = {I(a9,24,00,00),B(mop_gf ,17),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(mop_class ,25),I(24,00,00,00),B(string ,13),I(24,00,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,23),I(3c,00,24,00),B(mop_gf ,17),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(format ,18),I(23,00,00,00),B(format ,17),I(3b,fd,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(mop_gf ,17),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(mop_gf ,17),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(mop_class ,5),I(24,00,00,00),B(string ,13),I(24,00,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,23),I(3c,00,24,00),B(mop_gf ,17),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(format ,18),I(23,00,00,00),B(format ,14),I(3b,fd,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(mop_gf ,17),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(mop_gf ,17),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(fpi ,6),I(24,00,00,00),B(string ,13),I(24,00,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,23),I(3c,00,24,00),B(mop_gf ,17),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(format ,18),I(23,00,00,00),B(format ,13),I(3b,fd,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(mop_gf ,17),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(mop_gf ,17),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(stream2 ,21),I(24,00,00,00),B(string ,13),I(24,00,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,23),I(3c,00,24,00),B(mop_gf ,17),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(format ,18),I(23,00,00,00),B(format ,12),I(3b,fd,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(mop_gf ,17),I(1c,24,00,00),B(mop_meth ,5),I(3d,02,18,45),I(18,00,00,00)};
