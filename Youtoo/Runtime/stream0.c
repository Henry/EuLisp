...
void initialize_module_stream0()
{
  ...
  static const void *G00486[] = {I(43,fe,1c,10),I(1d,11,1b,10),I(24,00,00,00),B(symbol ,6),I(3c,00,1f,03),I(1d,1d,23,00),B(stream0 ,20),I(86,0f,23,00),B(stream0 ,21),I(1c,0f,1b,86),I(0f,23,00,00),B(stream0 ,22),I(1c,0f,1f,05),I(1c,0f,23,00),B(stream0 ,23),I(1c,0f,23,00),B(stream0 ,24),I(1c,0f,23,00),B(stream0 ,25),I(1c,0f,1b,86),I(0f,1f,0b,1c),I(0f,86,86,0f),I(1f,0b,1c,0f),I(1b,86,0f,1f),I(03,1c,0f,23),B(stream0 ,14),I(1f,16,0f,1b),I(86,0f,1f,10),I(1c,0f,23,00),B(stream0 ,11),I(1c,0f,1f,14),I(86,0f,23,00),B(stream0 ,26),I(1c,0f,1b,86),I(0f,1f,03,1c),I(0f,23,00,00),B(stream0 ,27),I(1c,0f,1f,17),I(86,0f,1c,1c),I(0f,1f,0b,1c),I(0f,23,00,00),B(stream0 ,17),I(1c,0f,45,23)};
  ...
  static const void *G00515[] = {I(43,fe,1c,10),I(1d,11,1b,10),I(24,00,00,00),B(symbol ,6),I(3c,00,1f,03),I(1d,1d,1c,86),I(0f,23,00,00),B(stream0 ,23),I(1c,0f,23,00),B(stream0 ,24),I(1c,0f,23,00),B(stream0 ,25),I(1c,0f,1b,86),I(0f,1f,07,1c),I(0f,86,86,0f),I(1f,07,1c,0f),I(1b,86,0f,1f),I(03,1c,0f,23),B(stream0 ,14),I(1f,12,0f,1b),I(86,0f,1f,0c),I(1c,0f,23,00),B(stream0 ,11),I(1c,0f,1f,10),I(86,0f,23,00),B(stream0 ,26),I(1c,0f,1b,86),I(0f,1f,03,1c),I(0f,23,00,00),B(stream0 ,27),I(1c,0f,1f,13),I(86,0f,1c,1c),I(0f,1f,0b,1c),I(0f,23,00,00),B(stream0 ,17),I(1c,0f,45,1f)};

  /* Byte-vector with size: 50 is_init: 1 index: 0 binding: initialize-stream0 */
  static const void *G00517[] = {I(87,25,00,00),B(stream0 ,1),I(24,00,00,00),B(level1 ,1),I(3e,0b,24,00),B(level1 ,0),I(3c,00,21,01),I(23,00,00,00),B(stream0 ,35),I(23,00,00,00),B(stream0 ,44),I(3b,fe,25,00),B(stream0 ,8),I(23,00,00,00),B(stream0 ,45),I(23,00,00,00),B(stream0 ,43),I(3b,fe,25,00),B(stream0 ,7),I(23,00,00,00),B(stream0 ,46),I(23,00,00,00),B(stream0 ,40),I(3b,fe,25,00),B(stream0 ,6),I(23,00,00,00),B(stream0 ,47),I(23,00,00,00),B(stream0 ,39),I(3b,fe,25,00),B(stream0 ,5),I(23,00,00,00),B(stream0 ,48),I(23,00,00,00),B(stream0 ,36),I(3b,fe,25,00),B(stream0 ,4),I(23,00,00,00),B(stream0 ,49),I(23,00,00,00),B(stream0 ,28),I(3b,fe,25,00),B(stream0 ,3),I(23,00,00,00),B(stream0 ,50),I(23,00,00,00),B(stream0 ,19),I(3b,fd,25,00),B(stream0 ,2),I(86,ac,00,00)};
