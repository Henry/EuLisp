...
void initialize_module_socket()
{
  ...
  static const void *G003468[] = {I(ab,1c,8a,03),I(1d,24,00,00),B(socket ,8),I(09,45,02,00)};
  ...
  static const void *G003480[] = {I(a9,8a,05,45),I(00,00,00,00)};
  ...
  static const void *G003529[] = {I(aa,8a,03,24),B(socket ,8),I(08,45,00,00)};
