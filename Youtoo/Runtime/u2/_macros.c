...
void initialize_module__macros()
{
  ...
  static const void *G001049[] = {I(aa,1b,10,1c),I(11,1d,47,00),I(01,50,1b,44),I(0b,1d,23,00),B(_macros ,20),I(50,36,02,86),I(1b,44,0b,23),B(_macros ,20),I(1f,03,0f,36),I(bd,1f,03,7b),I(24,00,00,00),B(_macros ,9),I(3c,01,1b,44),I(26,1f,04,86),I(0f,23,00,00),B(_macros ,21),I(1c,0f,1b,86),I(0f,47,00,00),I(1c,0f,23,00),B(_macros ,22),I(1c,0f,1b,1f),I(09,0f,22,05),I(36,86,1f,04),I(12,1b,44,17),I(47,00,00,86),I(0f,23,00,00),B(_macros ,23),I(1c,0f,1b,1f),I(07,0f,22,02),I(36,68,1f,05),I(11,1b,44,2f),I(1f,06,86,0f),I(23,00,00,00),B(_macros ,21),I(1c,0f,23,00),B(_macros ,22),I(86,0f,1c,1c),I(0f,47,00,00),I(1c,0f,23,00),B(_macros ,24),I(1c,0f,1b,1f),I(0c,0f,22,06),I(36,32,24,00),B(boot1 ,14),I(44,29,1f,06),I(10,1b,86,0f),I(23,00,00,00),B(_macros ,21),I(1c,0f,1b,86),I(0f,47,00,00),I(1c,0f,23,00),B(_macros ,22),I(1c,0f,1b,1f),I(0c,0f,22,06),I(36,02,86,22),I(01,22,01,22),I(01,45,05,00)};
  ...
  static const void *G001123[] = {I(a7,1b,12,1b),I(44,2d,1d,86),I(0f,23,00,00),B(_macros ,81),I(1c,0f,83,86),I(0f,1c,1c,0f),I(23,00,00,00),B(_macros ,41),I(1c,0f,1b,86),I(0f,23,00,00),B(_macros ,81),I(1c,0f,22,06),I(36,27,1d,86),I(0f,23,00,00),B(_macros ,81),I(1c,0f,1b,1f),I(04,0f,23,00),B(_macros ,41),I(1c,0f,1b,86),I(0f,23,00,00),B(_macros ,81),I(1c,0f,22,05),I(45,03,00,00)};

  /* Byte-vector with size: 7 is_init: 0 index: 83 binding: return-from */
  static const void *G001126[] = {I(a7,23,00,00),B(_macros ,32),I(1c,0f,1d,1c),I(24,00,00,00),B(boot1 ,26),I(3d,02,03,45),I(03,00,00,00)};
  ...
  static const void *G001132[] = {I(43,fc,1d,1b),I(44,04,1b,36),I(08,23,00,00),B(_macros ,87),I(1f,03,1f,03),I(0f,1c,1c,0f),I(1f,07,1c,0f),I(23,00,00,00),B(_macros ,88),I(1c,0f,45,09)};

  /* Byte-vector with size: 8 is_init: 0 index: 90 binding: throw */
  static const void *G001136[] = {I(a7,1c,86,0f),I(23,00,00,00),B(_macros ,50),I(1c,0f,23,00),B(_macros ,32),I(1f,03,0f,1b),I(86,0f,1d,1c),I(0f,45,06,00)};
  ...
  static const void *G001140[] = {I(a7,24,00,00),B(symbol ,6),I(3c,00,1b,86),I(0f,1f,03,1c),I(0f,1b,86,0f),I(1b,1f,05,0f),I(23,00,00,00),B(_macros ,92),I(1c,0f,1b,86),I(0f,1f,06,1c),I(0f,23,00,00),B(_macros ,43),I(1c,0f,45,0a)};
