...
void initialize_module__macros()
{
  ...
  static const void *G00996[] = {I(43,fc,1d,1b),I(44,04,1b,36),I(08,23,00,00),B(_macros ,87),I(1f,03,1f,03),I(0f,1c,1c,0f),I(1f,07,1c,0f),I(23,00,00,00),B(_macros ,88),I(1c,0f,45,09)};

  /* Byte-vector with size: 8 is_init: 0 index: 90 binding: throw */
  static const void *G001000[] = {I(a7,1c,86,0f),I(23,00,00,00),B(_macros ,50),I(1c,0f,23,00),B(_macros ,32),I(1f,03,0f,1b),I(86,0f,1d,1c),I(0f,45,06,00)};
  ...
  static const void *G001004[] = {I(a7,24,00,00),B(symbol ,6),I(3c,00,1b,86),I(0f,1f,03,1c),I(0f,1b,86,0f),I(1b,1f,05,0f),I(23,00,00,00),B(_macros ,92),I(1c,0f,1b,86),I(0f,1f,06,1c),I(0f,23,00,00),B(_macros ,43),I(1c,0f,45,0a)};
