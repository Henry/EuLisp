...
void initialize_module_thread()
{
  ...
  static const void *G00393[] = {I(ab,1c,8a,03),I(1d,24,00,00),B(thread ,25),I(09,45,02,00)};
  ...
  static const void *G00406[] = {I(aa,1b,83,24),B(thread ,34),I(08,1b,44,0c),I(1c,82,24,00),B(thread ,34),I(08,36,15,24),B(thread ,7),I(3c,00,2a,1c),I(24,00,00,00),B(thread ,5),I(3d,01,02,45),I(02,00,00,00)};

  /* Byte-vector with size: 6 is_init: 0 index: 50 binding: (method-thread-start) */
  static const void *G00408[] = {I(a7,1c,1c,24),B(thread ,13),I(3c,02,24,00),B(thread ,9),I(3c,01,2a,1c),I(45,02,00,00)};

  /* Byte-vector with size: 13 is_init: 0 index: 52 binding: anonymous */
  static const void *G00410[] = {I(aa,47,01,00),I(1c,1c,8a,03),I(1d,24,00,00),B(thread ,34),I(09,22,02,2a),I(47,01,00,23),B(thread ,51),I(1c,84,1d,24),B(thread ,34),I(09,22,02,2a),I(47,01,00,47),I(00,00,3d,01),I(01,00,00,00)};
  ...
  static const void *G00424[] = {I(ab,1c,8a,03),I(1d,24,00,00),B(thread ,34),I(09,45,02,00)};
  ...
  static const void *G00436[] = {I(ab,1c,8a,03),I(1d,24,00,00),B(thread ,8),I(09,45,02,00)};
  ...
  static const void *G00442[] = {I(a8,1b,44,2c),I(1b,10,1b,23),B(thread ,69),I(1c,84,1d,24),B(thread ,34),I(09,22,02,2a),I(1b,24,00,00),B(thread ,36),I(3c,01,2a,24),B(thread ,17),I(3d,00,02,22),I(01,36,11,24),B(thread ,7),I(24,00,00,00),B(thread ,11),I(3d,01,01,45),I(01,00,00,00)};

  /* Byte-vector with size: 15 is_init: 0 index: 71 binding: anonymous */
  static const void *G00445[] = {I(a8,1b,44,22),I(1b,10,23,00),B(thread ,51),I(1c,84,1d,24),B(thread ,34),I(09,22,02,2a),I(24,00,00,00),B(thread ,17),I(3d,00,01,36),I(13,24,00,00),B(thread ,4),I(24,00,00,00),B(thread ,11),I(3d,01,01,45),I(01,00,00,00)};
  ...
  static const void *G00513[] = {I(aa,24,00,00),B(thread ,33),I(1b,1d,1c,8a),I(03,1d,24,00),B(thread ,34),I(09,22,02,2a),I(86,89,00,00),B(thread ,33),I(2a,47,00,00),I(1c,47,00,01),I(24,00,00,00),B(boot ,5),I(3c,03,24,00),B(thread ,21),I(3d,01,02,45),I(02,00,00,00)};

  /* Byte-vector with size: 9 is_init: 0 index: 131 binding: ^ */
  static const void *G00515[] = {I(a7,46,02,1c),I(48,00,00,1b),I(48,00,01,23),B(thread ,53),I(23,00,00,00),B(thread ,130),I(3b,01,24,00),B(thread ,18),I(3d,01,02,00)};
  ...
  static const void *G00519[] = {I(aa,47,01,00),I(1c,1c,8a,03),I(1d,24,00,00),B(thread ,34),I(09,22,02,2a),I(47,01,00,47),I(00,00,3d,01),I(01,00,00,00)};

  /* Byte-vector with size: 14 is_init: 0 index: 134 binding: anonymous */
  static const void *G00521[] = {I(aa,46,01,1b),I(48,00,00,47),I(01,00,8a,03),I(24,00,00,00),B(thread ,34),I(08,23,00,00),B(thread ,53),I(23,00,00,00),B(thread ,133),I(3b,01,24,00),B(thread ,18),I(3c,01,2a,47),I(01,01,1c,3d),I(01,02,45,02)};
  ...
  static const void *G00525[] = {I(aa,8a,03,24),B(thread ,25),I(08,45,00,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 137 binding: thread-error-handlers */
  static const void *G00527[] = {I(aa,8a,03,24),B(thread ,8),I(08,45,00,00)};
  ...
  static const void *G00529[] = {I(a9,24,00,00),B(thread ,10),I(12,1b,44,16),I(86,23,00,00),B(thread ,138),I(24,00,00,00),B(boot ,13),I(3d,02,01,36),I(1c,24,00,00),B(thread ,10),I(10,24,00,00),B(thread ,10),I(11,1b,89,00),B(thread ,10),I(2a,1c,22,02),I(45,01,00,00)};

  /* Byte-vector with size: 9 is_init: 0 index: 140 binding: call1/cc */
  static const void *G00532[] = {I(aa,24,00,00),B(thread ,25),I(24,00,00,00),B(mop_gf ,2),I(3c,01,24,00),B(thread ,31),I(3c,02,1b,44),I(04,1b,36,02),I(86,45,01,00)};
  ...
  static const void *G00538[] = {I(aa,1b,89,00),B(thread ,33),I(2a,1b,23,00),B(thread ,117),I(1c,84,1d,24),B(thread ,34),I(09,22,02,2a),I(1b,8a,03,24),B(thread ,34),I(08,1c,1c,3d),I(01,02,45,02)};
  ...
  static const void *G00544[] = {I(aa,1b,11,12),I(1b,44,0d,47),I(00,00,86,0f),I(1d,1c,90,22),I(01,36,09,1c),I(11,47,00,01),I(3d,01,02,45),I(02,00,00,00)};

  /* Byte-vector with size: 16 is_init: 0 index: 147 binding: tconc */
  static const void *G00546[] = {I(ab,46,02,1b),I(48,00,00,86),I(1b,48,00,01),I(23,00,00,00),B(thread ,53),I(23,00,00,00),B(thread ,146),I(3b,01,48,00),I(01,1d,12,1b),I(44,0f,47,00),I(00,86,0f,1b),I(20,05,1f,04),I(22,01,36,08),I(1f,03,47,00),I(01,3c,01,2a),I(1f,03,45,04)};

  /* Byte-vector with size: 3 is_init: 0 index: 148 binding: thread-continuation */
  static const void *G00548[] = {I(aa,8a,03,24),B(thread ,34),I(08,45,00,00)};
  ...
  static const void *G00552[] = {I(ab,46,01,1b),I(48,00,00,47),I(00,00,5a,2a),I(23,00,00,00),B(thread ,53),I(23,00,00,00),B(thread ,149),I(3b,01,1d,3c),I(01,1b,44,04),I(1b,36,02,86),I(45,03,00,00)};
  ...
  static const void *G00554[] = {I(a9,24,00,00),B(thread ,10),I(24,00,00,00),B(boot ,28),I(3c,01,1b,12),I(1b,44,17,86),I(23,00,00,00),B(thread ,151),I(24,00,00,00),B(boot ,13),I(3d,02,02,36),I(18,1c,10,1d),I(11,24,00,00),B(boot ,28),I(3c,01,1b,89),B(thread ,10),I(2a,1c,22,02),I(45,02,00,00)};
  ...
  static const void *G00559[] = {I(aa,24,00,00),B(thread ,10),I(12,1b,44,11),I(1c,86,0f,1b),I(89,00,00,00),B(thread ,10),I(22,01,36,14),I(24,00,00,00),B(thread ,10),I(1d,24,00,00),B(thread ,28),I(3d,02,02,45),I(02,00,00,00)};
