...
(definterface level-1
  (import (bit callback character collect compare condition convert copy dynamic event float fpi format read handler integer let-cc list lock number random stream stream3 string symbol telos thread table vector)
   ...
   export (
    ...
    ((name . stream-sink) (pos . 37) (origin stream2 . stream-sink) (inline (G002816 (static-fpi-byte-ref 5) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G002842 (stack-ref 1) (static-fpi-byte-ref 5) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . control-block-buffer) (pos . 32) (origin stream2 . control-block-buffer) (inline (G002798 (static-fpi-byte-ref 3) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G002828 (stack-ref 1) (static-fpi-byte-ref 3) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . socket-port) (pos . 9) (origin socket . socket-port) (inline (G003353 (static-fpi-byte-ref 3) (binding-ref ? <socket>) (primitive-relative-ref))) (setter (G003365 (stack-ref 1) (static-fpi-byte-ref 3) (stack-ref 2) (binding-ref ? <socket>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-read-action) (pos . 7) (origin stream2 . stream-read-action) (inline (G002812 (static-fpi-byte-ref 3) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G002838 (stack-ref 1) (static-fpi-byte-ref 3) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-source) (pos . 21) (origin stream2 . stream-source) (inline (G002814 (static-fpi-byte-ref 4) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G002840 (stack-ref 1) (static-fpi-byte-ref 4) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
