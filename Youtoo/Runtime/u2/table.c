...
void initialize_module_table()
{
  ...
  static const void *G005289[] = {I(aa,1b,7a,1b),I(34,00,00,00),I(00,00,00,20),I(1c,10,1d,11),I(47,00,00,1d),I(1d,47,00,01),I(3d,03,04,22),I(02,32,00,00),I(00,00,00,08),I(86,45,02,00)};

  /* Byte-vector with size: 24 is_init: 0 index: 18 binding: (method-member) */
  static const void *G005291[] = {I(43,fd,46,02),I(1d,48,00,00),I(1b,12,1b,34),I(00,00,00,19),I(1d,47,00,00),I(24,00,00,00),B(table ,7),I(3d,02,04,32),I(00,00,00,3e),I(1c,10,1b,48),I(00,01,1f,03),I(26,00,00,00),I(00,00,00,03),I(24,00,00,00),B(table1 ,3),I(08,47,00,00),I(1c,23,00,00),B(table ,17),I(23,00,00,00),B(table ,16),I(3b,01,24,00),B(collect ,11),I(3d,03,06,22),I(02,45,04,00)};
  ...
  static const void *G005294[] = {I(43,fd,12,1b),I(34,00,00,00),I(00,00,00,18),I(1d,1d,24,00),B(table ,5),I(3d,02,03,32),I(00,00,00,20),I(24,00,00,00),B(condition ,8),I(23,00,00,00),B(table ,19),I(24,00,00,00),B(boot ,13),I(3d,02,03,45),I(03,00,00,00)};
  ...
  static const void *G005297[] = {I(43,fd,12,1b),I(34,00,00,00),I(00,00,00,18),I(1d,1d,24,00),B(table ,8),I(3d,02,03,32),I(00,00,00,20),I(24,00,00,00),B(condition ,8),I(23,00,00,00),B(table ,21),I(24,00,00,00),B(boot ,13),I(3d,02,03,45),I(03,00,00,00)};
  ...
  static const void *G005300[] = {I(43,fd,12,1b),I(34,00,00,00),I(00,00,00,18),I(1d,1d,24,00),B(table ,2),I(3d,02,03,32),I(00,00,00,20),I(24,00,00,00),B(condition ,8),I(23,00,00,00),B(table ,23),I(24,00,00,00),B(boot ,13),I(3d,02,03,45),I(03,00,00,00)};
  ...
  static const void *G005303[] = {I(43,fd,12,1b),I(34,00,00,00),I(00,00,00,18),I(1d,1d,24,00),B(table ,9),I(3d,02,03,32),I(00,00,00,20),I(24,00,00,00),B(condition ,8),I(23,00,00,00),B(table ,25),I(24,00,00,00),B(boot ,13),I(3d,02,03,45),I(03,00,00,00)};
  ...
  static const void *G005308[] = {I(aa,47,00,03),I(1c,02,1b,7a),I(1b,34,00,00),I(00,00,00,5b),I(1c,10,1b,47),I(00,01,47,00),I(04,3c,02,1b),I(34,00,00,00),I(00,00,00,1c),I(1f,03,11,1f),I(04,47,00,02),I(90,2a,1b,22),I(01,32,00,00),I(00,00,00,2c),I(1f,04,2b,1b),I(47,00,06,1a),I(1b,34,00,00),I(00,00,00,13),I(1c,47,00,05),I(3d,01,07,32),I(00,00,00,0c),I(82,47,00,05),I(3d,01,07,22),I(02,22,02,32),I(00,00,00,6c),I(47,00,00,83),I(24,00,00,00),B(table1 ,3),I(08,2b,47,00),I(01,47,00,02),I(0f,47,00,03),I(1f,05,1d,03),I(2a,47,00,00),I(1d,1c,83,1d),I(24,00,00,00),B(table1 ,3),I(09,22,02,2a),I(47,00,00,82),I(24,00,00,00),B(table1 ,3),I(08,1d,1c,1a),I(1b,34,00,00),I(00,00,00,0f),I(86,32,00,00),I(00,00,00,11),I(47,00,00,24),B(table ,3),I(3c,01,2a,47),I(00,00,84,24),B(table1 ,3),I(08,22,04,45),I(03,00,00,00)};
  ...
  static const void *G005368[] = {I(aa,1b,7a,1b),I(34,00,00,00),I(00,00,00,10),I(86,32,00,00),I(00,00,00,11),I(1c,10,1d,11),I(47,00,00,3d),I(02,02,45,02)};

  /* Byte-vector with size: 12 is_init: 0 index: 68 binding: all1-table? */
  static const void *G005370[] = {I(ab,46,01,1c),I(48,00,00,26),I(00,00,00,03),I(24,00,00,00),B(table1 ,3),I(08,23,00,00),B(table ,17),I(23,00,00,00),B(table ,67),I(3b,01,1c,24),B(vector ,10),I(3d,02,02,00)};
  ...
  static const void *G005374[] = {I(aa,1b,7a,1b),I(34,00,00,00),I(00,00,00,10),I(86,32,00,00),I(00,00,00,11),I(1c,10,1d,11),I(47,00,00,3d),I(02,02,45,02)};

  /* Byte-vector with size: 12 is_init: 0 index: 71 binding: anyp1-table */
  static const void *G005376[] = {I(ab,46,01,1c),I(48,00,00,26),I(00,00,00,03),I(24,00,00,00),B(table1 ,3),I(08,23,00,00),B(table ,17),I(23,00,00,00),B(table ,70),I(3b,01,1c,24),B(vector ,4),I(3d,02,02,00)};

  /* Byte-vector with size: 8 is_init: 0 index: 72 binding: anonymous */
  static const void *G005378[] = {I(aa,1b,7a,1b),I(34,00,00,00),I(00,00,00,18),I(1c,10,1d,11),I(47,00,00,3d),I(02,02,32,00),I(00,00,00,07),I(86,45,02,00)};

  /* Byte-vector with size: 12 is_init: 0 index: 73 binding: do1-table */
  static const void *G005380[] = {I(ab,46,01,1c),I(48,00,00,26),I(00,00,00,03),I(24,00,00,00),B(table1 ,3),I(08,23,00,00),B(table ,17),I(23,00,00,00),B(table ,72),I(3b,01,1c,24),B(vector ,16),I(3d,02,02,00)};
