...
void initialize_module_stream3()
{
  ...
  static const void *G00429[] = {I(ab,1c,82,02),I(24,00,00,00),B(character ,10),I(1c,24,00,00),B(collect ,16),I(3c,02,1b,44),I(10,1c,1f,03),I(24,00,00,00),B(stream2 ,31),I(3c,02,36,23),I(1d,27,7c,24),B(stream ,23),I(3c,02,2a,1c),I(1f,03,24,00),B(stream2 ,31),I(3c,02,2a,1d),I(27,7c,24,00),B(stream ,23),I(3c,02,2a,1f),I(03,45,04,00)};
