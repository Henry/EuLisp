...
void initialize_module_stream3()
{
  ...
  static const void *G00372[] = {I(ab,1c,82,02),I(1b,44,04,1b),I(36,07,23,00),B(stream3 ,2),I(82,02,1d,27),I(3c,24,00,00),B(stream ,23),I(3c,02,2a,1b),I(06,1c,1c,1f),I(05,24,00,00),B(stream ,11),I(3c,03,2a,1f),I(03,27,3e,24),B(stream ,23),I(3c,02,2a,1f),I(04,45,05,00)};
  ...
  static const void *G00381[] = {I(ab,1b,27,28),I(24,00,00,00),B(stream ,23),I(3c,02,2a,1c),I(24,00,00,00),B(stream2 ,30),I(1d,24,00,00),B(stream ,18),I(3c,03,1b,12),I(1b,44,04,86),I(36,21,23,00),B(stream3 ,7),I(8a,03,1f,04),I(24,00,00,00),B(stream ,11),I(3c,03,2a,1d),I(1d,24,00,00),B(stream ,8),I(3c,02,2a,1d),I(27,29,24,00),B(stream ,23),I(3c,02,2a,1f),I(03,45,04,00)};

  /* Byte-vector with size: 17 is_init: 0 index: 9 binding: anonymous */
  static const void *G00384[] = {I(a9,47,00,03),I(47,00,02,1a),I(1b,44,37,47),I(00,00,47,00),I(03,02,47,00),I(01,1c,24,00),B(stream ,8),I(3c,02,2a,47),I(00,01,27,20),I(24,00,00,00),B(stream ,23),I(3c,02,2a,47),I(00,03,2b,1b),I(48,00,03,47),I(00,04,3d,00),I(03,22,02,36),I(02,86,45,01)};
  ...
  static const void *G00386[] = {I(ab,46,06,1c),I(48,00,00,1b),I(48,00,01,47),I(00,00,06,1b),I(2d,1b,44,19),I(23,00,00,00),B(stream3 ,10),I(8a,03,47,00),I(01,24,00,00),B(stream ,11),I(3c,03,36,ab),I(1c,83,19,1b),I(44,3d,23,00),B(stream3 ,11),I(84,47,00,01),I(24,00,00,00),B(stream ,11),I(3c,03,2a,47),I(00,00,82,02),I(47,00,01,1c),I(24,00,00,00),B(stream ,8),I(3c,02,2a,47),I(00,01,27,29),I(24,00,00,00),B(stream ,23),I(3c,02,22,01),I(36,67,1d,2c),I(82,1c,48,00),I(02,1b,48,00),I(03,23,00,00),B(stream3 ,12),I(84,47,00,01),I(24,00,00,00),B(stream ,11),I(3c,03,2a,86),I(1b,48,00,04),I(23,00,00,00),B(stream3 ,2),I(23,00,00,00),B(stream3 ,9),I(3b,00,48,00),I(04,47,00,04),I(3c,00,2a,47),I(00,00,47,00),I(02,02,47,00),I(01,1c,24,00),B(stream ,8),I(3c,02,2a,47),I(00,01,27,29),I(24,00,00,00),B(stream ,23),I(3c,02,22,04),I(22,01,2a,47),I(00,00,45,04)};

  eul_allocate_static_string(str_393, "#<~a: ~a:~a>", 12);
  /* Byte-vector with size: 14 is_init: 0 index: 15 binding: (method-generic-write) */
  static const void *G00391[] = {I(ab,1c,04,1b),I(82,02,1f,03),I(84,24,00,00),B(socket ,8),I(08,1f,04,8a),I(03,24,00,00),B(socket ,8),I(08,1f,04,23),B(stream3 ,14),I(1f,04,1f,04),I(1f,04,24,00),B(format ,4),I(3c,05,2a,1f),I(05,45,06,00)};
  ...
  static const void *G00405[] = {I(ab,1c,27,0a),I(50,1b,44,19),I(23,00,00,00),B(stream3 ,24),I(8a,04,1f,03),I(24,00,00,00),B(stream ,11),I(3c,03,36,23),I(1c,27,23,24),B(stream ,23),I(3c,02,2a,1c),I(27,5c,24,00),B(stream ,23),I(3c,02,2a,1c),I(1f,03,24,00),B(stream ,23),I(3c,02,2a,1d),I(45,03,00,00)};

  eul_allocate_static_string(str_410, " . ", 3);
  /* Byte-vector with size: 23 is_init: 0 index: 27 binding: (method-generic-write) */
  static const void *G00408[] = {I(ab,1b,27,28),I(24,00,00,00),B(stream ,23),I(3c,02,2a,1c),I(24,00,00,00),B(stream2 ,27),I(1d,24,00,00),B(stream ,18),I(3c,03,1b,12),I(1b,44,04,86),I(36,21,23,00),B(stream3 ,26),I(8a,03,1f,04),I(24,00,00,00),B(stream ,11),I(3c,03,2a,1d),I(1d,24,00,00),B(stream ,4),I(3c,02,2a,1d),I(27,29,24,00),B(stream ,23),I(3c,02,2a,1f),I(03,45,04,00)};

  /* Byte-vector with size: 17 is_init: 0 index: 28 binding: anonymous */
  static const void *G00411[] = {I(a9,47,00,03),I(47,00,02,1a),I(1b,44,37,47),I(00,00,47,00),I(03,02,47,00),I(01,1c,24,00),B(stream ,4),I(3c,02,2a,47),I(00,01,27,20),I(24,00,00,00),B(stream ,23),I(3c,02,2a,47),I(00,03,2b,1b),I(48,00,03,47),I(00,04,3d,00),I(03,22,02,36),I(02,86,45,01)};
  ...
  static const void *G00413[] = {I(ab,46,06,1c),I(48,00,00,1b),I(48,00,01,47),I(00,00,06,1b),I(2d,1b,44,19),I(23,00,00,00),B(stream3 ,29),I(8a,03,47,00),I(01,24,00,00),B(stream ,11),I(3c,03,36,ab),I(1c,83,19,1b),I(44,3d,23,00),B(stream3 ,30),I(84,47,00,01),I(24,00,00,00),B(stream ,11),I(3c,03,2a,47),I(00,00,82,02),I(47,00,01,1c),I(24,00,00,00),B(stream ,4),I(3c,02,2a,47),I(00,01,27,29),I(24,00,00,00),B(stream ,23),I(3c,02,22,01),I(36,67,1d,2c),I(82,1c,48,00),I(02,1b,48,00),I(03,23,00,00),B(stream3 ,31),I(84,47,00,01),I(24,00,00,00),B(stream ,11),I(3c,03,2a,86),I(1b,48,00,04),I(23,00,00,00),B(stream3 ,2),I(23,00,00,00),B(stream3 ,28),I(3b,00,48,00),I(04,47,00,04),I(3c,00,2a,47),I(00,00,47,00),I(02,02,47,00),I(01,1c,24,00),B(stream ,4),I(3c,02,2a,47),I(00,01,27,29),I(24,00,00,00),B(stream ,23),I(3c,02,22,04),I(22,01,2a,47),I(00,00,45,04)};
  ...
  static const void *G00429[] = {I(ab,1c,82,02),I(24,00,00,00),B(character ,10),I(1c,24,00,00),B(collect ,16),I(3c,02,1b,44),I(10,1c,1f,03),I(24,00,00,00),B(stream2 ,30),I(3c,02,36,23),I(1d,27,7c,24),B(stream ,23),I(3c,02,2a,1c),I(1f,03,24,00),B(stream2 ,30),I(3c,02,2a,1d),I(27,7c,24,00),B(stream ,23),I(3c,02,2a,1f),I(03,45,04,00)};
