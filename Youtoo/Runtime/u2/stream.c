...
void initialize_module_stream()
{
  ...
  static const void *G004039[] = {I(43,03,1d,8a),I(04,24,00,00),B(stream2 ,20),I(08,1b,82,24),B(stream2 ,22),I(08,1c,8a,03),I(24,00,00,00),B(stream2 ,22),I(08,1b,06,1d),I(1c,19,1b,44),I(0d,1f,07,24),B(stream2 ,2),I(3c,01,2d,36),I(02,86,1b,44),I(15,1f,07,44),I(0d,1f,08,24),B(stream2 ,18),I(3d,01,09,36),I(03,1f,06,36),I(33,1f,05,82),I(24,00,00,00),B(stream2 ,22),I(08,1f,06,8a),I(03,24,00,00),B(stream2 ,22),I(08,1b,1d,0b),I(1d,2b,1f,09),I(1c,1c,82,1d),I(24,00,00,00),B(stream2 ,22),I(09,22,02,2a),I(1c,22,04,45),I(09,00,00,00)};

  /* Byte-vector with size: 35 is_init: 0 index: 27 binding: (method-generic-read) */
  static const void *G004041[] = {I(43,03,1d,8a),I(04,24,00,00),B(stream2 ,20),I(08,1b,82,24),B(stream2 ,22),I(08,2d,1b,44),I(0d,1f,04,24),B(stream2 ,2),I(3c,01,2d,36),I(02,86,1b,44),I(15,1f,04,44),I(0d,1f,05,24),B(stream2 ,18),I(3d,01,06,36),I(03,1f,03,36),I(4b,1d,82,24),B(stream2 ,22),I(08,1f,03,83),I(24,00,00,00),B(stream2 ,22),I(08,2b,1c,2c),I(1f,05,1c,1c),I(82,1d,24,00),B(stream2 ,22),I(09,22,02,2a),I(1f,05,1d,1c),I(83,1d,24,00),B(stream2 ,22),I(09,22,02,2a),I(1f,05,8a,03),I(24,00,00,00),B(stream2 ,22),I(08,1b,1f,03),I(0b,22,04,45),I(06,00,00,00)};

  /* Byte-vector with size: 7 is_init: 0 index: 28 binding: (method-generic-read) */
  static const void *G004043[] = {I(43,03,1d,8a),I(03,24,00,00),B(stream2 ,20),I(08,1f,03,1f),I(03,1f,03,1f),I(03,3d,03,04),I(45,04,00,00)};
  ...
  static const void *G004094[] = {I(a7,24,00,00),B(stream ,9),I(3d,02,00,00)};
  ...
  static const void *G004123[] = {I(43,fd,1b,44),I(17,1b,10,1f),I(03,1f,03,1d),I(24,00,00,00),B(stream ,10),I(3d,03,04,22),I(01,36,0d,1d),I(1d,24,00,00),B(stream ,23),I(3d,02,03,45),I(03,00,00,00)};
  ...
  static const void *G004127[] = {I(a7,1b,44,18),I(1b,10,24,00),B(stream2 ,34),I(1f,03,1d,24),B(stream ,10),I(3d,03,03,22),I(01,36,11,24),B(stream2 ,34),I(1d,24,00,00),B(stream ,23),I(3d,02,02,45),I(02,00,00,00)};
  ...
  static const void *G004133[] = {I(aa,1b,10,1b),I(47,00,01,47),I(00,00,3c,02),I(2a,1c,11,7a),I(1b,44,1b,47),I(00,01,27,20),I(24,00,00,00),B(stream ,23),I(3c,02,2a,1d),I(11,47,00,02),I(3d,01,03,36),I(03,1d,11,45),I(03,00,00,00)};
  ...
  static const void *G004137[] = {I(a7,1c,24,00),B(string ,13),I(24,00,00,00),B(convert ,2),I(3c,02,1b,1d),I(41,00,00,00),B(stream ,25),I(45,05,00,00)};
  ...
  static const void *G004141[] = {I(43,03,24,00),B(string ,13),I(23,00,00,00),B(stream ,33),I(8a,19,24,00),B(mop_gf ,2),I(3c,03,1b,82),I(1f,04,1f,04),I(41,00,00,00),B(stream1 ,19),I(22,04,1c,82),I(1d,24,00,00),B(string ,6),I(3c,03,1b,1d),I(1f,07,24,00),B(stream ,11),I(3d,03,06,45),I(06,00,00,00)};

  /* Byte-vector with size: 26 is_init: 0 index: 88 binding: sprint-one-char */
  static const void *G004143[] = {I(ab,1c,8a,05),I(24,00,00,00),B(stream2 ,20),I(08,1b,83,24),B(stream2 ,22),I(08,1b,2b,1d),I(84,24,00,00),B(stream2 ,22),I(08,1f,03,8a),I(03,24,00,00),B(stream2 ,22),I(08,1b,1f,04),I(1f,07,0c,2a),I(1f,04,1f,03),I(1c,83,1d,24),B(stream2 ,22),I(09,22,02,2a),I(1f,05,27,0a),I(51,1b,44,04),I(1b,36,07,1f),I(03,1f,03,1a),I(12,1b,44,0e),I(1f,08,24,00),B(stream2 ,23),I(3d,01,09,36),I(02,86,45,09)};

  /* Byte-vector with size: 16 is_init: 0 index: 89 binding: make-space */
  static const void *G004145[] = {I(ab,1c,8a,05),I(24,00,00,00),B(stream2 ,20),I(08,1b,84,24),B(stream2 ,22),I(08,1c,83,24),B(stream2 ,22),I(08,1c,1c,15),I(1f,04,1c,1a),I(1b,44,04,87),I(36,13,1f,06),I(24,00,00,00),B(stream2 ,23),I(3c,01,2a,1f),I(05,1f,04,1a),I(45,07,00,00)};
