...
(definterface double1
  (import (telos number integer fpi float string)
   syntax (_telos0)
   full-import (mop-alloc mop-access mop-prim mop-key mop-class mop-init mop-inspect mop-gf mop-meth mop-defcl boot boot1 telos copy compare callback let-cc dynamic thread event condition number integer fpi collect convert)
   export (
    ...
    ((name . fpi-as-double) (pos . 13) (origin double1 . fpi-as-double) (class . ff) (arity . 1) (ff (0) 2 ("eul_fpi_as_dbl" . "ff_stub_eul_fpi_as_dbl237")))
