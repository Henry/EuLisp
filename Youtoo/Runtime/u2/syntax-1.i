...
;;;   Interface file for module syntax-1

(definterface syntax-1
  (import (level-1 telos0 stream0)
   ...
   export (
    ...
    ((name . dynamic-let) (pos . 11) (origin syntax-1 . dynamic-let))
    ((name . defmethod-sig) (pos . 8) (origin mop-meth0 . defmethod-sig))
    ((name . dynamic-setq) (pos . 15) (origin syntax-1 . dynamic-setq))
    ((name . defmethod-domain) (pos . 4) (origin mop-meth0 . defmethod-domain))
    ((name . with-source) (pos . 4) (origin stream0 . with-source))
    ((name . butlast) (pos . 13) (origin syntax-1 . butlast))
    ((name . dynamic) (pos . 18) (origin syntax-1 . dynamic))
    ((name . time-execution) (pos . 12) (origin syntax-1 . time-execution))
    ((name . method-function-lambda) (pos . 6) (origin mop-meth0 . method-function-lambda))
    ((name . last) (pos . 5) (origin syntax-1 . last))
    ((name . return-from) (pos . 14) (origin syntax-1 . return-from))
    ((name . not) (pos . 9) (origin syntax-1 . not))
    ...
    ((name . block) (pos . 6) (origin syntax-1 . block))
    ((name . or) (pos . 8) (origin boot0 . or))
    ((name . case) (pos . 2) (origin syntax-1 . case))
    ((name . catch) (pos . 19) (origin syntax-1 . catch))
    ((name . throw) (pos . 17) (origin syntax-1 . throw))
    ((name . with-input-file) (pos . 7) (origin stream0 . with-input-file))
    ((name . with-handler) (pos . 3) (origin syntax-1 . with-handler))
    ...
    ((name . defcondition) (pos . 16) (origin syntax-1 . defcondition))
    ((name . defglobal) (pos . 7) (origin syntax-1 . defglobal))
    ((name . while) (pos . 10) (origin syntax-1 . while))
