...
(definterface read
  (import (telos condition convert convert1 vector string lock dynamic table stream format)
   syntax (_macros)
   full-import (mop-alloc mop-access mop-prim mop-key mop-class mop-init mop-inspect mop-gf mop-meth mop-defcl boot boot1 telos let-cc dynamic thread event condition convert table format socket stream2 lock stream1 stream table1 vector list character string fpi copy number integer collect callback compare convert1)
   export (
