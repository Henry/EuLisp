...
void initialize_module_integer()
{
  ...
  static const void *G002197[] = {I(a9,24,00,00),B(number ,7),I(24,00,00,00),B(boot1 ,26),I(3c,01,24,00),B(boot1 ,26),I(3c,00,24,00),B(mop_class ,70),I(23,00,00,00),B(integer ,8),I(23,00,00,00),B(integer ,9),I(23,00,00,00),B(integer ,10),I(1f,05,23,00),B(integer ,11),I(1f,06,23,00),B(integer ,12),I(86,23,00,00),B(integer ,13),I(87,24,00,00),B(mop_gf ,2),I(3c,0b,1b,89),B(integer ,2),I(2a,83,24,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,43),I(3c,02,24,00),B(boot1 ,26),I(3c,00,24,00),B(boot1 ,26),I(3c,00,23,00),B(integer ,14),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,55),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(integer ,4),I(2a,24,00,00),B(integer ,4),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,43),I(3c,02,24,00),B(boot1 ,26),I(3c,00,24,00),B(integer ,4),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,7),I(3c,02,1f,04),I(1f,04,23,00),B(integer ,15),I(23,00,00,00),B(integer ,7),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(integer ,4),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(integer ,4),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(integer ,2),I(24,00,00,00),B(boot1 ,43),I(3c,02,24,00),B(boot1 ,26),I(3c,00,24,00),B(integer ,4),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,7),I(3c,02,1f,04),I(1f,04,23,00),B(integer ,15),I(23,00,00,00),B(integer ,6),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(integer ,4),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(integer ,4),I(2a,24,00,00),B(integer ,2),I(45,13,00,00)};
  ...
  eul_intern_symbol(sym_2205,"integer?");
  eul_intern_symbol(sym_2206,"(method integer?)");
