...
/* Foreign functions */
static LispRef ff_stub_eul_fpi_as_str2337 (Stack *reg_value_stack, LispRef *sreg_value_sp, LispRef *sreg_value_sb)
{
  LispRef G002391, res;

  POPVAL1(G002391);
  FF_RES_CONVERT3(res,eul_fpi_as_str(FF_ARG_CONVERT0(G002391)));
  return res;
}
...
void initialize_module_fpi()
{
  ...
  static const void *G002340[] = {I(ab,24,00,00),B(fpi ,5),I(3d,02,00,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 10 binding: (method-binary-gcd) */
  static const void *G002342[] = {I(ab,24,00,00),B(fpi ,4),I(3d,02,00,00)};
  ...
  eul_intern_symbol(sym_2388,"fpi-binary-lcm");
  eul_intern_symbol(sym_2389,"fpi-binary-gcd");
  ...
  fpi_bindings[ 7] = (LispRef) (LispRef (*) (Stack *, LispRef *, LispRef *)) ff_stub_eul_fpi_as_str2337;
