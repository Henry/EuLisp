...
void initialize_module_read()
{
  ...
  {
  /* Declarations */
  LispRef sym_9201, sym_9200, sym_9199, sym_9198, sym_9197, sym_9196, sym_9195, sym_9194, sym_9193, sym_9192, sym_9191, G009190, G009188, G009186, sym_9182, sym_9180, sym_9179, G009178, sym_9172, G009171, G009168, G009166, G009164, G009162, G009160, G009158, G009156, G009154, G009152, G009150, G009148, key_9146, sym_9145, G009144, G009142, key_9140, G009139, sym_9137, sym_9136, sym_9135, key_9133, sym_9121, key_9120, key_9119, sym_9118, key_9117, key_9116, key_9115, sym_9114, key_9113, sym_9112, key_9111, key_9110, G009109, G009107, G009105, G009103, G009101;

  /* Code vector and literal definitions */
  /* Byte-vector with size: 1 is_init: 0 index: 32 binding: (method-special?) */
  static const void *G009100[] = {I(aa,1b,45,01)};

  /* Byte-vector with size: 1 is_init: 0 index: 33 binding: (method-special?) */
  static const void *G009102[] = {I(aa,86,45,01)};

  /* Byte-vector with size: 4 is_init: 0 index: 34 binding: (setter-tag) */
  static const void *G009104[] = {I(ab,1c,82,1d),I(24,00,00,00),B(read ,31),I(09,45,02,00)};

  /* Byte-vector with size: 9 is_init: 0 index: 35 binding: anonymous */
  static const void *G009106[] = {I(43,03,1d,26),I(00,00,00,04),I(24,00,00,00),B(stream2 ,21),I(08,1b,1f,03),I(1f,03,24,00),B(read ,28),I(3d,03,04,45),I(04,00,00,00)};

  eul_allocate_static_cons(cons_9122, NULL, NULL);
  eul_allocate_static_string(str_9123, "(", 1);
  eul_allocate_static_string(str_9124, ")", 1);
  eul_allocate_static_string(str_9125, "#(", 2);
  eul_allocate_static_string(str_9126, "'", 1);
  ...
  eul_intern_keyword(key_9110,"source");
  eul_intern_keyword(key_9111,"read-action");
  eul_intern_symbol(sym_9112,"anonymous");
  eul_intern_keyword(key_9113,"name");
  eul_intern_symbol(sym_9114,"read-error");
  eul_intern_keyword(key_9115,"direct-superclasses");
  eul_intern_keyword(key_9116,"direct-slots");
  eul_intern_keyword(key_9117,"direct-keywords");
  eul_intern_symbol(sym_9118,"tag");
  eul_intern_keyword(key_9119,"keyword");
  eul_intern_keyword(key_9120,"tag");
  eul_intern_symbol(sym_9121,"special");
  object_class(cons_9122) = eul_static_cons_class;
  eul_car(cons_9122) = key_9120;
  eul_cdr(cons_9122) = eul_nil;
  ...
  eul_intern_keyword(key_9133,"string");
  object_class(str_9134) = eul_static_string_class;
  eul_intern_symbol(sym_9135,"special?");
  eul_intern_symbol(sym_9136,"(setter tag)");
  eul_intern_symbol(sym_9137,"(method special?)");
  eul_allocate_bytevector( G009109,G009108);
  eul_intern_keyword(key_9140,"value");
  eul_allocate_bytevector( G009139,G009138);
  eul_allocate_bytevector( G009142,G009141);
  eul_intern_symbol(sym_9145,"*clean-ups*");
  eul_intern_keyword(key_9146,"buffer");
  ...
  eul_intern_symbol(sym_9172,"unquote");
  ...
  eul_intern_symbol(sym_9179,"quote");
  eul_intern_symbol(sym_9180,"quasiquote");
  object_class(str_9181) = eul_static_string_class;
  eul_intern_symbol(sym_9182,"unquote-splicing");
  ...
  eul_intern_symbol(sym_9191,"reverse-onto");
  eul_intern_symbol(sym_9192,"parse");
  eul_intern_symbol(sym_9193,"read-token");
  eul_intern_symbol(sym_9194,"read");
  eul_intern_symbol(sym_9195,"set-dispatch-macro-character");
  eul_intern_symbol(sym_9196,"read-line");
  eul_intern_symbol(sym_9197,"read-s-expression");
  eul_intern_symbol(sym_9198,"sread");
  eul_intern_symbol(sym_9199,"read-char");
  eul_intern_symbol(sym_9200,"sread-s-expression");
  eul_intern_symbol(sym_9201,"top-level");
  ...
  read_bindings[ 32] = G009101;
  read_bindings[ 33] = G009103;
  read_bindings[ 34] = G009105;
  read_bindings[ 35] = G009107;
  read_bindings[ 36] = key_9110;
  read_bindings[ 37] = key_9111;
  read_bindings[ 38] = sym_9112;
  read_bindings[ 39] = key_9113;
  read_bindings[ 40] = sym_9114;
  read_bindings[ 41] = key_9115;
  read_bindings[ 42] = key_9116;
  read_bindings[ 43] = key_9117;
  read_bindings[ 44] = sym_9118;
  read_bindings[ 45] = key_9119;
  read_bindings[ 46] = key_9120;
  read_bindings[ 47] = sym_9121;
  read_bindings[ 48] = cons_9122;
  read_bindings[ 49] = str_9123;
  read_bindings[ 50] = str_9124;
  read_bindings[ 51] = str_9125;
  read_bindings[ 52] = str_9126;
  read_bindings[ 53] = str_9127;
  read_bindings[ 54] = str_9128;
  read_bindings[ 55] = str_9129;
  read_bindings[ 56] = str_9130;
  read_bindings[ 57] = str_9131;
  read_bindings[ 58] = str_9132;
  read_bindings[ 59] = key_9133;
  read_bindings[ 60] = str_9134;
  read_bindings[ 61] = sym_9135;
  read_bindings[ 62] = sym_9136;
  read_bindings[ 63] = sym_9137;
  read_bindings[ 64] = G009109;
  read_bindings[ 65] = key_9140;
  read_bindings[ 66] = G009139;
  read_bindings[ 67] = G009142;
  read_bindings[ 68] = sym_9145;
  read_bindings[ 69] = key_9146;
  read_bindings[ 70] = G009144;
  read_bindings[ 71] = G009148;
  read_bindings[ 72] = G009150;
  read_bindings[ 73] = G009152;
  read_bindings[ 74] = G009154;
  read_bindings[ 75] = G009156;
  read_bindings[ 76] = G009158;
  read_bindings[ 77] = G009160;
  read_bindings[ 78] = G009162;
  read_bindings[ 79] = G009164;
  read_bindings[ 80] = G009166;
  read_bindings[ 81] = str_9169;
  read_bindings[ 82] = G009168;
  read_bindings[ 83] = sym_9172;
  read_bindings[ 84] = str_9173;
  read_bindings[ 85] = str_9174;
  read_bindings[ 86] = str_9175;
  read_bindings[ 87] = str_9176;
  read_bindings[ 88] = G009171;
  read_bindings[ 89] = sym_9179;
  read_bindings[ 90] = sym_9180;
  read_bindings[ 91] = str_9181;
  read_bindings[ 92] = sym_9182;
  read_bindings[ 93] = str_9183;
  read_bindings[ 94] = str_9184;
  read_bindings[ 95] = G009178;
  read_bindings[ 96] = G009186;
  read_bindings[ 97] = G009188;
  read_bindings[ 1] = eul_nil;
  read_bindings[ 98] = sym_9191;
  read_bindings[ 99] = sym_9192;
  read_bindings[ 100] = sym_9193;
  read_bindings[ 101] = sym_9194;
  read_bindings[ 102] = sym_9195;
  read_bindings[ 103] = sym_9196;
  read_bindings[ 104] = sym_9197;
  read_bindings[ 105] = sym_9198;
  read_bindings[ 106] = sym_9199;
  read_bindings[ 107] = sym_9200;
  read_bindings[ 108] = sym_9201;
  eul_allocate_lambda( read_bindings[0], "initialize-read", 0, G009190);
