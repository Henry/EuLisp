...
void initialize_module_read()
{
  ...
  static const void *G009176[] = {I(43,03,1d,1d),I(24,00,00,00),B(boot1 ,25),I(3c,02,1b,24),B(string ,13),I(24,00,00,00),B(convert ,2),I(3c,02,24,00),B(mop_class ,5),I(23,00,00,00),B(read ,39),I(1d,24,00,00),B(mop_gf ,2),I(3c,03,24,00),B(table ,5),I(24,00,00,00),B(boot1 ,41),I(3c,01,24,00),B(read ,17),I(1d,1f,06,1f),I(03,3d,03,07),I(45,07,00,00)};
