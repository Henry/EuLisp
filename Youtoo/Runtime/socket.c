...
void initialize_module_socket()
{
  ...
  {
  /* Declarations */
  LispRef sym_5940, sym_5939, sym_5938, sym_5937, sym_5936, sym_5935, sym_5934, G005933, G005931, G005929, G005927, G005925, G005923, G005921, sym_5919, sym_5918, sym_5917, sym_5916, sym_5915, sym_5914, sym_5913, sym_5912, sym_5911, sym_5910, sym_5909, key_5906, sym_5904, key_5900, key_5899, key_5898, sym_5897, key_5896, sym_5895, sym_5894, key_5893, sym_5892, key_5891, key_5890, key_5889, sym_5888, key_5887, G005886, G005884, G005882, G005880, G005878, G005876, G005874, G005872, G005870, G005868, G005866, G005864, sym_5862, sym_5861, key_5860, G005858, G005856, G005854, G005852, G005850, G005848;

  /* Code vector and literal definitions */
  /* Byte-vector with size: 1 is_init: 0 index: 12 binding: (method-connection?) */
  static const void *G005847[] = {I(aa,1b,45,01)};

  /* Byte-vector with size: 1 is_init: 0 index: 13 binding: (method-connection?) */
  static const void *G005849[] = {I(aa,86,45,01)};

  /* Byte-vector with size: 4 is_init: 0 index: 14 binding: (setter-connection-host) */
  static const void *G005851[] = {I(ab,1c,83,1d),I(24,00,00,00),B(socket ,2),I(09,45,02,00)};

  /* Byte-vector with size: 4 is_init: 0 index: 15 binding: (setter-connection-port) */
  static const void *G005853[] = {I(ab,1c,82,1d),I(24,00,00,00),B(socket ,2),I(09,45,02,00)};

  /* Byte-vector with size: 7 is_init: 0 index: 16 binding: anonymous */
  static const void *G005855[] = {I(a9,47,00,00),I(24,00,00,00),B(lock ,4),I(3c,01,2a,83),I(24,00,00,00),B(dynamic ,8),I(3d,01,00,00)};

  eul_allocate_static_string(str_5859, "tcp", 3);
  /* Byte-vector with size: 81 is_init: 0 index: 21 binding: (method-initialize) */
  static const void *G005857[] = {I(ab,46,02,1c),I(1c,37,02,2a),I(1c,26,00,00),I(00,00,00,03),I(24,00,00,00),B(socket ,8),I(08,24,00,00),B(string ,13),I(24,00,00,00),B(convert ,2),I(3c,02,1d,82),I(24,00,00,00),B(socket ,8),I(08,1c,23,00),B(socket ,17),I(1d,41,00,00),B(stream1 ,21),I(22,03,1b,85),I(19,1b,34,00),I(00,00,00,32),I(24,00,00,00),B(stream1 ,6),I(3c,00,1b,24),B(stream2 ,38),I(23,00,00,00),B(socket ,18),I(1f,09,24,00),B(boot ,12),I(3d,04,07,22),I(01,32,00,00),I(00,00,00,cc),I(1c,85,1a,1b),I(34,00,00,00),I(00,00,00,34),I(1d,41,00,00),B(stream1 ,24),I(22,01,1b,24),B(stream2 ,38),I(23,00,00,00),B(socket ,18),I(1f,0a,24,00),B(boot ,12),I(3d,04,08,22),I(01,32,00,00),I(00,00,00,92),I(1f,06,1f,03),I(1c,83,1d,24),B(socket ,8),I(09,22,02,2a),I(24,00,00,00),B(stream2 ,12),I(1b,48,00,00),I(23,00,00,00),B(socket ,19),I(24,00,00,00),B(dynamic ,3),I(3c,01,23,00),B(socket ,20),I(23,00,00,00),B(socket ,16),I(3b,00,1c,0f),I(23,00,00,00),B(socket ,19),I(1c,24,00,00),B(dynamic ,2),I(3c,02,2a,47),I(00,00,24,00),B(lock ,3),I(3c,01,2a,1f),I(09,24,00,00),B(stream2 ,37),I(0f,1b,89,00),B(stream2 ,37),I(47,00,00,24),B(lock ,4),I(3c,01,2a,83),I(24,00,00,00),B(dynamic ,8),I(3c,01,2a,1f),I(0b,22,05,22),I(01,45,06,00)};

  /* Byte-vector with size: 1 is_init: 0 index: 22 binding: (method-socket?) */
  static const void *G005863[] = {I(aa,1b,45,01)};

  /* Byte-vector with size: 1 is_init: 0 index: 23 binding: (method-socket?) */
  static const void *G005865[] = {I(aa,86,45,01)};

  /* Byte-vector with size: 5 is_init: 0 index: 24 binding: (setter-socket-port) */
  static const void *G005867[] = {I(ab,1c,26,00),I(00,00,00,03),I(1d,24,00,00),B(socket ,8),I(09,45,02,00)};

  /* Byte-vector with size: 4 is_init: 0 index: 25 binding: (setter-socket-host) */
  static const void *G005869[] = {I(ab,1c,84,1d),I(24,00,00,00),B(socket ,8),I(09,45,02,00)};

  /* Byte-vector with size: 4 is_init: 0 index: 26 binding: (setter-socket-descriptor) */
  static const void *G005871[] = {I(ab,1c,83,1d),I(24,00,00,00),B(socket ,8),I(09,45,02,00)};

  /* Byte-vector with size: 4 is_init: 0 index: 27 binding: (setter-socket-queue-size) */
  static const void *G005873[] = {I(ab,1c,82,1d),I(24,00,00,00),B(socket ,8),I(09,45,02,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 28 binding: anonymous */
  static const void *G005875[] = {I(a9,26,00,00),I(00,00,12,67),I(45,00,00,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 29 binding: anonymous */
  static const void *G005877[] = {I(a9,24,00,00),B(stream1 ,3),I(3d,00,00,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 30 binding: anonymous */
  static const void *G005879[] = {I(a9,26,00,00),I(00,00,00,05),I(45,00,00,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 31 binding: anonymous */
  static const void *G005881[] = {I(a9,24,00,00),B(stream1 ,3),I(3d,00,00,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 32 binding: anonymous */
  static const void *G005883[] = {I(a9,26,00,00),I(00,00,12,67),I(45,00,00,00)};

  eul_allocate_static_cons(cons_5903, NULL, NULL);
  eul_allocate_static_cons(cons_5902, NULL, eul_as_static(cons_5903));
  ...
  eul_intern_keyword(key_5860,"value");
  eul_intern_symbol(sym_5861,"*clean-ups*");
  eul_intern_symbol(sym_5862,"anonymous");
  ...
  eul_intern_keyword(key_5887,"name");
  eul_intern_symbol(sym_5888,"port");
  eul_intern_keyword(key_5889,"default");
  eul_intern_keyword(key_5890,"keyword");
  eul_intern_keyword(key_5891,"port");
  eul_intern_symbol(sym_5892,"host");
  eul_intern_keyword(key_5893,"host");
  eul_intern_symbol(sym_5894,"descriptor");
  eul_intern_symbol(sym_5895,"queue-size");
  eul_intern_keyword(key_5896,"queue-size");
  eul_intern_symbol(sym_5897,"socket");
  eul_intern_keyword(key_5898,"direct-superclasses");
  eul_intern_keyword(key_5899,"direct-slots");
  eul_intern_keyword(key_5900,"direct-keywords");
  object_class(cons_5903) = eul_static_cons_class;
  eul_car(cons_5903) = key_5891;
  eul_cdr(cons_5903) = eul_nil;
  object_class(cons_5902) = eul_static_cons_class;
  eul_car(cons_5902) = key_5893;
  object_class(cons_5901) = eul_static_cons_class;
  eul_car(cons_5901) = key_5896;
  eul_intern_symbol(sym_5904,"connection");
  eul_intern_keyword(key_5906,"socket");
  object_class(cons_5908) = eul_static_cons_class;
  eul_car(cons_5908) = key_5893;
  eul_cdr(cons_5908) = eul_nil;
  object_class(cons_5907) = eul_static_cons_class;
  eul_car(cons_5907) = key_5891;
  object_class(cons_5905) = eul_static_cons_class;
  eul_car(cons_5905) = key_5906;
  eul_intern_symbol(sym_5909,"socket?");
  eul_intern_symbol(sym_5910,"connection?");
  eul_intern_symbol(sym_5911,"(setter socket-queue-size)");
  eul_intern_symbol(sym_5912,"(setter socket-descriptor)");
  eul_intern_symbol(sym_5913,"(setter socket-host)");
  eul_intern_symbol(sym_5914,"(setter socket-port)");
  eul_intern_symbol(sym_5915,"(method socket?)");
  eul_intern_symbol(sym_5916,"(method initialize)");
  eul_intern_symbol(sym_5917,"(setter connection-port)");
  eul_intern_symbol(sym_5918,"(setter connection-host)");
  eul_intern_symbol(sym_5919,"(method connection?)");
  eul_allocate_bytevector( G005886,G005885);
  eul_allocate_bytevector( G005921,G005920);
  ...
  eul_intern_symbol(sym_5934,"socket-host");
  eul_intern_symbol(sym_5935,"socket-port");
  eul_intern_symbol(sym_5936,"connection-port");
  eul_intern_symbol(sym_5937,"socket-queue-size");
  eul_intern_symbol(sym_5938,"connection-host");
  eul_intern_symbol(sym_5939,"socket-descriptor");
  eul_intern_symbol(sym_5940,"top-level");
  ...
  socket_bindings[ 12] = G005848;
  socket_bindings[ 13] = G005850;
  socket_bindings[ 14] = G005852;
  socket_bindings[ 15] = G005854;
  socket_bindings[ 16] = G005856;
  socket_bindings[ 17] = str_5859;
  socket_bindings[ 18] = key_5860;
  socket_bindings[ 19] = sym_5861;
  socket_bindings[ 20] = sym_5862;
  socket_bindings[ 21] = G005858;
  socket_bindings[ 22] = G005864;
  socket_bindings[ 23] = G005866;
  socket_bindings[ 24] = G005868;
  socket_bindings[ 25] = G005870;
  socket_bindings[ 26] = G005872;
  socket_bindings[ 27] = G005874;
  socket_bindings[ 28] = G005876;
  socket_bindings[ 29] = G005878;
  socket_bindings[ 30] = G005880;
  socket_bindings[ 31] = G005882;
  socket_bindings[ 32] = G005884;
  socket_bindings[ 33] = key_5887;
  socket_bindings[ 34] = sym_5888;
  socket_bindings[ 35] = key_5889;
  socket_bindings[ 36] = key_5890;
  socket_bindings[ 37] = key_5891;
  socket_bindings[ 38] = sym_5892;
  socket_bindings[ 39] = key_5893;
  socket_bindings[ 40] = sym_5894;
  socket_bindings[ 41] = sym_5895;
  socket_bindings[ 42] = key_5896;
  socket_bindings[ 43] = sym_5897;
  socket_bindings[ 44] = key_5898;
  socket_bindings[ 45] = key_5899;
  socket_bindings[ 46] = key_5900;
  socket_bindings[ 47] = cons_5901;
  socket_bindings[ 48] = sym_5904;
  socket_bindings[ 49] = key_5906;
  socket_bindings[ 50] = cons_5905;
  socket_bindings[ 51] = sym_5909;
  socket_bindings[ 52] = sym_5910;
  socket_bindings[ 53] = sym_5911;
  socket_bindings[ 54] = sym_5912;
  socket_bindings[ 55] = sym_5913;
  socket_bindings[ 56] = sym_5914;
  socket_bindings[ 57] = sym_5915;
  socket_bindings[ 58] = sym_5916;
  socket_bindings[ 59] = sym_5917;
  socket_bindings[ 60] = sym_5918;
  socket_bindings[ 61] = sym_5919;
  socket_bindings[ 62] = G005886;
  socket_bindings[ 63] = G005921;
  socket_bindings[ 64] = G005923;
  socket_bindings[ 65] = G005925;
  socket_bindings[ 66] = G005927;
  socket_bindings[ 67] = G005929;
  socket_bindings[ 68] = G005931;
  socket_bindings[ 1] = eul_nil;
  socket_bindings[ 69] = sym_5934;
  socket_bindings[ 70] = sym_5935;
  socket_bindings[ 71] = sym_5936;
  socket_bindings[ 72] = sym_5937;
  socket_bindings[ 73] = sym_5938;
  socket_bindings[ 74] = sym_5939;
  socket_bindings[ 75] = sym_5940;
  eul_allocate_lambda( socket_bindings[0], "initialize-socket", 0, G005933);
