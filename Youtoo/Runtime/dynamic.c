...
void initialize_module_dynamic()
{
  ...
  static const void *G00740[] = {I(a9,82,89,00),B(dynamic ,7),I(2a,82,89,00),B(dynamic ,4),I(2a,24,00,00),B(boot1 ,39),I(24,00,00,00),B(boot1 ,39),I(3c,01,24,00),B(dynamic ,3),I(23,00,00,00),B(dynamic ,13),I(23,00,00,00),B(dynamic ,12),I(3b,02,1d,3d),I(02,01,45,01)};
