...
/* Foreign functions */
static LispRef ff_stub_eul_table_ref8035 (Stack *reg_value_stack, LispRef *sreg_value_sp, LispRef *sreg_value_sb)
{
  LispRef G008148, G008149, res;

  POPVAL1(G008149);
  POPVAL1(G008148);
  FF_RES_CONVERT6(res,eul_table_ref(FF_ARG_CONVERT8(G008148), FF_ARG_CONVERT3(G008149)));
  return res;
}

static LispRef ff_stub_eul_addr_str8036 (Stack *reg_value_stack, LispRef *sreg_value_sp, LispRef *sreg_value_sb)
{
  LispRef G008150, res;

  POPVAL1(G008150);
  FF_RES_CONVERT3(res,eul_addr_str(FF_ARG_CONVERT8(G008150)));
  return res;
}

static LispRef ff_stub_eul_table_set8037 (Stack *reg_value_stack, LispRef *sreg_value_sp, LispRef *sreg_value_sb)
{
  LispRef G008151, G008152, G008153, res;

  POPVAL1(G008153);
  POPVAL1(G008152);
  POPVAL1(G008151);
  FF_RES_CONVERT6(res,eul_table_set(FF_ARG_CONVERT8(G008151), FF_ARG_CONVERT3(G008152), FF_ARG_CONVERT8(G008153)));
  return res;
}
...
void initialize_module_table()
{
  ...
  eul_intern_symbol(sym_8046,"anonymous");
  ...
  eul_intern_symbol(sym_8089,"table-ref");
  eul_intern_symbol(sym_8090,"(method element)");
  eul_intern_symbol(sym_8091,"(method table-ref)");
  eul_intern_symbol(sym_8092,"(method (setter element))");
  eul_intern_symbol(sym_8094,"setter");
  object_class(cons_8095) = eul_static_cons_class;
  eul_car(cons_8095) = sym_8089;
  eul_cdr(cons_8095) = eul_nil;
  object_class(cons_8093) = eul_static_cons_class;
  eul_car(cons_8093) = sym_8094;
  eul_intern_symbol(sym_8096,"(method (setter table-ref))");
  eul_intern_symbol(sym_8097,"(method emptyp)");
  eul_intern_symbol(sym_8098,"(method do)");
  eul_intern_symbol(sym_8099,"(method map)");
  eul_intern_symbol(sym_8100,"(method any?)");
  eul_intern_symbol(sym_8101,"(method all?)");
  eul_intern_symbol(sym_8102,"(method member)");
  eul_intern_symbol(sym_8103,"(method accumulate)");
  eul_intern_symbol(sym_8104,"(method accumulate1)");
  eul_intern_symbol(sym_8106,"converter");
  eul_intern_symbol(sym_8108,"<table>");
  object_class(cons_8107) = eul_static_cons_class;
  eul_car(cons_8107) = sym_8108;
  eul_cdr(cons_8107) = eul_nil;
  ...
  eul_intern_symbol(sym_8144,"table-empty?");
  eul_intern_symbol(sym_8145,"all1-table?");
  eul_intern_symbol(sym_8146,"accumulate-table");
  eul_intern_symbol(sym_8147,"top-level");
  ...
  table_bindings[ 11] = (LispRef) (LispRef (*) (Stack *, LispRef *, LispRef *)) ff_stub_eul_table_ref8035;
  table_bindings[ 12] = (LispRef) (LispRef (*) (Stack *, LispRef *, LispRef *)) ff_stub_eul_addr_str8036;
  table_bindings[ 13] = (LispRef) (LispRef (*) (Stack *, LispRef *, LispRef *)) ff_stub_eul_table_set8037;
  table_bindings[ 14] = G008039;
  table_bindings[ 15] = G008041;
  table_bindings[ 16] = G008043;
  table_bindings[ 17] = sym_8046;
  table_bindings[ 18] = G008045;
  table_bindings[ 19] = str_8049;
  table_bindings[ 20] = G008048;
  table_bindings[ 21] = str_8052;
  table_bindings[ 22] = G008051;
  table_bindings[ 23] = str_8055;
  table_bindings[ 24] = G008054;
  table_bindings[ 25] = str_8058;
  table_bindings[ 26] = G008057;
  table_bindings[ 27] = G008060;
  table_bindings[ 28] = G008062;
  table_bindings[ 29] = G008064;
  table_bindings[ 30] = G008066;
  table_bindings[ 31] = str_8069;
  table_bindings[ 32] = G008068;
  table_bindings[ 33] = G008071;
  table_bindings[ 34] = G008073;
  table_bindings[ 35] = G008075;
  table_bindings[ 36] = G008077;
  table_bindings[ 37] = G008079;
  table_bindings[ 38] = str_8082;
  table_bindings[ 39] = G008081;
  table_bindings[ 40] = G008084;
  table_bindings[ 41] = G008086;
  table_bindings[ 42] = sym_8089;
  table_bindings[ 43] = sym_8090;
  table_bindings[ 44] = sym_8091;
  table_bindings[ 45] = sym_8092;
  table_bindings[ 46] = sym_8094;
  table_bindings[ 47] = cons_8093;
  table_bindings[ 48] = sym_8096;
  table_bindings[ 49] = sym_8097;
  table_bindings[ 50] = sym_8098;
  table_bindings[ 51] = sym_8099;
  table_bindings[ 52] = sym_8100;
  table_bindings[ 53] = sym_8101;
  table_bindings[ 54] = sym_8102;
  table_bindings[ 55] = sym_8103;
  table_bindings[ 56] = sym_8104;
  table_bindings[ 57] = sym_8106;
  table_bindings[ 58] = sym_8108;
  table_bindings[ 59] = cons_8105;
  table_bindings[ 60] = G008088;
  table_bindings[ 61] = G008110;
  table_bindings[ 62] = G008112;
  table_bindings[ 63] = G008114;
  table_bindings[ 64] = G008116;
  table_bindings[ 65] = G008118;
  table_bindings[ 66] = G008120;
  table_bindings[ 67] = G008122;
  table_bindings[ 68] = G008124;
  table_bindings[ 69] = G008126;
  table_bindings[ 70] = G008128;
  table_bindings[ 71] = G008130;
  table_bindings[ 72] = G008132;
  table_bindings[ 73] = G008134;
  table_bindings[ 74] = G008136;
  table_bindings[ 1] = eul_nil;
  table_bindings[ 75] = sym_8139;
  table_bindings[ 76] = sym_8140;
  table_bindings[ 77] = sym_8141;
  table_bindings[ 78] = sym_8142;
  table_bindings[ 79] = sym_8143;
  table_bindings[ 80] = sym_8144;
  table_bindings[ 81] = sym_8145;
  table_bindings[ 82] = sym_8146;
  table_bindings[ 83] = sym_8147;
  eul_allocate_lambda( table_bindings[0], "initialize-table", 0, G008138);
