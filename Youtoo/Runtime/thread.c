...
void initialize_module_thread()
{
  ...
  static const void *G00479[] = {I(a8,1b,34,00),I(00,00,00,36),I(1b,10,1b,23),B(thread ,69),I(1c,84,1d,24),B(thread ,34),I(09,22,02,2a),I(1b,24,00,00),B(thread ,36),I(3c,01,2a,24),B(thread ,16),I(3d,00,02,22),I(01,32,00,00),I(00,00,00,1a),I(24,00,00,00),B(thread ,7),I(24,00,00,00),B(thread ,11),I(3d,01,01,45),I(01,00,00,00)};

  /* Byte-vector with size: 17 is_init: 0 index: 71 binding: anonymous */
  static const void *G00482[] = {I(a8,1b,34,00),I(00,00,00,2a),I(1b,10,23,00),B(thread ,51),I(1c,84,1d,24),B(thread ,34),I(09,22,02,2a),I(24,00,00,00),B(thread ,16),I(3d,00,01,32),I(00,00,00,18),I(24,00,00,00),B(thread ,4),I(24,00,00,00),B(thread ,11),I(3d,01,01,45),I(01,00,00,00)};
  ...
  static const void *G00566[] = {I(a9,24,00,00),B(thread ,10),I(12,1b,34,00),I(00,00,00,1e),I(23,00,00,00),B(thread ,138),I(24,00,00,00),B(boot ,22),I(3d,01,01,32),I(00,00,00,21),I(24,00,00,00),B(thread ,10),I(10,24,00,00),B(thread ,10),I(11,1b,89,00),B(thread ,10),I(2a,1c,22,02),I(45,01,00,00)};
  ...
  static const void *G00591[] = {I(a9,24,00,00),B(thread ,10),I(24,00,00,00),B(boot ,24),I(3c,01,1b,12),I(1b,34,00,00),I(00,00,00,1f),I(23,00,00,00),B(thread ,151),I(24,00,00,00),B(boot ,22),I(3d,01,02,32),I(00,00,00,1d),I(1c,10,1d,11),I(24,00,00,00),B(boot ,24),I(3c,01,1b,89),B(thread ,10),I(2a,1c,22,02),I(45,02,00,00)};
  ...
  static const void *G00596[] = {I(aa,24,00,00),B(thread ,10),I(12,1b,34,00),I(00,00,00,1a),I(1c,86,0f,1b),I(89,00,00,00),B(thread ,10),I(22,01,32,00),I(00,00,00,19),I(24,00,00,00),B(thread ,10),I(1d,24,00,00),B(thread ,27),I(3d,02,02,45),I(02,00,00,00)};
  ...
  static const void *G00602[] = {I(87,25,00,00),B(thread ,1),I(24,00,00,00),B(event ,1),I(3e,0b,24,00),B(event ,0),I(3c,00,21,01),I(24,00,00,00),B(telos ,1),I(3e,0b,24,00),B(telos ,0),I(3c,00,21,01),I(86,25,00,00),B(thread ,39),I(23,00,00,00),B(thread ,157),I(23,00,00,00),B(thread ,156),I(3b,01,25,00),B(thread ,38),I(23,00,00,00),B(thread ,158),I(23,00,00,00),B(thread ,155),I(3b,01,25,00),B(thread ,37),I(23,00,00,00),B(thread ,159),I(23,00,00,00),B(thread ,154),I(3b,01,25,00),B(thread ,36),I(23,00,00,00),B(thread ,160),I(23,00,00,00),B(thread ,153),I(3b,01,25,00),B(thread ,35),I(86,25,00,00),B(thread ,34),I(86,25,00,00),B(thread ,33),I(23,00,00,00),B(thread ,161),I(23,00,00,00),B(thread ,152),I(3b,00,25,00),B(thread ,32),I(23,00,00,00),B(thread ,162),I(23,00,00,00),B(thread ,150),I(3b,02,25,00),B(thread ,31),I(86,25,00,00),B(thread ,30),I(23,00,00,00),B(thread ,163),I(23,00,00,00),B(thread ,148),I(3b,01,25,00),B(thread ,29),I(86,25,00,00),B(thread ,28),I(23,00,00,00),B(thread ,164),I(23,00,00,00),B(thread ,147),I(3b,02,25,00),B(thread ,27),I(23,00,00,00),B(thread ,165),I(23,00,00,00),B(thread ,145),I(3b,01,25,00),B(thread ,26),I(86,25,00,00),B(thread ,25),I(86,25,00,00),B(thread ,24),I(86,25,00,00),B(thread ,23),I(23,00,00,00),B(thread ,166),I(23,00,00,00),B(thread ,144),I(3b,01,25,00),B(thread ,22),I(86,25,00,00),B(thread ,21),I(23,00,00,00),B(thread ,167),I(23,00,00,00),B(thread ,143),I(3b,01,25,00),B(thread ,20),I(23,00,00,00),B(thread ,168),I(23,00,00,00),B(thread ,142),I(3b,01,25,00),B(thread ,19),I(23,00,00,00),B(thread ,169),I(23,00,00,00),B(thread ,141),I(3b,02,25,00),B(thread ,18),I(23,00,00,00),B(thread ,170),I(23,00,00,00),B(thread ,140),I(3b,01,25,00),B(thread ,17),I(23,00,00,00),B(thread ,171),I(23,00,00,00),B(thread ,139),I(3b,00,25,00),B(thread ,16),I(23,00,00,00),B(thread ,172),I(23,00,00,00),B(thread ,137),I(3b,01,25,00),B(thread ,15),I(23,00,00,00),B(thread ,173),I(23,00,00,00),B(thread ,136),I(3b,01,25,00),B(thread ,14),I(23,00,00,00),B(thread ,174),I(23,00,00,00),B(thread ,135),I(3b,02,25,00),B(thread ,13),I(23,00,00,00),B(thread ,175),I(23,00,00,00),B(thread ,132),I(3b,01,25,00),B(thread ,12),I(23,00,00,00),B(thread ,176),I(23,00,00,00),B(thread ,131),I(3b,fe,25,00),B(thread ,11),I(86,25,00,00),B(thread ,10),I(23,00,00,00),B(thread ,177),I(23,00,00,00),B(thread ,129),I(3b,01,25,00),B(thread ,9),I(86,25,00,00),B(thread ,8),I(86,25,00,00),B(thread ,7),I(86,25,00,00),B(thread ,6),I(86,25,00,00),B(thread ,5),I(86,25,00,00),B(thread ,4),I(86,25,00,00),B(thread ,3),I(86,25,00,00),B(thread ,2),I(23,00,00,00),B(thread ,178),I(23,00,00,00),B(thread ,128),I(3b,00,3d,00),I(00,ac,00,00)};
