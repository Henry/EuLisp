...
void initialize_module_thread()
{
  ...
  static const void *G00550[] = {I(aa,24,00,00),B(thread ,33),I(1b,1d,1c,26),I(00,00,00,03),I(1d,24,00,00),B(thread ,34),I(09,22,02,2a),I(86,89,00,00),B(thread ,33),I(2a,47,00,00),I(1c,47,00,01),I(24,00,00,00),B(boot ,9),I(3c,03,24,00),B(thread ,21),I(3d,01,02,45),I(02,00,00,00)};
