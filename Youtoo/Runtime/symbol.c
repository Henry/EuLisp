...
void initialize_module_symbol()
{
  ...
  static const void *G0010622[] = {I(ab,1c,12,1b),I(44,1a,47,00),I(00,04,1b,23),B(symbol ,9),I(1f,04,24,00),B(mop_gf ,2),I(3d,03,04,22),I(01,36,2f,1d),I(11,1f,03,10),I(1b,24,00,00),B(string ,13),I(24,00,00,00),B(convert ,2),I(3c,02,1f,04),I(1c,24,00,00),B(string ,11),I(3c,02,1f,03),I(1c,47,00,01),I(3d,02,07,22),I(04,45,03,00)};

  /* Byte-vector with size: 14 is_init: 0 index: 13 binding: (method-concatenate) */
  static const void *G0010624[] = {I(a7,46,02,1c),I(48,00,00,86),I(1b,48,00,01),I(23,00,00,00),B(symbol ,12),I(23,00,00,00),B(symbol ,11),I(3b,02,48,00),I(01,47,00,00),I(24,00,00,00),B(collect ,8),I(3c,01,1d,1c),I(47,00,01,3d),I(02,04,45,04)};
  ...
  static const void *G0010653[] = {I(a8,1b,44,05),I(1b,10,36,09),I(23,00,00,00),B(symbol ,31),I(24,00,00,00),B(symbol ,3),I(41,00,00,00),B(fpi ,7),I(22,01,1c,1c),I(24,00,00,00),B(string ,11),I(3c,02,41,00),B(boot1 ,56),I(22,01,24,00),B(symbol ,3),I(2b,1b,89,00),B(symbol ,3),I(2a,1c,45,05)};
