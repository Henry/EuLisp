...
/* Foreign functions */
static LispRef ff_stub_eul_init_symbol10611 (Stack *reg_value_stack, LispRef *sreg_value_sp, LispRef *sreg_value_sb)
{
  LispRef G0010656, res;

  POPVAL1(G0010656);
  FF_RES_CONVERT6(res,eul_init_symbol(FF_ARG_CONVERT8(G0010656)));
  return res;
}

static LispRef ff_stub_eul_init_keyword10612 (Stack *reg_value_stack, LispRef *sreg_value_sp, LispRef *sreg_value_sb)
{
  LispRef G0010657, res;

  POPVAL1(G0010657);
  FF_RES_CONVERT6(res,eul_init_keyword(FF_ARG_CONVERT8(G0010657)));
  return res;
}
...
void initialize_module_symbol()
{
  ...
  eul_intern_symbol(sym_10633,"namep");
  eul_intern_symbol(sym_10634,"(method initialize)");
  eul_intern_symbol(sym_10635,"(method namep)");
  eul_intern_symbol(sym_10636,"(method binary<)");
  eul_intern_symbol(sym_10637,"(method concatenate)");
  eul_intern_symbol(sym_10639,"converter");
  eul_intern_symbol(sym_10641,"<symbol>");
  object_class(cons_10640) = eul_static_cons_class;
  eul_car(cons_10640) = sym_10641;
  eul_cdr(cons_10640) = eul_nil;
  object_class(cons_10638) = eul_static_cons_class;
  eul_car(cons_10638) = sym_10639;
  eul_intern_symbol(sym_10642,"(method (converter <symbol>))");
  ...
  object_class(str_10649) = eul_static_string_class;
  eul_allocate_bytevector( G0010648,G0010647);
  eul_intern_symbol(sym_10652,"gensym");
  eul_intern_symbol(sym_10653,"symbol-exists?");
  eul_intern_symbol(sym_10654,"keyword?");
  eul_intern_symbol(sym_10655,"top-level");
  ...
  symbol_bindings[ 7] = (LispRef) (LispRef (*) (Stack *, LispRef *, LispRef *)) ff_stub_eul_init_symbol10611;
  symbol_bindings[ 8] = (LispRef) (LispRef (*) (Stack *, LispRef *, LispRef *)) ff_stub_eul_init_keyword10612;
  symbol_bindings[ 9] = key_10615;
  symbol_bindings[ 10] = G0010614;
  symbol_bindings[ 11] = G0010617;
  symbol_bindings[ 12] = sym_10620;
  symbol_bindings[ 13] = G0010619;
  symbol_bindings[ 14] = G0010622;
  symbol_bindings[ 15] = G0010624;
  symbol_bindings[ 16] = G0010626;
  symbol_bindings[ 17] = G0010628;
  symbol_bindings[ 18] = G0010630;
  symbol_bindings[ 19] = sym_10633;
  symbol_bindings[ 20] = sym_10634;
  symbol_bindings[ 21] = sym_10635;
  symbol_bindings[ 22] = sym_10636;
  symbol_bindings[ 23] = sym_10637;
  symbol_bindings[ 24] = sym_10639;
  symbol_bindings[ 25] = sym_10641;
  symbol_bindings[ 26] = cons_10638;
  symbol_bindings[ 27] = sym_10642;
  symbol_bindings[ 28] = G0010632;
  symbol_bindings[ 29] = G0010644;
  symbol_bindings[ 30] = G0010646;
  symbol_bindings[ 31] = str_10649;
  symbol_bindings[ 32] = G0010648;
  symbol_bindings[ 1] = eul_nil;
  symbol_bindings[ 33] = sym_10652;
  symbol_bindings[ 34] = sym_10653;
  symbol_bindings[ 35] = sym_10654;
  symbol_bindings[ 36] = sym_10655;
  eul_allocate_lambda( symbol_bindings[0], "initialize-symbol", 0, G0010651);
