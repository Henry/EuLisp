...
(definterface stream
  (import (telos stream1 stream2 socket dynamic condition lock convert collect list string fpi)
   ...
   local-literals (
    ...
    ("%s" . 65)
    ("%s" . 64)
    (|(method generic-read)| . 60)
    (|(method end-of-stream)| . 59)
    (|(method flush-buffer)| . 58)
    (|(method fill-buffer)| . 57)
    (|(method disconnect)| . 56)
    (|(method reconnect)| . 55)
    (|(method generic-connect)| . 54)
    (a . 52)
    (w . 51)
    (r . 50)
    (anonymous . 44)
