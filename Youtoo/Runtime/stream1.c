...
void initialize_module_stream1()
{
  ...
  static const void *G004757[] = {I(a9,41,00,00),B(stream1 ,14),I(1b,89,00,00),B(stream1 ,9),I(2a,24,00,00),B(stream1 ,9),I(82,02,1b,89),B(stream1 ,4),I(2a,24,00,00),B(stream1 ,9),I(83,02,1b,89),B(stream1 ,11),I(2a,24,00,00),B(stream1 ,9),I(84,02,1b,89),B(stream1 ,2),I(2a,24,00,00),B(stream1 ,9),I(8a,03,02,1b),I(89,00,00,00),B(stream1 ,7),I(2a,24,00,00),B(stream1 ,9),I(8a,04,02,1b),I(89,00,00,00),B(stream1 ,10),I(2a,24,00,00),B(stream1 ,9),I(8a,05,02,1b),I(89,00,00,00),B(stream1 ,8),I(2a,24,00,00),B(stream1 ,9),I(8a,06,02,1b),I(89,00,00,00),B(stream1 ,13),I(2a,24,00,00),B(stream1 ,9),I(8a,07,02,1b),I(89,00,00,00),B(stream1 ,12),I(2a,24,00,00),B(stream1 ,8),I(24,00,00,00),B(stream1 ,13),I(14,24,00,00),B(stream1 ,11),I(1c,14,24,00),B(stream1 ,11),I(24,00,00,00),B(stream1 ,7),I(14,24,00,00),B(stream1 ,2),I(24,00,00,00),B(stream1 ,7),I(14,23,00,00),B(stream1 ,29),I(24,00,00,00),B(stream1 ,4),I(23,00,00,00),B(stream1 ,30),I(1f,05,23,00),B(stream1 ,31),I(1f,06,23,00),B(stream1 ,32),I(24,00,00,00),B(stream1 ,2),I(23,00,00,00),B(stream1 ,33),I(24,00,00,00),B(stream1 ,2),I(23,00,00,00),B(stream1 ,34),I(1f,0b,24,00),B(boot1 ,26),I(3c,0c,1b,89),B(stream1 ,5),I(45,0e,00,00)};
