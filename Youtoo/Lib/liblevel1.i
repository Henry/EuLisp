...
(definterface level1
  (import ()
   ...
   export (
    ...
    ((name . table-fill-value) (pos . 17) (origin table1 . table-fill-value) (inline (G005418 (static-ref2) (binding-ref ? <table>) (primitive-relative-ref))))
    ...
    ((name . string-as-int) (pos . 22) (origin string . string-as-int) (class . ff) (arity . 1) (ff (3) 0 (atoi . ff_stub_atoi774)))
    ...
    ((name . table-entries) (pos . 15) (origin table1 . table-entries) (inline (G005420 (static-fpi-ref 3) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G005430 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-threshold) (pos . 12) (origin table1 . table-threshold) (inline (G005414 (static-ref0) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G005426 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ((name . table-hash-function) (pos . 11) (origin table1 . table-hash-function) (inline (G005422 (static-ref0) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G005432 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ((name . string-empty?) (pos . 7) (origin string . string-empty?) (inline (G00579 (primitive-size) (fpi-zerop))))
    ...
    ((name . table-comparator) (pos . 8) (origin table1 . table-comparator) (inline (G005424 (static-ref1) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G005434 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . string-compare) (pos . 17) (origin string . string-compare) (class . ff) (arity . 2) (ff (3 3) 0 (strcmp . ff_stub_strcmp769)))
    ...
    ((name . eul_list_as_eul_string) (pos . 20) (origin string . eul_list_as_eul_string) (class . ff) (arity . 1) (ff (8) 6 (eul_list_as_eul_string . ff_stub_eul_list_as_eul_string772)))
    ...
    ((name . vector-empty?) (pos . 16) (origin vector . vector-empty?) (inline (G004813 (primitive-size) (fpi-zerop))))
    ...
    ((name . string-data) (pos . 12) (origin string . string-data) (inline (G00577 (static-ref0) (binding-ref ? <string>) (primitive-relative-ref))) (setter (G00584 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <string>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . string-equal) (pos . 8) (origin string . string-equal) (inline (G00582 (call-foreign-function string-compare) (nobble 2) (fpi-zerop))))
    ...
    ((name . table-size) (pos . 5) (origin table1 . table-size) (inline (G005416 (static-ref1) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G005428 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
