...
(definterface level1
  (import ()
   ...
   export (
    ...
    ((name . table-fill-value) (pos . 17) (origin table1 . table-fill-value) (inline (G008399 (static-ref2) (binding-ref ? <table>) (primitive-relative-ref))))
    ...
    ((name . table-entries) (pos . 15) (origin table1 . table-entries) (inline (G008401 (static-fpi-ref 3) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G008411 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-threshold) (pos . 12) (origin table1 . table-threshold) (inline (G008395 (static-ref0) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G008407 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ((name . table-hash-function) (pos . 11) (origin table1 . table-hash-function) (inline (G008403 (static-ref0) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G008413 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-comparator) (pos . 8) (origin table1 . table-comparator) (inline (G008405 (static-ref1) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G008415 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . vector-empty?) (pos . 18) (origin vector . vector-empty?) (inline (G007760 (primitive-size) (fpi-zerop))))
    ...
    ((name . table-size) (pos . 5) (origin table1 . table-size) (inline (G008397 (static-ref1) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G008409 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
