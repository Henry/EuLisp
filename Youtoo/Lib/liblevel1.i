...
(definterface level1
  (import ()
   ...
   export (
    ...
    ((name . table-fill-value) (pos . 17) (origin table1 . table-fill-value) (inline (G00940 (static-ref2) (binding-ref ? <table>) (primitive-relative-ref))))
    ...
    ((name . table-entries) (pos . 15) (origin table1 . table-entries) (inline (G00942 (static-fpi-ref 3) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G00952 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-threshold) (pos . 12) (origin table1 . table-threshold) (inline (G00936 (static-ref0) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G00948 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ((name . table-hash-function) (pos . 11) (origin table1 . table-hash-function) (inline (G00944 (static-ref0) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G00954 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-comparator) (pos . 8) (origin table1 . table-comparator) (inline (G00946 (static-ref1) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G00956 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . vector-empty?) (pos . 18) (origin vector . vector-empty?) (inline (G00301 (primitive-size) (fpi-zerop))))
    ...
    ((name . table-size) (pos . 5) (origin table1 . table-size) (inline (G00938 (static-ref1) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G00950 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
