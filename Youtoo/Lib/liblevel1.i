...
(definterface level1
  (import ()
   ...
   export (
    ...
    ((name . table-fill-value) (pos . 17) (origin table1 . table-fill-value) (inline (G004978 (static-ref2) (binding-ref ? <table>) (primitive-relative-ref))))
    ((name . string-stream-string-list) (pos . 48) (origin stream2 . string-stream-string-list) (inline (G002412 (static-ref0) (binding-ref ? <string-stream>) (primitive-relative-ref))) (setter (G002438 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <string-stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . string-as-int) (pos . 23) (origin string . string-as-int) (class . ff) (arity . 1) (ff (3) 0 (atoi . ff_stub_atoi794)))
    ...
    ((name . table-entries) (pos . 15) (origin table1 . table-entries) (inline (G004980 (static-fpi-ref 3) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G004990 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-sink) (pos . 36) (origin stream2 . stream-sink) (inline (G002410 (static-fpi-ref 5) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G002436 (stack-ref 1) (static-fpi-ref 5) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . control-block-buffer) (pos . 32) (origin stream2 . control-block-buffer) (inline (G002392 (static-fpi-ref 3) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G002422 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-lock) (pos . 31) (origin stream2 . stream-lock) (inline (G002402 (static-ref1) (binding-ref ? <stream>) (primitive-relative-ref))))
    ...
    ((name . control-block-mode) (pos . 29) (origin stream2 . control-block-mode) (inline (G002396 (static-ref1) (binding-ref ? <file-control-block>) (primitive-relative-ref))) (setter (G002426 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <file-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . cadar) (pos . 19) (origin list . cadar) (inline (G001477 (cdar) (car))))
    ...
    ((name . table-threshold) (pos . 12) (origin table1 . table-threshold) (inline (G004974 (static-ref0) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G004986 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ((name . table-hash-function) (pos . 11) (origin table1 . table-hash-function) (inline (G004982 (static-ref0) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G004992 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ((name . string-empty?) (pos . 7) (origin string . string-empty?) (inline (G00595 (primitive-size) (fpi-zerop))))
    ((name . assoc-list-ref) (pos . 16) (origin boot . assoc-list-ref))
    ((name . cddr) (pos . 12) (origin list . cddr) (inline (G001461 (cddr))))
    ...
    ((name . table-comparator) (pos . 8) (origin table1 . table-comparator) (inline (G004984 (static-ref1) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G004994 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . string-compare) (pos . 17) (origin string . string-compare) (class . ff) (arity . 2) (ff (3 3) 0 (strcmp . ff_stub_strcmp788)))
    ...
    ((name . stream-write-action) (pos . 13) (origin stream2 . stream-write-action) (inline (G002404 (static-ref2) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G002430 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . control-block-buffer-size) (pos . 9) (origin stream2 . control-block-buffer-size) (inline (G002390 (static-ref2) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G002420 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-read-action) (pos . 8) (origin stream2 . stream-read-action) (inline (G002406 (static-fpi-ref 3) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G002432 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . cddar) (pos . 5) (origin list . cddar) (inline (G001468 (cdar) (cdr))))
    ...
    ((name . eul_list_as_eul_string) (pos . 21) (origin string . eul_list_as_eul_string) (class . ff) (arity . 1) (ff (8) 6 (eul_list_as_eul_string . ff_stub_eul_list_as_eul_string792)))
    ...
    ((name . vector-empty?) (pos . 16) (origin vector . vector-empty?) (inline (G004367 (primitive-size) (fpi-zerop))))
    ...
    ((name . cdddr) (pos . 29) (origin list . cdddr) (inline (G001483 (cddr) (cdr))))
    ...
    ((name . control-block-buffer-cnt) (pos . 47) (origin stream2 . control-block-buffer-cnt) (inline (G002386 (static-ref0) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G002416 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . string-data) (pos . 12) (origin string . string-data) (inline (G00593 (static-ref0) (binding-ref ? <string>) (primitive-relative-ref))) (setter (G00600 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <string>) (set-primitive-relative-ref) (nobble 2))))
    ((name . int?) (pos . 30) (origin boot1 . int?) (inline (G0049 (fpip))))
    ((name . control-block-descriptor) (pos . 41) (origin stream2 . control-block-descriptor) (inline (G002394 (static-ref0) (binding-ref ? <file-control-block>) (primitive-relative-ref))) (setter (G002424 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <file-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . caar) (pos . 27) (origin list . caar) (inline (G001455 (caar))))
    ...
    ((name . caaar) (pos . 24) (origin list . caaar) (inline (G001480 (caar) (car))))
    ((name . control-block-file-name) (pos . 33) (origin stream2 . control-block-file-name) (inline (G002398 (static-ref2) (binding-ref ? <file-control-block>) (primitive-relative-ref))) (setter (G002428 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <file-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ((name . cdaar) (pos . 23) (origin list . cdaar) (inline (G001474 (caar) (cdr))))
    ...
    ((name . caddr) (pos . 22) (origin list . caddr) (inline (G001463 (caddr))))
    ...
    ((name . cdadr) (pos . 21) (origin list . cdadr) (inline (G001465 (cadr) (cdr))))
    ...
    ((name . cadr) (pos . 20) (origin list . cadr) (inline (G001457 (cadr))))
    ...
    ((name . caadr) (pos . 14) (origin list . caadr) (inline (G001471 (cadr) (car))))
    ...
    ((name . string-equal) (pos . 8) (origin string . string-equal) (inline (G00598 (call-foreign-function string-compare) (nobble 2) (fpi-zerop))))
    ...
    ((name . stream-source) (pos . 22) (origin stream2 . stream-source) (inline (G002408 (static-fpi-ref 4) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G002434 (stack-ref 1) (static-fpi-ref 4) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . cadddr) (pos . 11) (origin list . cadddr) (inline (G001486 (cadddr))))
    ...
    ((name . handle) (pos . 3) (origin handler . handle) (inline (G007003 (static-ref0) (binding-ref ? <handler>) (primitive-relative-ref))) (setter (G007005 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <handler>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-mode) (pos . 17) (origin stream2 . stream-mode) (inline (G002400 (static-ref0) (binding-ref ? <stream>) (primitive-relative-ref))))
    ...
    ((name . table-size) (pos . 5) (origin table1 . table-size) (inline (G004976 (static-ref1) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G004988 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . control-block-buffer-pos) (pos . 11) (origin stream2 . control-block-buffer-pos) (inline (G002388 (static-ref1) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G002418 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . cdar) (pos . 3) (origin list . cdar) (inline (G001459 (cdar))))
