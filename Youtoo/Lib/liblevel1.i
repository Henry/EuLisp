...
(definterface level1
  (import ()
   ...
   export (
    ...
    ((name . table-fill-value) (pos . 17) (origin table1 . table-fill-value) (inline (G001066 (static-ref2) (binding-ref ? <table>) (primitive-relative-ref))))
    ...
    ((name . table-entries) (pos . 16) (origin table1 . table-entries) (inline (G001068 (static-fpi-ref 3) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G001078 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-threshold) (pos . 14) (origin table1 . table-threshold) (inline (G001062 (static-ref0) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G001074 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ((name . table-hash-function) (pos . 13) (origin table1 . table-hash-function) (inline (G001070 (static-ref0) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G001080 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-comparator) (pos . 10) (origin table1 . table-comparator) (inline (G001072 (static-ref1) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G001082 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . handle) (pos . 3) (origin handler . handle) (inline (G003091 (static-ref0) (binding-ref ? <handler>) (primitive-relative-ref))) (setter (G003093 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <handler>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-size) (pos . 4) (origin table1 . table-size) (inline (G001064 (static-ref1) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G001076 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
