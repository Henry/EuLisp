...
(definterface boot
  (import ()
   ...
   export (
    ...
    ((name . member1-list) (pos . 29) (origin boot . member1-list) (inline (G00569 (static-ref-nil) (memq))))
    ...
    ((name . getchar) (pos . 32) (origin boot . getchar) (class . ff) (arity . 0) (ff () 1 (getchar . ff_stub_getchar844)))
