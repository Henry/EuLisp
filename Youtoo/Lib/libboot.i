...
(definterface boot
  (import ()
   ...
   export (
    ...
    ((name . member1-list) (pos . 30) (origin boot . member1-list) (inline (G00571 (static-ref-nil) (memq))))
    ...
    ((name . getchar) (pos . 32) (origin boot . getchar) (class . ff) (arity . 0) (ff () 1 (getchar . ff_stub_getchar846)))
