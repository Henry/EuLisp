...
void initialize_module_mop_access()
{
  ...
  static const void *G002980[] = {I(43,04,46,01),I(1b,26,00,00),I(00,00,00,05),I(02,1b,34,00),I(00,00,00,0e),I(86,32,00,00),I(00,00,00,63),I(1f,03,1f,05),I(1f,04,24,00),B(mop_access ,7),I(3c,03,1b,48),I(00,00,1d,26),I(00,00,00,03),I(02,84,1f,07),I(86,24,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,23),I(3c,00,1d,1d),I(23,00,00,00),B(mop_access ,14),I(23,00,00,00),B(mop_access ,18),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,1f,06),I(1c,24,00,00),B(mop_meth ,8),I(3c,02,22,05),I(2a,1c,45,05)};
  ...
  static const void *G002992[] = {I(43,04,46,01),I(1b,26,00,00),I(00,00,00,05),I(02,1b,34,00),I(00,00,00,0e),I(86,32,00,00),I(00,00,00,63),I(1f,03,1f,05),I(1f,04,24,00),B(mop_access ,4),I(3c,03,1b,48),I(00,00,1d,26),I(00,00,00,03),I(02,83,1f,07),I(24,00,00,00),B(boot1 ,38),I(3c,02,24,00),B(boot1 ,23),I(3c,00,1d,1d),I(23,00,00,00),B(mop_access ,14),I(23,00,00,00),B(mop_access ,24),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,1f,06),I(1c,24,00,00),B(mop_meth ,8),I(3c,02,22,05),I(2a,1c,45,05)};
  ...
  static const void *G002998[] = {I(43,03,84,1f),I(03,24,00,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,23),I(3c,00,24,00),B(boot1 ,23),I(3c,00,23,00),B(mop_access ,14),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,54),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,45),I(07,00,00,00)};
  ...
  static const void *G003004[] = {I(43,03,83,1f),I(03,24,00,00),B(boot1 ,38),I(3c,02,24,00),B(boot1 ,23),I(3c,00,24,00),B(boot1 ,23),I(3c,00,23,00),B(mop_access ,14),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,54),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,45),I(07,00,00,00)};
