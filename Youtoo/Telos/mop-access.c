...
void initialize_module_mop_access()
{
  ...
  static const void *G002973[] = {I(43,04,46,01),I(1b,26,00,00),I(00,00,00,05),I(02,1b,34,00),I(00,00,00,0e),I(86,32,00,00),I(00,00,00,63),I(1f,03,1f,05),I(1f,04,24,00),B(mop_access ,7),I(3c,03,1b,48),I(00,00,1d,26),I(00,00,00,03),I(02,84,1f,07),I(86,24,00,00),B(boot1 ,39),I(3c,03,24,00),B(boot1 ,25),I(3c,00,1d,1d),I(23,00,00,00),B(mop_access ,15),I(23,00,00,00),B(mop_access ,19),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,1f,06),I(1c,24,00,00),B(mop_meth ,8),I(3c,02,22,05),I(2a,1c,45,05)};
  ...
  static const void *G002985[] = {I(43,04,46,01),I(1b,26,00,00),I(00,00,00,05),I(02,1b,34,00),I(00,00,00,0e),I(86,32,00,00),I(00,00,00,63),I(1f,03,1f,05),I(1f,04,24,00),B(mop_access ,4),I(3c,03,1b,48),I(00,00,1d,26),I(00,00,00,03),I(02,83,1f,07),I(24,00,00,00),B(boot1 ,39),I(3c,02,24,00),B(boot1 ,25),I(3c,00,1d,1d),I(23,00,00,00),B(mop_access ,15),I(23,00,00,00),B(mop_access ,25),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,1f,06),I(1c,24,00,00),B(mop_meth ,8),I(3c,02,22,05),I(2a,1c,45,05)};
  ...
  static const void *G002991[] = {I(43,03,84,1f),I(03,24,00,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,39),I(3c,03,24,00),B(boot1 ,25),I(3c,00,24,00),B(boot1 ,25),I(3c,00,23,00),B(mop_access ,15),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,55),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,45),I(07,00,00,00)};
  ...
  static const void *G002997[] = {I(43,03,83,1f),I(03,24,00,00),B(boot1 ,39),I(3c,02,24,00),B(boot1 ,25),I(3c,00,24,00),B(boot1 ,25),I(3c,00,23,00),B(mop_access ,15),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,55),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,45),I(07,00,00,00)};
  ...
  static const void *G003029[] = {I(aa,04,26,00),I(00,00,00,04),I(02,23,00,00),B(mop_access ,15),I(23,00,00,00),B(mop_access ,56),I(3b,01,1c,24),B(boot ,10),I(3d,02,01,00)};

  eul_allocate_static_string(str_3033, "\n  ~a = ~a", 10);
  /* Byte-vector with size: 11 is_init: 0 index: 59 binding: anonymous */
  static const void *G003031[] = {I(aa,1b,84,02),I(1c,82,02,47),I(00,01,1c,3c),I(01,1d,1c,47),I(00,00,23,00),B(mop_access ,58),I(1f,03,1f,03),I(24,00,00,00),B(boot1 ,47),I(3d,04,06,45),I(06,00,00,00)};
