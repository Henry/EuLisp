...
void initialize_module_mop_gf()
{
  ...
  eul_allocate_static_string(str_1853, "*** WARNING [level1]: ", 22);
  eul_allocate_static_string(str_1854, "\n", 1);
  /* Byte-vector with size: 15 is_init: 0 index: 19 binding: warning */
  static const void *G001851[] = {I(43,fe,84,23),B(mop_gf ,17),I(24,00,00,00),B(boot1 ,48),I(3c,02,2a,24),B(boot1 ,48),I(84,1f,03,1f),I(03,24,00,00),B(boot ,5),I(3c,04,2a,84),I(23,00,00,00),B(mop_gf ,18),I(24,00,00,00),B(boot1 ,48),I(3d,02,02,00)};

  eul_allocate_static_string(str_1857, "*** ERROR [level1]: ", 20);
  ...
  static const void *G001860[] = {I(a9,84,24,00),B(mop_class ,22),I(24,00,00,00),B(mop_class ,22),I(24,00,00,00),B(boot1 ,40),I(3c,03,24,00),B(boot1 ,25),I(3c,00,24,00),B(boot1 ,25),I(3c,00,23,00),B(mop_gf ,24),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,63),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(mop_gf ,12),I(2a,83,24,00),B(mop_class ,22),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,25),I(3c,00,24,00),B(boot1 ,25),I(3c,00,23,00),B(mop_gf ,25),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,63),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(mop_gf ,14),I(2a,84,24,00),B(mop_class ,86),I(24,00,00,00),B(mop_class ,22),I(24,00,00,00),B(boot1 ,40),I(3c,03,24,00),B(boot1 ,25),I(3c,00,24,00),B(boot1 ,25),I(3c,00,23,00),B(mop_gf ,26),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,63),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(mop_gf ,8),I(2a,24,00,00),B(mop_gf ,12),I(2a,26,00,00),I(00,00,00,22),I(24,00,00,00),B(boot1 ,40),I(3c,01,24,00),B(mop_gf ,12),I(1c,1c,26,00),I(00,00,00,08),I(1d,03,22,02),I(2a,24,00,00),B(mop_gf ,14),I(2a,24,00,00),B(mop_gf ,8),I(2a,23,00,00),B(mop_gf ,27),I(23,00,00,00),B(mop_gf ,23),I(3b,fd,89,00),B(boot ,14),I(2a,23,00,00),B(mop_gf ,28),I(23,00,00,00),B(mop_gf ,19),I(3b,fe,89,00),B(boot ,3),I(45,0d,00,00)};

  /* Byte-vector with size: 8 is_init: 0 index: 30 binding: make */
  static const void *G001867[] = {I(43,fe,1c,1c),I(24,00,00,00),B(mop_gf ,8),I(3c,02,1b,1d),I(24,00,00,00),B(mop_gf ,12),I(3d,02,03,45),I(03,00,00,00)};

  /* Byte-vector with size: 11 is_init: 0 index: 31 binding: anonymous */
  static const void *G001869[] = {I(aa,1b,47,00),I(01,1a,1b,34),I(00,00,00,1d),I(47,00,03,1d),I(86,03,2a,1c),I(83,14,47,00),I(00,3d,01,02),I(32,00,00,00),I(00,00,00,0b),I(47,00,03,45),I(02,00,00,00)};

  /* Byte-vector with size: 19 is_init: 0 index: 33 binding: gf-reset-cache */
  static const void *G001871[] = {I(aa,46,04,26),I(00,00,00,08),I(02,1b,48,00),I(03,47,00,03),I(34,00,00,00),I(00,00,00,38),I(47,00,03,06),I(1b,48,00,01),I(86,1b,48,00),I(00,23,00,00),B(mop_gf ,32),I(23,00,00,00),B(mop_gf ,31),I(3b,01,48,00),I(00,82,47,00),I(00,3d,01,03),I(22,02,32,00),I(00,00,00,07),I(86,45,01,00)};
  ...
  static const void *G001890[] = {I(43,03,46,01),I(1d,26,00,00),I(00,00,00,08),I(02,82,02,1b),I(48,00,00,1f),I(03,26,00,00),I(00,00,00,05),I(02,47,00,00),I(1c,24,00,00),B(mop_gf ,9),I(3c,02,1b,23),B(mop_gf ,32),I(23,00,00,00),B(mop_gf ,42),I(3b,02,24,00),B(boot ,16),I(3d,02,06,45),I(06,00,00,00)};
  ...
  static const void *G001896[] = {I(aa,1b,47,00),I(03,1a,1b,34),I(00,00,00,31),I(47,00,00,1d),I(02,47,00,01),I(1f,03,02,50),I(1b,34,00,00),I(00,00,00,17),I(1d,83,14,47),I(00,02,3d,01),I(03,32,00,00),I(00,00,00,08),I(86,22,01,32),I(00,00,00,06),I(87,45,02,00)};
  ...
  static const void *G001900[] = {I(aa,1b,47,00),I(03,1a,1b,34),I(00,00,00,51),I(47,00,01,1d),I(02,1b,34,00),I(00,00,00,36),I(47,00,00,1f),I(03,02,1b,1d),I(24,00,00,00),B(mop_inspect ,11),I(3c,02,1b,34),I(00,00,00,15),I(1f,04,83,14),I(47,00,02,3d),I(01,05,32,00),I(00,00,00,07),I(86,22,02,32),I(00,00,00,0e),I(1d,83,14,47),I(00,02,3d,01),I(03,22,01,32),I(00,00,00,06),I(87,45,02,00)};
  ...
  static const void *G001904[] = {I(aa,1b,10,47),I(00,00,1c,50),I(1b,34,00,00),I(00,00,00,0f),I(87,32,00,00),I(00,00,00,26),I(47,00,01,1d),I(50,1b,34,00),I(00,00,00,0e),I(86,32,00,00),I(00,00,00,10),I(1f,03,11,47),I(00,02,3d,01),I(04,22,01,45),I(03,00,00,00)};

  /* Byte-vector with size: 31 is_init: 0 index: 51 binding: anonymous */
  static const void *G001906[] = {I(aa,46,03,1b),I(47,01,04,1a),I(1b,34,00,00),I(00,00,00,6f),I(47,01,00,1d),I(02,47,01,01),I(1f,03,02,1c),I(48,00,00,1b),I(48,00,01,47),I(00,00,47,00),I(01,50,1b,34),I(00,00,00,15),I(1f,04,83,14),I(47,01,03,3d),I(01,05,32,00),I(00,00,00,37),I(86,1b,48,00),I(02,23,00,00),B(mop_gf ,32),I(23,00,00,00),B(mop_gf ,50),I(3b,01,48,00),I(02,47,01,02),I(1f,06,02,1b),I(26,00,00,00),I(00,00,00,06),I(02,47,00,02),I(3d,01,07,22),I(02,22,03,32),I(00,00,00,06),I(87,45,02,00)};
