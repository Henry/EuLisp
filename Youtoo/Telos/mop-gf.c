...
void initialize_module_mop_gf()
{
  ...
  static const void *G001852[] = {I(a9,84,24,00),B(mop_class ,20),I(24,00,00,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,41),I(3c,03,24,00),B(boot1 ,26),I(3c,00,24,00),B(boot1 ,26),I(3c,00,23,00),B(mop_gf ,25),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,55),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(mop_gf ,12),I(2a,83,24,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,41),I(3c,02,24,00),B(boot1 ,26),I(3c,00,24,00),B(boot1 ,26),I(3c,00,23,00),B(mop_gf ,26),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,55),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(mop_gf ,14),I(2a,84,24,00),B(mop_class ,75),I(24,00,00,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,41),I(3c,03,24,00),B(boot1 ,26),I(3c,00,24,00),B(boot1 ,26),I(3c,00,23,00),B(mop_gf ,27),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,55),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(mop_gf ,8),I(2a,84,24,00),B(mop_class ,20),I(24,00,00,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,41),I(3c,03,24,00),B(boot1 ,26),I(3c,00,24,00),B(boot1 ,26),I(3c,00,23,00),B(mop_gf ,28),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,55),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(mop_gf ,17),I(2a,24,00,00),B(mop_gf ,12),I(2a,26,00,00),I(00,00,00,22),I(24,00,00,00),B(boot1 ,41),I(3c,01,24,00),B(mop_gf ,12),I(1c,1c,26,00),I(00,00,00,08),I(1d,03,22,02),I(2a,24,00,00),B(mop_gf ,14),I(2a,24,00,00),B(mop_gf ,8),I(2a,24,00,00),B(mop_gf ,17),I(2a,23,00,00),B(mop_gf ,29),I(23,00,00,00),B(mop_gf ,24),I(3b,fe,89,00),B(boot ,13),I(2a,23,00,00),B(mop_gf ,30),I(23,00,00,00),B(mop_gf ,20),I(3b,fe,89,00),B(boot ,3),I(45,11,00,00)};
  ...
  static const void *G001893[] = {I(aa,1b,47,00),I(03,1a,1b,34),I(00,00,00,51),I(47,00,01,1d),I(02,1b,34,00),I(00,00,00,36),I(47,00,00,1f),I(03,02,1b,1d),I(24,00,00,00),B(mop_inspect ,11),I(3c,02,1b,34),I(00,00,00,15),I(1f,04,83,14),I(47,00,02,3d),I(01,05,32,00),I(00,00,00,07),I(86,22,02,32),I(00,00,00,0e),I(1d,83,14,47),I(00,02,3d,01),I(03,22,01,32),I(00,00,00,06),I(87,45,02,00)};
  ...
  static const void *G001903[] = {I(ab,1c,82,02),I(24,00,00,00),B(mop_inspect ,5),I(1d,24,00,00),B(boot ,10),I(3c,02,23,00),B(mop_gf ,55),I(1d,1f,04,1f),I(03,24,00,00),B(boot ,12),I(3d,04,04,45),I(04,00,00,00)};
