...
void initialize_module_mop_gf0()
{
  ...
  static const void *G00169[] = {I(aa,1b,7a,12),I(1b,34,00,00),I(00,00,00,17),I(23,00,00,00),B(mop_gf0 ,6),I(32,00,00,00),I(00,00,00,0a),I(1c,73,45,02)};
  ...
  static const void *G00203[] = {I(aa,1b,7a,12),I(1b,34,00,00),I(00,00,00,0f),I(86,32,00,00),I(00,00,00,1a),I(1c,10,1d,11),I(1b,24,00,00),B(mop_gf0 ,4),I(3c,01,1d,1c),I(0f,22,03,45),I(02,00,00,00)};

  /* Byte-vector with size: 8 is_init: 0 index: 32 binding: anonymous */
  static const void *G00205[] = {I(aa,1b,7a,12),I(1b,34,00,00),I(00,00,00,17),I(23,00,00,00),B(mop_gf0 ,6),I(32,00,00,00),I(00,00,00,0a),I(1c,73,45,02)};
  ...
  static const void *G00207[] = {I(43,fe,23,00),B(mop_gf0 ,8),I(1c,23,00,00),B(mop_gf0 ,9),I(24,00,00,00),B(mop_key ,2),I(3c,03,23,00),B(mop_gf0 ,10),I(1d,23,00,00),B(mop_gf0 ,11),I(24,00,00,00),B(mop_key ,2),I(3c,03,23,00),B(mop_gf0 ,12),I(1f,03,86,24),B(mop_key ,2),I(3c,03,23,00),B(mop_gf0 ,24),I(1f,04,23,00),B(mop_gf0 ,13),I(24,00,00,00),B(mop_key ,2),I(3c,03,1f,05),I(24,00,00,00),B(mop_gf0 ,4),I(3c,01,23,00),B(mop_gf0 ,13),I(23,00,00,00),B(mop_gf0 ,32),I(3b,01,1c,24),B(collect ,2),I(3c,02,24,00),B(symbol ,6),I(3c,00,1f,03),I(86,0f,23,00),B(mop_gf0 ,20),I(1c,0f,1f,03),I(24,00,00,00),B(collect ,9),I(3c,01,1b,1f),I(05,0f,23,00),B(mop_gf0 ,21),I(1c,0f,23,00),B(mop_gf0 ,22),I(1f,0a,0f,1f),I(0d,23,00,00),B(mop_gf0 ,33),I(24,00,00,00),B(mop_key ,3),I(3c,02,23,00),B(mop_gf0 ,22),I(1c,0f,1b,86),I(0f,1f,03,1c),I(0f,1f,0f,1c),I(0f,1f,11,1c),I(0f,1f,07,1c),I(0f,1f,0b,1c),I(0f,23,00,00),B(mop_gf0 ,26),I(1c,0f,1b,86),I(0f,1f,10,1c),I(0f,1b,86,0f),I(1f,12,1f,1a),I(24,00,00,00),B(mop_gf0 ,3),I(3c,02,1f,13),I(86,0f,1c,1c),I(24,00,00,00),B(boot ,11),I(3c,02,1f,03),I(1c,0f,23,00),B(mop_gf0 ,34),I(1c,0f,45,1f)};

  /* Byte-vector with size: 32 is_init: 1 index: 0 binding: initialize-mop-gf0 */
  static const void *G00215[] = {I(87,25,00,00),B(mop_gf0 ,1),I(24,00,00,00),B(level1 ,1),I(3e,0b,24,00),B(level1 ,0),I(3c,00,21,01),I(23,00,00,00),B(mop_gf0 ,36),I(23,00,00,00),B(mop_gf0 ,35),I(3b,fe,25,00),B(mop_gf0 ,5),I(23,00,00,00),B(mop_gf0 ,37),I(23,00,00,00),B(mop_gf0 ,31),I(3b,01,25,00),B(mop_gf0 ,4),I(23,00,00,00),B(mop_gf0 ,38),I(23,00,00,00),B(mop_gf0 ,30),I(3b,02,25,00),B(mop_gf0 ,3),I(23,00,00,00),B(mop_gf0 ,39),I(23,00,00,00),B(mop_gf0 ,28),I(3b,fd,25,00),B(mop_gf0 ,2),I(86,ac,00,00)};
