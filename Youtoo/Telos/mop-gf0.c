...
void initialize_module_mop_gf0()
{
  ...
  static const void *G00172[] = {I(43,fd,23,00),B(mop_gf0 ,8),I(1c,23,00,00),B(mop_gf0 ,9),I(24,00,00,00),B(mop_key ,2),I(3c,03,23,00),B(mop_gf0 ,10),I(1d,23,00,00),B(mop_gf0 ,11),I(24,00,00,00),B(mop_key ,2),I(3c,03,23,00),B(mop_gf0 ,12),I(1f,03,86,24),B(mop_key ,2),I(3c,03,1f,04),I(24,00,00,00),B(mop_gf0 ,4),I(3c,01,23,00),B(mop_gf0 ,13),I(23,00,00,00),B(mop_gf0 ,7),I(3b,01,1c,24),B(boot ,10),I(3c,02,1f,07),I(1f,08,7c,1b),I(34,00,00,00),I(00,00,00,18),I(23,00,00,00),B(mop_gf0 ,14),I(32,00,00,00),I(00,00,00,8e),I(1f,09,7a,1b),I(34,00,00,00),I(00,00,00,18),I(1f,0a,10,23),B(mop_gf0 ,15),I(50,32,00,00),I(00,00,00,08),I(86,1b,34,00),I(00,00,00,1a),I(1f,0b,73,1b),I(20,05,23,00),B(mop_gf0 ,16),I(22,01,32,00),I(00,00,00,52),I(1f,0b,7a,1b),I(34,00,00,00),I(00,00,00,18),I(1f,0c,10,23),B(mop_gf0 ,17),I(50,32,00,00),I(00,00,00,08),I(86,1b,34,00),I(00,00,00,1a),I(1f,0d,73,1b),I(20,07,23,00),B(mop_gf0 ,18),I(22,01,32,00),I(00,00,00,18),I(86,23,00,00),B(mop_gf0 ,19),I(1f,0f,24,00),B(boot ,12),I(3c,03,22,02),I(22,02,1f,0a),I(86,0f,23,00),B(mop_gf0 ,20),I(1c,0f,1f,05),I(24,00,00,00),B(collect ,9),I(3c,01,1b,1f),I(07,0f,23,00),B(mop_gf0 ,21),I(1c,0f,23,00),B(mop_gf0 ,22),I(1f,0b,0f,1f),I(0e,23,00,00),B(mop_gf0 ,25),I(24,00,00,00),B(mop_key ,3),I(3c,02,23,00),B(mop_gf0 ,22),I(1c,0f,1b,86),I(0f,1f,03,1c),I(0f,1f,10,1c),I(0f,1f,12,1c),I(0f,1f,07,1c),I(0f,1f,0b,1c),I(0f,23,00,00),B(mop_gf0 ,26),I(1c,0f,1b,86),I(0f,1f,12,1c),I(0f,1f,11,1c),I(0f,1f,1c,1f),I(1b,24,00,00),B(mop_gf0 ,3),I(3c,02,1f,1d),I(86,0f,1c,1c),I(24,00,00,00),B(boot ,7),I(3c,02,1f,03),I(1c,0f,23,00),B(mop_gf0 ,27),I(1c,0f,45,21)};
  ...
  static const void *G00207[] = {I(43,fe,23,00),B(mop_gf0 ,8),I(1c,23,00,00),B(mop_gf0 ,9),I(24,00,00,00),B(mop_key ,2),I(3c,03,23,00),B(mop_gf0 ,10),I(1d,23,00,00),B(mop_gf0 ,11),I(24,00,00,00),B(mop_key ,2),I(3c,03,23,00),B(mop_gf0 ,12),I(1f,03,86,24),B(mop_key ,2),I(3c,03,23,00),B(mop_gf0 ,24),I(1f,04,23,00),B(mop_gf0 ,13),I(24,00,00,00),B(mop_key ,2),I(3c,03,1f,05),I(24,00,00,00),B(mop_gf0 ,4),I(3c,01,23,00),B(mop_gf0 ,13),I(23,00,00,00),B(mop_gf0 ,32),I(3b,01,1c,24),B(collect ,2),I(3c,02,24,00),B(symbol ,6),I(3c,00,1f,03),I(86,0f,23,00),B(mop_gf0 ,20),I(1c,0f,1f,03),I(24,00,00,00),B(collect ,9),I(3c,01,1b,1f),I(05,0f,23,00),B(mop_gf0 ,21),I(1c,0f,23,00),B(mop_gf0 ,22),I(1f,0a,0f,1f),I(0d,23,00,00),B(mop_gf0 ,33),I(24,00,00,00),B(mop_key ,3),I(3c,02,23,00),B(mop_gf0 ,22),I(1c,0f,1b,86),I(0f,1f,03,1c),I(0f,1f,0f,1c),I(0f,1f,11,1c),I(0f,1f,07,1c),I(0f,1f,0b,1c),I(0f,23,00,00),B(mop_gf0 ,26),I(1c,0f,1b,86),I(0f,1f,10,1c),I(0f,1b,86,0f),I(1f,12,1f,1a),I(24,00,00,00),B(mop_gf0 ,3),I(3c,02,1f,13),I(86,0f,1c,1c),I(24,00,00,00),B(boot ,7),I(3c,02,1f,03),I(1c,0f,23,00),B(mop_gf0 ,34),I(1c,0f,45,1f)};
