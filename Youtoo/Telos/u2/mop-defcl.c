...
void initialize_module_mop_defcl()
{
  ...
  static const void *G002069[] = {I(aa,1b,84,02),I(10,1b,8a,03),I(02,1d,1c,24),B(boot ,18),I(3c,02,1d,1c),I(1c,8a,03,1d),I(03,22,02,2a),I(24,00,00,00),B(mop_init ,2),I(3c,00,2a,1f),I(03,45,04,00)};

  /* Byte-vector with size: 5 is_init: 0 index: 42 binding: (method-add-subclass) */
  static const void *G002071[] = {I(ab,1c,8a,03),I(02,1c,1c,0f),I(1f,03,1c,1c),I(8a,03,1d,03),I(45,06,00,00)};
  ...
  static const void *G002090[] = {I(aa,46,01,1b),I(48,00,00,47),I(00,00,8a,0c),I(1a,1b,44,0f),I(24,00,00,00),B(mop_defcl ,5),I(47,00,00,02),I(36,11,23,00),B(mop_defcl ,53),I(23,00,00,00),B(mop_defcl ,56),I(3b,02,45,02)};
  ...
  static const void *G002094[] = {I(aa,46,01,1b),I(48,00,00,47),I(00,00,8a,0c),I(1a,1b,44,0f),I(24,00,00,00),B(mop_defcl ,2),I(47,00,00,02),I(36,11,23,00),B(mop_defcl ,53),I(23,00,00,00),B(mop_defcl ,58),I(3b,01,45,02)};

  /* Byte-vector with size: 16 is_init: 0 index: 60 binding: slot-value */
  static const void *G002096[] = {I(ab,1c,04,1b),I(04,24,00,00),B(mop_inspect ,6),I(3c,01,1b,44),I(11,1f,03,1f),I(03,24,00,00),B(mop_inspect ,10),I(3d,02,04,36),I(1d,1f,03,04),I(1b,1f,04,24),B(mop_defcl ,9),I(3c,02,1b,1f),I(06,24,00,00),B(mop_defcl ,11),I(3d,02,06,22),I(02,45,04,00)};
  ...
  static const void *G002098[] = {I(aa,1b,12,1b),I(44,18,86,23),B(mop_defcl ,61),I(47,00,01,47),I(00,00,24,00),B(boot ,13),I(3d,04,02,36),I(1c,1c,10,1b),I(84,02,1b,47),I(00,01,50,1b),I(44,04,1d,36),I(0a,1f,04,11),I(47,00,02,3d),I(01,05,22,03),I(45,02,00,00)};

  /* Byte-vector with size: 13 is_init: 0 index: 63 binding: find-slot */
  static const void *G002101[] = {I(ab,46,03,1c),I(48,00,00,1b),I(48,00,01,86),I(1b,48,00,02),I(23,00,00,00),B(mop_defcl ,53),I(23,00,00,00),B(mop_defcl ,62),I(3b,01,48,00),I(02,47,00,00),I(8a,04,02,47),I(00,02,3d,01),I(03,45,03,00)};

  /* Byte-vector with size: 16 is_init: 0 index: 64 binding: anonymous */
  static const void *G002103[] = {I(43,04,1f,03),I(12,1b,44,0e),I(1c,24,00,00),B(boot ,28),I(3d,01,05,36),I(29,1f,04,10),I(1f,04,10,1c),I(1f,05,1d,24),B(mop_defcl ,13),I(3c,03,1f,07),I(11,1f,07,11),I(1f,07,83,14),I(1f,03,1f,08),I(0f,47,00,00),I(3d,04,08,22),I(03,45,05,00)};

  /* Byte-vector with size: 13 is_init: 0 index: 65 binding: make-slotds */
  static const void *G002105[] = {I(43,fd,46,01),I(86,1b,48,00),I(00,23,00,00),B(mop_defcl ,53),I(23,00,00,00),B(mop_defcl ,64),I(3b,04,48,00),I(00,1c,44,05),I(1c,10,36,02),I(82,1f,04,1f),I(04,1d,86,47),I(00,00,3d,04),I(05,45,05,00)};

  /* Byte-vector with size: 30 is_init: 0 index: 67 binding: primitive-make-slot */
  static const void *G002107[] = {I(43,03,24,00),B(mop_class ,59),I(8a,06,01,1b),I(1f,04,1c,84),I(1d,03,22,02),I(2a,1f,03,82),I(02,1b,41,00),B(boot1 ,57),I(22,01,1d,1c),I(1c,8a,03,1d),I(03,22,02,2a),I(1f,03,23,00),B(mop_defcl ,66),I(50,1f,03,1c),I(1c,8a,05,1d),I(03,22,02,2a),I(1f,03,1f,05),I(1c,8a,04,1d),I(03,22,02,2a),I(1f,05,24,00),B(mop_defcl ,6),I(3c,01,1f,04),I(1c,1c,82,1d),I(03,22,02,2a),I(1f,06,24,00),B(mop_defcl ,3),I(3c,01,1f,05),I(1c,1c,83,1d),I(03,22,02,2a),I(1f,05,45,09)};
