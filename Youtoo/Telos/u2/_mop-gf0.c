...
void initialize_module__mop_gf0()
{
  ...
  static const void *G00351[] = {I(aa,1b,7a,12),I(1b,44,08,23),B(_mop_gf0 ,6),I(36,03,1c,73),I(45,02,00,00)};
  ...
  static const void *G00354[] = {I(43,fd,23,00),B(_mop_gf0 ,8),I(1c,23,00,00),B(_mop_gf0 ,9),I(24,00,00,00),B(mop_key ,2),I(3c,03,23,00),B(_mop_gf0 ,10),I(1d,23,00,00),B(_mop_gf0 ,11),I(24,00,00,00),B(mop_key ,2),I(3c,03,23,00),B(_mop_gf0 ,12),I(1f,03,86,24),B(mop_key ,2),I(3c,03,1f,04),I(24,00,00,00),B(_mop_gf0 ,4),I(3c,01,23,00),B(_mop_gf0 ,13),I(23,00,00,00),B(_mop_gf0 ,7),I(3b,01,1c,24),B(boot ,11),I(3c,02,1f,07),I(1f,08,7c,1b),I(44,09,23,00),B(_mop_gf0 ,14),I(36,65,1f,09),I(7a,1b,44,0c),I(1f,0a,10,23),B(_mop_gf0 ,15),I(50,36,02,86),I(1b,44,12,1f),I(0b,73,1b,20),I(05,23,00,00),B(_mop_gf0 ,16),I(22,01,36,3d),I(1f,0b,7a,1b),I(44,0e,1f,0c),I(10,23,00,00),B(_mop_gf0 ,17),I(50,36,02,86),I(1b,44,12,1f),I(0d,73,1b,20),I(07,23,00,00),B(_mop_gf0 ,18),I(22,01,36,13),I(86,23,00,00),B(_mop_gf0 ,19),I(1f,0f,24,00),B(boot ,13),I(3c,03,22,02),I(22,02,1f,0a),I(86,0f,23,00),B(_mop_gf0 ,20),I(1c,0f,1f,05),I(24,00,00,00),B(collect ,9),I(3c,01,1b,1f),I(07,0f,23,00),B(_mop_gf0 ,21),I(1c,0f,23,00),B(_mop_gf0 ,22),I(1f,0b,0f,1f),I(0e,23,00,00),B(_mop_gf0 ,25),I(24,00,00,00),B(mop_key ,3),I(3c,02,23,00),B(_mop_gf0 ,22),I(1c,0f,1b,86),I(0f,1f,03,1c),I(0f,1f,10,1c),I(0f,1f,12,1c),I(0f,1f,07,1c),I(0f,1f,0b,1c),I(0f,23,00,00),B(_mop_gf0 ,26),I(1c,0f,1b,86),I(0f,1f,12,1c),I(0f,1f,11,1c),I(0f,1f,1c,1f),I(1b,24,00,00),B(_mop_gf0 ,3),I(3c,02,1f,1d),I(86,0f,1c,1c),I(24,00,00,00),B(boot ,8),I(3c,02,1f,03),I(1c,0f,23,00),B(_mop_gf0 ,27),I(1c,0f,45,21)};

  /* Byte-vector with size: 20 is_init: 0 index: 30 binding: do-defgeneric-methods */
  static const void *G00382[] = {I(ab,1b,12,1b),I(44,04,86,36),I(43,1c,10,23),B(_mop_gf0 ,23),I(50,1b,44,26),I(1d,73,1f,04),I(1c,0f,23,00),B(_mop_gf0 ,29),I(1c,0f,1f,05),I(75,1f,07,1c),I(24,00,00,00),B(_mop_gf0 ,3),I(3c,02,1d,1c),I(0f,22,05,36),I(11,1d,75,1f),I(04,1c,24,00),B(_mop_gf0 ,3),I(3d,02,05,22),I(01,22,01,45),I(03,00,00,00)};

  /* Byte-vector with size: 8 is_init: 0 index: 31 binding: required-args */
  static const void *G00385[] = {I(aa,1b,7a,12),I(1b,44,04,86),I(36,12,1c,10),I(1d,11,1b,24),B(_mop_gf0 ,4),I(3c,01,1d,1c),I(0f,22,03,45),I(02,00,00,00)};

  /* Byte-vector with size: 5 is_init: 0 index: 32 binding: anonymous */
  static const void *G00387[] = {I(aa,1b,7a,12),I(1b,44,08,23),B(_mop_gf0 ,6),I(36,03,1c,73),I(45,02,00,00)};
  ...
  static const void *G00389[] = {I(a7,23,00,00),B(_mop_gf0 ,8),I(1c,23,00,00),B(_mop_gf0 ,9),I(24,00,00,00),B(mop_key ,2),I(3c,03,23,00),B(_mop_gf0 ,10),I(1d,23,00,00),B(_mop_gf0 ,11),I(24,00,00,00),B(mop_key ,2),I(3c,03,23,00),B(_mop_gf0 ,12),I(1f,03,86,24),B(mop_key ,2),I(3c,03,23,00),B(_mop_gf0 ,24),I(1f,04,23,00),B(_mop_gf0 ,13),I(24,00,00,00),B(mop_key ,2),I(3c,03,1f,05),I(24,00,00,00),B(_mop_gf0 ,4),I(3c,01,23,00),B(_mop_gf0 ,13),I(23,00,00,00),B(_mop_gf0 ,32),I(3b,01,1c,24),B(collect ,2),I(3c,02,24,00),B(symbol ,6),I(3c,00,1f,03),I(86,0f,23,00),B(_mop_gf0 ,20),I(1c,0f,1f,03),I(24,00,00,00),B(collect ,9),I(3c,01,1b,1f),I(05,0f,23,00),B(_mop_gf0 ,21),I(1c,0f,23,00),B(_mop_gf0 ,22),I(1f,0a,0f,1f),I(0d,23,00,00),B(_mop_gf0 ,33),I(24,00,00,00),B(mop_key ,3),I(3c,02,23,00),B(_mop_gf0 ,22),I(1c,0f,1b,86),I(0f,1f,03,1c),I(0f,1f,0f,1c),I(0f,1f,11,1c),I(0f,1f,07,1c),I(0f,1f,0b,1c),I(0f,23,00,00),B(_mop_gf0 ,26),I(1c,0f,1b,86),I(0f,1f,10,1c),I(0f,1b,86,0f),I(1f,12,1f,1a),I(24,00,00,00),B(_mop_gf0 ,3),I(3c,02,1f,13),I(86,0f,1c,1c),I(24,00,00,00),B(boot ,8),I(3c,02,1f,03),I(1c,0f,23,00),B(_mop_gf0 ,34),I(1c,0f,45,1f)};

  /* Byte-vector with size: 32 is_init: 1 index: 0 binding: initialize-_mop-gf0 */
  static const void *G00397[] = {I(87,25,00,00),B(_mop_gf0 ,1),I(24,00,00,00),B(level_1 ,1),I(3e,0b,24,00),B(level_1 ,0),I(3c,00,21,01),I(23,00,00,00),B(_mop_gf0 ,36),I(23,00,00,00),B(_mop_gf0 ,35),I(3b,fe,25,00),B(_mop_gf0 ,5),I(23,00,00,00),B(_mop_gf0 ,37),I(23,00,00,00),B(_mop_gf0 ,31),I(3b,01,25,00),B(_mop_gf0 ,4),I(23,00,00,00),B(_mop_gf0 ,38),I(23,00,00,00),B(_mop_gf0 ,30),I(3b,02,25,00),B(_mop_gf0 ,3),I(23,00,00,00),B(_mop_gf0 ,39),I(23,00,00,00),B(_mop_gf0 ,28),I(3b,fd,25,00),B(_mop_gf0 ,2),I(86,ac,00,00)};
