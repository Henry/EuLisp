...
void initialize_module__mop_meth0()
{
  ...
  static const void *G00420[] = {I(43,fe,23,00),B(_mop_meth0 ,22),I(1c,24,00,00),B(_mop_meth0 ,9),I(3c,01,1d,24),B(_mop_meth0 ,8),I(3c,01,1f,03),I(24,00,00,00),B(_mop_meth0 ,7),I(3c,01,1d,23),B(_mop_meth0 ,23),I(24,00,00,00),B(mop_key ,3),I(3c,02,23,00),B(_mop_meth0 ,12),I(1f,04,1f,06),I(24,00,00,00),B(mop_key ,2),I(3c,03,1f,03),I(24,00,00,00),B(_mop_meth0 ,2),I(3c,01,1f,04),I(24,00,00,00),B(_mop_meth0 ,4),I(3c,01,1d,1f),I(08,50,1b,34),I(00,00,00,1d),I(1f,0a,86,0f),I(23,00,00,00),B(_mop_meth0 ,24),I(1c,0f,22,01),I(32,00,00,00),I(00,00,00,0a),I(1f,03,1d,24),B(collect ,9),I(3c,01,1b,1f),I(04,0f,23,00),B(_mop_meth0 ,15),I(1c,0f,1f,06),I(1f,0a,0f,1f),I(0f,1c,0f,23),B(_mop_meth0 ,25),I(1c,0f,23,00),B(_mop_meth0 ,17),I(1f,0c,0f,1f),I(12,86,0f,23),B(_mop_meth0 ,26),I(1c,0f,1b,86),I(0f,1f,03,1c),I(0f,23,00,00),B(_mop_meth0 ,27),I(1c,0f,1b,86),I(0f,1f,07,1c),I(0f,1f,0b,1c),I(0f,1f,0f,1c),I(0f,23,00,00),B(_mop_meth0 ,18),I(1c,0f,1b,86),I(0f,1f,1d,1c),I(0f,23,00,00),B(_mop_meth0 ,28),I(1c,0f,45,1f)};

  /* Byte-vector with size: 7 is_init: 0 index: 32 binding: method-function-lambda */
  static const void *G00430[] = {I(43,fe,23,00),B(_mop_meth0 ,30),I(1c,0f,1b,86),I(0f,1f,03,1c),I(0f,23,00,00),B(_mop_meth0 ,31),I(1c,0f,45,05)};

  /* Byte-vector with size: 10 is_init: 0 index: 33 binding: defmethod-body */
  static const void *G00434[] = {I(aa,1b,10,7a),I(12,1b,34,00),I(00,00,00,1e),I(1c,11,1b,11),I(24,00,00,00),B(_mop_meth0 ,7),I(3d,01,03,22),I(01,32,00,00),I(00,00,00,09),I(1c,11,45,02)};

  /* Byte-vector with size: 10 is_init: 0 index: 34 binding: defmethod-sig */
  static const void *G00436[] = {I(aa,1b,10,7a),I(12,1b,34,00),I(00,00,00,1e),I(1c,11,1b,11),I(24,00,00,00),B(_mop_meth0 ,8),I(3d,01,03,22),I(01,32,00,00),I(00,00,00,09),I(1c,10,45,02)};

  /* Byte-vector with size: 14 is_init: 0 index: 35 binding: defmethod-keywords */
  static const void *G00438[] = {I(aa,1b,10,7a),I(12,1b,34,00),I(00,00,00,2e),I(1c,10,1d,11),I(1b,10,1f,04),I(11,1b,11,1b),I(24,00,00,00),B(_mop_meth0 ,9),I(3c,01,1f,03),I(1c,0f,1f,06),I(1c,0f,22,07),I(32,00,00,00),I(00,00,00,09),I(86,45,02,00)};

  /* Byte-vector with size: 11 is_init: 0 index: 38 binding: named-method-function-lambda */
  static const void *G00440[] = {I(43,fd,1d,86),I(0f,23,00,00),B(_mop_meth0 ,36),I(1c,0f,23,00),B(_mop_meth0 ,30),I(1f,03,0f,1b),I(86,0f,1f,05),I(1c,0f,1f,03),I(1c,0f,23,00),B(_mop_meth0 ,37),I(1c,0f,45,09)};

  /* Byte-vector with size: 62 is_init: 1 index: 0 binding: initialize-_mop-meth0 */
  static const void *G00444[] = {I(87,25,00,00),B(_mop_meth0 ,1),I(24,00,00,00),B(level_1 ,1),I(3e,0b,24,00),B(level_1 ,0),I(3c,00,21,01),I(23,00,00,00),B(_mop_meth0 ,25),I(23,00,00,00),B(_mop_meth0 ,38),I(3b,fd,25,00),B(_mop_meth0 ,10),I(23,00,00,00),B(_mop_meth0 ,39),I(23,00,00,00),B(_mop_meth0 ,35),I(3b,01,25,00),B(_mop_meth0 ,9),I(23,00,00,00),B(_mop_meth0 ,40),I(23,00,00,00),B(_mop_meth0 ,34),I(3b,01,25,00),B(_mop_meth0 ,8),I(23,00,00,00),B(_mop_meth0 ,41),I(23,00,00,00),B(_mop_meth0 ,33),I(3b,01,25,00),B(_mop_meth0 ,7),I(23,00,00,00),B(_mop_meth0 ,16),I(23,00,00,00),B(_mop_meth0 ,32),I(3b,fe,25,00),B(_mop_meth0 ,6),I(23,00,00,00),B(_mop_meth0 ,42),I(23,00,00,00),B(_mop_meth0 ,29),I(3b,fe,25,00),B(_mop_meth0 ,5),I(23,00,00,00),B(_mop_meth0 ,43),I(23,00,00,00),B(_mop_meth0 ,20),I(3b,01,25,00),B(_mop_meth0 ,4),I(23,00,00,00),B(_mop_meth0 ,44),I(23,00,00,00),B(_mop_meth0 ,19),I(3b,ff,25,00),B(_mop_meth0 ,3),I(23,00,00,00),B(_mop_meth0 ,45),I(23,00,00,00),B(_mop_meth0 ,11),I(3b,01,25,00),B(_mop_meth0 ,2),I(86,ac,00,00)};
  ...
  _mop_meth0_bindings[ 11] = G00408;
  _mop_meth0_bindings[ 12] = key_412;
  _mop_meth0_bindings[ 13] = cons_411;
  _mop_meth0_bindings[ 14] = sym_413;
  _mop_meth0_bindings[ 15] = sym_414;
  _mop_meth0_bindings[ 16] = sym_415;
  _mop_meth0_bindings[ 17] = sym_416;
  _mop_meth0_bindings[ 18] = sym_417;
  _mop_meth0_bindings[ 19] = G00410;
  _mop_meth0_bindings[ 20] = G00419;
  _mop_meth0_bindings[ 21] = sym_423;
  _mop_meth0_bindings[ 22] = cons_422;
  _mop_meth0_bindings[ 23] = cons_424;
  _mop_meth0_bindings[ 24] = sym_425;
  _mop_meth0_bindings[ 25] = sym_426;
  _mop_meth0_bindings[ 26] = sym_427;
  _mop_meth0_bindings[ 27] = sym_428;
  _mop_meth0_bindings[ 28] = sym_429;
  _mop_meth0_bindings[ 29] = G00421;
  _mop_meth0_bindings[ 30] = sym_432;
  _mop_meth0_bindings[ 31] = sym_433;
  _mop_meth0_bindings[ 32] = G00431;
  _mop_meth0_bindings[ 33] = G00435;
  _mop_meth0_bindings[ 34] = G00437;
  _mop_meth0_bindings[ 35] = G00439;
  _mop_meth0_bindings[ 36] = sym_442;
  _mop_meth0_bindings[ 37] = sym_443;
  _mop_meth0_bindings[ 38] = G00441;
  _mop_meth0_bindings[ 1] = eul_nil;
  _mop_meth0_bindings[ 39] = sym_446;
  _mop_meth0_bindings[ 40] = sym_447;
  _mop_meth0_bindings[ 41] = sym_448;
  _mop_meth0_bindings[ 42] = sym_449;
  _mop_meth0_bindings[ 43] = sym_450;
  _mop_meth0_bindings[ 44] = sym_451;
  _mop_meth0_bindings[ 45] = sym_452;
  eul_allocate_lambda( _mop_meth0_bindings[0], "initialize-_mop-meth0", 0, G00445);
