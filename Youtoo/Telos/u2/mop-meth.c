...
void initialize_module_mop_meth()
{
  ...
  static const void *G001661[] = {I(ab,1c,1c,37),I(02,2a,23,00),B(mop_meth ,20),I(1c,86,24,00),B(mop_key ,2),I(3c,03,1b,44),I(10,1b,1f,03),I(24,00,00,00),B(mop_meth ,8),I(3c,02,36,02),I(86,2a,1d,45),I(03,00,00,00)};
  ...
  static const void *G001670[] = {I(aa,1b,83,02),I(1c,8a,05,02),I(1d,1d,1d,24),B(mop_meth ,7),I(3c,03,1f,03),I(1f,03,1d,1f),I(04,24,00,00),B(mop_meth ,12),I(3c,04,1f,04),I(1d,1c,8a,06),I(1d,03,22,02),I(2a,1f,04,1c),I(1c,8a,07,1d),I(03,22,02,2a),I(1f,04,24,00),B(mop_gf ,3),I(3c,01,2a,1f),I(04,45,05,00)};

  /* Byte-vector with size: 16 is_init: 0 index: 27 binding: (method-remove-method) */
  static const void *G001672[] = {I(ab,1c,8a,05),I(02,1c,1c,86),I(6c,1b,44,2f),I(1d,1d,24,00),B(boot ,18),I(3c,02,1f,04),I(1c,1c,8a,05),I(1d,03,22,02),I(2a,1f,03,86),I(1c,82,1d,03),I(22,02,2a,1f),I(04,24,00,00),B(mop_meth ,13),I(3c,01,22,01),I(36,02,86,2a),I(1f,03,45,04)};
  ...
  static const void *G001705[] = {I(ab,1c,04,24),B(mop_class ,16),I(50,1b,44,0c),I(1c,04,24,00),B(mop_class ,63),I(50,36,02,86),I(1b,44,0f,1f),I(03,1f,03,24),B(mop_meth ,2),I(3d,02,04,36),I(0f,1f,03,1f),I(03,24,00,00),B(mop_meth ,8),I(3d,02,04,45),I(04,00,00,00)};

  /* Byte-vector with size: 12 is_init: 0 index: 53 binding: anonymous */
  static const void *G001707[] = {I(aa,1b,12,1b),I(44,04,86,36),I(23,1c,10,1b),I(83,02,1b,47),I(00,00,24,00),B(mop_gf ,10),I(3c,02,1b,44),I(04,1d,36,0a),I(1f,04,11,47),I(00,01,3d,01),I(05,22,03,45),I(02,00,00,00)};

  /* Byte-vector with size: 12 is_init: 0 index: 54 binding: primitive-find-method */
  static const void *G001709[] = {I(ab,46,02,1b),I(48,00,00,86),I(1b,48,00,01),I(23,00,00,00),B(mop_meth ,24),I(23,00,00,00),B(mop_meth ,53),I(3b,01,48,00),I(01,1d,8a,05),I(02,47,00,01),I(3d,01,03,45),I(03,00,00,00)};

  /* Byte-vector with size: 16 is_init: 0 index: 55 binding: primitive-remove-method */
  static const void *G001711[] = {I(ab,1c,8a,05),I(02,1c,1c,86),I(6c,1b,44,2f),I(1d,1d,24,00),B(boot ,18),I(3c,02,1f,04),I(1c,1c,8a,05),I(1d,03,22,02),I(2a,1f,03,86),I(1c,82,1d,03),I(22,02,2a,1f),I(04,24,00,00),B(mop_gf ,3),I(3c,01,22,01),I(36,02,86,2a),I(1f,03,45,04)};
