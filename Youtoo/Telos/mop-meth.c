...
void initialize_module_mop_meth()
{
  ...
  static const void *G002218[] = {I(ab,46,01,1c),I(48,00,00,47),I(00,00,1c,37),I(02,2a,23,00),B(mop_meth ,23),I(1c,86,24,00),B(mop_key ,2),I(3c,03,23,00),B(mop_meth ,24),I(23,00,00,00),B(mop_meth ,22),I(3b,01,1c,24),B(boot ,16),I(3c,02,2a,47),I(00,00,24,00),B(mop_meth ,13),I(3c,01,2a,47),I(00,00,45,03)};
  ...
  static const void *G002257[] = {I(ab,1c,04,24),B(mop_class ,15),I(50,1b,34,00),I(00,00,00,16),I(1c,04,24,00),B(mop_class ,55),I(50,32,00,00),I(00,00,00,08),I(86,1b,34,00),I(00,00,00,1a),I(1f,03,1f,03),I(24,00,00,00),B(mop_meth ,2),I(3d,02,04,32),I(00,00,00,14),I(1f,03,1f,03),I(24,00,00,00),B(mop_meth ,8),I(3d,02,04,45),I(04,00,00,00)};
