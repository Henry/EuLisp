...
void initialize_module_mop_meth()
{
  ...
  static const void *G002213[] = {I(ab,1c,1c,37),I(02,2a,23,00),B(mop_meth ,20),I(1c,86,24,00),B(mop_key ,2),I(3c,03,1b,34),I(00,00,00,15),I(1b,1f,03,24),B(mop_meth ,8),I(3c,02,32,00),I(00,00,00,07),I(86,2a,1d,45),I(03,00,00,00)};
  ...
  static const void *G002228[] = {I(ab,1b,1d,24),B(mop_meth ,4),I(3c,02,2a,1b),I(04,1d,26,00),I(00,00,00,03),I(02,24,00,00),B(mop_inspect ,2),I(3c,02,1b,34),I(00,00,00,0d),I(86,32,00,00),I(00,00,00,1f),I(1d,82,02,1d),I(04,23,00,00),B(mop_meth ,29),I(1d,1d,24,00),B(boot ,13),I(3c,03,22,02),I(2a,1c,83,02),I(1f,03,1c,24),B(mop_meth ,10),I(3c,02,1b,34),I(00,00,00,15),I(1f,04,1c,24),B(mop_meth ,6),I(3c,02,32,00),I(00,00,00,07),I(86,2a,1f,04),I(26,00,00,00),I(00,00,00,05),I(02,1f,04,1c),I(0f,1f,06,1c),I(1c,26,00,00),I(00,00,00,05),I(1d,03,22,02),I(2a,1f,05,1f),I(07,1c,82,1d),I(03,22,02,2a),I(1f,06,24,00),B(mop_meth ,13),I(3c,01,2a,1f),I(06,45,07,00)};

  /* Byte-vector with size: 380 is_init: 0 index: 44 binding: top-level */
  static const void *G002231[] = {I(a9,84,24,00),B(mop_class ,51),I(24,00,00,00),B(mop_class ,25),I(24,00,00,00),B(boot1 ,40),I(3c,03,24,00),B(boot1 ,25),I(3c,00,24,00),B(boot1 ,25),I(3c,00,23,00),B(mop_meth ,31),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,63),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(mop_meth ,8),I(2a,84,24,00),B(mop_class ,51),I(24,00,00,00),B(mop_class ,22),I(24,00,00,00),B(boot1 ,40),I(3c,03,24,00),B(boot1 ,25),I(3c,00,24,00),B(boot1 ,25),I(3c,00,23,00),B(mop_meth ,32),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,63),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(mop_meth ,10),I(2a,84,24,00),B(mop_class ,51),I(24,00,00,00),B(mop_class ,25),I(24,00,00,00),B(boot1 ,40),I(3c,03,24,00),B(boot1 ,25),I(3c,00,24,00),B(boot1 ,25),I(3c,00,23,00),B(mop_meth ,33),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,63),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(mop_meth ,6),I(2a,83,24,00),B(mop_class ,51),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,25),I(3c,00,24,00),B(boot1 ,25),I(3c,00,23,00),B(mop_meth ,34),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,63),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(mop_meth ,13),I(2a,26,00,00),I(00,00,00,03),I(24,00,00,00),B(mop_class ,51),I(24,00,00,00),B(mop_class ,22),I(24,00,00,00),B(mop_class ,22),I(24,00,00,00),B(boot1 ,40),I(3c,04,24,00),B(boot1 ,25),I(3c,00,24,00),B(boot1 ,25),I(3c,00,23,00),B(mop_meth ,35),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,63),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(mop_meth ,7),I(2a,26,00,00),I(00,00,00,04),I(24,00,00,00),B(mop_class ,51),I(24,00,00,00),B(mop_class ,22),I(24,00,00,00),B(mop_class ,22),I(24,00,00,00),B(mop_class ,22),I(24,00,00,00),B(boot1 ,40),I(3c,05,24,00),B(boot1 ,25),I(3c,00,24,00),B(boot1 ,25),I(3c,00,23,00),B(mop_meth ,36),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,63),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(mop_meth ,12),I(2a,24,00,00),B(mop_meth ,8),I(2a,24,00,00),B(mop_meth ,8),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(mop_class ,51),I(24,00,00,00),B(mop_class ,25),I(24,00,00,00),B(boot1 ,40),I(3c,03,24,00),B(boot1 ,25),I(3c,00,24,00),B(mop_meth ,8),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,8),I(3c,02,1f,04),I(1f,04,23,00),B(mop_meth ,37),I(23,00,00,00),B(mop_meth ,30),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(mop_meth ,8),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(mop_meth ,10),I(2a,24,00,00),B(mop_meth ,10),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(mop_class ,51),I(86,24,00,00),B(boot1 ,40),I(3c,03,24,00),B(boot1 ,25),I(3c,00,24,00),B(mop_meth ,10),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,8),I(3c,02,1f,04),I(1f,04,23,00),B(mop_meth ,38),I(23,00,00,00),B(mop_meth ,28),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(mop_meth ,10),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(mop_meth ,6),I(2a,24,00,00),B(mop_meth ,6),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(mop_class ,51),I(24,00,00,00),B(mop_class ,25),I(24,00,00,00),B(boot1 ,40),I(3c,03,24,00),B(boot1 ,25),I(3c,00,24,00),B(mop_meth ,6),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,8),I(3c,02,1f,04),I(1f,04,23,00),B(mop_meth ,39),I(23,00,00,00),B(mop_meth ,27),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(mop_meth ,6),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(mop_meth ,13),I(2a,24,00,00),B(mop_meth ,13),I(26,00,00,00),I(00,00,00,03),I(02,83,24,00),B(mop_class ,51),I(24,00,00,00),B(boot1 ,40),I(3c,02,24,00),B(boot1 ,25),I(3c,00,24,00),B(mop_meth ,13),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,8),I(3c,02,1f,04),I(1f,04,23,00),B(mop_meth ,40),I(23,00,00,00),B(mop_meth ,26),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(mop_meth ,13),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(mop_gf ,12),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(mop_class ,51),I(86,24,00,00),B(boot1 ,40),I(3c,03,24,00),B(boot1 ,25),I(3c,00,24,00),B(mop_gf ,12),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,8),I(3c,02,1f,04),I(1f,04,23,00),B(mop_meth ,41),I(23,00,00,00),B(mop_meth ,25),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(mop_gf ,12),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(mop_gf ,12),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(mop_class ,25),I(86,24,00,00),B(boot1 ,40),I(3c,03,24,00),B(boot1 ,25),I(3c,00,24,00),B(mop_gf ,12),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,8),I(3c,02,1f,04),I(1f,04,23,00),B(mop_meth ,41),I(23,00,00,00),B(mop_meth ,21),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(mop_gf ,12),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(mop_meth ,7),I(2a,24,00,00),B(mop_meth ,7),I(26,00,00,00),I(00,00,00,03),I(02,26,00,00),I(00,00,00,03),I(24,00,00,00),B(mop_class ,51),I(86,86,24,00),B(boot1 ,40),I(3c,04,24,00),B(boot1 ,25),I(3c,00,24,00),B(mop_meth ,7),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,8),I(3c,02,1f,04),I(1f,04,23,00),B(mop_meth ,42),I(23,00,00,00),B(mop_meth ,19),I(3b,03,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(mop_meth ,7),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(mop_meth ,12),I(2a,24,00,00),B(mop_meth ,12),I(26,00,00,00),I(00,00,00,03),I(02,26,00,00),I(00,00,00,04),I(24,00,00,00),B(mop_class ,51),I(86,86,86,24),B(boot1 ,40),I(3c,05,24,00),B(boot1 ,25),I(3c,00,24,00),B(mop_meth ,12),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,8),I(3c,02,1f,04),I(1f,04,23,00),B(mop_meth ,43),I(23,00,00,00),B(mop_meth ,16),I(3b,04,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(mop_meth ,12),I(1c,24,00,00),B(mop_meth ,5),I(3d,02,48,45),I(48,00,00,00)};

  /* Byte-vector with size: 27 is_init: 0 index: 45 binding: primitive-add-method */
  static const void *G002246[] = {I(ab,1b,1d,24),B(mop_meth ,4),I(3c,02,2a,1b),I(83,02,1d,1c),I(24,00,00,00),B(mop_meth ,9),I(3c,02,1b,34),I(00,00,00,15),I(1f,03,1c,24),B(mop_meth ,11),I(3c,02,32,00),I(00,00,00,07),I(86,2a,1f,03),I(26,00,00,00),I(00,00,00,05),I(02,1f,03,1c),I(0f,1f,05,1c),I(1c,26,00,00),I(00,00,00,05),I(1d,03,22,02),I(2a,1f,04,1f),I(06,1c,82,1d),I(03,22,02,2a),I(1f,05,24,00),B(mop_gf ,3),I(3c,01,2a,1f),I(05,45,06,00)};

  /* Byte-vector with size: 38 is_init: 0 index: 48 binding: make-method */
  static const void *G002248[] = {I(43,04,1f,03),I(24,00,00,00),B(mop_class ,63),I(50,1b,34,00),I(00,00,00,26),I(1d,24,00,00),B(mop_inspect ,8),I(3c,01,1b,34),I(00,00,00,0d),I(1d,12,32,00),I(00,00,00,07),I(86,22,01,32),I(00,00,00,06),I(86,1b,34,00),I(00,00,00,36),I(24,00,00,00),B(mop_class ,63),I(26,00,00,00),I(00,00,00,03),I(01,1b,1f,06),I(1c,83,1d,03),I(22,02,2a,1b),I(1f,05,1c,84),I(1d,03,22,02),I(2a,1b,22,01),I(32,00,00,00),I(00,00,00,2f),I(24,00,00,00),B(mop_gf ,2),I(1f,06,23,00),B(mop_meth ,46),I(1f,07,23,00),B(mop_meth ,47),I(1f,08,1f,08),I(24,00,00,00),B(boot ,5),I(3d,07,06,45),I(06,00,00,00)};

  /* Byte-vector with size: 34 is_init: 0 index: 49 binding: anonymous */
  static const void *G002252[] = {I(aa,1b,47,00),I(02,1a,1b,34),I(00,00,00,7d),I(47,00,01,1d),I(02,1b,34,00),I(00,00,00,0e),I(1b,32,00,00),I(00,00,00,0f),I(24,00,00,00),B(mop_class ,22),I(47,00,03,1f),I(04,02,1b,34),I(00,00,00,2d),I(1c,1c,24,00),B(mop_inspect ,11),I(3c,02,1b,34),I(00,00,00,15),I(1f,05,83,14),I(47,00,00,3d),I(01,06,32,00),I(00,00,00,07),I(86,22,01,32),I(00,00,00,24),I(1c,24,00,00),B(mop_class ,22),I(50,1b,34,00),I(00,00,00,12),I(47,00,01,1f),I(06,86,03,32),I(00,00,00,06),I(86,22,01,22),I(03,32,00,00),I(00,00,00,08),I(87,45,02,00)};
  ...
  static const void *G002257[] = {I(ab,1c,04,24),B(mop_class ,16),I(50,1b,34,00),I(00,00,00,16),I(1c,04,24,00),B(mop_class ,63),I(50,32,00,00),I(00,00,00,08),I(86,1b,34,00),I(00,00,00,1a),I(1f,03,1f,03),I(24,00,00,00),B(mop_meth ,2),I(3d,02,04,32),I(00,00,00,14),I(1f,03,1f,03),I(24,00,00,00),B(mop_meth ,8),I(3d,02,04,45),I(04,00,00,00)};

  /* Byte-vector with size: 17 is_init: 0 index: 53 binding: anonymous */
  static const void *G002259[] = {I(aa,1b,12,1b),I(34,00,00,00),I(00,00,00,10),I(86,32,00,00),I(00,00,00,32),I(1c,10,1b,83),I(02,1b,47,00),I(00,24,00,00),B(mop_gf ,10),I(3c,02,1b,34),I(00,00,00,0d),I(1d,32,00,00),I(00,00,00,10),I(1f,04,11,47),I(00,01,3d,01),I(05,22,03,45),I(02,00,00,00)};

  /* Byte-vector with size: 13 is_init: 0 index: 54 binding: primitive-find-method */
  static const void *G002261[] = {I(ab,46,02,1b),I(48,00,00,86),I(1b,48,00,01),I(23,00,00,00),B(mop_meth ,24),I(23,00,00,00),B(mop_meth ,53),I(3b,01,48,00),I(01,1d,26,00),I(00,00,00,05),I(02,47,00,01),I(3d,01,03,45),I(03,00,00,00)};

  /* Byte-vector with size: 21 is_init: 0 index: 55 binding: primitive-remove-method */
  static const void *G002263[] = {I(ab,1c,26,00),I(00,00,00,05),I(02,1c,1c,86),I(6c,1b,34,00),I(00,00,00,3e),I(1d,1d,24,00),B(boot ,18),I(3c,02,1f,04),I(1c,1c,26,00),I(00,00,00,05),I(1d,03,22,02),I(2a,1f,03,86),I(1c,82,1d,03),I(22,02,2a,1f),I(04,24,00,00),B(mop_gf ,3),I(3c,01,22,01),I(32,00,00,00),I(00,00,00,09),I(86,2a,1f,03),I(45,04,00,00)};
