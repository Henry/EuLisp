...
void initialize_module_mop_inspect()
{
  ...
  static const void *G001583[] = {I(43,03,1d,04),I(1b,8a,04,02),I(1c,1f,04,1d),I(82,24,00,00),B(mop_inspect ,7),I(3c,04,1f,05),I(1c,1f,05,03),I(45,06,00,00)};

  /* Byte-vector with size: 24 is_init: 0 index: 17 binding: top-level */
  static const void *G001585[] = {I(a9,24,00,00),B(mop_class ,81),I(24,00,00,00),B(mop_class ,86),I(24,00,00,00),B(mop_class ,27),I(24,00,00,00),B(mop_class ,86),I(24,00,00,00),B(boot1 ,26),I(3c,04,1b,89),B(mop_inspect ,14),I(2a,24,00,00),B(boot1 ,42),I(24,00,00,00),B(boot1 ,42),I(3c,01,24,00),B(mop_inspect ,10),I(23,00,00,00),B(mop_inspect ,16),I(23,00,00,00),B(mop_inspect ,15),I(3b,03,1d,3d),I(02,02,45,02)};

  /* Byte-vector with size: 11 is_init: 0 index: 18 binding: anonymous */
  static const void *G001588[] = {I(aa,1b,12,1b),I(44,04,86,36),I(21,1c,10,1b),I(47,00,01,24),B(mop_inspect ,2),I(3c,02,1b,44),I(06,47,00,00),I(36,0a,1f,03),I(11,47,00,02),I(3d,01,04,22),I(02,45,02,00)};

  /* Byte-vector with size: 26 is_init: 0 index: 20 binding: subclass? */
  static const void *G001590[] = {I(ab,46,03,1c),I(48,00,00,1b),I(48,00,01,47),I(00,00,47,00),I(01,50,1b,44),I(04,87,36,4d),I(47,00,00,8a),I(09,02,47,00),I(01,8a,09,02),I(1c,44,04,1b),I(36,02,86,1b),I(44,10,1d,1d),I(24,00,00,00),B(mop_inspect ,9),I(3d,02,06,36),I(26,86,1b,48),I(00,02,23,00),B(mop_inspect ,19),I(23,00,00,00),B(mop_inspect ,18),I(3b,01,48,00),I(02,47,00,00),I(84,02,47,00),I(02,3d,01,07),I(22,01,22,03),I(45,03,00,00)};

  /* Byte-vector with size: 7 is_init: 0 index: 21 binding: generic-function? */
  static const void *G001593[] = {I(aa,1b,04,24),B(mop_class ,51),I(24,00,00,00),B(mop_inspect ,2),I(3c,02,1b,44),I(04,1c,36,02),I(86,45,02,00)};

  /* Byte-vector with size: 7 is_init: 0 index: 22 binding: class? */
  static const void *G001595[] = {I(aa,1b,04,24),B(mop_class ,86),I(24,00,00,00),B(mop_inspect ,2),I(3c,02,1b,44),I(04,1c,36,02),I(86,45,02,00)};
  ...
  static const void *G001604[] = {I(aa,1b,04,24),B(mop_class ,32),I(24,00,00,00),B(mop_inspect ,2),I(3c,02,1b,44),I(04,1c,36,02),I(86,45,02,00)};

  /* Byte-vector with size: 8 is_init: 0 index: 28 binding: subcode? */
  static const void *G001606[] = {I(ab,1c,10,1c),I(10,1a,1b,44),I(04,86,36,10),I(1c,11,1f,03),I(11,1a,1b,44),I(04,86,36,02),I(87,22,01,45),I(03,00,00,00)};

  /* Byte-vector with size: 7 is_init: 0 index: 29 binding: primitive-slot-value */
  static const void *G001608[] = {I(ab,1c,04,1b),I(8a,04,02,1c),I(1f,03,1d,82),I(24,00,00,00),B(mop_inspect ,7),I(3c,04,1f,04),I(1c,02,45,05)};

  /* Byte-vector with size: 15 is_init: 0 index: 30 binding: cpl-subclass? */
  static const void *G001610[] = {I(ab,1c,1c,50),I(1b,44,04,87),I(36,2e,1d,8a),I(09,02,1d,8a),I(09,02,1c,44),I(04,1b,36,02),I(86,1b,44,0e),I(1d,1d,24,00),B(mop_inspect ,9),I(3d,02,06,36),I(0d,1f,05,8a),I(06,02,1f,05),I(1c,86,6c,22),I(01,22,03,45),I(03,00,00,00)};

  /* Byte-vector with size: 7 is_init: 0 index: 31 binding: methodp */
  static const void *G001612[] = {I(aa,1b,04,24),B(mop_class ,25),I(24,00,00,00),B(mop_inspect ,2),I(3c,02,1b,44),I(04,1c,36,02),I(86,45,02,00)};

  /* Byte-vector with size: 7 is_init: 0 index: 32 binding: slotp */
  static const void *G001614[] = {I(aa,1b,04,24),B(mop_class ,57),I(24,00,00,00),B(mop_inspect ,2),I(3c,02,1b,44),I(04,1c,36,02),I(86,45,02,00)};
