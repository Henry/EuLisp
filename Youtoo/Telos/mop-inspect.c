...
void initialize_module_mop_inspect()
{
  ...
  static const void *G001593[] = {I(aa,1b,04,24),B(mop_class ,51),I(24,00,00,00),B(mop_inspect ,2),I(3c,02,1b,34),I(00,00,00,0d),I(1c,32,00,00),I(00,00,00,08),I(86,45,02,00)};

  /* Byte-vector with size: 9 is_init: 0 index: 22 binding: class? */
  static const void *G001595[] = {I(aa,1b,04,24),B(mop_class ,86),I(24,00,00,00),B(mop_inspect ,2),I(3c,02,1b,34),I(00,00,00,0d),I(1c,32,00,00),I(00,00,00,08),I(86,45,02,00)};
  ...
  static const void *G001604[] = {I(aa,1b,04,24),B(mop_class ,32),I(24,00,00,00),B(mop_inspect ,2),I(3c,02,1b,34),I(00,00,00,0d),I(1c,32,00,00),I(00,00,00,08),I(86,45,02,00)};
  ...
  static const void *G001612[] = {I(aa,1b,04,24),B(mop_class ,25),I(24,00,00,00),B(mop_inspect ,2),I(3c,02,1b,34),I(00,00,00,0d),I(1c,32,00,00),I(00,00,00,08),I(86,45,02,00)};

  /* Byte-vector with size: 9 is_init: 0 index: 32 binding: slotp */
  static const void *G001614[] = {I(aa,1b,04,24),B(mop_class ,57),I(24,00,00,00),B(mop_inspect ,2),I(3c,02,1b,34),I(00,00,00,0d),I(1c,32,00,00),I(00,00,00,08),I(86,45,02,00)};
