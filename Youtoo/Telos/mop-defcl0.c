...
void initialize_module_mop_defcl0()
{
  ...
  static const void *G001157[] = {I(43,03,1d,12),I(1b,34,00,00),I(00,00,00,0f),I(1c,32,00,00),I(00,00,00,36),I(1f,03,11,1f),I(03,11,1f,05),I(10,1f,05,10),I(1c,1c,24,00),B(boot1 ,25),I(3c,02,1f,06),I(1c,24,00,00),B(boot ,11),I(3c,02,1f,05),I(1f,05,1d,47),I(00,00,3d,03),I(0a,22,06,45),I(04,00,00,00)};
  ...
  static const void *G001166[] = {I(aa,1b,82,02),I(1b,82,0b,27),I(3c,50,1b,34),I(00,00,00,25),I(1c,06,1b,2c),I(1f,03,83,1d),I(24,00,00,00),B(string ,6),I(3c,03,41,00),B(boot1 ,53),I(22,03,32,00),I(00,00,00,07),I(1d,45,03,00)};
