...
void initialize_module_mop_defcl0()
{
  ...
  static const void *G001128[] = {I(43,fb,1f,04),I(24,00,00,00),B(mop_defcl0 ,10),I(3c,01,1f,04),I(86,0f,23,00),B(mop_defcl0 ,38),I(1c,0f,1b,86),I(0f,1f,08,1c),I(0f,23,00,00),B(mop_defcl0 ,39),I(1c,0f,23,00),B(mop_defcl0 ,40),I(86,0f,23,00),B(mop_defcl0 ,41),I(1c,0f,23,00),B(mop_defcl0 ,42),I(86,0f,1f,0d),I(1c,0f,1d,1c),I(0f,1f,0a,86),I(0f,23,00,00),B(mop_defcl0 ,14),I(1c,0f,1f,0f),I(7b,1b,34,00),I(00,00,00,0e),I(1f,10,32,00),I(00,00,00,10),I(1f,10,24,00),B(boot1 ,25),I(3c,01,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,0f),I(23,00,00,00),B(mop_defcl0 ,44),I(23,00,00,00),B(mop_defcl0 ,16),I(1c,0f,1f,12),I(24,00,00,00),B(mop_defcl0 ,2),I(3c,01,23,00),B(mop_defcl0 ,16),I(1c,0f,23,00),B(mop_defcl0 ,45),I(1f,14,86,24),B(mop_key ,2),I(3c,03,1f,15),I(24,00,00,00),B(mop_defcl0 ,6),I(3c,01,1c,1c),I(24,00,00,00),B(boot ,7),I(3c,02,1b,86),I(0f,23,00,00),B(mop_defcl0 ,14),I(1c,0f,1f,18),I(23,00,00,00),B(mop_defcl0 ,50),I(24,00,00,00),B(mop_key ,3),I(3c,02,1c,1c),I(0f,23,00,00),B(mop_defcl0 ,51),I(1c,0f,1f,08),I(1c,0f,23,00),B(mop_defcl0 ,52),I(1c,0f,1f,0c),I(1c,0f,23,00),B(mop_defcl0 ,53),I(1c,0f,1f,12),I(1c,0f,23,00),B(mop_defcl0 ,15),I(1c,0f,23,00),B(mop_defcl0 ,16),I(1c,0f,1b,86),I(0f,1f,27,1c),I(0f,23,00,00),B(mop_defcl0 ,54),I(1c,0f,1f,29),I(1f,27,24,00),B(mop_defcl0 ,12),I(3c,02,1f,2a),I(1f,27,24,00),B(mop_defcl0 ,8),I(3c,02,1f,2b),I(1f,28,24,00),B(mop_defcl0 ,9),I(3c,02,1f,2c),I(1f,29,24,00),B(mop_defcl0 ,13),I(3c,02,1f,2d),I(86,0f,1c,1c),I(24,00,00,00),B(boot ,7),I(3c,02,1f,03),I(1c,24,00,00),B(boot ,7),I(3c,02,1f,05),I(1c,24,00,00),B(boot ,7),I(3c,02,1f,07),I(1c,24,00,00),B(boot ,7),I(3c,02,1f,09),I(1c,0f,1f,24),I(1c,0f,1f,2a),I(1c,0f,23,00),B(mop_defcl0 ,55),I(1c,0f,45,36)};
  ...
  static const void *G001165[] = {I(43,03,1d,12),I(1b,34,00,00),I(00,00,00,0f),I(1c,32,00,00),I(00,00,00,36),I(1f,03,11,1f),I(03,11,1f,05),I(10,1f,05,10),I(1c,1c,24,00),B(boot1 ,25),I(3c,02,1f,06),I(1c,24,00,00),B(boot ,7),I(3c,02,1f,05),I(1f,05,1d,47),I(00,00,3d,03),I(0a,22,06,45),I(04,00,00,00)};
  ...
  static const void *G001174[] = {I(aa,1b,82,02),I(1b,82,0b,27),I(3c,50,1b,34),I(00,00,00,25),I(1c,06,1b,2c),I(1f,03,83,1d),I(24,00,00,00),B(string ,6),I(3c,03,41,00),B(boot1 ,54),I(22,03,32,00),I(00,00,00,07),I(1d,45,03,00)};
  ...
  static const void *G001176[] = {I(43,fc,1f,03),I(24,00,00,00),B(mop_defcl0 ,10),I(3c,01,23,00),B(mop_defcl0 ,47),I(1d,23,00,00),B(mop_defcl0 ,42),I(24,00,00,00),B(mop_key ,2),I(3c,03,1c,86),I(0f,23,00,00),B(mop_defcl0 ,14),I(1c,0f,1f,06),I(7b,1b,34,00),I(00,00,00,0e),I(1f,07,32,00),I(00,00,00,10),I(1f,07,24,00),B(boot1 ,25),I(3c,01,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,0f),I(23,00,00,00),B(mop_defcl0 ,73),I(23,00,00,00),B(mop_defcl0 ,16),I(1c,0f,1f,09),I(24,00,00,00),B(mop_defcl0 ,2),I(3c,01,23,00),B(mop_defcl0 ,16),I(1c,0f,23,00),B(mop_defcl0 ,45),I(1f,0b,86,24),B(mop_key ,2),I(3c,03,1f,0c),I(24,00,00,00),B(mop_defcl0 ,6),I(3c,01,1c,1c),I(24,00,00,00),B(boot ,7),I(3c,02,1b,86),I(0f,23,00,00),B(mop_defcl0 ,14),I(1c,0f,1f,0f),I(23,00,00,00),B(mop_defcl0 ,74),I(24,00,00,00),B(mop_key ,3),I(3c,02,1c,1c),I(0f,23,00,00),B(mop_defcl0 ,51),I(1c,0f,1f,08),I(1c,0f,23,00),B(mop_defcl0 ,52),I(1c,0f,1f,0c),I(1c,0f,23,00),B(mop_defcl0 ,53),I(1c,0f,1f,12),I(1c,0f,23,00),B(mop_defcl0 ,15),I(1c,0f,1f,16),I(1c,0f,23,00),B(mop_defcl0 ,69),I(1c,0f,1b,86),I(0f,1f,1e,1c),I(0f,23,00,00),B(mop_defcl0 ,39),I(1c,0f,1f,20),I(1f,1f,24,00),B(mop_defcl0 ,12),I(3c,02,1f,21),I(1f,1f,24,00),B(mop_defcl0 ,8),I(3c,02,1f,22),I(1f,20,24,00),B(mop_defcl0 ,9),I(3c,02,1f,23),I(1f,21,24,00),B(mop_defcl0 ,13),I(3c,02,1f,24),I(86,0f,1c,1c),I(24,00,00,00),B(boot ,7),I(3c,02,1f,03),I(1c,24,00,00),B(boot ,7),I(3c,02,1f,05),I(1c,24,00,00),B(boot ,7),I(3c,02,1f,07),I(1c,24,00,00),B(boot ,7),I(3c,02,1f,09),I(1c,0f,23,00),B(mop_defcl0 ,55),I(1c,0f,45,2b)};
  ...
  static const void *G001186[] = {I(ab,46,02,1c),I(48,00,00,86),I(1b,48,00,01),I(23,00,00,00),B(mop_defcl0 ,58),I(23,00,00,00),B(mop_defcl0 ,76),I(3b,03,48,00),I(01,1c,24,00),B(boot ,18),I(3c,01,1b,2c),I(1f,03,86,1d),I(47,00,01,3d),I(03,05,45,05)};
  ...
  static const void *G001194[] = {I(87,25,00,00),B(mop_defcl0 ,1),I(24,00,00,00),B(level1 ,1),I(3e,0b,24,00),B(level1 ,0),I(3c,00,21,01),I(23,00,00,00),B(mop_defcl0 ,83),I(23,00,00,00),B(mop_defcl0 ,82),I(3b,02,25,00),B(mop_defcl0 ,13),I(23,00,00,00),B(mop_defcl0 ,84),I(23,00,00,00),B(mop_defcl0 ,77),I(3b,02,25,00),B(mop_defcl0 ,12),I(23,00,00,00),B(mop_defcl0 ,85),I(23,00,00,00),B(mop_defcl0 ,75),I(3b,fc,25,00),B(mop_defcl0 ,11),I(23,00,00,00),B(mop_defcl0 ,86),I(23,00,00,00),B(mop_defcl0 ,72),I(3b,01,25,00),B(mop_defcl0 ,10),I(23,00,00,00),B(mop_defcl0 ,87),I(23,00,00,00),B(mop_defcl0 ,71),I(3b,02,25,00),B(mop_defcl0 ,9),I(23,00,00,00),B(mop_defcl0 ,88),I(23,00,00,00),B(mop_defcl0 ,65),I(3b,02,25,00),B(mop_defcl0 ,8),I(23,00,00,00),B(mop_defcl0 ,89),I(23,00,00,00),B(mop_defcl0 ,62),I(3b,fb,25,00),B(mop_defcl0 ,7),I(23,00,00,00),B(mop_defcl0 ,90),I(23,00,00,00),B(mop_defcl0 ,59),I(3b,01,25,00),B(mop_defcl0 ,6),I(23,00,00,00),B(mop_defcl0 ,91),I(23,00,00,00),B(mop_defcl0 ,56),I(3b,fb,25,00),B(mop_defcl0 ,5),I(23,00,00,00),B(mop_defcl0 ,92),I(23,00,00,00),B(mop_defcl0 ,37),I(3b,04,25,00),B(mop_defcl0 ,4),I(23,00,00,00),B(mop_defcl0 ,93),I(23,00,00,00),B(mop_defcl0 ,27),I(3b,04,25,00),B(mop_defcl0 ,3),I(23,00,00,00),B(mop_defcl0 ,94),I(23,00,00,00),B(mop_defcl0 ,26),I(3b,01,25,00),B(mop_defcl0 ,2),I(86,ac,00,00)};
