...
void initialize_module_mop_defcl0()
{
  ...
  static const void *G001166[] = {I(aa,1b,82,02),I(1b,82,0b,27),I(3c,50,1b,34),I(00,00,00,25),I(1c,06,1b,2c),I(1f,03,83,1d),I(24,00,00,00),B(string ,6),I(3c,03,41,00),B(boot1 ,56),I(22,03,32,00),I(00,00,00,07),I(1d,45,03,00)};
