...
void initialize_module_mop_alloc()
{
  ...
  static const void *G003402[] = {I(ab,23,00,00),B(mop_alloc ,17),I(1c,23,00,00),B(mop_alloc ,18),I(24,00,00,00),B(mop_key ,2),I(3c,03,1d,8a),I(05,02,1c,1c),I(86,6c,1b,44),I(04,1d,36,02),I(86,23,00,00),B(mop_alloc ,19),I(1f,05,1d,24),B(mop_key ,2),I(3c,03,1f,06),I(1f,06,24,00),B(mop_alloc ,12),I(3c,02,1f,06),I(23,00,00,00),B(mop_alloc ,20),I(24,00,00,00),B(mop_key ,3),I(3c,02,24,00),B(mop_gf ,2),I(1d,23,00,00),B(mop_alloc ,19),I(1f,05,1f,04),I(24,00,00,00),B(boot ,5),I(3d,05,09,45),I(09,00,00,00)};
  ...
  static const void *G003410[] = {I(43,03,1c,10),I(1f,03,1f,03),I(1f,03,24,00),B(mop_alloc ,2),I(3c,03,1d,12),I(1b,44,13,1f),I(05,1f,03,1f),I(03,24,00,00),B(mop_alloc ,5),I(3d,03,06,36),I(13,1f,05,1f),I(03,1f,03,1f),I(06,24,00,00),B(mop_alloc ,11),I(3d,04,06,45),I(06,00,00,00)};

  /* Byte-vector with size: 16 is_init: 0 index: 24 binding: anonymous */
  static const void *G003412[] = {I(aa,23,00,00),B(mop_alloc ,17),I(1c,23,00,00),B(mop_alloc ,18),I(24,00,00,00),B(mop_key ,2),I(3c,03,1b,47),I(00,01,86,6c),I(1b,44,04,86),I(36,16,47,00),I(00,1f,03,24),B(mop_alloc ,7),I(3c,02,24,00),B(boot1 ,26),I(3d,01,03,45),I(03,00,00,00)};

  /* Byte-vector with size: 12 is_init: 0 index: 25 binding: anonymous */
  static const void *G003414[] = {I(aa,1b,24,00),B(boot1 ,26),I(3c,01,1c,84),I(02,47,00,02),I(1c,24,00,00),B(boot ,32),I(3c,02,47,00),I(00,1f,03,1d),I(24,00,00,00),B(mop_alloc ,15),I(3d,03,04,45),I(04,00,00,00)};

  /* Byte-vector with size: 11 is_init: 0 index: 26 binding: anonymous */
  static const void *G003416[] = {I(aa,23,00,00),B(mop_alloc ,17),I(1c,23,00,00),B(mop_alloc ,18),I(24,00,00,00),B(mop_key ,2),I(3c,03,1b,1d),I(24,00,00,00),B(boot1 ,26),I(3d,02,02,45),I(02,00,00,00)};
  ...
  static const void *G003421[] = {I(ab,10,1b,8a),I(04,02,24,00),B(boot1 ,26),I(3d,01,02,00)};
  ...
  static const void *G003425[] = {I(ab,10,1b,8a),I(05,02,24,00),B(boot1 ,26),I(3d,01,02,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 32 binding: (method-compute-class-precedence-list) */
  static const void *G003427[] = {I(ab,10,1b,8a),I(06,02,1d,1c),I(0f,45,03,00)};

  /* Byte-vector with size: 7 is_init: 0 index: 33 binding: (method-compatible-superclass?) */
  static const void *G003429[] = {I(ab,1b,8a,07),I(02,1b,44,04),I(87,36,0d,1d),I(04,1d,04,24),B(mop_inspect ,2),I(3d,02,03,45),I(03,00,00,00)};
  ...
  static const void *G003474[] = {I(aa,1b,12,1b),I(44,04,87,36),I(31,1c,10,1b),I(47,00,02,86),I(6c,1b,44,10),I(1f,03,11,1b),I(11,47,00,01),I(3d,01,05,22),I(01,36,15,23),B(mop_alloc ,70),I(1d,47,00,00),I(24,00,00,00),B(boot ,25),I(3d,03,04,22),I(02,45,02,00)};

  /* Byte-vector with size: 13 is_init: 0 index: 72 binding: check-keywords */
  static const void *G003477[] = {I(43,03,46,04),I(1d,48,00,00),I(1c,8a,05,02),I(1b,48,00,02),I(86,1b,48,00),I(01,23,00,00),B(mop_alloc ,27),I(23,00,00,00),B(mop_alloc ,71),I(3b,01,48,00),I(01,1d,47,00),I(01,3d,01,05),I(45,05,00,00)};
