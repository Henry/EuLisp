...
void initialize_module_mop_alloc()
{
  ...
  static const void *G003418[] = {I(aa,1b,24,00),B(boot1 ,25),I(3c,01,1c,84),I(02,47,00,02),I(1c,24,00,00),B(boot ,28),I(3c,02,47,00),I(00,1f,03,1d),I(24,00,00,00),B(mop_alloc ,15),I(3d,03,04,45),I(04,00,00,00)};
