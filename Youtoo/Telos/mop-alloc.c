...
void initialize_module_mop_alloc()
{
  ...
  static const void *G003445[] = {I(ab,1c,26,00),I(00,00,00,07),I(02,1b,34,00),I(00,00,00,1e),I(86,23,00,00),B(mop_alloc ,43),I(1f,04,24,00),B(boot ,12),I(3d,03,03,32),I(00,00,00,0e),I(1d,83,02,1f),I(03,1c,01,22),I(01,45,03,00)};
