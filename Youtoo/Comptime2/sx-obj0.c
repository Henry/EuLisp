...
void initialize_module_sx_obj0()
{
  ...
  static const void *G00147[] = {I(ab,1b,34,00),I(00,00,00,ea),I(1c,82,02,1b),I(06,1b,2c,1d),I(83,1d,24,00),B(string ,6),I(3c,03,23,00),B(sx_obj0 ,14),I(24,00,00,00),B(collect ,20),I(3c,02,1f,04),I(10,82,02,24),B(mop_class ,81),I(23,00,00,00),B(sx_obj0 ,5),I(1d,24,00,00),B(mop_gf ,2),I(3c,03,1d,1d),I(23,00,00,00),B(sx_obj0 ,15),I(24,00,00,00),B(collect ,20),I(3c,03,24,00),B(mop_class ,5),I(23,00,00,00),B(sx_obj0 ,5),I(1d,24,00,00),B(mop_gf ,2),I(3c,03,1f,04),I(1f,04,23,00),B(sx_obj0 ,16),I(24,00,00,00),B(collect ,20),I(3c,03,24,00),B(mop_class ,5),I(23,00,00,00),B(sx_obj0 ,5),I(1d,24,00,00),B(mop_gf ,2),I(3c,03,1b,47),I(00,01,0f,1f),I(03,1c,0f,1b),I(48,00,01,1f),I(0c,10,1b,23),B(sx_obj0 ,17),I(1f,09,23,00),B(sx_obj0 ,18),I(86,23,00,00),B(sx_obj0 ,19),I(1f,0b,23,00),B(sx_obj0 ,20),I(1f,0b,24,00),B(boot1 ,23),I(3c,09,1f,0e),I(11,1f,10,1c),I(47,00,00,3c),I(02,1d,1c,0f),I(22,10,32,00),I(00,00,00,07),I(86,45,02,00)};
