...
void initialize_module_sx_obj0()
{
  ...
  static const void *G00152[] = {I(43,fc,46,03),I(1f,03,82,02),I(1b,06,1b,2c),I(1d,83,1d,24),B(string ,6),I(3c,03,23,00),B(sx_obj0 ,22),I(24,00,00,00),B(collect ,19),I(3c,02,24,00),B(mop_class ,5),I(23,00,00,00),B(sx_obj0 ,5),I(1d,24,00,00),B(mop_gf ,2),I(3c,03,86,1b),I(48,00,01,86),I(1b,48,00,00),I(23,00,00,00),B(sx_obj0 ,23),I(23,00,00,00),B(sx_obj0 ,21),I(3b,02,48,00),I(00,1f,0a,1f),I(09,47,00,00),I(3c,02,1f,03),I(1f,09,0f,23),B(sx_obj0 ,24),I(1c,0f,1d,1c),I(0f,1f,0d,1c),I(0f,1f,0f,1c),I(0f,23,00,00),B(sx_obj0 ,25),I(1c,0f,1f,09),I(47,00,01,0f),I(1f,12,1c,0f),I(23,00,00,00),B(sx_obj0 ,26),I(1c,0f,1b,86),I(0f,1f,04,1c),I(0f,23,00,00),B(sx_obj0 ,27),I(1c,0f,45,17)};
