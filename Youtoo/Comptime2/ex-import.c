...
void initialize_module_ex_import()
{
  ...
  static const void *G004524[] = {I(ab,24,00,00),B(stream2 ,9),I(23,00,00,00),B(ex_import ,14),I(24,00,00,00),B(format ,4),I(3c,02,2a,24),B(stream2 ,9),I(1d,24,00,00),B(mop_access ,8),I(3c,02,2a,24),B(i_param ,55),I(34,00,00,00),I(00,00,00,10),I(86,32,00,00),I(00,00,00,2a),I(23,00,00,00),B(ex_import ,15),I(24,00,00,00),B(i_error ,5),I(23,00,00,00),B(ex_import ,16),I(47,00,00,24),B(boot ,12),I(3d,04,02,45),I(02,00,00,00)};
  ...
  static const void *G004540[] = {I(ab,24,00,00),B(stream2 ,9),I(23,00,00,00),B(ex_import ,25),I(24,00,00,00),B(format ,4),I(3c,02,2a,24),B(stream2 ,9),I(1d,24,00,00),B(mop_access ,8),I(3c,02,2a,24),B(i_param ,55),I(34,00,00,00),I(00,00,00,10),I(86,32,00,00),I(00,00,00,2a),I(23,00,00,00),B(ex_import ,26),I(24,00,00,00),B(i_error ,5),I(23,00,00,00),B(ex_import ,16),I(47,00,00,24),B(boot ,12),I(3d,04,02,45),I(02,00,00,00)};
  ...
  static const void *G004551[] = {I(ab,24,00,00),B(stream2 ,9),I(23,00,00,00),B(ex_import ,32),I(24,00,00,00),B(format ,4),I(3c,02,2a,24),B(stream2 ,9),I(1d,24,00,00),B(mop_access ,8),I(3c,02,2a,24),B(i_param ,55),I(34,00,00,00),I(00,00,00,10),I(86,32,00,00),I(00,00,00,2a),I(23,00,00,00),B(ex_import ,33),I(24,00,00,00),B(i_error ,5),I(23,00,00,00),B(ex_import ,16),I(47,00,00,24),B(boot ,12),I(3d,04,02,45),I(02,00,00,00)};
  ...
  static const void *G004562[] = {I(ab,24,00,00),B(stream2 ,9),I(23,00,00,00),B(ex_import ,39),I(24,00,00,00),B(format ,4),I(3c,02,2a,24),B(stream2 ,9),I(1d,24,00,00),B(mop_access ,8),I(3c,02,2a,24),B(i_param ,55),I(34,00,00,00),I(00,00,00,10),I(86,32,00,00),I(00,00,00,2a),I(23,00,00,00),B(ex_import ,40),I(24,00,00,00),B(i_error ,5),I(23,00,00,00),B(ex_import ,16),I(47,00,00,24),B(boot ,12),I(3d,04,02,45),I(02,00,00,00)};
