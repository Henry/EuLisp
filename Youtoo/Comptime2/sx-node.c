...
void initialize_module_sx_node()
{
  ...
  static const void *G003285[] = {I(aa,1b,34,00),I(00,00,00,46),I(1b,26,00,00),I(00,00,00,07),I(24,00,00,00),B(sx_obj ,19),I(08,23,00,00),B(sx_node ,36),I(50,1b,34,00),I(00,00,00,1e),I(1c,82,24,00),B(sx_obj1 ,3),I(08,24,00,00),B(i_param ,41),I(3d,01,02,32),I(00,00,00,06),I(1c,22,01,32),I(00,00,00,06),I(86,45,01,00)};
  ...
  static const void *G003320[] = {I(aa,1b,24,00),B(list ,16),I(3c,01,1b,34),I(00,00,00,15),I(1c,24,00,00),B(boot ,8),I(3d,01,02,32),I(00,00,00,2d),I(1c,7a,12,1b),I(34,00,00,00),I(00,00,00,10),I(85,32,00,00),I(00,00,00,19),I(1d,24,00,00),B(boot ,8),I(3c,01,1b,83),I(14,82,1c,15),I(22,02,22,01),I(45,02,00,00)};

  /* Byte-vector with size: 99 is_init: 0 index: 68 binding: make-fun */
  static const void *G003322[] = {I(43,fb,1f,03),I(7a,1b,34,00),I(00,00,00,1a),I(1f,04,24,00),B(boot ,8),I(3c,01,83,19),I(32,00,00,00),I(00,00,00,09),I(86,1b,34,00),I(00,00,00,0e),I(1f,05,10,32),I(00,00,00,07),I(1f,05,1f,05),I(7c,1b,34,00),I(00,00,00,16),I(1f,06,24,00),B(boot1 ,24),I(3c,01,32,00),I(00,00,00,08),I(1f,06,1f,07),I(24,00,00,00),B(sx_node ,7),I(3c,01,1f,07),I(24,00,00,00),B(sx_obj1 ,70),I(3c,01,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,12),I(23,00,00,00),B(sx_node ,63),I(1f,09,0f,1f),I(08,34,00,00),I(00,00,00,0f),I(1f,08,10,32),I(00,00,00,06),I(86,1f,0d,23),B(sx_node ,48),I(1f,08,23,00),B(sx_node ,64),I(1f,08,23,00),B(sx_node ,65),I(1f,09,23,00),B(sx_node ,66),I(1f,09,23,00),B(sx_node ,67),I(1f,0a,24,00),B(mop_gf ,2),I(3c,0b,1b,24),B(sx_obj ,10),I(3c,01,1b,34),I(00,00,00,b9),I(1f,0e,23,00),B(sx_node ,36),I(50,1b,34,00),I(00,00,00,0e),I(1b,32,00,00),I(00,00,00,09),I(1f,0a,1b,34),I(00,00,00,4d),I(23,00,00,00),B(sx_node ,57),I(24,00,00,00),B(dynamic ,3),I(3c,01,1b,26),I(00,00,00,08),I(24,00,00,00),B(sx_obj1 ,59),I(08,1b,1f,06),I(24,00,00,00),B(thread ,27),I(3c,02,1d,1c),I(1c,26,00,00),I(00,00,00,08),I(1d,24,00,00),B(sx_obj1 ,59),I(09,22,05,32),I(00,00,00,48),I(23,00,00,00),B(sx_node ,57),I(24,00,00,00),B(dynamic ,3),I(3c,01,1b,26),I(00,00,00,09),I(24,00,00,00),B(sx_obj1 ,59),I(08,1b,1f,06),I(24,00,00,00),B(thread ,27),I(3c,02,1d,1c),I(1c,26,00,00),I(00,00,00,09),I(1d,24,00,00),B(sx_obj1 ,59),I(09,22,05,22),I(02,32,00,00),I(00,00,00,08),I(86,2a,1c,45),I(10,00,00,00)};

  /* Byte-vector with size: 68 is_init: 0 index: 74 binding: true-local-binding? */
  static const void *G003329[] = {I(aa,1b,24,00),B(sx_obj1 ,30),I(3c,01,1b,34),I(00,00,01,01),I(1c,84,24,00),B(sx_obj1 ,43),I(08,1d,24,00),B(sx_obj1 ,11),I(3c,01,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,db),I(1f,03,26,00),I(00,00,00,03),I(24,00,00,00),B(sx_obj1 ,43),I(08,1b,34,00),I(00,00,00,0e),I(1b,32,00,00),I(00,00,00,b9),I(1d,24,00,00),B(sx_obj ,21),I(3c,01,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,9f),I(1f,05,23,00),B(sx_node ,69),I(24,00,00,00),B(sx_node ,20),I(3c,02,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,7d),I(1f,06,23,00),B(sx_node ,70),I(24,00,00,00),B(sx_node ,20),I(3c,02,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,5b),I(1f,07,23,00),B(sx_node ,71),I(24,00,00,00),B(sx_node ,20),I(3c,02,23,00),B(sx_node ,72),I(50,1b,34,00),I(00,00,00,1e),I(1f,08,23,00),B(sx_node ,73),I(24,00,00,00),B(sx_node ,20),I(3c,02,32,00),I(00,00,00,07),I(86,1b,34,00),I(00,00,00,0e),I(1b,32,00,00),I(00,00,00,11),I(1f,07,24,00),B(mop_inspect ,11),I(3c,01,22,02),I(22,01,22,01),I(22,01,22,01),I(12,22,02,32),I(00,00,00,06),I(86,45,02,00)};
  ...
  static const void *G003339[] = {I(ab,1b,1d,24),B(boot ,16),I(3c,02,1b,34),I(00,00,00,0d),I(1b,11,32,00),I(00,00,00,07),I(86,45,03,00)};
  ...
  static const void *G003348[] = {I(aa,1b,24,00),B(number ,24),I(3c,01,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,1b),I(1c,81,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,09),I(1d,12,22,01),I(45,02,00,00)};
  ...
  static const void *G003363[] = {I(ab,46,01,24),B(sx_obj ,2),I(23,00,00,00),B(sx_node ,36),I(1f,03,1f,03),I(24,00,00,00),B(sx_node ,8),I(3c,04,1b,48),I(00,00,23,00),B(sx_node ,36),I(23,00,00,00),B(sx_node ,90),I(3b,01,1f,03),I(24,00,00,00),B(boot ,4),I(3c,02,2a,1d),I(24,00,00,00),B(sx_node ,2),I(3c,01,2a,47),I(00,00,45,03)};
  ...
  /* Initializations */
  eul_intern_keyword(key_3278,"local-name");
  eul_intern_keyword(key_3279,"module");
  eul_intern_keyword(key_3280,"immutable");
  eul_intern_keyword(key_3281,"imported");
  eul_intern_keyword(key_3282,"obj");
  eul_intern_keyword(key_3283,"local-index");
  eul_intern_keyword(key_3284,"info");
  eul_allocate_bytevector( G003277,G003276);
  eul_intern_symbol(sym_3287,"anonymous");
  eul_allocate_bytevector( G003286,G003285);
  eul_allocate_bytevector( G003289,G003288);
  eul_allocate_bytevector( G003291,G003290);
  eul_intern_symbol(sym_3294,"binding-origin-module-name");
  eul_intern_symbol(sym_3295,"clone-node");
  eul_intern_symbol(sym_3296,"(method binding-origin-module-name)");
  eul_intern_symbol(sym_3297,"(method get-named-encl-lambda)");
  eul_intern_symbol(sym_3298,"(method clone-node)");
  eul_allocate_bytevector( G003293,G003292);
  eul_intern_symbol(sym_3301,"*encl-lambda*");
  eul_allocate_bytevector( G003300,G003299);
  eul_intern_keyword(key_3304,"name");
  eul_intern_keyword(key_3305,"lexical-env");
  eul_intern_keyword(key_3306,"interactive-lexical-env");
  eul_intern_keyword(key_3307,"external-env");
  eul_intern_keyword(key_3308,"syntax-env");
  eul_allocate_bytevector( G003303,G003302);
  object_class(str_3311) = eul_static_string_class;
  eul_intern_symbol(sym_3312,"setter");
  eul_intern_symbol(sym_3313,"inline");
  eul_intern_symbol(sym_3314,"*actual-module*");
  eul_allocate_bytevector( G003310,G003309);
  eul_intern_symbol(sym_3317," unbound ");
  eul_allocate_bytevector( G003316,G003315);
  eul_allocate_bytevector( G003319,G003318);
  eul_allocate_bytevector( G003321,G003320);
  eul_intern_symbol(sym_3324,"progn");
  eul_intern_keyword(key_3325,"args");
  eul_intern_keyword(key_3326,"arity");
  ...
  eul_intern_symbol(sym_3381,"make-inlined-setter");
  eul_intern_symbol(sym_3382,"register-binding-ref");
  ...
  eul_intern_symbol(sym_3401,"make-dummy-binding");
  eul_intern_symbol(sym_3402,"get-imported-inlined-setter-binding");
  eul_intern_symbol(sym_3403,"make-module");
  eul_intern_symbol(sym_3404,"register-delegated-vars");
  eul_intern_symbol(sym_3405,"top-level");
  eul_allocate_bytevector( G003380,G003379);
  ...
  sx_node_bindings[ 28] = key_3278;
  sx_node_bindings[ 29] = key_3279;
  sx_node_bindings[ 30] = key_3280;
  sx_node_bindings[ 31] = key_3281;
  sx_node_bindings[ 32] = key_3282;
  sx_node_bindings[ 33] = key_3283;
  sx_node_bindings[ 34] = key_3284;
  sx_node_bindings[ 35] = G003277;
  sx_node_bindings[ 36] = sym_3287;
  sx_node_bindings[ 37] = G003286;
  sx_node_bindings[ 38] = G003289;
  sx_node_bindings[ 39] = G003291;
  sx_node_bindings[ 40] = sym_3294;
  sx_node_bindings[ 41] = sym_3295;
  sx_node_bindings[ 42] = sym_3296;
  sx_node_bindings[ 43] = sym_3297;
  sx_node_bindings[ 44] = sym_3298;
  sx_node_bindings[ 45] = G003293;
  sx_node_bindings[ 46] = sym_3301;
  sx_node_bindings[ 47] = G003300;
  sx_node_bindings[ 48] = key_3304;
  sx_node_bindings[ 49] = key_3305;
  sx_node_bindings[ 50] = key_3306;
  sx_node_bindings[ 51] = key_3307;
  sx_node_bindings[ 52] = key_3308;
  sx_node_bindings[ 53] = G003303;
  sx_node_bindings[ 54] = str_3311;
  sx_node_bindings[ 55] = sym_3312;
  sx_node_bindings[ 56] = sym_3313;
  sx_node_bindings[ 57] = sym_3314;
  sx_node_bindings[ 58] = G003310;
  sx_node_bindings[ 59] = sym_3317;
  sx_node_bindings[ 60] = G003316;
  sx_node_bindings[ 61] = G003319;
  sx_node_bindings[ 62] = G003321;
  sx_node_bindings[ 63] = sym_3324;
  sx_node_bindings[ 64] = key_3325;
  sx_node_bindings[ 65] = key_3326;
  sx_node_bindings[ 66] = key_3327;
  sx_node_bindings[ 67] = key_3328;
  sx_node_bindings[ 68] = G003323;
  ...
  sx_node_bindings[ 92] = G003366;
  sx_node_bindings[ 93] = G003368;
  sx_node_bindings[ 94] = G003370;
  sx_node_bindings[ 95] = G003372;
  sx_node_bindings[ 96] = G003374;
  sx_node_bindings[ 97] = G003376;
  sx_node_bindings[ 98] = G003378;
  sx_node_bindings[ 1] = eul_nil;
  sx_node_bindings[ 99] = sym_3381;
  sx_node_bindings[ 100] = sym_3382;
  sx_node_bindings[ 101] = sym_3383;
  sx_node_bindings[ 102] = sym_3384;
  sx_node_bindings[ 103] = sym_3385;
  sx_node_bindings[ 104] = sym_3386;
  sx_node_bindings[ 105] = sym_3387;
  sx_node_bindings[ 106] = sym_3388;
  sx_node_bindings[ 107] = sym_3389;
  sx_node_bindings[ 108] = sym_3390;
  sx_node_bindings[ 109] = sym_3391;
  sx_node_bindings[ 110] = sym_3392;
  sx_node_bindings[ 111] = sym_3393;
  sx_node_bindings[ 112] = sym_3394;
  sx_node_bindings[ 113] = sym_3395;
  sx_node_bindings[ 114] = sym_3396;
  sx_node_bindings[ 115] = sym_3397;
  sx_node_bindings[ 116] = sym_3398;
  sx_node_bindings[ 117] = sym_3399;
  sx_node_bindings[ 118] = sym_3400;
  sx_node_bindings[ 119] = sym_3401;
  sx_node_bindings[ 120] = sym_3402;
  sx_node_bindings[ 121] = sym_3403;
  sx_node_bindings[ 122] = sym_3404;
  sx_node_bindings[ 123] = sym_3405;
  eul_allocate_lambda( sx_node_bindings[0], "initialize-sx-node", 0, G003380);
