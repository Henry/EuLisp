...
void initialize_module_sx_node()
{
  ...
  static const void *G003284[] = {I(aa,1b,34,00),I(00,00,00,46),I(1b,26,00,00),I(00,00,00,07),I(24,00,00,00),B(sx_obj ,8),I(08,23,00,00),B(sx_node ,36),I(50,1b,34,00),I(00,00,00,1e),I(1c,82,24,00),B(sx_obj1 ,3),I(08,24,00,00),B(i_param ,39),I(3d,01,02,32),I(00,00,00,06),I(1c,22,01,32),I(00,00,00,06),I(86,45,01,00)};
  ...
  static const void *G003298[] = {I(aa,23,00,00),B(sx_node ,46),I(24,00,00,00),B(dynamic ,3),I(3c,01,23,00),B(sx_node ,46),I(24,00,00,00),B(dynamic ,3),I(3c,01,1b,83),I(24,00,00,00),B(sx_obj ,30),I(08,1b,1f,04),I(24,00,00,00),B(boot ,7),I(3c,02,1f,03),I(1c,1c,83,1d),I(24,00,00,00),B(sx_obj ,30),I(09,45,07,00)};
  ...
  static const void *G003317[] = {I(43,03,24,00),B(sx_obj ,30),I(1f,03,1f,03),I(1f,03,24,00),B(sx_node ,8),I(3c,04,1b,24),B(sx_node ,22),I(3c,01,24,00),B(p_env ,5),I(3c,01,2a,1b),I(45,04,00,00)};
  ...
  static const void *G003340[] = {I(ab,24,00,00),B(sx_obj2 ,34),I(23,00,00,00),B(sx_node ,78),I(1f,03,23,00),B(sx_node ,32),I(1f,04,24,00),B(mop_gf ,2),I(3d,05,02,00)};

  /* Byte-vector with size: 18 is_init: 0 index: 82 binding: make-local-static-var */
  static const void *G003343[] = {I(43,fe,1b,34),I(00,00,00,0d),I(1b,10,32,00),I(00,00,00,07),I(86,24,00,00),B(sx_obj2 ,27),I(23,00,00,00),B(sx_node ,48),I(1f,04,23,00),B(sx_node ,80),I(1f,04,23,00),B(sx_node ,81),I(82,24,00,00),B(mop_gf ,2),I(3c,07,1b,24),B(sx_node ,15),I(3c,01,2a,1b),I(45,04,00,00)};
  ...
  static const void *G003360[] = {I(aa,1b,47,00),I(00,1c,83,1d),I(24,00,00,00),B(sx_obj2 ,27),I(09,45,03,00)};

  /* Byte-vector with size: 20 is_init: 0 index: 91 binding: make-let* */
  static const void *G003362[] = {I(ab,46,01,24),B(sx_obj ,25),I(23,00,00,00),B(sx_node ,36),I(1f,03,1f,03),I(24,00,00,00),B(sx_node ,8),I(3c,04,1b,48),I(00,00,23,00),B(sx_node ,36),I(23,00,00,00),B(sx_node ,90),I(3b,01,1f,03),I(24,00,00,00),B(boot ,16),I(3c,02,2a,1d),I(24,00,00,00),B(sx_node ,2),I(3c,01,2a,47),I(00,00,45,03)};
  ...
  static const void *G003374[] = {I(aa,23,00,00),B(sx_node ,46),I(24,00,00,00),B(dynamic ,3),I(3c,01,23,00),B(sx_node ,57),I(24,00,00,00),B(dynamic ,3),I(3c,01,1c,34),I(00,00,00,25),I(1c,82,24,00),B(sx_obj ,30),I(08,1f,03,1c),I(0f,1f,03,1c),I(1c,82,1d,24),B(sx_obj ,30),I(09,22,04,32),I(00,00,00,30),I(1b,26,00,00),I(00,00,00,05),I(24,00,00,00),B(sx_obj1 ,59),I(08,1f,03,1c),I(0f,1d,1c,1c),I(26,00,00,00),I(00,00,00,05),I(1d,24,00,00),B(sx_obj1 ,59),I(09,22,04,45),I(03,00,00,00)};

  /* Byte-vector with size: 29 is_init: 0 index: 98 binding: make-inlined-setter */
  static const void *G003376[] = {I(43,03,24,00),B(sx_obj ,30),I(1f,03,1f,03),I(1f,03,24,00),B(sx_node ,8),I(3c,04,1b,24),B(sx_node ,22),I(3c,01,1c,87),I(1c,84,1d,24),B(sx_obj ,30),I(09,22,02,2a),I(23,00,00,00),B(sx_node ,57),I(24,00,00,00),B(dynamic ,3),I(3c,01,1b,26),I(00,00,00,0a),I(24,00,00,00),B(sx_obj1 ,59),I(08,1b,1f,03),I(24,00,00,00),B(thread ,28),I(3c,02,1d,1c),I(1c,26,00,00),I(00,00,00,0a),I(1d,24,00,00),B(sx_obj1 ,59),I(09,22,02,2a),I(1f,04,45,08)};
