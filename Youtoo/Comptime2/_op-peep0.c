...
void initialize_module__op_peep0()
{
  ...
  static const void *G0088[] = {I(aa,1b,12,1b),I(34,00,00,00),I(00,00,00,10),I(86,32,00,00),I(00,00,00,3c),I(1c,10,1b,11),I(23,00,00,00),B(_op_peep0 ,10),I(23,00,00,00),B(_op_peep0 ,9),I(3b,01,1c,24),B(collect ,2),I(3c,02,1f,04),I(11,1b,47,00),I(00,3c,01,1d),I(1c,24,00,00),B(boot ,21),I(3d,02,07,22),I(05,45,02,00)};
