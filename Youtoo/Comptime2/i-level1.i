...
(definterface i-level1
  (import (boot boot level1 aux-table)
   ...
   export (
    ...
    ((name . class-precedence-list) (pos . 6) (origin mop-class . class-precedence-list) (inline (G00715 (static-fpi-ref 6) (primitive-ref))) (setter (G00775 (stack-ref 1) (static-fpi-ref 6) (stack-ref 2) (set-primitive-ref) (nobble 2))))
