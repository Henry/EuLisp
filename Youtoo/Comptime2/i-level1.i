...
(definterface i-level1
  (import (boot boot level1 aux-table)
   ...
   export (
    ...
    ((name . sprin-one-char) (pos . 24) (origin stream . sprin-one-char))
    ...
    ((name . table-fill-value) (pos . 17) (origin table1 . table-fill-value) (inline (G007806 (static-ref2) (binding-ref ? <table>) (primitive-relative-ref))))
    ...
    ((name . make-space) (pos . 23) (origin stream . make-space))
    ...
    ((name . sprin) (pos . 22) (origin stream . sprin))
    ((name . find-key) (pos . 2) (origin mop-key . find-key))
    ((name . table-entries) (pos . 16) (origin table1 . table-entries) (inline (G007808 (static-fpi-ref 3) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G007818 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . prin) (pos . 19) (origin stream . prin))
    ...
    ((name . table-threshold) (pos . 14) (origin table1 . table-threshold) (inline (G007802 (static-ref0) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G007814 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ((name . table-hash-function) (pos . 13) (origin table1 . table-hash-function) (inline (G007810 (static-ref0) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G007820 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-comparator) (pos . 10) (origin table1 . table-comparator) (inline (G007812 (static-ref1) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G007822 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . handle) (pos . 3) (origin handler . handle) (inline (G009831 (static-ref0) (binding-ref ? <handler>) (primitive-relative-ref))) (setter (G009833 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <handler>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-size) (pos . 4) (origin table1 . table-size) (inline (G007804 (static-ref1) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G007816 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
