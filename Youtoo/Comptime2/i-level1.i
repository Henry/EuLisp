...
(definterface i-level1
  (import (boot boot level1 aux-table)
   ...
   export (
    ...
    ((name . table-fill-value) (pos . 17) (origin table1 . table-fill-value) (inline (G007796 (static-ref2) (binding-ref ? <table>) (primitive-relative-ref))))
    ...
    ((name . table-entries) (pos . 16) (origin table1 . table-entries) (inline (G007798 (static-fpi-ref 3) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G007808 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-threshold) (pos . 14) (origin table1 . table-threshold) (inline (G007792 (static-ref0) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G007804 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ((name . table-hash-function) (pos . 13) (origin table1 . table-hash-function) (inline (G007800 (static-ref0) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G007810 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-comparator) (pos . 10) (origin table1 . table-comparator) (inline (G007802 (static-ref1) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G007812 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . vector-empty?) (pos . 18) (origin vector . vector-empty?) (inline (G007155 (primitive-size) (fpi-zerop))))
    ...
    ((name . table-size) (pos . 4) (origin table1 . table-size) (inline (G007794 (static-ref1) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G007806 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
