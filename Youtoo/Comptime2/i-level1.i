...
(definterface i-level1
  (import (boot boot level1 aux-table)
   ...
   export (
    ...
    ((name . table-fill-value) (pos . 17) (origin table1 . table-fill-value) (inline (G007844 (static-ref2) (binding-ref ? <table>) (primitive-relative-ref))))
    ((name . primitive-format) (pos . 48) (origin boot1 . format))
    ((name . string-stream-string-list) (pos . 48) (origin stream2 . string-stream-string-list) (inline (G005290 (static-ref0) (binding-ref ? <string-stream>) (primitive-relative-ref))) (setter (G005316 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <string-stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . string-as-int) (pos . 23) (origin string . string-as-int) (class . ff) (arity . 1) (ff (3) 0 (atoi . ff_stub_atoi2818)))
    ...
    ((name . socket-host) (pos . 11) (origin socket . socket-host) (inline (G005823 (static-ref2) (binding-ref ? <socket>) (primitive-relative-ref))) (setter (G005835 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <socket>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-entries) (pos . 15) (origin table1 . table-entries) (inline (G007846 (static-fpi-ref 3) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G007856 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-sink) (pos . 36) (origin stream2 . stream-sink) (inline (G005288 (static-fpi-ref 5) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G005314 (stack-ref 1) (static-fpi-ref 5) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . caaadr) (pos . 36) (origin list . caaadr) (inline (G003731 (cdr) (caar) (car))) (setter (G003814 (stack-ref 1) (cadr) (car) (stack-ref 0) (stack-ref 2) (set-car) (nobble 1) (nobble 2))))
    ...
    ((name . cdadar) (pos . 35) (origin list . cdadar) (inline (G003757 (cdar) (cdar))) (setter (G003841 (stack-ref 1) (cdar) (car) (stack-ref 0) (stack-ref 2) (set-cdr) (nobble 1) (nobble 2))))
    ...
    ((name . control-block-buffer) (pos . 32) (origin stream2 . control-block-buffer) (inline (G005270 (static-fpi-ref 3) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G005300 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-lock) (pos . 31) (origin stream2 . stream-lock) (inline (G005280 (static-ref1) (binding-ref ? <stream>) (primitive-relative-ref))))
    ...
    ((name . control-block-mode) (pos . 29) (origin stream2 . control-block-mode) (inline (G005274 (static-ref1) (binding-ref ? <file-control-block>) (primitive-relative-ref))) (setter (G005304 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <file-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . cadar) (pos . 29) (origin list . cadar) (inline (G003719 (cdar) (car))) (setter (G003802 (stack-ref 1) (cdar) (stack-ref 0) (stack-ref 2) (set-car) (nobble 1) (nobble 2))))
    ...
    ((name . abs) (pos . 20) (origin number . abs) (inline (G001929 (stack-ref 0) (static-ref0) (fpi-lt) (stack-ref 0) (branch-nil G001931number) (static-ref0) (stack-ref 2) (fpi-difference) (branch G001932number) (label G001931number) (stack-ref 1) (label G001932number) (nobble 1) (nobble 1))))
    ...
    ((name . socket-port) (pos . 9) (origin socket . socket-port) (inline (G005825 (static-fpi-ref 3) (binding-ref ? <socket>) (primitive-relative-ref))) (setter (G005837 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <socket>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-threshold) (pos . 12) (origin table1 . table-threshold) (inline (G007840 (static-ref0) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G007852 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ((name . table-hash-function) (pos . 11) (origin table1 . table-hash-function) (inline (G007848 (static-ref0) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G007858 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ((name . string-empty?) (pos . 7) (origin string . string-empty?) (inline (G002619 (primitive-size) (fpi-zerop))))
    ((name . assoc-list-ref) (pos . 20) (origin boot . assoc-list-ref) (inline (G00143 (stack-ref 0) (stack-ref 2) (static-ref-nil) (assq) (nobble 2))))
    ((name . cddr) (pos . 20) (origin list . cddr) (inline (G003703 (cddr))) (setter (G003784 (stack-ref 1) (cdr) (stack-ref 0) (stack-ref 2) (set-cdr) (nobble 1) (nobble 2))))
    ...
    ((name . cadadr) (pos . 18) (origin list . cadadr) (inline (G003743 (cadr) (cadr))) (setter (G003826 (stack-ref 1) (cadr) (cdr) (stack-ref 0) (stack-ref 2) (set-car) (nobble 1) (nobble 2))))
    ...
    ((name . table-comparator) (pos . 8) (origin table1 . table-comparator) (inline (G007850 (static-ref1) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G007860 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . string-compare) (pos . 17) (origin string . string-compare) (class . ff) (arity . 2) (ff (3 3) 0 (strcmp . ff_stub_strcmp2812)))
    ...
    ((name . connection-port) (pos . 7) (origin socket . connection-port) (inline (G005827 (static-ref0) (binding-ref ? <connection>) (primitive-relative-ref))) (setter (G005839 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <connection>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-write-action) (pos . 13) (origin stream2 . stream-write-action) (inline (G005282 (static-ref2) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G005308 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . control-block-buffer-size) (pos . 9) (origin stream2 . control-block-buffer-size) (inline (G005268 (static-ref2) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G005298 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-read-action) (pos . 8) (origin stream2 . stream-read-action) (inline (G005284 (static-fpi-ref 3) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G005310 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . signum) (pos . 5) (origin number . signum) (inline (G001934 (stack-ref 0) (fpi-zerop) (stack-ref 0) (branch-nil G001936number) (stack-ref 0) (branch G001937number) (label G001936number) (stack-ref 1) (stack-ref 0) (static-ref0) (fpi-lt) (stack-ref 0) (branch-nil G001938G001931number) (static-ref0) (stack-ref 2) (fpi-difference) (branch G001938G001932number) (label G001938G001931number) (stack-ref 1) (label G001938G001932number) (nobble 1) (nobble 1) (stack-ref 2) (stack-ref 1) (fpi-quotient) (nobble 1) (label G001937number) (nobble 1) (nobble 1))))
    ...
    ((name . cddar) (pos . 9) (origin list . cddar) (inline (G003710 (cdar) (cdr))) (setter (G003793 (stack-ref 1) (cdar) (stack-ref 0) (stack-ref 2) (set-cdr) (nobble 1) (nobble 2))))
    ...
    ((name . caddar) (pos . 5) (origin list . caddar) (inline (G003746 (cdar) (cadr))) (setter (G003829 (stack-ref 1) (cdar) (cdr) (stack-ref 0) (stack-ref 2) (set-car) (nobble 1) (nobble 2))))
    ...
    ((name . negative?) (pos . 2) (origin number . negative?) (inline (G001942 (static-ref0) (fpi-lt))))
    ...
    ((name . cdaddr) (pos . 44) (origin list . cdaddr) (inline (G003760 (cddr) (cdar))) (setter (G003844 (stack-ref 1) (caddr) (stack-ref 0) (stack-ref 2) (set-cdr) (nobble 1) (nobble 2))))
    ...
    ((name . vector-empty?) (pos . 16) (origin vector . vector-empty?) (inline (G007233 (primitive-size) (fpi-zerop))))
    ((name . eul_list_as_eul_string) (pos . 21) (origin string . eul_list_as_eul_string) (class . ff) (arity . 1) (ff (8) 6 (eul_list_as_eul_string . ff_stub_eul_list_as_eul_string2816)))
    ...
    ((name . cdddr) (pos . 43) (origin list . cdddr) (inline (G003725 (cddr) (cdr))) (setter (G003808 (stack-ref 1) (cddr) (stack-ref 0) (stack-ref 2) (set-cdr) (nobble 1) (nobble 2))))
    ...
    ((name . cdaadr) (pos . 41) (origin list . cdaadr) (inline (G003754 (cadr) (cdar))) (setter (G003838 (stack-ref 1) (cadr) (car) (stack-ref 0) (stack-ref 2) (set-cdr) (nobble 1) (nobble 2))))
    ((name . control-block-buffer-cnt) (pos . 47) (origin stream2 . control-block-buffer-cnt) (inline (G005264 (static-ref0) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G005294 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . string-data) (pos . 12) (origin string . string-data) (inline (G002617 (static-ref0) (binding-ref ? <string>) (primitive-relative-ref))) (setter (G002624 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <string>) (set-primitive-relative-ref) (nobble 2))))
    ((name . int?) (pos . 31) (origin boot1 . int?) (inline (G0049 (fpip))))
    ((name . control-block-descriptor) (pos . 41) (origin stream2 . control-block-descriptor) (inline (G005272 (static-ref0) (binding-ref ? <file-control-block>) (primitive-relative-ref))) (setter (G005302 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <file-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . caar) (pos . 39) (origin list . caar) (inline (G003697 (caar))) (setter (G003775 (stack-ref 1) (car) (stack-ref 0) (stack-ref 2) (set-car) (nobble 1) (nobble 2))))
    ...
    ((name . caaar) (pos . 34) (origin list . caaar) (inline (G003722 (caar) (car))) (setter (G003805 (stack-ref 1) (caar) (stack-ref 0) (stack-ref 2) (set-car) (nobble 1) (nobble 2))))
    ((name . control-block-file-name) (pos . 33) (origin stream2 . control-block-file-name) (inline (G005276 (static-ref2) (binding-ref ? <file-control-block>) (primitive-relative-ref))) (setter (G005306 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <file-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ((name . cdaar) (pos . 33) (origin list . cdaar) (inline (G003716 (caar) (cdr))) (setter (G003799 (stack-ref 1) (caar) (stack-ref 0) (stack-ref 2) (set-cdr) (nobble 1) (nobble 2))))
    ...
    ((name . semaphore-counter) (pos . 6) (origin lock . semaphore-counter) (inline (G004921 (static-ref0) (binding-ref ? <semaphore>) (primitive-relative-ref))) (setter (G004923 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <semaphore>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . caddr) (pos . 32) (origin list . caddr) (inline (G003705 (caddr))) (setter (G003787 (stack-ref 1) (cddr) (stack-ref 0) (stack-ref 2) (set-car) (nobble 1) (nobble 2))))
    ...
    ((name . cdadr) (pos . 31) (origin list . cdadr) (inline (G003707 (cadr) (cdr))) (setter (G003790 (stack-ref 1) (cadr) (stack-ref 0) (stack-ref 2) (set-cdr) (nobble 1) (nobble 2))))
    ...
    ((name . cddaar) (pos . 28) (origin list . cddaar) (inline (G003763 (caar) (cddr))) (setter (G003847 (stack-ref 1) (caar) (cdr) (stack-ref 0) (stack-ref 2) (set-cdr) (nobble 1) (nobble 2))))
    ((name . call/ep) (pos . 2) (origin let-cc . call/ep))
    ((name . name-keywords) (pos . 8) (origin mop-class . name-keywords) (class . constant))
    ((name . cadr) (pos . 30) (origin list . cadr) (inline (G003699 (cadr))) (setter (G003778 (stack-ref 1) (cdr) (stack-ref 0) (stack-ref 2) (set-car) (nobble 1) (nobble 2))))
    ...
    ((name . caadr) (pos . 23) (origin list . caadr) (inline (G003713 (cadr) (car))) (setter (G003796 (stack-ref 1) (cadr) (stack-ref 0) (stack-ref 2) (set-car) (nobble 1) (nobble 2))))
    ...
    ((name . string-equal) (pos . 8) (origin string . string-equal) (inline (G002622 (call-foreign-function string-compare) (nobble 2) (fpi-zerop))))
    ...
    ((name . caadar) (pos . 21) (origin list . caadar) (inline (G003734 (cdar) (caar))) (setter (G003817 (stack-ref 1) (cdar) (car) (stack-ref 0) (stack-ref 2) (set-car) (nobble 1) (nobble 2))))
    ((name . zero?) (pos . 16) (origin number . zero?))
    ((name . access-table-keys) (pos . 3) (origin aux-table . access-table-keys))
    ((name . stream-source) (pos . 22) (origin stream2 . stream-source) (inline (G005286 (static-fpi-ref 4) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G005312 (stack-ref 1) (static-fpi-ref 4) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . cadddr) (pos . 19) (origin list . cadddr) (inline (G003749 (cadddr))) (setter (G003832 (stack-ref 1) (cddr) (cdr) (stack-ref 0) (stack-ref 2) (set-car) (nobble 1) (nobble 2))))
    ...
    ((name . handle) (pos . 3) (origin handler . handle) (inline (G009869 (static-ref0) (binding-ref ? <handler>) (primitive-relative-ref))) (setter (G009871 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <handler>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-mode) (pos . 17) (origin stream2 . stream-mode) (inline (G005278 (static-ref0) (binding-ref ? <stream>) (primitive-relative-ref))))
    ...
    ((name . caaddr) (pos . 14) (origin list . caaddr) (inline (G003737 (cddr) (caar))) (setter (G003820 (stack-ref 1) (caddr) (stack-ref 0) (stack-ref 2) (set-car) (nobble 1) (nobble 2))))
    ...
    ((name . caaaar) (pos . 13) (origin list . caaaar) (inline (G003728 (caar) (caar))) (setter (G003811 (stack-ref 1) (caar) (car) (stack-ref 0) (stack-ref 2) (set-car) (nobble 1) (nobble 2))))
    ...
    ((name . cdddar) (pos . 11) (origin list . cdddar) (inline (G003769 (cdar) (cddr))) (setter (G003853 (stack-ref 1) (cdar) (cdr) (stack-ref 0) (stack-ref 2) (set-cdr) (nobble 1) (nobble 2))))
    ((name . read-char) (pos . 5) (origin read . read-char))
    ((name . cddadr) (pos . 12) (origin list . cddadr) (inline (G003766 (cadr) (cddr))) (setter (G003850 (stack-ref 1) (cadr) (cdr) (stack-ref 0) (stack-ref 2) (set-cdr) (nobble 1) (nobble 2))))
    ((name . connection-host) (pos . 5) (origin socket . connection-host) (inline (G005829 (static-ref1) (binding-ref ? <connection>) (primitive-relative-ref))) (setter (G005841 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <connection>) (set-primitive-relative-ref) (nobble 2))))
    ((name . socket-queue-size) (pos . 6) (origin socket . socket-queue-size) (inline (G005819 (static-ref0) (binding-ref ? <socket>) (primitive-relative-ref))) (setter (G005831 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <socket>) (set-primitive-relative-ref) (nobble 2))))
    ((name . hostname) (pos . 3) (origin stream1 . hostname))
    ((name . table-size) (pos . 5) (origin table1 . table-size) (inline (G007842 (static-ref1) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G007854 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . control-block-buffer-pos) (pos . 11) (origin stream2 . control-block-buffer-pos) (inline (G005266 (static-ref1) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G005296 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . cadaar) (pos . 7) (origin list . cadaar) (inline (G003740 (caar) (cadr))) (setter (G003823 (stack-ref 1) (caar) (cdr) (stack-ref 0) (stack-ref 2) (set-car) (nobble 1) (nobble 2))))
    ...
    ((name . positive?) (pos . 3) (origin number . positive?) (inline (G001940 (static-ref0) (stack-ref 1) (fpi-lt) (nobble 1))))
    ((name . compute-class-codes) (pos . 2) (origin mop-init . compute-class-codes))
    ((name . cdaaar) (pos . 4) (origin list . cdaaar) (inline (G003751 (caar) (cdar))) (setter (G003835 (stack-ref 1) (caar) (car) (stack-ref 0) (stack-ref 2) (set-cdr) (nobble 1) (nobble 2))))
    ((name . <file-control-block>) (pos . 4) (origin stream2 . <file-control-block>) (class . constant))
    ((name . socket-descriptor) (pos . 3) (origin socket . socket-descriptor) (inline (G005821 (static-ref1) (binding-ref ? <socket>) (primitive-relative-ref))) (setter (G005833 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <socket>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . cdar) (pos . 6) (origin list . cdar) (inline (G003701 (cdar))) (setter (G003781 (stack-ref 1) (car) (stack-ref 0) (stack-ref 2) (set-cdr) (nobble 1) (nobble 2))))
    ...
    ((name . cddddr) (pos . 2) (origin list . cddddr) (inline (G003772 (cddr) (cddr))) (setter (G003856 (stack-ref 1) (cddr) (cdr) (stack-ref 0) (stack-ref 2) (set-cdr) (nobble 1) (nobble 2))))
