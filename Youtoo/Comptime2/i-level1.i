...
(definterface i-level1
  (import (boot boot level1 aux-table)
   ...
   export (
    ...
    ((name . table-fill-value) (pos . 17) (origin table1 . table-fill-value) (inline (G008391 (static-ref2) (binding-ref ? <table>) (primitive-relative-ref))))
    ((name . primitive-format) (pos . 47) (origin boot1 . format))
    ((name . string-stream-string-list) (pos . 48) (origin stream2 . string-stream-string-list) (inline (G005810 (static-ref0) (binding-ref ? <string-stream>) (primitive-relative-ref))) (setter (G005836 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <string-stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . socket-host) (pos . 11) (origin socket . socket-host) (inline (G006343 (static-ref2) (binding-ref ? <socket>) (primitive-relative-ref))) (setter (G006355 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <socket>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . eul_make_socket) (pos . 21) (origin stream1 . eul_make_socket) (class . ff) (arity . 3) (ff (3 3 0) 0 (eul_make_socket . ff_stub_eul_make_socket5320)))
    ...
    ((name . table-entries) (pos . 15) (origin table1 . table-entries) (inline (G008393 (static-fpi-ref 3) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G008403 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-sink) (pos . 37) (origin stream2 . stream-sink) (inline (G005808 (static-fpi-ref 5) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G005834 (stack-ref 1) (static-fpi-ref 5) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . control-block-buffer) (pos . 32) (origin stream2 . control-block-buffer) (inline (G005790 (static-fpi-ref 3) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G005820 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ((name . filter-keywords) (pos . 3) (origin mop-key . filter-keywords))
    ((name . all?) (pos . 16) (origin collect . all?))
    ((name . double-binary=) (pos . 12) (origin double . double-binary=) (class . ff) (arity . 2) (ff (2 2) 6 (eul_dbl_equal . ff_stub_eul_dbl_equal3724)))
    ((name . stream-lock) (pos . 31) (origin stream2 . stream-lock) (inline (G005800 (static-ref1) (binding-ref ? <stream>) (primitive-relative-ref))))
    ...
    ((name . eul_close) (pos . 16) (origin stream1 . eul_close) (class . ff) (arity . 1) (ff (0) 0 (close . ff_stub_close5315)))
    ((name . <method>) (pos . 22) (origin mop-class . <method>) (class . constant))
    ((name . do1-table) (pos . 9) (origin table . do1-table))
    ((name . control-block-mode) (pos . 29) (origin stream2 . control-block-mode) (inline (G005794 (static-ref1) (binding-ref ? <file-control-block>) (primitive-relative-ref))) (setter (G005824 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <file-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . double-binary<) (pos . 13) (origin double . double-binary<) (class . ff) (arity . 2) (ff (2 2) 6 (eul_dbl_less . ff_stub_eul_dbl_less3725)))
    ...
    ((name . eul_read) (pos . 17) (origin stream1 . eul_read) (class . ff) (arity . 3) (ff (0 3 0) 0 (read . ff_stub_read5316)))
    ...
    ((name . socket-port) (pos . 9) (origin socket . socket-port) (inline (G006345 (static-fpi-ref 3) (binding-ref ? <socket>) (primitive-relative-ref))) (setter (G006357 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <socket>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-threshold) (pos . 12) (origin table1 . table-threshold) (inline (G008387 (static-ref0) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G008399 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ((name . table-hash-function) (pos . 11) (origin table1 . table-hash-function) (inline (G008395 (static-ref0) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G008405 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-comparator) (pos . 8) (origin table1 . table-comparator) (inline (G008397 (static-ref1) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G008407 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . ntok) (pos . 26) (origin stream1 . ntok) (class . ff) (arity . 2) (ff (8 8) 6 (ntok . ff_stub_ntok5325)))
    ...
    ((name . connection-port) (pos . 7) (origin socket . connection-port) (inline (G006347 (static-ref0) (binding-ref ? <connection>) (primitive-relative-ref))) (setter (G006359 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <connection>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-write-action) (pos . 13) (origin stream2 . stream-write-action) (inline (G005802 (static-ref2) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G005828 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . control-block-buffer-size) (pos . 9) (origin stream2 . control-block-buffer-size) (inline (G005788 (static-ref2) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G005818 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-read-action) (pos . 8) (origin stream2 . stream-read-action) (inline (G005804 (static-fpi-ref 3) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G005830 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . eul_open) (pos . 15) (origin stream1 . eul_open) (class . ff) (arity . 3) (ff (3 0 0) 0 (open . ff_stub_open5314)))
    ...
    ((name . vector-empty?) (pos . 18) (origin vector . vector-empty?) (inline (G007757 (primitive-size) (fpi-zerop))))
    ...
    ((name . control-block-buffer-cnt) (pos . 47) (origin stream2 . control-block-buffer-cnt) (inline (G005784 (static-ref0) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G005814 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . eul_socket_strerror) (pos . 24) (origin stream1 . eul_socket_strerror) (class . ff) (arity . 1) (ff (0) 3 (eul_socket_strerror . ff_stub_eul_socket_strerror5323)))
    ...
    ((name . control-block-descriptor) (pos . 41) (origin stream2 . control-block-descriptor) (inline (G005792 (static-ref0) (binding-ref ? <file-control-block>) (primitive-relative-ref))) (setter (G005822 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <file-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . eul_write) (pos . 18) (origin stream1 . eul_write) (class . ff) (arity . 3) (ff (0 3 0) 0 (write . ff_stub_write5317)))
    ...
    ((name . control-block-file-name) (pos . 33) (origin stream2 . control-block-file-name) (inline (G005796 (static-ref2) (binding-ref ? <file-control-block>) (primitive-relative-ref))) (setter (G005826 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <file-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . eul_make_connection) (pos . 23) (origin stream1 . eul_make_connection) (class . ff) (arity . 3) (ff (3 3 3) 0 (eul_make_connection . ff_stub_eul_make_connection5322)))
    ...
    ((name . stream-source) (pos . 22) (origin stream2 . stream-source) (inline (G005806 (static-fpi-ref 4) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G005832 (stack-ref 1) (static-fpi-ref 4) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . eul_sprintf_string) (pos . 20) (origin stream1 . eul_sprintf_string) (class . ff) (arity . 6) (ff (3 0 0 0 3 3) 0 (eul_sprintf_string . ff_stub_eul_sprintf_string5319)))
    ...
    ((name . eul_socket_accept) (pos . 22) (origin stream1 . eul_socket_accept) (class . ff) (arity . 1) (ff (0) 0 (eul_socket_accept . ff_stub_eul_socket_accept5321)))
    ...
    ((name . handle) (pos . 3) (origin handler . handle) (inline (G0010416 (static-ref0) (binding-ref ? <handler>) (primitive-relative-ref))) (setter (G0010418 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <handler>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . read-into-buffer) (pos . 27) (origin stream1 . read-into-buffer) (class . ff) (arity . 3) (ff (0 3 0) 0 (read_into_buffer . ff_stub_read_into_buffer5326)))
    ((name . stream-mode) (pos . 17) (origin stream2 . stream-mode) (inline (G005798 (static-ref0) (binding-ref ? <stream>) (primitive-relative-ref))))
    ...
    ((name . eul_sprintf) (pos . 19) (origin stream1 . eul_sprintf) (class . ff) (arity . 4) (ff (3 0 3 8) 0 (eul_sprintf . ff_stub_eul_sprintf5318)))
    ...
    ((name . connection-host) (pos . 5) (origin socket . connection-host) (inline (G006349 (static-ref1) (binding-ref ? <connection>) (primitive-relative-ref))) (setter (G006361 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <connection>) (set-primitive-relative-ref) (nobble 2))))
    ((name . socket-queue-size) (pos . 6) (origin socket . socket-queue-size) (inline (G006339 (static-ref0) (binding-ref ? <socket>) (primitive-relative-ref))) (setter (G006351 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <socket>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-size) (pos . 5) (origin table1 . table-size) (inline (G008389 (static-ref1) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G008401 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . control-block-buffer-pos) (pos . 11) (origin stream2 . control-block-buffer-pos) (inline (G005786 (static-ref1) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G005816 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . socket-descriptor) (pos . 3) (origin socket . socket-descriptor) (inline (G006341 (static-ref1) (binding-ref ? <socket>) (primitive-relative-ref))) (setter (G006353 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <socket>) (set-primitive-relative-ref) (nobble 2))))
