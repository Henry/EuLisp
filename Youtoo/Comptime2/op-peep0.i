...
;;;   Interface file for module op-peep0

(definterface op-peep0
  (import (level1)
   syntax (macros)
   ...
   export (
    ((name . guarded-rule) (pos . 2) (origin op-peep0 . guarded-rule))
    ((name . simple-rule) (pos . 3) (origin op-peep0 . simple-rule))
   )
   local-literals (
    (simple-rule . 17)
    (guarded-rule . 15)
