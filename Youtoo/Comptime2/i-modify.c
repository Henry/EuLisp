...
void initialize_module_i_modify()
{
  ...
  static const void *G003482[] = {I(aa,24,00,00),B(stream ,16),I(1c,24,00,00),B(i_param ,16),I(24,00,00,00),B(boot ,5),I(3c,03,1b,34),I(00,00,00,0d),I(1b,10,32,00),I(00,00,00,21),I(23,00,00,00),B(i_modify ,11),I(23,00,00,00),B(i_modify ,12),I(1f,03,24,00),B(i_error ,4),I(3d,03,02,45),I(02,00,00,00)};
  ...
  static const void *G003490[] = {I(aa,24,00,00),B(stream ,16),I(1c,24,00,00),B(i_param ,9),I(24,00,00,00),B(boot ,5),I(3c,03,1b,34),I(00,00,00,0d),I(1b,11,32,00),I(00,00,00,07),I(86,45,02,00)};
