...
void initialize_module_aux_table()
{
  ...
  static const void *G0039[] = {I(a8,46,01,24),B(mop_gf ,2),I(24,00,00,00),B(table1 ,4),I(1d,24,00,00),B(boot ,9),I(3c,03,1b,48),I(00,00,23,00),B(aux_table ,12),I(23,00,00,00),B(aux_table ,16),I(3b,01,24,00),B(boot1 ,41),I(24,00,00,00),B(boot1 ,41),I(3c,01,1c,23),B(aux_table ,12),I(23,00,00,00),B(aux_table ,15),I(3b,02,1d,3c),I(02,2a,1c,45),I(04,00,00,00)};
