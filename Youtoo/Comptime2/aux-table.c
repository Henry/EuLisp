...
void initialize_module_aux_table()
{
  ...
  static const void *G0028[] = {I(aa,47,00,00),I(10,24,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3d,03,00,00)};

  /* Byte-vector with size: 28 is_init: 0 index: 13 binding: access-table-print */
  static const void *G0030[] = {I(43,fe,46,01),I(1b,48,00,00),I(1c,24,00,00),B(boot1 ,41),I(3c,01,86,86),I(1d,3c,02,47),I(00,00,12,1b),I(34,00,00,00),I(00,00,00,34),I(1c,26,00,00),I(00,00,00,03),I(24,00,00,00),B(table1 ,3),I(08,24,00,00),B(stream ,12),I(1c,24,00,00),B(vector ,15),I(3d,02,06,22),I(01,32,00,00),I(00,00,00,22),I(23,00,00,00),B(aux_table ,12),I(23,00,00,00),B(aux_table ,11),I(3b,01,24,00),B(vector ,15),I(3d,01,05,45),I(05,00,00,00)};
  ...
  static const void *G0035[] = {I(ab,1c,34,00),I(00,00,00,2e),I(24,00,00,00),B(table ,7),I(24,00,00,00),B(boot1 ,41),I(3c,01,47,00),I(00,1f,03,1f),I(03,1f,03,3c),I(03,2a,1c,22),I(01,32,00,00),I(00,00,00,0a),I(47,00,00,45),I(02,00,00,00)};
  ...
  static const void *G0039[] = {I(a8,46,01,24),B(mop_gf ,2),I(24,00,00,00),B(table1 ,3),I(1d,24,00,00),B(boot ,5),I(3c,03,1b,48),I(00,00,23,00),B(aux_table ,12),I(23,00,00,00),B(aux_table ,16),I(3b,01,24,00),B(boot1 ,41),I(24,00,00,00),B(boot1 ,41),I(3c,01,1c,23),B(aux_table ,12),I(23,00,00,00),B(aux_table ,15),I(3b,02,1d,3c),I(02,2a,1c,45),I(04,00,00,00)};

  /* Byte-vector with size: 7 is_init: 0 index: 18 binding: access-table-size */
  static const void *G0041[] = {I(aa,24,00,00),B(boot1 ,41),I(3c,01,86,86),I(1d,3c,02,83),I(24,00,00,00),B(table1 ,3),I(08,45,01,00)};

  /* Byte-vector with size: 8 is_init: 0 index: 19 binding: access-table-map */
  static const void *G0043[] = {I(ab,24,00,00),B(boot1 ,41),I(3c,01,86,86),I(1d,3c,02,1d),I(1c,24,00,00),B(table ,2),I(3d,02,03,45),I(03,00,00,00)};

  /* Byte-vector with size: 8 is_init: 0 index: 20 binding: access-table-do */
  static const void *G0045[] = {I(ab,24,00,00),B(boot1 ,41),I(3c,01,86,86),I(1d,3c,02,1d),I(1c,24,00,00),B(table ,9),I(3d,02,03,45),I(03,00,00,00)};

  /* Byte-vector with size: 6 is_init: 0 index: 21 binding: access-table-values */
  static const void *G0047[] = {I(aa,24,00,00),B(boot1 ,41),I(3c,01,86,86),I(1d,3c,02,24),B(table1 ,8),I(3d,01,01,00)};

  /* Byte-vector with size: 6 is_init: 0 index: 22 binding: access-table-clear */
  static const void *G0049[] = {I(aa,24,00,00),B(boot1 ,41),I(3c,01,86,86),I(1d,3c,02,24),B(table1 ,12),I(3d,01,01,00)};
