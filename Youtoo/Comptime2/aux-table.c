...
void initialize_module_aux_table()
{
  ...
  static const void *G0049[] = {I(aa,24,00,00),B(boot1 ,39),I(3c,01,86,86),I(1d,3c,02,24),B(table1 ,9),I(3d,01,01,00)};
