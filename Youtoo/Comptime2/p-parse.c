...
void initialize_module_p_parse()
{
  ...
  eul_intern_symbol(sym_2107,"(method parse-module)");
  ...
  eul_intern_symbol(sym_2114,"interactive-parse");
  eul_intern_symbol(sym_2115,"top-level");
  ...
  p_parse_bindings[ 3] = G002092;
  p_parse_bindings[ 4] = str_2095;
  p_parse_bindings[ 5] = sym_2096;
  p_parse_bindings[ 6] = str_2097;
  p_parse_bindings[ 7] = sym_2098;
  p_parse_bindings[ 8] = sym_2099;
  p_parse_bindings[ 9] = sym_2100;
  p_parse_bindings[ 10] = sym_2101;
  p_parse_bindings[ 11] = str_2102;
  p_parse_bindings[ 12] = str_2103;
  p_parse_bindings[ 13] = str_2104;
  p_parse_bindings[ 14] = G002094;
  p_parse_bindings[ 15] = sym_2107;
  p_parse_bindings[ 16] = G002106;
  p_parse_bindings[ 17] = str_2110;
  p_parse_bindings[ 18] = str_2111;
  p_parse_bindings[ 19] = G002109;
  p_parse_bindings[ 1] = eul_nil;
  p_parse_bindings[ 20] = sym_2114;
  p_parse_bindings[ 21] = sym_2115;
  eul_allocate_lambda( p_parse_bindings[0], "initialize-p-parse", 0, G002113);
