...
void initialize_module_p_parse()
{
  ...
  eul_intern_symbol(sym_1097,"(method parse-module)");
  ...
  eul_intern_symbol(sym_1104,"interactive-parse");
  eul_intern_symbol(sym_1105,"top-level");
  ...
  p_parse_bindings[ 3] = G001082;
  p_parse_bindings[ 4] = str_1085;
  p_parse_bindings[ 5] = sym_1086;
  p_parse_bindings[ 6] = str_1087;
  p_parse_bindings[ 7] = sym_1088;
  p_parse_bindings[ 8] = sym_1089;
  p_parse_bindings[ 9] = sym_1090;
  p_parse_bindings[ 10] = sym_1091;
  p_parse_bindings[ 11] = str_1092;
  p_parse_bindings[ 12] = str_1093;
  p_parse_bindings[ 13] = str_1094;
  p_parse_bindings[ 14] = G001084;
  p_parse_bindings[ 15] = sym_1097;
  p_parse_bindings[ 16] = G001096;
  p_parse_bindings[ 17] = str_1100;
  p_parse_bindings[ 18] = str_1101;
  p_parse_bindings[ 19] = G001099;
  p_parse_bindings[ 1] = eul_nil;
  p_parse_bindings[ 20] = sym_1104;
  p_parse_bindings[ 21] = sym_1105;
  eul_allocate_lambda( p_parse_bindings[0], "initialize-p-parse", 0, G001103);
