...
(definterface cg-bycode2
  (import (i-level1 cg-bycode)
   ...
   export (
    ...
    ((name . bytecode-code?) (pos . 14) (origin cg-bycode . bytecode-code?) (inline (G004259 (static-fpi-ref 3) (binding-ref ? <bytecode>) (primitive-relative-ref))))
    ((name . bytecode-modus!) (pos . 10) (origin cg-bycode . bytecode-modus!) (inline (G004249 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <bytecode>) (set-primitive-relative-ref) (nobble 2))))
    ((name . bytecode-args?) (pos . 8) (origin cg-bycode . bytecode-args?) (inline (G004263 (static-fpi-ref 4) (binding-ref ? <bytecode>) (primitive-relative-ref))))
    ((name . bytecodep) (pos . 3) (origin cg-bycode . bytecodep))
    ((name . bytecode-code!) (pos . 15) (origin cg-bycode . bytecode-code!) (inline (G004261 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <bytecode>) (set-primitive-relative-ref) (nobble 2))))
    ((name . bytecode-properties!) (pos . 11) (origin cg-bycode . bytecode-properties!) (inline (G004257 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <bytecode>) (set-primitive-relative-ref) (nobble 2))))
    ((name . bytecode-name?) (pos . 12) (origin cg-bycode . bytecode-name?) (inline (G004267 (static-fpi-ref 5) (binding-ref ? <bytecode>) (primitive-relative-ref))))
    ...
    ((name . bytecode-size?) (pos . 13) (origin cg-bycode . bytecode-size?) (inline (G004251 (static-ref1) (binding-ref ? <bytecode>) (primitive-relative-ref))))
    ((name . <bytecode>) (pos . 6) (origin cg-bycode . <bytecode>) (class . constant))
    ((name . bytecode-modus?) (pos . 16) (origin cg-bycode . bytecode-modus?) (inline (G004247 (static-ref0) (binding-ref ? <bytecode>) (primitive-relative-ref))))
    ((name . bytecode-properties?) (pos . 5) (origin cg-bycode . bytecode-properties?) (inline (G004255 (static-ref2) (binding-ref ? <bytecode>) (primitive-relative-ref))))
