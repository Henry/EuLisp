...
void initialize_module_an_side()
{
  ...
  static const void *G002903[] = {I(aa,1b,47,00),I(00,86,6c,12),I(1b,44,2f,1c),I(8a,03,24,00),B(sx_obj2 ,11),I(08,23,00,00),B(an_side ,3),I(1c,24,00,00),B(i_notify ,4),I(3c,02,2a,1d),I(87,1c,82,1d),I(24,00,00,00),B(sx_obj2 ,9),I(09,22,03,36),I(02,86,45,02)};

  /* Byte-vector with size: 27 is_init: 0 index: 6 binding: (method-compute-captured-vars) */
  static const void *G002906[] = {I(aa,46,01,1b),I(8a,05,24,00),B(sx_obj ,17),I(08,1c,83,24),B(sx_obj ,13),I(08,24,00,00),B(boot ,8),I(3c,02,1b,48),I(00,00,1c,82),I(24,00,00,00),B(sx_obj ,13),I(08,24,00,00),B(sx_obj1 ,18),I(1c,24,00,00),B(boot ,11),I(3c,02,24,00),B(sx_obj2 ,18),I(1c,24,00,00),B(list ,37),I(3c,02,23,00),B(an_side ,5),I(23,00,00,00),B(an_side ,4),I(3b,01,1c,24),B(boot ,17),I(3d,02,05,45),I(05,00,00,00)};

  /* Byte-vector with size: 16 is_init: 0 index: 7 binding: (method-compute-captured-vars) */
  static const void *G002909[] = {I(aa,1b,8a,09),I(24,00,00,00),B(sx_obj1 ,59),I(08,24,00,00),B(an_side ,2),I(1c,24,00,00),B(boot ,17),I(3c,02,2a,1c),I(8a,08,24,00),B(sx_obj1 ,59),I(08,24,00,00),B(an_side ,2),I(1c,24,00,00),B(boot ,17),I(3d,02,03,45),I(03,00,00,00)};
