...
void initialize_module_i_notify()
{
  ...
  static const void *G00313[] = {I(43,fc,1d,12),I(1b,34,00,00),I(00,00,00,0f),I(86,32,00,00),I(00,00,00,3e),I(24,00,00,00),B(format ,4),I(1f,05,1f,04),I(1f,04,24,00),B(boot ,5),I(3c,04,2a,1f),I(04,24,00,00),B(stream ,11),I(24,00,00,00),B(stream ,6),I(3c,02,2a,1f),I(04,24,00,00),B(stream ,12),I(3d,01,05,45),I(05,00,00,00)};
