...
void initialize_module_i_notify()
{
  ...
  static const void *G00309[] = {I(43,fd,24,00),B(i_param ,46),I(83,14,1b,89),B(i_param ,46),I(2a,24,00,00),B(i_param ,38),I(3c,00,2a,24),B(i_param ,10),I(12,1b,34,00),I(00,00,00,36),I(24,00,00,00),B(i_notify ,2),I(24,00,00,00),B(i_param ,25),I(23,00,00,00),B(i_notify ,24),I(1f,06,1f,06),I(24,00,00,00),B(boot ,5),I(3c,05,2a,1f),I(04,32,00,00),I(00,00,00,4c),I(86,24,00,00),B(i_param ,3),I(3c,01,24,00),B(format ,2),I(1f,05,1f,05),I(24,00,00,00),B(boot ,5),I(3c,03,23,00),B(i_notify ,12),I(24,00,00,00),B(dynamic ,3),I(3c,01,1d,1d),I(23,00,00,00),B(i_notify ,25),I(1f,03,24,00),B(boot ,13),I(3d,04,08,22),I(03,45,05,00)};
