...
void initialize_module_i_notify()
{
  ...
  static const void *G00301[] = {I(43,fe,24,00),B(i_param ,20),I(12,23,00,00),B(i_notify ,19),I(24,00,00,00),B(dynamic ,3),I(3c,01,1b,1f),I(04,24,00,00),B(string ,11),I(3c,02,24,00),B(i_notify ,7),I(24,00,00,00),B(stream2 ,10),I(1f,04,1f,03),I(1f,07,24,00),B(boot ,5),I(3d,05,05,45),I(05,00,00,00)};

  /* Byte-vector with size: 10 is_init: 0 index: 21 binding: notify0 */
  static const void *G00304[] = {I(43,fe,24,00),B(i_notify ,7),I(24,00,00,00),B(stream2 ,10),I(24,00,00,00),B(i_param ,51),I(1f,04,1f,04),I(24,00,00,00),B(boot ,5),I(3d,05,02,00)};
  ...
  static const void *G00309[] = {I(43,fd,24,00),B(i_param ,46),I(83,14,1b,89),B(i_param ,46),I(2a,24,00,00),B(i_param ,38),I(3c,00,2a,24),B(i_param ,10),I(12,1b,34,00),I(00,00,00,36),I(24,00,00,00),B(i_notify ,2),I(24,00,00,00),B(i_param ,25),I(23,00,00,00),B(i_notify ,24),I(1f,06,1f,06),I(24,00,00,00),B(boot ,5),I(3c,05,2a,1f),I(04,32,00,00),I(00,00,00,4c),I(24,00,00,00),B(format ,2),I(1f,04,1f,04),I(24,00,00,00),B(boot ,5),I(3c,03,86,24),B(i_param ,3),I(3c,01,23,00),B(i_notify ,12),I(24,00,00,00),B(dynamic ,3),I(3c,01,1d,1d),I(23,00,00,00),B(i_notify ,25),I(1f,03,24,00),B(boot ,12),I(3d,04,08,22),I(03,45,05,00)};

  /* Byte-vector with size: 18 is_init: 0 index: 27 binding: basic-notify */
  static const void *G00313[] = {I(43,fc,1d,12),I(1b,34,00,00),I(00,00,00,0f),I(86,32,00,00),I(00,00,00,36),I(24,00,00,00),B(format ,4),I(1f,05,1f,04),I(1f,04,24,00),B(boot ,5),I(3c,04,2a,1f),I(04,24,00,00),B(stream ,6),I(3c,01,2a,1f),I(04,24,00,00),B(stream ,13),I(3d,01,05,45),I(05,00,00,00)};
