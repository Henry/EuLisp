...
void initialize_module_i_all()
{
  ...
  static const void *G00416[] = {I(87,25,00,00),B(i_all ,1),I(24,00,00,00),B(i_notify ,1),I(3e,0b,24,00),B(i_notify ,0),I(3c,00,21,01),I(24,00,00,00),B(i_error ,1),I(3e,0b,24,00),B(i_error ,0),I(3c,00,21,01),I(24,00,00,00),B(i_param ,1),I(3e,0b,24,00),B(i_param ,0),I(3c,00,21,01),I(24,00,00,00),B(i_level_1 ,1),I(3e,0b,24,00),B(i_level_1 ,0),I(3c,00,21,01),I(86,ac,00,00)};
  ...
  eul_allocate_lambda( i_all_bindings[0], "initialize-i-all", 0, G00417);
