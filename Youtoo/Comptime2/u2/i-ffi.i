...
(definterface i-ffi
  (import (i-all)
   ...
   local-literals (
    ...
    (* . 26)
    (#(<fpi> <character> <double-float> <string> <symbol> boolean ptr <int*> <double*> <string*> void) . 25)
    (void . 24)
    (#("int" "char" "double" "const char *" "void **" "int" "const char *" "int" "void *" "int *" "double *" "char **") . 23)
    (#(<fpi> <character> <double-float> <string> <vector> <file-stream> <symbol> boolean ptr <int*> <double*> <string*>) . 22)
    (<string*> . 21)
    (<double*> . 20)
    (<int*> . 19)
    (ptr . 18)
