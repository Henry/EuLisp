...
(definterface i-all
  (import (i-level-1 i-param i-error i-notify)
   ...
   export (
    ...
    ((name . table-fill-value) (pos . 20) (origin table1 . table-fill-value) (inline (G007962 (static-ref2) (binding-ref ? <table>) (primitive-relative-ref))))
    ...
    ((name . table-entries) (pos . 19) (origin table1 . table-entries) (inline (G007964 (static-fpi-byte-ref 3) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G007974 (stack-ref 1) (static-fpi-byte-ref 3) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-threshold) (pos . 16) (origin table1 . table-threshold) (inline (G007958 (static-ref0) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G007970 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-hash-function) (pos . 15) (origin table1 . table-hash-function) (inline (G007966 (static-ref0) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G007976 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-comparator) (pos . 12) (origin table1 . table-comparator) (inline (G007968 (static-ref1) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G007978 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . handle) (pos . 3) (origin handler . handle) (inline (G009995 (static-ref0) (binding-ref ? <handler>) (primitive-relative-ref))) (setter (G009997 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <handler>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-size) (pos . 5) (origin table1 . table-size) (inline (G007960 (static-ref1) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G007972 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
