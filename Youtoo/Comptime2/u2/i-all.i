...
(definterface i-all
  (import (i-level-1 i-param i-error i-notify)
   ...
   export (
    ...
    ((name . table-entries) (pos . 19) (origin table1 . table-entries) (inline (G007818 (static-fpi-ref 3) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G007828 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-sink) (pos . 38) (origin stream2 . stream-sink) (inline (G005241 (static-fpi-ref 5) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G005269 (stack-ref 1) (static-fpi-ref 5) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . control-block-buffer) (pos . 33) (origin stream2 . control-block-buffer) (inline (G005223 (static-fpi-ref 4) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G005255 (stack-ref 1) (static-fpi-ref 4) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . socket-port) (pos . 9) (origin socket . socket-port) (inline (G005794 (static-fpi-ref 3) (binding-ref ? <socket>) (primitive-relative-ref))) (setter (G005806 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <socket>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . control-block-buffer-size) (pos . 8) (origin stream2 . control-block-buffer-size) (inline (G005221 (static-fpi-ref 3) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G005253 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-read-action) (pos . 7) (origin stream2 . stream-read-action) (inline (G005237 (static-fpi-ref 3) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G005265 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-source) (pos . 22) (origin stream2 . stream-source) (inline (G005239 (static-fpi-ref 4) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G005267 (stack-ref 1) (static-fpi-ref 4) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . handle) (pos . 3) (origin handler . handle) (inline (G009843 (static-ref0) (binding-ref ? <handler>) (primitive-relative-ref))) (setter (G009845 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <handler>) (set-primitive-relative-ref) (nobble 2))))
