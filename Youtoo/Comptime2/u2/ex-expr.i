...
(definterface ex-expr
  (import (i-all p-env sx-node sx-obj ex-import ex-syntax ex-direct cg-dld)
   ...
   local-literals (
    ...
    ("APPLY MACRO: ~a" . 286)
    (|(method G005898)| . 285)
    ("bad macro expansion of ~a in ~s" . 283)
    ...
    (fpi-binary . 259)
    (setter . 255)
    ("no lexical binding ~a available in ~s" . 254)
    (ff . 252)
    (opencoding . 251)
    ("~~" . 249)
    ("~~" . 248)
    ...
    (args: . 242)
    (fun: . 241)
    ("no lexical binding ~a available in ~s" . 237)
    ...
    (lift-if . 175)
    (check-appl . 174)
    ("no applicable object ~a in ~s" . 172)
    ("macro binding ~a should be in syntax import in ~s" . 171)
    (*encl-lambda* . 164)
    ("missing else branch in (if ~a ...) in ~s" . 161)
    ("bad if syntax (if ~a ...) in ~s" . 160)
    (|(method G006368)| . 159)
    ("bad if syntax ~a in ~s" . 157)
