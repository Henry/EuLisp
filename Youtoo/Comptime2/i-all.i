...
(definterface i-all
  (import (i-level1 i-param i-error i-notify)
   ...
   export (
    ...
    ((name . <simple-method>) (pos . 54) (origin mop-class . <simple-method>) (class . constant))
    ...
    ((name . reset) (pos . 21) (origin collect . reset))
    ...
    ((name . int-binary-mod) (pos . 39) (origin boot1 . mod) (inline (G0070 (fpi-remainder))))
    ...
    ((name . concatenate) (pos . 20) (origin collect . concatenate))
    ...
    ((name . all?) (pos . 19) (origin collect . all?))
    ((name . primitive-prin) (pos . 36) (origin boot1 . prin))
    ...
    ((name . int-binary=) (pos . 10) (origin boot1 . =) (inline (G0074 (fpi-equal))))
    ...
    ((name . gf-keywords) (pos . 55) (origin mop-class . gf-keywords) (class . constant))
    ((name . call1/cc) (pos . 17) (origin thread . call1/cc))
    ((name . slot-writer) (pos . 52) (origin mop-class . slot-writer) (inline (G00749 (static-ref1) (primitive-ref))) (setter (G00809 (stack-ref 1) (static-ref1) (stack-ref 2) (set-primitive-ref) (nobble 2))))
    ...
    ((name . reverse) (pos . 24) (origin boot . reverse-list))
    ...
    ((name . fill) (pos . 22) (origin collect . fill))
    ...
    ((name . <local-slot>) (pos . 56) (origin mop-class . <local-slot>) (class . constant))
    ...
    ((name . method-generic-function) (pos . 53) (origin mop-class . method-generic-function) (inline (G00741 (static-ref0) (primitive-ref))) (setter (G00801 (stack-ref 1) (static-ref0) (stack-ref 2) (set-primitive-ref) (nobble 2))))
    ...
    ((name . int-binary<) (pos . 41) (origin boot1 . <) (inline (G0072 (fpi-lt))))
