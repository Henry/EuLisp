...
(definterface i-all
  (import (i-level1 i-param i-error i-notify)
   ...
   export (
    ...
    ((name . socket-port) (pos . 9) (origin socket . socket-port) (inline (G005378 (static-fpi-ref 3) (binding-ref ? <socket>) (primitive-relative-ref))) (setter (G005390 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <socket>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . connection-port) (pos . 7) (origin socket . connection-port) (inline (G005380 (static-ref0) (binding-ref ? <connection>) (primitive-relative-ref))) (setter (G005392 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <connection>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . <thread>) (pos . 8) (origin thread . <thread>))
    ...
    ((name . handle) (pos . 3) (origin handler . handle) (inline (G009400 (static-ref0) (binding-ref ? <handler>) (primitive-relative-ref))) (setter (G009402 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <handler>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . connection-host) (pos . 5) (origin socket . connection-host) (inline (G005382 (static-ref1) (binding-ref ? <connection>) (primitive-relative-ref))) (setter (G005394 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <connection>) (set-primitive-relative-ref) (nobble 2))))
    ((name . socket-queue-size) (pos . 6) (origin socket . socket-queue-size) (inline (G005372 (static-ref0) (binding-ref ? <socket>) (primitive-relative-ref))) (setter (G005384 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <socket>) (set-primitive-relative-ref) (nobble 2))))
