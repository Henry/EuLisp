...
(definterface i-all
  (import (i-level1 i-param i-error i-notify)
   ...
   export (
    ...
    ((name . vector-empty?) (pos . 16) (origin vector . vector-empty?) (inline (G006750 (primitive-size) (fpi-zerop))))
    ...
    ((name . handle) (pos . 3) (origin handler . handle) (inline (G009386 (static-ref0) (binding-ref ? <handler>) (primitive-relative-ref))) (setter (G009388 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <handler>) (set-primitive-relative-ref) (nobble 2))))
