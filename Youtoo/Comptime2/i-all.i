...
(definterface i-all
  (import (i-level1 i-param i-error i-notify)
   ...
   export (
    ...
    ((name . table-fill-value) (pos . 17) (origin table1 . table-fill-value) (inline (G007370 (static-ref2) (binding-ref ? <table>) (primitive-relative-ref))))
    ...
    ((name . table-entries) (pos . 15) (origin table1 . table-entries) (inline (G007372 (static-fpi-ref 3) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G007382 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-threshold) (pos . 11) (origin table1 . table-threshold) (inline (G007366 (static-ref0) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G007378 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ((name . *debug*) (pos . 47) (origin i-param . *debug*))
    ((name . ct-serious-warning) (pos . 6) (origin i-notify . ct-serious-warning))
    ((name . table-hash-function) (pos . 10) (origin table1 . table-hash-function) (inline (G007374 (static-ref0) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G007384 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-comparator) (pos . 7) (origin table1 . table-comparator) (inline (G007376 (static-ref1) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G007386 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . handle) (pos . 4) (origin handler . handle) (inline (G009395 (static-ref0) (binding-ref ? <handler>) (primitive-relative-ref))) (setter (G009397 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <handler>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-size) (pos . 5) (origin table1 . table-size) (inline (G007368 (static-ref1) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G007380 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
