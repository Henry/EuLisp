...
(definterface i-all
  (import (i-level1 i-param i-error i-notify)
   ...
   export (
    ...
    ((name . generic-function-domain) (pos . 59) (origin mop-class . generic-function-domain) (inline (G00727 (static-ref1) (primitive-ref))) (setter (G00787 (stack-ref 1) (static-ref1) (stack-ref 2) (set-primitive-ref) (nobble 2))))
    ...
    ((name . int-binary-) (pos . 14) (origin boot1 . -) (inline (G0062 (fpi-difference))))
    ...
    ((name . print-all) (pos . 20) (origin stream . print-all))
    ...
    ((name . int-binary+) (pos . 13) (origin boot1 . +) (inline (G0060 (fpi-sum))))
    ...
    ((name . sprint-all) (pos . 7) (origin stream . sprint-all))
    ...
    ((name . int-binary*) (pos . 33) (origin boot1 . *) (inline (G0064 (fpi-product))))
