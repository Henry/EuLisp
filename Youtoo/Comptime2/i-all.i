...
(definterface i-all
  (import (i-level1 i-param i-error i-notify)
   ...
   export (
    ...
    ((name . allp1-table) (pos . 10) (origin table . allp1-table))
    ((name . *no-gc*) (pos . 64) (origin i-param . *no-gc*))
    ...
    ((name . negativep) (pos . 20) (origin number . negativep) (inline (G001972 (static-ref0) (fpi-lt))))
    ...
    ((name . do1-table) (pos . 8) (origin table . do1-table))
    ...
    ((name . anyp1-table) (pos . 7) (origin table . anyp1-table))
    ...
    ((name . abs) (pos . 19) (origin number . abs) (inline (G001959 (stack-ref 0) (static-ref0) (fpi-lt) (stack-ref 0) (branch-nil G001961number) (static-ref0) (stack-ref 2) (fpi-difference) (branch G001962number) (label G001961number) (stack-ref 1) (label G001962number) (nobble 1) (nobble 1))))
    ...
    ((name . positivep) (pos . 15) (origin number . positivep) (inline (G001970 (static-ref0) (stack-ref 1) (fpi-lt) (nobble 1))))
    ...
    ((name . table-ref) (pos . 4) (origin table . table-ref))
    ...
    ((name . table-empty?) (pos . 3) (origin table . table-empty?))
    ...
    ((name . list-equal) (pos . 46) (origin boot1 . equal))
    ...
    ((name . map1-table) (pos . 5) (origin table . map1-table))
    ...
    ((name . int-binary<) (pos . 40) (origin boot1 . <) (inline (G0072 (fpi-lt))))
    ...
    ((name . keywordp) (pos . 2) (origin symbol . keywordp))
