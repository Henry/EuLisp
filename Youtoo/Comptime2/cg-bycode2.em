...
(def-bytecode eql ()   81 (in obj1 obj2) (out obj))
...
(def-register double-float-class      6)
(def-register double-float-ref-class  41)
...
;  (def-register cons-class        4)
;  (def-register double-float-class      5)
;  (def-register double-float-ref-class  6)
