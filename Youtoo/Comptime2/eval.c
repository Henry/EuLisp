...
void initialize_module_eval()
{
  ...
  static const void *G0052[] = {I(ab,24,00,00),B(stream2 ,9),I(1d,24,00,00),B(stream ,11),I(24,00,00,00),B(stream ,6),I(3c,03,2a,85),I(24,00,00,00),B(i_error ,2),I(3d,01,02,00)};
