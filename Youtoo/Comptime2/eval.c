...
void initialize_module_eval()
{
  ...
  /* Byte-vector with size: 10 is_init: 0 index: 10 binding: (method-G003) */
  static const void *G0052[] = {I(ab,24,00,00),B(stream2 ,9),I(1d,24,00,00),B(stream ,14),I(24,00,00,00),B(stream ,7),I(3c,03,2a,85),I(24,00,00,00),B(i_error ,2),I(3d,01,02,00)};
