...
void initialize_module_eval()
{
  ...
  {
  /* Declarations */
  LispRef sym_8135, sym_8134, G008133, sym_8131, G008130, G008128, G008126, sym_8124, G008121, G008118;

  /* Code vector and literal definitions */
  eul_allocate_static_string(str_8119, "Module ~a need not be recompiled.", 33);
  /* Byte-vector with size: 18 is_init: 0 index: 5 binding: anonymous */
  static const void *G008117[] = {I(aa,1b,89,00),B(i_param ,23),I(2a,1b,24,00),B(cg_interf ,7),I(3c,01,1b,34),I(00,00,00,15),I(1c,24,00,00),B(i_compile ,10),I(3c,01,32,00),I(00,00,00,18),I(23,00,00,00),B(eval ,4),I(1d,24,00,00),B(i_notify ,3),I(3c,02,2a,1c),I(24,00,00,00),B(i_compile ,3),I(3d,01,02,00)};

  eul_allocate_static_string(str_8122, "", 0);
  eul_allocate_static_string(str_8123, "Start EuLysses ...", 18);
  ...
  eval_bindings[ 4] = str_8119;
  eval_bindings[ 5] = G008118;
  eval_bindings[ 6] = str_8122;
  eval_bindings[ 7] = str_8123;
  eval_bindings[ 8] = sym_8124;
  eval_bindings[ 9] = G008121;
  eval_bindings[ 10] = G008126;
  eval_bindings[ 11] = G008128;
  eval_bindings[ 12] = sym_8131;
  eval_bindings[ 13] = G008130;
  eval_bindings[ 1] = eul_nil;
  eval_bindings[ 14] = sym_8134;
  eval_bindings[ 15] = sym_8135;
  eul_allocate_lambda( eval_bindings[0], "initialize-eval", 0, G008133);
