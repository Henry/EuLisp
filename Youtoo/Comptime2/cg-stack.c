...
void initialize_module_cg_stack()
{
  ...
  static const void *G002822[] = {I(ab,1c,12,1b),I(34,00,00,00),I(00,00,00,34),I(47,00,00,26),I(00,00,00,03),I(24,00,00,00),B(sx_obj2 ,11),I(08,86,23,00),B(cg_stack ,19),I(1d,24,00,00),B(i_notify ,6),I(3d,03,04,22),I(01,32,00,00),I(00,00,00,3a),I(1d,10,47,00),I(00,1c,24,00),B(list ,4),I(3c,02,1b,34),I(00,00,00,15),I(1f,03,1c,24),B(boot1 ,26),I(3d,02,05,32),I(00,00,00,12),I(1f,04,11,83),I(1f,05,14,47),I(00,01,3d,02),I(05,22,02,45),I(03,00,00,00)};
