...
void initialize_module_cg_stack()
{
  ...
  static const void *G002805[] = {I(aa,1b,34,00),I(00,00,00,2e),I(1b,73,1b,47),I(00,00,50,1b),I(34,00,00,00),I(00,00,00,10),I(1d,10,32,00),I(00,00,00,0e),I(1d,75,47,00),I(01,3d,01,03),I(22,02,32,00),I(00,00,00,21),I(23,00,00,00),B(cg_stack ,9),I(24,00,00,00),B(condition ,8),I(24,00,00,00),B(boot ,12),I(3d,02,01,45),I(01,00,00,00)};

  /* Byte-vector with size: 18 is_init: 0 index: 12 binding: stack-var-index */
  static const void *G002808[] = {I(ab,46,02,1c),I(48,00,00,86),I(1b,48,00,01),I(23,00,00,00),B(cg_stack ,11),I(23,00,00,00),B(cg_stack ,10),I(3b,01,48,00),I(01,1c,26,00),I(00,00,00,03),I(24,00,00,00),B(cg_state ,30),I(08,1d,84,24),B(cg_state ,30),I(08,1b,47,00),I(01,3c,01,1b),I(83,14,1f,03),I(1c,15,45,07)};

  /* Byte-vector with size: 16 is_init: 0 index: 13 binding: push-stack-var */
  static const void *G002811[] = {I(ab,1b,26,00),I(00,00,00,03),I(24,00,00,00),B(cg_state ,30),I(08,1c,84,24),B(cg_state ,30),I(08,83,1f,03),I(24,00,00,00),B(cg_stack ,6),I(3c,02,2a,1f),I(03,1c,0f,1d),I(1c,0f,1f,04),I(1c,1c,84,1d),I(24,00,00,00),B(cg_state ,30),I(09,45,08,00)};
  ...
  static const void *G002815[] = {I(ab,46,02,1c),I(48,00,00,86),I(1b,48,00,01),I(23,00,00,00),B(cg_stack ,11),I(23,00,00,00),B(cg_stack ,14),I(3b,01,48,00),I(01,1c,84,24),B(cg_state ,30),I(08,1b,47,00),I(01,3c,01,1f),I(03,1c,1c,84),I(1d,24,00,00),B(cg_state ,30),I(09,45,07,00)};

  /* Byte-vector with size: 17 is_init: 0 index: 16 binding: pop-display */
  static const void *G002817[] = {I(ab,1c,82,19),I(1b,34,00,00),I(00,00,00,0f),I(1c,32,00,00),I(00,00,00,34),I(1c,83,24,00),B(cg_state ,30),I(08,1b,11,1f),I(03,1c,1c,83),I(1d,24,00,00),B(cg_state ,30),I(09,22,02,2a),I(1f,04,83,15),I(1b,1f,05,24),B(cg_stack ,5),I(3d,02,06,22),I(03,45,03,00)};

  eul_allocate_static_string(str_2821, "stack underflow", 15);
  /* Byte-vector with size: 34 is_init: 0 index: 18 binding: move-stack */
  static const void *G002819[] = {I(ab,1c,82,19),I(1b,34,00,00),I(00,00,00,0f),I(86,32,00,00),I(00,00,00,78),I(1c,26,00,00),I(00,00,00,03),I(24,00,00,00),B(cg_state ,30),I(08,1b,1f,04),I(14,1b,82,1a),I(1b,34,00,00),I(00,00,00,1f),I(86,23,00,00),B(cg_stack ,17),I(24,00,00,00),B(i_notify ,6),I(3d,02,06,32),I(00,00,00,3c),I(1f,04,1d,1c),I(26,00,00,00),I(00,00,00,03),I(1d,24,00,00),B(cg_state ,30),I(09,22,02,2a),I(1f,05,82,1a),I(1b,34,00,00),I(00,00,00,17),I(1d,1f,06,24),B(cg_stack ,4),I(3d,02,07,32),I(00,00,00,06),I(86,22,01,22),I(03,45,03,00)};
  ...
  static const void *G002822[] = {I(ab,1c,12,1b),I(34,00,00,00),I(00,00,00,34),I(47,00,00,26),I(00,00,00,03),I(24,00,00,00),B(sx_obj2 ,28),I(08,86,23,00),B(cg_stack ,19),I(1d,24,00,00),B(i_notify ,6),I(3d,03,04,22),I(01,32,00,00),I(00,00,00,3a),I(1d,10,47,00),I(00,1c,24,00),B(list ,8),I(3c,02,1b,34),I(00,00,00,15),I(1f,03,1c,24),B(boot1 ,25),I(3d,02,05,32),I(00,00,00,12),I(1f,04,11,83),I(1f,05,14,47),I(00,01,3d,02),I(05,22,02,45),I(03,00,00,00)};

  /* Byte-vector with size: 13 is_init: 0 index: 21 binding: display-var-index */
  static const void *G002825[] = {I(ab,46,02,1c),I(48,00,00,86),I(1b,48,00,01),I(23,00,00,00),B(cg_stack ,11),I(23,00,00,00),B(cg_stack ,20),I(3b,02,48,00),I(01,1c,83,24),B(cg_state ,30),I(08,82,47,00),I(01,3d,02,03),I(45,03,00,00)};

  /* Byte-vector with size: 7 is_init: 0 index: 22 binding: push-display */
  static const void *G002827[] = {I(ab,1b,83,24),B(cg_state ,30),I(08,1d,1c,0f),I(1d,1c,1c,83),I(1d,24,00,00),B(cg_state ,30),I(09,45,06,00)};
