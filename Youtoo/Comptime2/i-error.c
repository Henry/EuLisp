...
void initialize_module_i_error()
{
  ...
  static const void *G00384[] = {I(a9,24,00,00),B(condition ,9),I(24,00,00,00),B(boot1 ,23),I(3c,01,23,00),B(i_error ,9),I(23,00,00,00),B(i_error ,10),I(23,00,00,00),B(i_error ,11),I(23,00,00,00),B(i_error ,12),I(24,00,00,00),B(boot1 ,23),I(3c,04,1b,24),B(boot1 ,23),I(3c,01,24,00),B(mop_class ,70),I(23,00,00,00),B(i_error ,9),I(23,00,00,00),B(i_error ,13),I(23,00,00,00),B(i_error ,14),I(1f,06,23,00),B(i_error ,15),I(1f,06,23,00),B(i_error ,16),I(23,00,00,00),B(i_error ,17),I(24,00,00,00),B(mop_gf ,2),I(3c,09,1b,89),B(i_error ,5),I(2a,24,00,00),B(boot1 ,39),I(24,00,00,00),B(boot1 ,39),I(3c,01,24,00),B(i_error ,3),I(23,00,00,00),B(i_error ,18),I(23,00,00,00),B(i_error ,8),I(3b,02,1d,3c),I(02,2a,24,00),B(i_error ,5),I(2a,24,00,00),B(i_param ,3),I(26,00,00,00),I(00,00,00,03),I(02,83,86,24),B(boot1 ,37),I(3c,02,24,00),B(boot1 ,23),I(3c,00,24,00),B(i_param ,3),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(i_error ,19),I(23,00,00,00),B(i_error ,7),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(i_param ,3),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(stream2 ,2),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(i_error ,5),I(24,00,00,00),B(stream2 ,21),I(24,00,00,00),B(boot1 ,37),I(3c,03,24,00),B(boot1 ,23),I(3c,00,24,00),B(stream2 ,2),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(i_error ,20),I(23,00,00,00),B(i_error ,6),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(stream2 ,2),I(1c,24,00,00),B(mop_meth ,5),I(3d,02,11,45),I(11,00,00,00)};
