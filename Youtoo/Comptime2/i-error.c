...
void initialize_module_i_error()
{
  ...
  static const void *G00405[] = {I(43,fd,24,00),B(format ,2),I(1d,1d,24,00),B(boot ,5),I(3c,03,24,00),B(i_error ,5),I(1c,23,00,00),B(i_error ,12),I(1f,06,24,00),B(boot ,12),I(3d,04,04,45),I(04,00,00,00)};
