...
(definterface cg-bycode
  (import (i-level1)
   ...
   export (
    ...
    ((name . bytecode-modus?) (pos . 15) (origin cg-bycode . bytecode-modus?) (inline (G004266 (static-ref0) (binding-ref ? <bytecode>) (primitive-relative-ref))))
    ((name . bytecode-properties?) (pos . 3) (origin cg-bycode . bytecode-properties?) (inline (G004274 (static-ref2) (binding-ref ? <bytecode>) (primitive-relative-ref))))
