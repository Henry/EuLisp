...
(definterface cg-bycode
  (import (i-level1)
   ...
   export (
    ...
    ((name . bytecode-args?) (pos . 7) (origin cg-bycode . bytecode-args?) (inline (G004263 (static-fpi-ref 4) (binding-ref ? <bytecode>) (primitive-relative-ref))))
    ((name . bytecode-code!) (pos . 14) (origin cg-bycode . bytecode-code!) (inline (G004261 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <bytecode>) (set-primitive-relative-ref) (nobble 2))))
    ((name . bytecode-properties!) (pos . 10) (origin cg-bycode . bytecode-properties!) (inline (G004257 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <bytecode>) (set-primitive-relative-ref) (nobble 2))))
    ((name . bytecode-name?) (pos . 11) (origin cg-bycode . bytecode-name?) (inline (G004267 (static-fpi-ref 5) (binding-ref ? <bytecode>) (primitive-relative-ref))))
    ...
    ((name . bytecode-size?) (pos . 12) (origin cg-bycode . bytecode-size?) (inline (G004251 (static-ref1) (binding-ref ? <bytecode>) (primitive-relative-ref))))
