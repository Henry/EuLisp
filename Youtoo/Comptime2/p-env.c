...
void initialize_module_p_env()
{
  ...
  static const void *G002698[] = {I(ab,1c,24,00),B(p_env ,17),I(3c,01,1b,34),I(00,00,00,1d),I(86,23,00,00),B(p_env ,40),I(1f,04,24,00),B(i_notify ,5),I(3d,03,03,32),I(00,00,00,21),I(24,00,00,00),B(i_param ,31),I(24,00,00,00),B(boot1 ,45),I(3c,01,1f,03),I(1f,03,1d,3d),I(02,04,22,01),I(45,03,00,00)};
