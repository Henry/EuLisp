...
void initialize_module_cg_asm()
{
  ...
  static const void *G006404[] = {I(ab,24,00,00),B(stream2 ,10),I(23,00,00,00),B(cg_asm ,29),I(24,00,00,00),B(mop_gf ,17),I(3c,02,2a,1c),I(24,00,00,00),B(stream2 ,10),I(24,00,00,00),B(mop_access ,3),I(3c,02,2a,24),B(i_param ,56),I(34,00,00,00),I(00,00,00,10),I(86,32,00,00),I(00,00,00,2a),I(23,00,00,00),B(cg_asm ,30),I(24,00,00,00),B(i_error ,5),I(23,00,00,00),B(cg_asm ,31),I(47,00,00,24),B(boot ,22),I(3d,04,02,45),I(02,00,00,00)};
  ...
  static const void *G006467[] = {I(ab,1c,82,02),I(1b,1d,24,00),B(string ,11),I(3c,02,1b,41),B(boot1 ,53),I(22,01,1b,24),B(cg_bycode ,18),I(3c,01,26,00),I(00,00,00,03),I(24,00,00,00),B(cg_bycode ,5),I(08,45,05,00)};
