...
void initialize_module_cg_asm()
{
  ...
  static const void *G006451[] = {I(ab,23,00,00),B(cg_asm ,62),I(1c,24,00,00),B(i_notify ,4),I(3c,02,2a,1c),I(82,24,00,00),B(cg_state ,19),I(08,1b,84,14),I(1f,03,1c,1c),I(82,1d,24,00),B(cg_state ,19),I(09,22,02,2a),I(1f,03,83,24),B(cg_state ,19),I(08,1f,03,1c),I(0f,1f,05,1c),I(1c,83,1d,24),B(cg_state ,19),I(09,45,08,00)};
  ...
  static const void *G006464[] = {I(43,03,23,00),B(cg_asm ,72),I(1d,1d,24,00),B(i_notify ,4),I(3c,03,2a,1c),I(1f,03,3c,01),I(1b,34,00,00),I(00,00,00,17),I(1b,11,1d,1c),I(0f,1d,1c,90),I(22,02,32,00),I(00,00,00,26),I(1f,03,24,00),B(boot1 ,41),I(3c,01,86,1f),I(03,24,00,00),B(boot1 ,25),I(3c,02,1f,04),I(1c,1f,03,3d),I(02,06,22,02),I(45,04,00,00)};

  /* Byte-vector with size: 12 is_init: 0 index: 74 binding: get-branch-code */
  static const void *G006467[] = {I(ab,1c,82,02),I(1b,1d,24,00),B(string ,11),I(3c,02,1b,41),B(boot1 ,54),I(22,01,1b,24),B(cg_bycode ,18),I(3c,01,26,00),I(00,00,00,03),I(24,00,00,00),B(cg_bycode ,5),I(08,45,05,00)};
  ...
  static const void *G006485[] = {I(43,03,1c,1f),I(03,3c,01,1b),I(34,00,00,00),I(00,00,00,44),I(1b,10,12,1b),I(34,00,00,00),I(00,00,00,14),I(1c,1f,03,8f),I(32,00,00,00),I(00,00,00,23),I(23,00,00,00),B(cg_asm ,89),I(24,00,00,00),B(condition ,8),I(24,00,00,00),B(boot ,12),I(3d,02,05,22),I(01,32,00,00),I(00,00,00,23),I(1f,03,24,00),B(boot1 ,41),I(3c,01,1d,24),B(boot1 ,25),I(3c,01,1f,04),I(1c,1f,03,3d),I(02,06,22,02),I(45,04,00,00)};
  ...
  static const void *G006490[] = {I(43,03,1d,12),I(1b,34,00,00),I(00,00,00,2f),I(47,00,00,1f),I(03,1c,82,1d),I(24,00,00,00),B(cg_state ,19),I(09,22,02,2a),I(47,00,00,1d),I(1c,83,1d,24),B(cg_state ,19),I(09,22,02,32),I(00,00,00,20),I(1f,03,11,1f),I(03,83,14,1f),I(05,10,1b,1f),I(05,0f,1f,03),I(1f,03,1d,47),I(00,01,3d,03),I(08,22,04,45),I(04,00,00,00)};

  /* Byte-vector with size: 18 is_init: 0 index: 93 binding: put-bytes */
  static const void *G006492[] = {I(ab,46,02,1c),I(48,00,00,86),I(1b,48,00,01),I(23,00,00,00),B(cg_asm ,23),I(23,00,00,00),B(cg_asm ,92),I(3b,03,48,00),I(01,47,00,00),I(82,24,00,00),B(cg_state ,19),I(08,47,00,00),I(83,24,00,00),B(cg_state ,19),I(08,1f,03,1d),I(1d,47,00,01),I(3d,03,05,45),I(05,00,00,00)};

  /* Byte-vector with size: 13 is_init: 0 index: 94 binding: assemble-branch */
  static const void *G006494[] = {I(43,04,1c,82),I(24,00,00,00),B(cg_state ,19),I(08,83,14,1f),I(04,1c,0f,1f),I(04,10,1f,03),I(1c,1f,03,24),B(cg_asm ,10),I(3c,03,2a,1f),I(04,1d,24,00),B(cg_asm ,8),I(3d,02,07,45),I(07,00,00,00)};

  eul_allocate_static_string(str_6498, "      PUT BYTE: ~a", 18);
  /* Byte-vector with size: 19 is_init: 0 index: 96 binding: put-byte */
  static const void *G006496[] = {I(ab,23,00,00),B(cg_asm ,95),I(1c,24,00,00),B(i_notify ,4),I(3c,02,2a,1c),I(83,24,00,00),B(cg_state ,19),I(08,1d,82,24),B(cg_state ,19),I(08,1b,83,14),I(1f,04,1c,1c),I(82,1d,24,00),B(cg_state ,19),I(09,22,02,2a),I(1f,03,1f,03),I(0f,1f,05,1c),I(1c,83,1d,24),B(cg_state ,19),I(09,45,08,00)};
  ...
  static const void *G006501[] = {I(aa,46,01,86),I(1b,48,00,00),I(23,00,00,00),B(cg_asm ,23),I(23,00,00,00),B(cg_asm ,97),I(3b,02,48,00),I(00,1c,82,24),B(cg_state ,19),I(08,1d,83,24),B(cg_state ,19),I(08,1c,26,00),I(00,00,00,04),I(18,1b,82,19),I(1b,34,00,00),I(00,00,00,0f),I(86,32,00,00),I(00,00,00,3e),I(26,00,00,00),I(00,00,00,04),I(1d,15,1b,1f),I(04,47,00,00),I(3c,02,1f,07),I(1c,1c,83,1d),I(24,00,00,00),B(cg_state ,19),I(09,22,02,2a),I(1f,05,1d,14),I(1f,08,1c,1c),I(82,1d,24,00),B(cg_state ,19),I(09,22,05,45),I(06,00,00,00)};

  /* Byte-vector with size: 32 is_init: 0 index: 99 binding: put-fix */
  static const void *G006503[] = {I(ab,1c,24,00),B(cg_asm ,19),I(3c,01,2a,1b),I(24,00,00,00),B(integer ,4),I(3c,01,1b,34),I(00,00,00,25),I(1c,24,00,00),B(cg_asm ,7),I(3c,01,1f,03),I(1c,24,00,00),B(cg_asm ,16),I(3d,02,04,22),I(01,32,00,00),I(00,00,00,46),I(1d,83,24,00),B(cg_state ,19),I(08,1f,03,82),I(24,00,00,00),B(cg_state ,19),I(08,1b,26,00),I(00,00,00,04),I(14,1f,05,1c),I(1c,82,1d,24),B(cg_state ,19),I(09,22,02,2a),I(1f,04,1f,03),I(0f,1f,06,1c),I(1c,83,1d,24),B(cg_state ,19),I(09,22,06,45),I(03,00,00,00)};
