...
;;;-----------------------------------------------------------------------------
(defun print-help ()
  (print "Usage: youtoo [<options>] <source-file(s)> [<options>]" nl)
  (print "  -help                 --  show usage" nl)
  (print "  -version              --  show current release" nl)
  (print "  -params               --  show current parameter setting" nl)
  (print "  -load_path <dir>      --  add <dir> to load path" nl)
  (print "  -c                    --  create C linkable module file only" nl)
  (print "  -ar                   --  create C linkable library file" nl)
  (print "  -l <lib>              --  specify C linkable library" nl)
  (print "  -L <dir>              --  extent C linkable library load path" nl)
  (print "  -fff <file>           --  specify C foreign function file" nl)
  (print "  -ffl <lib>            --  specify C foreign function library" nl)
  (print "  -o <file>             --  destination file" nl)
  (print "  -od <dir>             --  destination directory for object files" nl)
  (print "  --script <file>       --  script mode" nl)
  (print "  -silent               --  silent mode" nl)
  (print "  -verbose              --  verbose mode" nl)
  (print "  -no_warnings          --  no warning messages" nl)
  (print "  -no_errors            --  no error messages" nl)
  (print "  -no_else              --  omit warning for if without else" nl)
  (print "  -redefine             --  redefine imported bindings" nl)
  (print "  -no_inline            --  ignore inline declarations" nl)
  (print "  -stop_after <phase>   --  stop after compilation phase (e.g. read)" nl)
  (print "  -recompile            --  recompile imported modules" nl)
  (print "  -no_recompile         --  no automatic recompilation of imports" nl)
  (print "  -no_gc                --  garbage collection library not linked" nl)
  (print "  -cc                   --  used C compiler" nl)
  (print "  -ld                   --  used C linker" nl)
  (print "  -ar_cmd               --  used C ar command" nl)
  (print "  -ranlib_cmd           --  used C ranlib command" nl)
  (print "  -cflags               --  additional C flag" nl)
  (print "  -static               --  no shared libraries used" nl)
  (print "  -g                    --  C debug info" nl)
  (print "  -i                    --  force interpretation mode" nl)
  (print "  -no_ct_handlers       --  no compile-time error handling" nl)
  (flush))
