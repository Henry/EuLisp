...
void initialize_module_op_peep()
{
  ...
  static const void *G005640[] = {I(aa,1b,11,12),I(1b,34,00,00),I(00,00,00,0f),I(47,00,00,32),I(00,00,00,34),I(1c,11,1b,1f),I(03,24,00,00),B(op_peep ,2),I(3c,02,1b,34),I(00,00,00,15),I(1f,03,47,00),I(01,3d,01,04),I(32,00,00,00),I(00,00,00,11),I(1f,03,11,47),I(00,01,3d,01),I(04,22,02,45),I(02,00,00,00)};

  /* Byte-vector with size: 18 is_init: 0 index: 14 binding: peep-hole-optimize */
  static const void *G005642[] = {I(aa,46,02,1b),I(48,00,00,86),I(1b,48,00,01),I(23,00,00,00),B(op_peep ,11),I(23,00,00,00),B(op_peep ,13),I(3b,01,48,00),I(01,24,00,00),B(i_param ,50),I(12,1b,34,00),I(00,00,00,0e),I(47,00,00,32),I(00,00,00,10),I(86,47,00,00),I(0f,47,00,01),I(3d,01,03,45),I(03,00,00,00)};

  /* Byte-vector with size: 27 is_init: 0 index: 15 binding: anonymous */
  static const void *G005644[] = {I(ab,1c,12,1b),I(34,00,00,00),I(00,00,00,1c),I(47,00,00,11),I(24,00,00,00),B(boot1 ,25),I(3d,01,03,32),I(00,00,00,4e),I(1d,10,1d,10),I(1c,7c,1b,34),I(00,00,00,19),I(1f,05,11,1f),I(05,11,47,00),I(01,3d,02,06),I(32,00,00,00),I(00,00,00,2f),I(1d,1d,24,00),B(compare ,9),I(3c,02,1b,34),I(00,00,00,19),I(1f,06,11,1f),I(06,11,47,00),I(01,3d,02,07),I(32,00,00,00),I(00,00,00,09),I(86,22,01,22),I(03,45,03,00)};

  /* Byte-vector with size: 18 is_init: 0 index: 16 binding: match-pattern */
  static const void *G005646[] = {I(ab,46,02,1b),I(48,00,00,86),I(1b,48,00,01),I(23,00,00,00),B(op_peep ,11),I(23,00,00,00),B(op_peep ,15),I(3b,02,48,00),I(01,1d,10,47),I(00,00,10,50),I(1b,34,00,00),I(00,00,00,1b),I(1f,03,11,47),I(00,00,11,47),I(00,01,3d,02),I(04,32,00,00),I(00,00,00,08),I(86,45,04,00)};

  /* Byte-vector with size: 19 is_init: 0 index: 17 binding: add-rule */
  static const void *G005648[] = {I(43,04,1f,03),I(72,24,00,00),B(op_peep ,6),I(1c,24,00,00),B(table ,7),I(3c,02,24,00),B(table ,7),I(24,00,00,00),B(boot1 ,42),I(3c,01,1f,06),I(1f,06,1f,06),I(1f,06,24,00),B(boot1 ,25),I(3c,04,1b,1f),I(03,0f,24,00),B(op_peep ,6),I(1f,05,1d,1f),I(05,3c,03,2a),I(1f,08,45,09)};
