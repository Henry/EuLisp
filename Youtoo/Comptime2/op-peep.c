...
void initialize_module_op_peep()
{
  ...
  static const void *G005644[] = {I(ab,1c,12,1b),I(34,00,00,00),I(00,00,00,1c),I(47,00,00,11),I(24,00,00,00),B(boot1 ,26),I(3d,01,03,32),I(00,00,00,4e),I(1d,10,1d,10),I(1c,7c,1b,34),I(00,00,00,19),I(1f,05,11,1f),I(05,11,47,00),I(01,3d,02,06),I(32,00,00,00),I(00,00,00,2f),I(1d,1d,24,00),B(compare ,9),I(3c,02,1b,34),I(00,00,00,19),I(1f,06,11,1f),I(06,11,47,00),I(01,3d,02,07),I(32,00,00,00),I(00,00,00,09),I(86,22,01,22),I(03,45,03,00)};
