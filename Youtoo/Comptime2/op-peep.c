...
void initialize_module_op_peep()
{
  ...
  static const void *G005648[] = {I(43,04,1f,03),I(72,24,00,00),B(op_peep ,6),I(1c,24,00,00),B(table ,7),I(3c,02,24,00),B(table ,7),I(24,00,00,00),B(boot1 ,41),I(3c,01,1f,06),I(1f,06,1f,06),I(1f,06,24,00),B(boot1 ,25),I(3c,04,1b,1f),I(03,0f,24,00),B(op_peep ,6),I(1f,05,1d,1f),I(05,3c,03,2a),I(1f,08,45,09)};
