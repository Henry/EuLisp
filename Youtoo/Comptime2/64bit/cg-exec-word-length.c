...
{
  LispRef G008168, G008169, G008170, G008171, res;

  POPVAL1(G008171);
  POPVAL1(G008170);
  POPVAL1(G008169);
  POPVAL1(G008168);
  FF_RES_CONVERT6(res,eul_write_next_bv_binding_ref1(FF_ARG_CONVERT8(G008168), FF_ARG_CONVERT0(G008169), FF_ARG_CONVERT3(G008170), FF_ARG_CONVERT0(G008171)));
  return res;
}
...
void initialize_module_cg_exec_word_length()
{
  ...
  {
  /* Declarations */
  LispRef sym_8167, sym_8166, sym_8165, sym_8164, sym_8163, G008162, G008160, key_8158, key_8157, G008155, G008153, G008150, G008148;
  ...
  static const void *G008154[] = {I(aa,1b,84,16),I(23,00,00,00),B(cg_exec_word_length ,13),I(1c,24,00,00),B(i_notify ,4),I(3c,02,2a,1c),I(84,16,24,00),B(string ,13),I(23,00,00,00),B(cg_exec_word_length ,14),I(1d,23,00,00),B(cg_exec_word_length ,15),I(27,30,24,00),B(mop_gf ,2),I(3c,05,1b,89),B(cg_exec_word_length ,4),I(2a,82,89,00),B(cg_exec_word_length ,7),I(45,04,00,00)};

  /* Byte-vector with size: 15 is_init: 0 index: 17 binding: write-next-bv-byte */
  static const void *G008159[] = {I(aa,63,24,00),B(cg_exec_word_length ,4),I(24,00,00,00),B(cg_exec_word_length ,7),I(1d,0c,2a,24),B(cg_exec_word_length ,7),I(83,14,82,63),I(24,00,00,00),B(cg_exec_word_length ,4),I(1d,1d,0c,2a),I(24,00,00,00),B(cg_exec_word_length ,7),I(84,14,1b,89),B(cg_exec_word_length ,7),I(45,04,00,00)};
  ...
  eul_intern_keyword(key_8158,"fill-value");
  eul_allocate_bytevector( G008155,G008154);
  eul_allocate_bytevector( G008160,G008159);
  eul_intern_symbol(sym_8163,"write-next-bv-byte");
  eul_intern_symbol(sym_8164,"open-bytevector");
  eul_intern_symbol(sym_8165,"bytevector");
  eul_intern_symbol(sym_8166,"write-next-bv-binding-ref");
  eul_intern_symbol(sym_8167,"top-level");
  ...
  cg_exec_word_length_bindings[ 15] = key_8158;
  cg_exec_word_length_bindings[ 16] = G008155;
  cg_exec_word_length_bindings[ 17] = G008160;
  ...
  cg_exec_word_length_bindings[ 22] = sym_8167;
  eul_allocate_lambda( cg_exec_word_length_bindings[0], "initialize-cg-exec-word-length", 0, G008162);
