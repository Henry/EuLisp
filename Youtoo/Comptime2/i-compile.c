...
void initialize_module_i_compile()
{
  ...
  static const void *G008556[] = {I(a9,24,00,00),B(i_param ,59),I(34,00,00,00),I(00,00,00,40),I(24,00,00,00),B(i_param ,59),I(24,00,00,00),B(i_param ,24),I(50,1b,34,00),I(00,00,00,1e),I(86,89,00,00),B(i_param ,24),I(2a,24,00,00),B(i_error ,2),I(3d,00,01,32),I(00,00,00,06),I(86,22,01,32),I(00,00,00,06),I(86,45,00,00)};
