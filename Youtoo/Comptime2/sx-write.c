...
void initialize_module_sx_write()
{
  ...
  static const void *G002178[] = {I(aa,1b,24,00),B(sx_obj2 ,33),I(3c,01,1b,44),I(0b,1c,83,24),B(sx_obj2 ,11),I(08,36,02,86),I(47,00,00,23),B(sx_write ,9),I(1f,04,1f,03),I(24,00,00,00),B(format ,4),I(3d,04,03,45),I(03,00,00,00)};
  ...
  static const void *G002181[] = {I(ab,46,01,1b),I(48,00,00,47),I(00,00,23,00),B(sx_write ,11),I(24,00,00,00),B(format ,4),I(3c,02,2a,1c),I(8a,05,24,00),B(sx_obj ,17),I(08,23,00,00),B(sx_write ,12),I(23,00,00,00),B(sx_write ,10),I(3b,01,1c,24),B(boot ,17),I(3c,02,2a,1d),I(84,24,00,00),B(sx_obj ,17),I(08,47,00,00),I(23,00,00,00),B(sx_write ,13),I(1d,24,00,00),B(format ,4),I(3d,03,04,45),I(04,00,00,00)};
  ...
  static const void *G002186[] = {I(ab,1c,8a,05),I(24,00,00,00),B(sx_obj ,17),I(08,1d,84,24),B(sx_obj ,17),I(08,1d,23,00),B(sx_write ,15),I(1f,03,1f,03),I(24,00,00,00),B(format ,4),I(3d,04,04,45),I(04,00,00,00)};
  ...
  static const void *G002205[] = {I(ab,1c,8a,03),I(24,00,00,00),B(sx_obj2 ,11),I(08,1c,23,00),B(sx_write ,29),I(1d,24,00,00),B(format ,4),I(3d,03,03,45),I(03,00,00,00)};

  eul_allocate_static_string(str_2210, "~a", 2);
  /* Byte-vector with size: 9 is_init: 0 index: 32 binding: (method-new-generic-print) */
  static const void *G002208[] = {I(ab,1c,8a,06),I(24,00,00,00),B(sx_obj1 ,42),I(08,1c,23,00),B(sx_write ,31),I(1d,24,00,00),B(format ,4),I(3d,03,03,45),I(03,00,00,00)};

  eul_allocate_static_string(str_2213, "~a", 2);
  /* Byte-vector with size: 9 is_init: 0 index: 34 binding: (method-new-generic-print) */
  static const void *G002211[] = {I(ab,1c,8a,15),I(24,00,00,00),B(sx_obj1 ,59),I(08,1c,23,00),B(sx_write ,33),I(1d,24,00,00),B(format ,4),I(3d,03,03,45),I(03,00,00,00)};
  ...
  static const void *G002214[] = {I(ab,1c,24,00),B(mop_access ,5),I(3c,01,23,00),B(sx_write ,35),I(1c,86,6c,1b),I(44,2e,1f,03),I(23,00,00,00),B(sx_write ,35),I(24,00,00,00),B(mop_defcl ,8),I(3c,02,1f,03),I(23,00,00,00),B(sx_write ,36),I(1d,24,00,00),B(format ,4),I(3d,03,05,22),I(01,36,15,1d),I(23,00,00,00),B(sx_write ,37),I(24,00,00,00),B(format ,4),I(3d,02,04,45),I(04,00,00,00)};
  ...
  static const void *G002222[] = {I(ab,23,00,00),B(sx_write ,17),I(24,00,00,00),B(dynamic ,3),I(3c,01,1b,44),I(0d,1d,1d,24),B(sx_write ,3),I(3d,02,03,36),I(04,38,02,01),I(45,03,00,00)};
  ...
  static const void *G002224[] = {I(ab,1c,8a,05),I(24,00,00,00),B(sx_obj1 ,42),I(08,1d,8a,06),I(24,00,00,00),B(sx_obj1 ,42),I(08,1f,03,83),I(24,00,00,00),B(sx_obj1 ,42),I(08,1d,24,00),B(sx_obj1 ,45),I(3c,01,1b,44),I(0f,1f,03,8a),I(15,24,00,00),B(sx_obj1 ,59),I(08,36,03,1f),I(03,1d,7e,1b),I(44,1c,1f,06),I(23,00,00,00),B(sx_write ,42),I(1f,03,1f,07),I(1f,07,24,00),B(format ,4),I(3d,05,08,36),I(17,1f,06,23),B(sx_write ,43),I(1f,03,1f,07),I(24,00,00,00),B(format ,4),I(3d,04,08,45),I(08,00,00,00)};

  eul_allocate_static_string(str_2230, "#<module: ~a>", 13);
  /* Byte-vector with size: 9 is_init: 0 index: 46 binding: (method-generic-print) */
  static const void *G002228[] = {I(ab,1c,8a,15),I(24,00,00,00),B(sx_obj1 ,59),I(08,1c,23,00),B(sx_write ,45),I(1d,24,00,00),B(format ,4),I(3d,03,03,45),I(03,00,00,00)};
  ...
  static const void *G002236[] = {I(aa,84,24,00),B(sx_obj1 ,42),I(08,1b,24,00),B(mop_inspect ,8),I(3c,01,1b,44),I(0a,23,00,00),B(sx_write ,51),I(36,12,23,00),B(sx_write ,52),I(1d,24,00,00),B(format ,2),I(3d,02,02,45),I(02,00,00,00)};

  eul_allocate_static_string(str_2242, "\n   (~a . ~a)", 13);
  /* Byte-vector with size: 13 is_init: 0 index: 55 binding: anonymous */
  static const void *G002240[] = {I(ab,1b,8a,06),I(24,00,00,00),B(sx_obj1 ,42),I(08,1c,24,00),B(sx_write ,2),I(3c,01,47,00),I(00,23,00,00),B(sx_write ,54),I(1f,03,1f,03),I(24,00,00,00),B(format ,4),I(3d,04,04,45),I(04,00,00,00)};

  eul_allocate_static_string(str_2245, "\n   (~a . ~a)", 13);
  /* Byte-vector with size: 13 is_init: 0 index: 57 binding: anonymous */
  static const void *G002243[] = {I(ab,1b,8a,06),I(24,00,00,00),B(sx_obj1 ,42),I(08,1c,24,00),B(sx_write ,2),I(3c,01,47,00),I(00,23,00,00),B(sx_write ,56),I(1f,03,1f,03),I(24,00,00,00),B(format ,4),I(3d,04,04,45),I(04,00,00,00)};

  eul_allocate_static_string(str_2248, "\n   (~a . ~a)", 13);
  /* Byte-vector with size: 13 is_init: 0 index: 59 binding: anonymous */
  static const void *G002246[] = {I(ab,1b,8a,06),I(24,00,00,00),B(sx_obj1 ,42),I(08,1c,24,00),B(sx_write ,2),I(3c,01,47,00),I(00,23,00,00),B(sx_write ,58),I(1f,03,1f,03),I(24,00,00,00),B(format ,4),I(3d,04,04,45),I(04,00,00,00)};
