...
void initialize_module_sx_write()
{
  ...
  static const void *G001947[] = {I(ab,1c,84,24),B(sx_obj ,12),I(08,1d,83,24),B(sx_obj ,12),I(08,1f,03,82),I(24,00,00,00),B(sx_obj ,12),I(08,1f,03,23),B(sx_write ,5),I(1f,04,1f,04),I(1f,04,24,00),B(mop_gf ,17),I(3d,05,05,45),I(05,00,00,00)};

  eul_allocate_static_string(str_1952, "~a", 2);
  /* Byte-vector with size: 11 is_init: 0 index: 8 binding: (method-new-generic-prin) */
  static const void *G001950[] = {I(ab,1c,83,24),B(sx_obj ,39),I(08,1d,82,24),B(sx_obj ,39),I(08,1c,1c,0f),I(1f,03,23,00),B(sx_write ,7),I(1d,24,00,00),B(mop_gf ,17),I(3d,03,05,45),I(05,00,00,00)};

  eul_allocate_static_string(str_1955, "(~a ~a)", 7);
  /* Byte-vector with size: 15 is_init: 0 index: 10 binding: anonymous */
  static const void *G001953[] = {I(aa,1b,24,00),B(sx_obj2 ,33),I(3c,01,1b,34),I(00,00,00,15),I(1c,83,24,00),B(sx_obj2 ,11),I(08,32,00,00),I(00,00,00,08),I(86,47,00,00),I(23,00,00,00),B(sx_write ,9),I(1f,04,1f,03),I(24,00,00,00),B(mop_gf ,17),I(3d,04,03,00)};
  ...
  static const void *G001956[] = {I(ab,46,01,1b),I(48,00,00,47),I(00,00,23,00),B(sx_write ,11),I(24,00,00,00),B(mop_gf ,17),I(3c,02,2a,1c),I(26,00,00,00),I(00,00,00,05),I(24,00,00,00),B(sx_obj ,17),I(08,23,00,00),B(sx_write ,12),I(23,00,00,00),B(sx_write ,10),I(3b,01,1c,24),B(boot ,4),I(3c,02,2a,1d),I(84,24,00,00),B(sx_obj ,17),I(08,47,00,00),I(23,00,00,00),B(sx_write ,13),I(1d,24,00,00),B(mop_gf ,17),I(3d,03,04,45),I(04,00,00,00)};
  ...
  static const void *G001961[] = {I(ab,1c,26,00),I(00,00,00,05),I(24,00,00,00),B(sx_obj ,17),I(08,1d,84,24),B(sx_obj ,17),I(08,1d,23,00),B(sx_write ,15),I(1f,03,1f,03),I(24,00,00,00),B(mop_gf ,17),I(3d,04,04,45),I(04,00,00,00)};
  ...
  static const void *G001971[] = {I(ab,1c,82,24),B(sx_obj2 ,29),I(08,1c,23,00),B(sx_write ,23),I(1d,24,00,00),B(mop_gf ,17),I(3d,03,03,45),I(03,00,00,00)};

  eul_allocate_static_string(str_1976, "~a", 2);
  /* Byte-vector with size: 8 is_init: 0 index: 26 binding: (method-new-generic-prin) */
  static const void *G001974[] = {I(ab,1c,83,24),B(sx_obj2 ,22),I(08,1c,23,00),B(sx_write ,25),I(1d,24,00,00),B(mop_gf ,17),I(3d,03,03,45),I(03,00,00,00)};
  ...
  static const void *G001977[] = {I(ab,1c,83,24),B(sx_obj2 ,25),I(08,1d,82,24),B(sx_obj2 ,25),I(08,1d,23,00),B(sx_write ,27),I(1f,03,1f,03),I(24,00,00,00),B(mop_gf ,17),I(3d,04,04,45),I(04,00,00,00)};
  ...
  static const void *G001983[] = {I(ab,1c,26,00),I(00,00,00,06),I(24,00,00,00),B(sx_obj1 ,42),I(08,1c,23,00),B(sx_write ,31),I(1d,24,00,00),B(mop_gf ,17),I(3d,03,03,45),I(03,00,00,00)};
  ...
  static const void *G001999[] = {I(ab,1c,26,00),I(00,00,00,05),I(24,00,00,00),B(sx_obj1 ,42),I(08,1d,26,00),I(00,00,00,06),I(24,00,00,00),B(sx_obj1 ,42),I(08,1f,03,83),I(24,00,00,00),B(sx_obj1 ,42),I(08,1d,24,00),B(sx_obj1 ,45),I(3c,01,1b,34),I(00,00,00,1d),I(1f,03,26,00),I(00,00,00,15),I(24,00,00,00),B(sx_obj1 ,59),I(08,32,00,00),I(00,00,00,09),I(1f,03,1d,7e),I(1b,34,00,00),I(00,00,00,23),I(1f,06,23,00),B(sx_write ,42),I(1f,03,1f,07),I(1f,07,24,00),B(mop_gf ,17),I(3d,05,08,32),I(00,00,00,1c),I(1f,06,23,00),B(sx_write ,43),I(1f,03,1f,07),I(24,00,00,00),B(mop_gf ,17),I(3d,04,08,45),I(08,00,00,00)};
  ...
  static const void *G002006[] = {I(a9,84,24,00),B(mop_class ,20),I(24,00,00,00),B(mop_class ,20),I(24,00,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,24),I(3c,00,24,00),B(boot1 ,24),I(3c,00,23,00),B(sx_write ,47),I(1f,03,24,00),B(mop_class ,15),I(24,00,00,00),B(mop_class ,55),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,89),B(sx_write ,2),I(2a,24,00,00),B(stream2 ,2),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(sx_obj1 ,59),I(24,00,00,00),B(stream2 ,21),I(24,00,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,24),I(3c,00,24,00),B(stream2 ,2),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(sx_write ,48),I(23,00,00,00),B(sx_write ,46),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(stream2 ,2),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(stream2 ,2),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(sx_obj1 ,42),I(24,00,00,00),B(stream2 ,21),I(24,00,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,24),I(3c,00,24,00),B(stream2 ,2),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(sx_write ,48),I(23,00,00,00),B(sx_write ,44),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(stream2 ,2),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(stream2 ,2),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(sx_obj1 ,27),I(24,00,00,00),B(stream2 ,21),I(24,00,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,24),I(3c,00,24,00),B(stream2 ,2),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(sx_write ,48),I(23,00,00,00),B(sx_write ,41),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(stream2 ,2),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(sx_write ,2),I(2a,24,00,00),B(sx_write ,2),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(mop_class ,27),I(86,24,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,24),I(3c,00,24,00),B(sx_write ,2),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(sx_write ,49),I(23,00,00,00),B(sx_write ,40),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(sx_write ,2),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(sx_write ,2),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(sx_obj1 ,27),I(86,24,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,24),I(3c,00,24,00),B(sx_write ,2),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(sx_write ,49),I(23,00,00,00),B(sx_write ,38),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(sx_write ,2),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(sx_write ,2),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(sx_obj1 ,59),I(86,24,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,24),I(3c,00,24,00),B(sx_write ,2),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(sx_write ,49),I(23,00,00,00),B(sx_write ,34),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(sx_write ,2),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(sx_write ,2),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(sx_obj1 ,42),I(86,24,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,24),I(3c,00,24,00),B(sx_write ,2),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(sx_write ,49),I(23,00,00,00),B(sx_write ,32),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(sx_write ,2),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(sx_write ,2),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(sx_obj2 ,11),I(86,24,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,24),I(3c,00,24,00),B(sx_write ,2),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(sx_write ,49),I(23,00,00,00),B(sx_write ,30),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(sx_write ,2),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(sx_write ,2),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(sx_obj2 ,25),I(86,24,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,24),I(3c,00,24,00),B(sx_write ,2),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(sx_write ,49),I(23,00,00,00),B(sx_write ,28),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(sx_write ,2),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(sx_write ,2),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(sx_obj2 ,22),I(86,24,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,24),I(3c,00,24,00),B(sx_write ,2),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(sx_write ,49),I(23,00,00,00),B(sx_write ,26),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(sx_write ,2),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(sx_write ,2),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(sx_obj2 ,32),I(86,24,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,24),I(3c,00,24,00),B(sx_write ,2),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(sx_write ,49),I(23,00,00,00),B(sx_write ,24),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(sx_write ,2),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(sx_write ,2),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(sx_obj ,13),I(86,24,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,24),I(3c,00,24,00),B(sx_write ,2),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(sx_write ,49),I(23,00,00,00),B(sx_write ,22),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(sx_write ,2),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(sx_write ,2),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(sx_obj ,9),I(86,24,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,24),I(3c,00,24,00),B(sx_write ,2),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(sx_write ,49),I(23,00,00,00),B(sx_write ,16),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(sx_write ,2),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(sx_write ,2),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(sx_obj ,2),I(86,24,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,24),I(3c,00,24,00),B(sx_write ,2),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(sx_write ,49),I(23,00,00,00),B(sx_write ,14),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(sx_write ,2),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(sx_write ,2),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(sx_obj ,39),I(86,24,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,24),I(3c,00,24,00),B(sx_write ,2),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(sx_write ,49),I(23,00,00,00),B(sx_write ,8),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(sx_write ,2),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(sx_write ,2),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(sx_obj ,12),I(86,24,00,00),B(boot1 ,38),I(3c,03,24,00),B(boot1 ,24),I(3c,00,24,00),B(sx_write ,2),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(sx_write ,49),I(23,00,00,00),B(sx_write ,6),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(sx_write ,2),I(1c,24,00,00),B(mop_meth ,5),I(3d,02,64,45),I(64,00,00,00)};
  ...
  static const void *G002011[] = {I(aa,84,24,00),B(sx_obj1 ,42),I(08,1b,24,00),B(mop_inspect ,11),I(3c,01,1b,34),I(00,00,00,15),I(23,00,00,00),B(sx_write ,51),I(32,00,00,00),I(00,00,00,1b),I(86,23,00,00),B(sx_write ,52),I(1f,03,24,00),B(mop_gf ,17),I(3d,03,02,45),I(02,00,00,00)};

  eul_allocate_static_string(str_2017, "\n   (~a . ~a)", 13);
  /* Byte-vector with size: 14 is_init: 0 index: 55 binding: anonymous */
  static const void *G002015[] = {I(ab,1b,26,00),I(00,00,00,06),I(24,00,00,00),B(sx_obj1 ,42),I(08,1c,24,00),B(sx_write ,3),I(3c,01,47,00),I(00,23,00,00),B(sx_write ,54),I(1f,03,1f,03),I(24,00,00,00),B(mop_gf ,17),I(3d,04,04,45),I(04,00,00,00)};

  eul_allocate_static_string(str_2020, "\n   (~a . ~a)", 13);
  /* Byte-vector with size: 14 is_init: 0 index: 57 binding: anonymous */
  static const void *G002018[] = {I(ab,1b,26,00),I(00,00,00,06),I(24,00,00,00),B(sx_obj1 ,42),I(08,1c,24,00),B(sx_write ,3),I(3c,01,47,00),I(00,23,00,00),B(sx_write ,56),I(1f,03,1f,03),I(24,00,00,00),B(mop_gf ,17),I(3d,04,04,45),I(04,00,00,00)};

  eul_allocate_static_string(str_2023, "\n   (~a . ~a)", 13);
  /* Byte-vector with size: 14 is_init: 0 index: 59 binding: anonymous */
  static const void *G002021[] = {I(ab,1b,26,00),I(00,00,00,06),I(24,00,00,00),B(sx_obj1 ,42),I(08,1c,24,00),B(sx_write ,3),I(3c,01,47,00),I(00,23,00,00),B(sx_write ,58),I(1f,03,1f,03),I(24,00,00,00),B(mop_gf ,17),I(3d,04,04,45),I(04,00,00,00)};
