...
void initialize_module_sx_write()
{
  ...
  static const void *G001956[] = {I(ab,46,01,1b),I(48,00,00,47),I(00,00,23,00),B(sx_write ,11),I(24,00,00,00),B(mop_gf ,17),I(3c,02,2a,1c),I(26,00,00,00),I(00,00,00,05),I(24,00,00,00),B(sx_obj ,19),I(08,23,00,00),B(sx_write ,12),I(23,00,00,00),B(sx_write ,10),I(3b,01,1c,24),B(boot ,16),I(3c,02,2a,1d),I(84,24,00,00),B(sx_obj ,19),I(08,47,00,00),I(23,00,00,00),B(sx_write ,13),I(1d,24,00,00),B(mop_gf ,17),I(3d,03,04,45),I(04,00,00,00)};
  ...
  static const void *G002011[] = {I(aa,84,24,00),B(sx_obj1 ,43),I(08,1b,24,00),B(mop_inspect ,8),I(3c,01,1b,34),I(00,00,00,15),I(23,00,00,00),B(sx_write ,51),I(32,00,00,00),I(00,00,00,1b),I(86,23,00,00),B(sx_write ,52),I(1f,03,24,00),B(mop_gf ,17),I(3d,03,02,45),I(02,00,00,00)};
