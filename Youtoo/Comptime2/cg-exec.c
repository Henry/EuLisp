...
void initialize_module_cg_exec()
{
  ...
  static const void *G008114[] = {I(ab,24,00,00),B(table ,5),I(24,00,00,00),B(boot1 ,41),I(3c,01,24,00),B(cg_exec ,15),I(1f,03,1f,03),I(1f,03,3d,03),I(03,45,03,00)};
