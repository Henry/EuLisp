...
void initialize_module_cg_exec()
{
  ...
  /* Byte-vector with size: 35 is_init: 0 index: 44 binding: (method-G007952) */
  static const void *G008139[] = {I(ab,24,00,00),B(stream2 ,10),I(23,00,00,00),B(cg_exec ,41),I(24,00,00,00),B(format ,4),I(3c,02,2a,24),B(stream2 ,10),I(1d,24,00,00),B(mop_access ,8),I(3c,02,2a,24),B(i_param ,55),I(34,00,00,00),I(00,00,00,10),I(86,32,00,00),I(00,00,00,50),I(24,00,00,00),B(cg_exec ,16),I(26,00,00,00),I(00,00,00,15),I(24,00,00,00),B(sx_obj1 ,59),I(08,23,00,00),B(cg_exec ,42),I(47,00,00,1d),I(24,00,00,00),B(format ,2),I(3c,03,1b,24),B(i_error ,5),I(23,00,00,00),B(cg_exec ,43),I(47,00,00,24),B(boot ,12),I(3d,04,04,22),I(02,45,02,00)};
  ...
  static const void *G008169[] = {I(aa,1b,83,24),B(cg_state ,19),I(08,1c,26,00),I(00,00,00,03),I(24,00,00,00),B(cg_state ,19),I(08,1d,84,24),B(cg_state ,19),I(08,1f,03,82),I(24,00,00,00),B(cg_state ,19),I(08,1f,03,1c),I(1f,03,24,00),B(cg_exec ,12),I(3c,03,1b,24),B(cg_exec ,13),I(3c,01,1f,04),I(1c,24,00,00),B(cg_exec ,2),I(3d,02,07,45),I(07,00,00,00)};
  ...
  static const void *G008173[] = {I(aa,1b,82,24),B(sx_obj1 ,59),I(08,24,00,00),B(aux_table ,9),I(3c,01,2a,24),B(i_param ,47),I(24,00,00,00),B(aux_table ,9),I(3c,01,2a,1b),I(86,1c,26,00),I(00,00,00,06),I(1d,24,00,00),B(sx_obj1 ,59),I(09,22,02,2a),I(1b,86,1c,26),I(00,00,00,09),I(1d,24,00,00),B(sx_obj1 ,59),I(09,22,02,2a),I(1b,86,1c,26),I(00,00,00,08),I(1d,24,00,00),B(sx_obj1 ,59),I(09,22,02,2a),I(1b,86,1c,26),I(00,00,00,0d),I(1d,24,00,00),B(sx_obj1 ,59),I(09,22,02,2a),I(1b,86,1c,26),I(00,00,00,0c),I(1d,24,00,00),B(sx_obj1 ,59),I(09,22,02,2a),I(86,89,00,00),B(i_param ,55),I(2a,23,00,00),B(cg_exec ,63),I(89,00,00,00),B(i_param ,59),I(45,01,00,00)};
