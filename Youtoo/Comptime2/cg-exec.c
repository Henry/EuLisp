...
void initialize_module_cg_exec()
{
  ...
  static const void *G008114[] = {I(ab,24,00,00),B(table ,5),I(24,00,00,00),B(boot1 ,40),I(3c,01,24,00),B(cg_exec ,15),I(1f,03,1f,03),I(1f,03,3d,03),I(03,45,03,00)};
  ...
  static const void *G008149[] = {I(aa,1b,24,00),B(p_env ,7),I(3c,01,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,19),I(85,23,00,00),B(cg_exec ,49),I(1f,03,24,00),B(i_error ,4),I(3c,03,1b,24),B(sx_node ,27),I(3c,01,1c,83),I(24,00,00,00),B(sx_obj1 ,42),I(08,1c,41,00),B(cg_dld ,14),I(22,01,1c,7e),I(1b,34,00,00),I(00,00,00,17),I(1c,1f,03,24),B(cg_exec_word_length ,2),I(3d,02,07,32),I(00,00,00,1c),I(85,23,00,00),B(cg_exec ,50),I(1f,04,1f,09),I(24,00,00,00),B(i_error ,4),I(3d,04,07,45),I(07,00,00,00)};
  ...
  static const void *G008158[] = {I(a9,24,00,00),B(cg_exec ,16),I(82,24,00,00),B(sx_obj1 ,59),I(08,24,00,00),B(aux_table ,8),I(3c,01,24,00),B(sx_node ,9),I(1c,24,00,00),B(list ,25),I(3c,02,23,00),B(cg_exec ,30),I(23,00,00,00),B(cg_exec ,54),I(3b,01,1c,24),B(boot ,4),I(3d,02,02,45),I(02,00,00,00)};
  ...
  static const void *G008171[] = {I(aa,23,00,00),B(cg_exec ,30),I(23,00,00,00),B(cg_exec ,61),I(3b,01,1c,24),B(boot ,4),I(3d,02,01,00)};

  /* Byte-vector with size: 41 is_init: 0 index: 64 binding: reset-interactive-module */
  static const void *G008173[] = {I(aa,1b,82,24),B(sx_obj1 ,59),I(08,24,00,00),B(aux_table ,9),I(3c,01,2a,24),B(i_param ,48),I(24,00,00,00),B(aux_table ,9),I(3c,01,2a,1b),I(86,1c,26,00),I(00,00,00,06),I(1d,24,00,00),B(sx_obj1 ,59),I(09,22,02,2a),I(1b,86,1c,26),I(00,00,00,09),I(1d,24,00,00),B(sx_obj1 ,59),I(09,22,02,2a),I(1b,86,1c,26),I(00,00,00,08),I(1d,24,00,00),B(sx_obj1 ,59),I(09,22,02,2a),I(1b,86,1c,26),I(00,00,00,0d),I(1d,24,00,00),B(sx_obj1 ,59),I(09,22,02,2a),I(1b,86,1c,26),I(00,00,00,0c),I(1d,24,00,00),B(sx_obj1 ,59),I(09,22,02,2a),I(86,89,00,00),B(i_param ,56),I(2a,23,00,00),B(cg_exec ,63),I(89,00,00,00),B(i_param ,60),I(45,01,00,00)};
