...
void initialize_module_i_args()
{
  ...
  static const void *G00498[] = {I(ab,24,00,00),B(stream2 ,10),I(23,00,00,00),B(i_args ,63),I(24,00,00,00),B(format ,4),I(3c,02,2a,24),B(stream2 ,10),I(1d,24,00,00),B(mop_access ,8),I(3c,02,2a,24),B(i_param ,55),I(34,00,00,00),I(00,00,00,10),I(86,32,00,00),I(00,00,00,34),I(23,00,00,00),B(i_args ,64),I(47,00,00,24),B(format ,2),I(3c,02,1b,24),B(i_error ,5),I(23,00,00,00),B(i_args ,65),I(47,00,00,24),B(boot ,12),I(3d,04,03,22),I(01,45,02,00)};
