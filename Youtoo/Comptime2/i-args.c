...
void initialize_module_i_args()
{
  ...
  /* Byte-vector with size: 207 is_init: 0 index: 41 binding: print-help */
  static const void *G00439[] = {I(a9,23,00,00),B(i_args ,7),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,8),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,9),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,10),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,11),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,12),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,13),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,14),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,15),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,16),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,17),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,18),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,19),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,20),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,21),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,22),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,23),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,24),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,25),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,26),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,27),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,28),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,29),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,30),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,31),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,32),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,33),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,34),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,35),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,36),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,37),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,38),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,39),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,40),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,24),B(stream ,2),I(3d,00,00,00)};
  ...
  /* Byte-vector with size: 43 is_init: 0 index: 127 binding: print-version */
  static const void *G00559[] = {I(a9,23,00,00),B(i_args ,121),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,122),I(24,00,00,00),B(i_param ,43),I(24,00,00,00),B(format ,5),I(3c,02,2a,23),B(i_args ,123),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,124),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,125),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,23),B(i_args ,126),I(24,00,00,00),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,02,2a,24),B(stream ,14),I(24,00,00,00),B(stream ,12),I(3c,01,2a,24),B(stream ,2),I(3d,00,00,00)};
