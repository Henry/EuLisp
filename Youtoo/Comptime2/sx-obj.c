...
void initialize_module_sx_obj()
{
  ...
  static const void *G002315[] = {I(aa,8a,06,24),B(sx_obj ,17),I(08,45,00,00)};
  ...
  static const void *G002321[] = {I(ab,1c,8a,03),I(1d,24,00,00),B(sx_obj ,17),I(09,45,02,00)};

  /* Byte-vector with size: 3 is_init: 0 index: 148 binding: fun-range-and-domain? */
  static const void *G002323[] = {I(aa,8a,03,24),B(sx_obj ,17),I(08,45,00,00)};

  /* Byte-vector with size: 17 is_init: 0 index: 149 binding: local-name? */
  static const void *G002325[] = {I(aa,1b,24,00),B(sx_obj1 ,14),I(3c,01,1b,44),I(0f,1c,8a,06),I(24,00,00,00),B(sx_obj1 ,42),I(08,36,28,1c),I(23,00,00,00),B(sx_obj ,88),I(24,00,00,00),B(mop_defcl ,8),I(3c,02,1b,44),I(0f,1b,8a,06),I(24,00,00,00),B(sx_obj1 ,42),I(08,36,02,86),I(22,01,45,02)};
  ...
  static const void *G002346[] = {I(aa,1b,7a,1b),I(44,05,1c,75),I(36,1d,1c,24),B(sx_obj1 ,14),I(3c,01,1b,44),I(0f,1d,8a,06),I(24,00,00,00),B(sx_obj1 ,42),I(08,36,02,1d),I(22,01,45,02)};

  /* Byte-vector with size: 3 is_init: 0 index: 161 binding: fun-name? */
  static const void *G002348[] = {I(aa,8a,07,24),B(sx_obj ,17),I(08,45,00,00)};
  ...
  static const void *G002354[] = {I(aa,8a,05,24),B(sx_obj ,17),I(08,45,00,00)};
  ...
  static const void *G002362[] = {I(ab,1c,04,8a),I(04,02,23,00),B(sx_obj ,88),I(1c,23,00,00),B(sx_obj ,86),I(23,00,00,00),B(sx_obj ,167),I(3b,02,24,00),B(boot ,27),I(3c,03,1b,44),I(07,1b,10,83),I(02,36,02,86),I(1f,04,1f,04),I(1d,3d,02,05),I(45,05,00,00)};
  ...
  static const void *G002370[] = {I(ab,1c,8a,04),I(1d,24,00,00),B(sx_obj ,17),I(09,45,02,00)};
  ...
  static const void *G002378[] = {I(ab,1c,8a,06),I(1d,24,00,00),B(sx_obj ,17),I(09,45,02,00)};

  /* Byte-vector with size: 4 is_init: 0 index: 177 binding: fun-name! */
  static const void *G002380[] = {I(ab,1c,8a,07),I(1d,24,00,00),B(sx_obj ,17),I(09,45,02,00)};
  ...
  static const void *G002386[] = {I(ab,1c,8a,05),I(1d,24,00,00),B(sx_obj ,17),I(09,45,02,00)};
