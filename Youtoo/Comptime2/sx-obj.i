...
(definterface sx-obj
  (import (i-level1 sx-obj1 sx-obj2)
   ...
   export (
    ...
    ((name . setq-obj?) (pos . 5) (origin sx-obj2 . setq-obj?) (inline (G001474 (static-ref0) (binding-ref ? <setq>) (primitive-relative-ref))))
    ...
    ((name . var-value!) (pos . 6) (origin sx-obj2 . var-value!) (inline (G001456 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <var>) (set-primitive-relative-ref) (nobble 2))))
    ((name . origin-name?) (pos . 36) (origin sx-obj . origin-name?))
    ((name . fun-range-and-domain?) (pos . 10) (origin sx-obj . fun-range-and-domain?) (inline (G001966 (static-fpi-ref 3) (binding-ref ? <fun>) (primitive-relative-ref))))
