...
(definterface sx-obj
  (import (i-level1 sx-obj1 sx-obj2)
   ...
   export (
    ...
    ((name . <if>) (pos . 13) (origin sx-obj . <if>) (class . constant))
    ...
    ((name . call-next-method?) (pos . 12) (origin sx-obj . call-next-method?))
    ...
    ((name . origin-name?) (pos . 39) (origin sx-obj . origin-name?))
    ...
    ((name . lambdap) (pos . 10) (origin sx-obj . lambdap))
    ...
    ((name . binding!) (pos . 36) (origin sx-obj . binding!))
    ((name . fun-args?) (pos . 33) (origin sx-obj . fun-args?) (inline (G001973 (static-fpi-ref 5) (binding-ref ? <fun>) (primitive-relative-ref))))
    ((name . fun-appls!) (pos . 35) (origin sx-obj . fun-appls!) (inline (G001959 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <fun>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . fun-body!) (pos . 34) (origin sx-obj . fun-body!) (inline (G001963 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <fun>) (set-primitive-relative-ref) (nobble 2))))
    ((name . lambda-inlined!) (pos . 38) (origin sx-obj . lambda-inlined!) (inline (G001995 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <lambda>) (set-primitive-relative-ref) (nobble 2))))
    ((name . <opencoding>) (pos . 9) (origin sx-obj . <opencoding>) (class . constant))
    ((name . if-pred!) (pos . 37) (origin sx-obj . if-pred!) (inline (G002015 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <if>) (set-primitive-relative-ref) (nobble 2))))
