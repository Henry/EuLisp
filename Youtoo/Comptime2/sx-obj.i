...
(definterface sx-obj
  (import (i-level1 sx-obj1 sx-obj2)
   ...
   export (
    ...
    ((name . fun-args!) (pos . 48) (origin sx-obj . fun-args!) (inline (G001976 (stack-ref 1) (static-fpi-ref 5) (stack-ref 2) (binding-ref ? <fun>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . var-name?) (pos . 10) (origin sx-obj2 . var-name?) (inline (G001462 (static-fpi-ref 3) (binding-ref ? <var>) (primitive-relative-ref))))
    ...
    ((name . fun-arity?) (pos . 15) (origin sx-obj . fun-arity?) (inline (G001970 (static-fpi-ref 4) (binding-ref ? <fun>) (primitive-relative-ref))))
    ...
    ((name . var-name!) (pos . 30) (origin sx-obj2 . var-name!) (inline (G001464 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <var>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . fun-arity!) (pos . 37) (origin sx-obj . fun-arity!) (inline (G001972 (stack-ref 1) (static-fpi-ref 4) (stack-ref 2) (binding-ref ? <fun>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . fun-range-and-domain?) (pos . 9) (origin sx-obj . fun-range-and-domain?) (inline (G001966 (static-fpi-ref 3) (binding-ref ? <fun>) (primitive-relative-ref))))
    ...
    ((name . fun-args?) (pos . 30) (origin sx-obj . fun-args?) (inline (G001974 (static-fpi-ref 5) (binding-ref ? <fun>) (primitive-relative-ref))))
    ...
    ((name . fun-range-and-domain!) (pos . 6) (origin sx-obj . fun-range-and-domain!) (inline (G001968 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <fun>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . fun-binding?) (pos . 3) (origin sx-obj . fun-binding?) (inline (G001978 (static-fpi-ref 6) (binding-ref ? <fun>) (primitive-relative-ref))))
    ((name . fun-name!) (pos . 43) (origin sx-obj . fun-name!) (inline (G001984 (stack-ref 1) (static-fpi-ref 7) (stack-ref 2) (binding-ref ? <fun>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . fun-binding!) (pos . 42) (origin sx-obj . fun-binding!) (inline (G001980 (stack-ref 1) (static-fpi-ref 6) (stack-ref 2) (binding-ref ? <fun>) (set-primitive-relative-ref) (nobble 2))))
    ((name . <syntax-expr>) (pos . 3) (origin sx-obj1 . <syntax-expr>) (class . constant))
    ((name . fun-name?) (pos . 26) (origin sx-obj . fun-name?) (inline (G001982 (static-fpi-ref 7) (binding-ref ? <fun>) (primitive-relative-ref))))
