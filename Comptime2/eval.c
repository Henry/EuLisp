...
void initialize_module_eval()
{
  ...
  eval_bindings[ 4] = str_719;
  eval_bindings[ 5] = G00718;
  eval_bindings[ 6] = str_722;
  eval_bindings[ 7] = str_723;
  eval_bindings[ 8] = sym_724;
  eval_bindings[ 9] = G00721;
  eval_bindings[ 10] = G00726;
  eval_bindings[ 11] = G00728;
  eval_bindings[ 12] = sym_731;
  eval_bindings[ 13] = G00730;
  eval_bindings[ 1] = eul_nil;
  eval_bindings[ 14] = sym_734;
  eval_bindings[ 15] = sym_735;
  eul_allocate_lambda( eval_bindings[0], "initialize-eval", 0, G00733);
