...
void initialize_module_eval()
{
  ...
  {
  /* Declarations */
  LispRef sym_9358, sym_9357, G009356, sym_9354, G009353, G009351, G009349, sym_9347, G009344, G009341;

  /* Code vector and literal definitions */
  eul_allocate_static_string(str_9342, "Module ~a need not be recompiled.", 33);
  /* Byte-vector with size: 18 is_init: 0 index: 5 binding: anonymous */
  static const void *G009340[] = {I(aa,1b,89,00),B(i_param ,24),I(2a,1b,24,00),B(cg_interf ,7),I(3c,01,1b,34),I(00,00,00,15),I(1c,24,00,00),B(i_compile ,10),I(3c,01,32,00),I(00,00,00,18),I(23,00,00,00),B(eval ,4),I(1d,24,00,00),B(i_notify ,3),I(3c,02,2a,1c),I(24,00,00,00),B(i_compile ,3),I(3d,01,02,00)};

  eul_allocate_static_string(str_9345, "", 0);
  eul_allocate_static_string(str_9346, "Start EuLysses ...", 18);
  /* Byte-vector with size: 33 is_init: 0 index: 9 binding: start-eulysses */
  static const void *G009343[] = {I(a9,23,00,00),B(eval ,6),I(24,00,00,00),B(i_notify ,3),I(3c,01,2a,23),B(eval ,7),I(24,00,00,00),B(i_notify ,4),I(3c,01,2a,24),B(i_param ,10),I(34,00,00,00),I(00,00,00,24),I(24,00,00,00),B(i_rep ,6),I(3c,00,2a,82),I(24,00,00,00),B(boot1 ,22),I(3d,01,00,32),I(00,00,00,38),I(24,00,00,00),B(cg_interf ,4),I(3c,00,2a,23),B(eval ,8),I(23,00,00,00),B(eval ,5),I(3b,01,24,00),B(i_param ,34),I(24,00,00,00),B(boot ,4),I(3c,02,2a,24),B(i_error ,2),I(3d,00,00,45),I(00,00,00,00)};

  /* Byte-vector with size: 8 is_init: 0 index: 10 binding: (method-G009299) */
  static const void *G009348[] = {I(ab,1c,24,00),B(stream2 ,10),I(24,00,00,00),B(stream ,8),I(3c,02,2a,85),I(24,00,00,00),B(i_error ,2),I(3d,01,02,00)};

  /* Byte-vector with size: 1 is_init: 0 index: 11 binding: (method-G009299) */
  static const void *G009350[] = {I(ab,86,45,02)};

  /* Byte-vector with size: 100 is_init: 0 index: 13 binding: main */
  static const void *G009352[] = {I(aa,84,24,00),B(mop_class ,21),I(24,00,00,00),B(mop_class ,21),I(24,00,00,00),B(boot1 ,39),I(3c,03,24,00),B(boot1 ,26),I(3c,00,24,00),B(boot1 ,26),I(3c,00,23,00),B(eval ,8),I(1f,03,24,00),B(mop_class ,16),I(24,00,00,00),B(mop_class ,55),I(1f,05,1f,05),I(24,00,00,00),B(mop_gf ,16),I(3c,06,1b,26),I(00,00,00,03),I(02,84,86,86),I(24,00,00,00),B(boot1 ,39),I(3c,03,24,00),B(boot1 ,26),I(3c,00,1f,03),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(eval ,12),I(23,00,00,00),B(eval ,11),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,1f,06),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,1f,07),I(26,00,00,00),I(00,00,00,03),I(02,84,24,00),B(i_error ,5),I(86,24,00,00),B(boot1 ,39),I(3c,03,24,00),B(boot1 ,26),I(3c,00,1f,0a),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(eval ,12),I(23,00,00,00),B(eval ,10),I(3b,02,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,1f,0d),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,1f,0e),I(24,00,00,00),B(dynamic ,5),I(3c,01,2a,24),B(i_param ,61),I(3c,00,2a,1f),I(12,24,00,00),B(i_args ,4),I(3c,01,2a,24),B(i_compile ,7),I(3c,00,2a,24),B(i_param ,44),I(34,00,00,00),I(00,00,00,10),I(86,32,00,00),I(00,00,00,17),I(24,00,00,00),B(stream2 ,35),I(89,00,00,00),B(stream2 ,10),I(2a,24,00,00),B(eval ,2),I(3c,00,83,24),B(dynamic ,6),I(3c,01,2a,24),B(stream2 ,35),I(24,00,00,00),B(stream ,2),I(3c,01,2a,24),B(stream2 ,10),I(24,00,00,00),B(stream ,2),I(3d,01,14,00)};

  /* Byte-vector with size: 45 is_init: 1 index: 0 binding: initialize-eval */
  static const void *G009355[] = {I(87,25,00,00),B(eval ,1),I(24,00,00,00),B(i_rep ,1),I(3e,0b,24,00),B(i_rep ,0),I(3c,00,21,01),I(24,00,00,00),B(cg_interf ,1),I(3e,0b,24,00),B(cg_interf ,0),I(3c,00,21,01),I(24,00,00,00),B(i_modify ,1),I(3e,0b,24,00),B(i_modify ,0),I(3c,00,21,01),I(24,00,00,00),B(i_compile ,1),I(3e,0b,24,00),B(i_compile ,0),I(3c,00,21,01),I(24,00,00,00),B(i_args ,1),I(3e,0b,24,00),B(i_args ,0),I(3c,00,21,01),I(24,00,00,00),B(i_all ,1),I(3e,0b,24,00),B(i_all ,0),I(3c,00,21,01),I(23,00,00,00),B(eval ,14),I(23,00,00,00),B(eval ,13),I(3b,01,25,00),B(eval ,3),I(23,00,00,00),B(eval ,15),I(23,00,00,00),B(eval ,9),I(3b,00,25,00),B(eval ,2),I(86,ac,00,00)};


  /* Initializations */
  object_class(str_9342) = eul_static_string_class;
  eul_allocate_bytevector( G009341,G009340);
  object_class(str_9345) = eul_static_string_class;
  object_class(str_9346) = eul_static_string_class;
  eul_intern_symbol(sym_9347,"anonymous");
  eul_allocate_bytevector( G009344,G009343);
  eul_allocate_bytevector( G009349,G009348);
  eul_allocate_bytevector( G009351,G009350);
  eul_intern_symbol(sym_9354,"(method G009299)");
  eul_allocate_bytevector( G009353,G009352);
  eul_intern_symbol(sym_9357,"main");
  eul_intern_symbol(sym_9358,"start-eulysses");
  ...
  eval_bindings[ 4] = str_9342;
  eval_bindings[ 5] = G009341;
  eval_bindings[ 6] = str_9345;
  eval_bindings[ 7] = str_9346;
  eval_bindings[ 8] = sym_9347;
  eval_bindings[ 9] = G009344;
  eval_bindings[ 10] = G009349;
  eval_bindings[ 11] = G009351;
  eval_bindings[ 12] = sym_9354;
  eval_bindings[ 13] = G009353;
  eval_bindings[ 1] = eul_nil;
  eval_bindings[ 14] = sym_9357;
  eval_bindings[ 15] = sym_9358;
  eul_allocate_lambda( eval_bindings[0], "initialize-eval", 0, G009356);
