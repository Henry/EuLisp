...
void initialize_module_eval()
{
  ...
  eul_intern_symbol(sym_9355,"anonymous");
  eul_allocate_bytevector( G009352,G009351);
  eul_allocate_bytevector( G009357,G009356);
  eul_allocate_bytevector( G009359,G009358);
  eul_intern_symbol(sym_9362,"(method G009307)");
  eul_allocate_bytevector( G009361,G009360);
  eul_intern_symbol(sym_9365,"main");
  eul_intern_symbol(sym_9366,"start-eulysses");
  ...
  eval_bindings[ 4] = str_9350;
  eval_bindings[ 5] = G009349;
  eval_bindings[ 6] = str_9353;
  eval_bindings[ 7] = str_9354;
  eval_bindings[ 8] = sym_9355;
  eval_bindings[ 9] = G009352;
  eval_bindings[ 10] = G009357;
  eval_bindings[ 11] = G009359;
  eval_bindings[ 12] = sym_9362;
  eval_bindings[ 13] = G009361;
  eval_bindings[ 1] = eul_nil;
  eval_bindings[ 14] = sym_9365;
  eval_bindings[ 15] = sym_9366;
  eul_allocate_lambda( eval_bindings[0], "initialize-eval", 0, G009364);
