...
void initialize_module_eval()
{
  ...
  static const void *G0052[] = {I(ab,1c,24,00),B(stream2 ,10),I(24,00,00,00),B(stream ,8),I(3c,02,2a,85),I(24,00,00,00),B(i_error ,2),I(3d,01,02,00)};
