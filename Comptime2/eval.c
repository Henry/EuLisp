...
void initialize_module_eval()
{
  ...
  static const void *G009292[] = {I(aa,1b,89,00),B(i_param ,24),I(2a,1b,24,00),B(cg_interf ,7),I(3c,01,1b,34),I(00,00,00,15),I(1c,24,00,00),B(i_compile ,10),I(3c,01,32,00),I(00,00,00,18),I(23,00,00,00),B(eval ,4),I(1d,24,00,00),B(i_notify ,3),I(3c,02,2a,1c),I(24,00,00,00),B(i_compile ,3),I(3d,01,02,00)};
  ...
  static const void *G009300[] = {I(ab,1c,24,00),B(stream2 ,10),I(24,00,00,00),B(stream ,8),I(3c,02,2a,85),I(24,00,00,00),B(i_error ,2),I(3d,01,02,00)};
