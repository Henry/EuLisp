...
(definterface cg-state
  (import (i-all)
   ...
   export (
    ((name . C-state-code-vector-defs!) (pos . 7) (origin cg-state . C-state-code-vector-defs!) (inline (G002273 (stack-ref 1) (static-fpi-ref 6) (stack-ref 2) (binding-ref ? <C-state>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . code-state-enclosed-code!) (pos . 6) (origin cg-state . code-state-enclosed-code!) (inline (G002197 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <code-state>) (set-primitive-relative-ref) (nobble 2))))
    ((name . C-state-global-index?) (pos . 21) (origin cg-state . C-state-global-index?) (inline (G002247 (static-ref0) (binding-ref ? <C-state>) (primitive-relative-ref))))
    ...
    ((name . code-state-binding-name!) (pos . 33) (origin cg-state . code-state-binding-name!) (inline (G002217 (stack-ref 1) (static-fpi-ref 5) (stack-ref 2) (binding-ref ? <code-state>) (set-primitive-relative-ref) (nobble 2))))
    ((name . asm-function-state-code!) (pos . 32) (origin cg-state . asm-function-state-code!) (inline (G002237 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <asm-function-state>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . code-state-binding-name?) (pos . 35) (origin cg-state . code-state-binding-name?) (inline (G002215 (static-fpi-ref 5) (binding-ref ? <code-state>) (primitive-relative-ref))))
    ...
    ((name . asm-function-state-binding-name!) (pos . 19) (origin cg-state . asm-function-state-binding-name!) (inline (G002241 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <asm-function-state>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . code-state-stack-vars?) (pos . 18) (origin cg-state . code-state-stack-vars?) (inline (G002203 (static-ref2) (binding-ref ? <code-state>) (primitive-relative-ref))))
    ((name . asm-function-state-code?) (pos . 26) (origin cg-state . asm-function-state-code?) (inline (G002235 (static-ref1) (binding-ref ? <asm-function-state>) (primitive-relative-ref))))
    ((name . asm-state-init-bytevector?) (pos . 30) (origin cg-state . asm-state-init-bytevector?) (inline (G002227 (static-ref1) (binding-ref ? <asm-state>) (primitive-relative-ref))))
    ((name . make-C-state) (pos . 47) (origin cg-state . make-C-state))
    ((name . asm-function-state-pc!) (pos . 17) (origin cg-state . asm-function-state-pc!) (inline (G002233 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <asm-function-state>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . code-state-enclosed-code?) (pos . 29) (origin cg-state . code-state-enclosed-code?) (inline (G002195 (static-ref0) (binding-ref ? <code-state>) (primitive-relative-ref))))
    ((name . C-state-global-index!) (pos . 11) (origin cg-state . C-state-global-index!) (inline (G002249 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <C-state>) (set-primitive-relative-ref) (nobble 2))))
    ((name . <code-state>) (pos . 12) (origin cg-state . <code-state>) (class . constant))
    ((name . code-state-asm?) (pos . 16) (origin cg-state . code-state-asm?) (inline (G002211 (static-fpi-ref 4) (binding-ref ? <code-state>) (primitive-relative-ref))))
    ...
    ((name . C-state-globals?) (pos . 25) (origin cg-state . C-state-globals?) (inline (G002263 (static-fpi-ref 4) (binding-ref ? <C-state>) (primitive-relative-ref))))
    ...
    ((name . code-state-handle?) (pos . 15) (origin cg-state . code-state-handle?) (inline (G002219 (static-fpi-ref 6) (binding-ref ? <code-state>) (primitive-relative-ref))))
    ...
    ((name . asm-state-bytevectors?) (pos . 27) (origin cg-state . asm-state-bytevectors?) (inline (G002223 (static-ref0) (binding-ref ? <asm-state>) (primitive-relative-ref))))
    ...
    ((name . C-state-code-vector-str?) (pos . 10) (origin cg-state . C-state-code-vector-str?) (inline (G002251 (static-ref1) (binding-ref ? <C-state>) (primitive-relative-ref))))
    ((name . asm-state-bytevectors!) (pos . 24) (origin cg-state . asm-state-bytevectors!) (inline (G002225 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <asm-state>) (set-primitive-relative-ref) (nobble 2))))
    ((name . make-asm-function-state) (pos . 23) (origin cg-state . make-asm-function-state))
    ((name . code-state-stack-size?) (pos . 22) (origin cg-state . code-state-stack-size?) (inline (G002207 (static-fpi-ref 3) (binding-ref ? <code-state>) (primitive-relative-ref))))
    ((name . asm-function-state-handle!) (pos . 9) (origin cg-state . asm-function-state-handle!) (inline (G002245 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <asm-function-state>) (set-primitive-relative-ref) (nobble 2))))
    ((name . asm-function-state-binding-name?) (pos . 14) (origin cg-state . asm-function-state-binding-name?) (inline (G002239 (static-ref2) (binding-ref ? <asm-function-state>) (primitive-relative-ref))))
    ...
    ((name . C-state-initializations!) (pos . 34) (origin cg-state . C-state-initializations!) (inline (G002269 (stack-ref 1) (static-fpi-ref 5) (stack-ref 2) (binding-ref ? <C-state>) (set-primitive-relative-ref) (nobble 2))))
    ((name . code-state-asm!) (pos . 13) (origin cg-state . code-state-asm!) (inline (G002213 (stack-ref 1) (static-fpi-ref 4) (stack-ref 2) (binding-ref ? <code-state>) (set-primitive-relative-ref) (nobble 2))))
    ((name . C-state-used-module-names?) (pos . 8) (origin cg-state . C-state-used-module-names?) (inline (G002255 (static-ref2) (binding-ref ? <C-state>) (primitive-relative-ref))))
    ((name . code-state-stack-vars!) (pos . 36) (origin cg-state . code-state-stack-vars!) (inline (G002205 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <code-state>) (set-primitive-relative-ref) (nobble 2))))
    ((name . code-state-display!) (pos . 37) (origin cg-state . code-state-display!) (inline (G002201 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <code-state>) (set-primitive-relative-ref) (nobble 2))))
