...
(definterface cg-state
  (import (i-all)
   ...
   export (
    ...
    ((name . asm-function-state-code?) (pos . 25) (origin cg-state . asm-function-state-code?) (inline (G002235 (static-ref1) (binding-ref ? <asm-function-state>) (primitive-relative-ref))))
    ...
    ((name . code-state-enclosed-code?) (pos . 28) (origin cg-state . code-state-enclosed-code?) (inline (G002195 (static-ref0) (binding-ref ? <code-state>) (primitive-relative-ref))))
    ...
    ((name . asm-state-bytevectors?) (pos . 26) (origin cg-state . asm-state-bytevectors?) (inline (G002223 (static-ref0) (binding-ref ? <asm-state>) (primitive-relative-ref))))
