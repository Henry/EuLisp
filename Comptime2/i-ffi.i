...
(definterface i-ffi
  (import (i-all)
   ...
   local-literals (
    ...
    (* . 26)
    (#(<int> <character> <double> <string> <symbol> boolean ptr <int*> <double*> <string*> void) . 25)
    (void . 24)
    (#("int" "char" "double" "const char *" "void **" "int" "const char *" "int" "void *" "int *" "double *" "char **") . 23)
    (#(<int> <character> <double> <string> <vector> <file-stream> <symbol> boolean ptr <int*> <double*> <string*>) . 22)
    (<string*> . 21)
    (<double*> . 20)
    (<int*> . 19)
    (ptr . 18)
