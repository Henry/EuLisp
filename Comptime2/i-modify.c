...
void initialize_module_i_modify()
{
  ...
  static const void *G003482[] = {I(aa,24,00,00),B(stream ,14),I(1c,24,00,00),B(i_param ,17),I(24,00,00,00),B(boot ,5),I(3c,03,1b,34),I(00,00,00,0d),I(1b,10,32,00),I(00,00,00,21),I(23,00,00,00),B(i_modify ,11),I(23,00,00,00),B(i_modify ,12),I(1f,03,24,00),B(i_error ,4),I(3d,03,02,45),I(02,00,00,00)};
  ...
  static const void *G003486[] = {I(aa,24,00,00),B(i_param ,58),I(1b,34,00,00),I(00,00,00,0f),I(1b,32,00,00),I(00,00,00,64),I(1c,7d,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,0a),I(1d,82,02,1b),I(23,00,00,00),B(i_modify ,14),I(24,00,00,00),B(string ,11),I(3c,02,1f,04),I(7d,1b,34,00),I(00,00,00,0e),I(1b,32,00,00),I(00,00,00,0b),I(1f,05,82,02),I(1b,23,00,00),B(i_modify ,15),I(24,00,00,00),B(string ,11),I(3c,02,1f,03),I(1c,24,00,00),B(i_modify ,8),I(3d,02,08,22),I(06,45,02,00)};

  /* Byte-vector with size: 11 is_init: 0 index: 17 binding: external-file-exist? */
  static const void *G003490[] = {I(aa,24,00,00),B(stream ,14),I(1c,24,00,00),B(i_param ,9),I(24,00,00,00),B(boot ,5),I(3c,03,1b,34),I(00,00,00,0d),I(1b,11,32,00),I(00,00,00,07),I(86,45,02,00)};
