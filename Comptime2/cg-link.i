...
(definterface cg-link
  (import (i-all i-modify p-env sx-obj sx-node cg-state cg-asm cg-interf i-ffi ex-expr cg-dld)
   ...
   local-literals (
    ...
    (static-allocatable-p . 338)
    (wrap-init-code . 337)
    (set-fixed-bytes . 336)
    (set-up-init-bytevector . 335)
    (compute-bytevector . 334)
    (check-method-name . 333)
    (write-to-bv-str . 332)
...
" . 158)
    ...
    (("") . 155)
    ("(LispRef) (LispRef (*) (Stack *, LispRef *, LispRef *)) " . 152)
    ("ff binding ~a: index ~a" . 151)
    ("ff_stub_" . 150)
    (ff . 149)
    ("set-fixed-byes ~a ~a ~a" . 147)
    (? . 146)
    ("compute-binding ~a ~a" . 145)
    (|(method G006684)| . 144)
    (ct-error-value: . 142)
    ("can't compute binding ~a of module ~a" . 141)
    ("compile time error condition: " . 140)
    ("," . 137)
    (FF . 135)
    (BINDING . 134)
    (STATIC . 133)
