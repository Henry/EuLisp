...
void initialize_module_sx_obj0()
{
  ...
  static const void *G00136[] = {I(43,fd,1c,73),I(86,23,00,00),B(sx_obj0 ,4),I(1d,24,00,00),B(mop_gf ,17),I(3c,03,24,00),B(mop_class ,6),I(23,00,00,00),B(sx_obj0 ,5),I(1d,24,00,00),B(mop_gf ,2),I(3c,03,1f,04),I(73,86,23,00),B(sx_obj0 ,6),I(1d,24,00,00),B(mop_gf ,17),I(3c,03,24,00),B(mop_class ,6),I(23,00,00,00),B(sx_obj0 ,5),I(1d,24,00,00),B(mop_gf ,2),I(3c,03,1f,03),I(1c,1f,08,34),I(00,00,00,6d),I(23,00,00,00),B(sx_obj0 ,7),I(86,0f,23,00),B(sx_obj0 ,8),I(1c,0f,1b,86),I(0f,23,00,00),B(sx_obj0 ,9),I(1c,0f,1b,86),I(0f,23,00,00),B(sx_obj0 ,9),I(86,0f,1f,07),I(1c,0f,1b,86),I(0f,1f,12,1c),I(0f,23,00,00),B(sx_obj0 ,10),I(1c,0f,1b,86),I(0f,23,00,00),B(sx_obj0 ,9),I(1c,0f,1f,0c),I(1c,0f,1b,86),I(0f,1f,09,1c),I(0f,23,00,00),B(sx_obj0 ,11),I(1c,0f,22,0f),I(32,00,00,00),I(00,00,00,68),I(23,00,00,00),B(sx_obj0 ,7),I(86,0f,23,00),B(sx_obj0 ,8),I(1c,0f,1b,86),I(0f,23,00,00),B(sx_obj0 ,9),I(1c,0f,1b,86),I(0f,23,00,00),B(sx_obj0 ,9),I(86,0f,1f,07),I(1c,0f,1f,11),I(86,0f,1c,1c),I(0f,23,00,00),B(sx_obj0 ,12),I(1c,0f,1b,86),I(0f,23,00,00),B(sx_obj0 ,9),I(1c,0f,1f,0c),I(1c,0f,1b,86),I(0f,1f,09,1c),I(0f,23,00,00),B(sx_obj0 ,11),I(1c,0f,22,0f),I(45,0b,00,00)};
  ...
  static const void *G00147[] = {I(ab,1b,34,00),I(00,00,00,ea),I(1c,82,02,1b),I(06,1b,2c,1d),I(83,1d,24,00),B(string ,7),I(3c,03,23,00),B(sx_obj0 ,14),I(24,00,00,00),B(collect ,18),I(3c,02,1f,04),I(10,82,02,24),B(mop_class ,81),I(23,00,00,00),B(sx_obj0 ,5),I(1d,24,00,00),B(mop_gf ,2),I(3c,03,1d,1d),I(23,00,00,00),B(sx_obj0 ,15),I(24,00,00,00),B(collect ,18),I(3c,03,24,00),B(mop_class ,6),I(23,00,00,00),B(sx_obj0 ,5),I(1d,24,00,00),B(mop_gf ,2),I(3c,03,1f,04),I(1f,04,23,00),B(sx_obj0 ,16),I(24,00,00,00),B(collect ,18),I(3c,03,24,00),B(mop_class ,6),I(23,00,00,00),B(sx_obj0 ,5),I(1d,24,00,00),B(mop_gf ,2),I(3c,03,1b,47),I(00,01,0f,1f),I(03,1c,0f,1b),I(48,00,01,1f),I(0c,10,1b,23),B(sx_obj0 ,17),I(1f,09,23,00),B(sx_obj0 ,18),I(86,23,00,00),B(sx_obj0 ,19),I(1f,0b,23,00),B(sx_obj0 ,20),I(1f,0b,24,00),B(boot1 ,26),I(3c,09,1f,0e),I(11,1f,10,1c),I(47,00,00,3c),I(02,1d,1c,0f),I(22,10,32,00),I(00,00,00,07),I(86,45,02,00)};
  ...
  static const void *G00156[] = {I(43,fc,46,03),I(1f,03,82,02),I(1b,06,1b,2c),I(1d,83,1d,24),B(string ,7),I(3c,03,27,2d),I(1f,04,24,00),B(collect ,11),I(3c,02,1b,34),I(00,00,00,15),I(23,00,00,00),B(sx_obj0 ,22),I(32,00,00,00),I(00,00,00,10),I(23,00,00,00),B(sx_obj0 ,23),I(1d,1c,24,00),B(collect ,18),I(3c,02,24,00),B(mop_class ,6),I(23,00,00,00),B(sx_obj0 ,5),I(1d,24,00,00),B(mop_gf ,2),I(3c,03,86,1b),I(48,00,01,86),I(1b,48,00,00),I(23,00,00,00),B(sx_obj0 ,24),I(23,00,00,00),B(sx_obj0 ,21),I(3b,02,48,00),I(00,1f,0d,1f),I(0c,47,00,00),I(3c,02,1f,03),I(1f,0c,0f,23),B(sx_obj0 ,25),I(1c,0f,1d,1c),I(0f,1f,10,1c),I(0f,1f,12,1c),I(0f,23,00,00),B(sx_obj0 ,26),I(1c,0f,1f,09),I(47,00,01,0f),I(1f,15,1c,0f),I(23,00,00,00),B(sx_obj0 ,27),I(1c,0f,1b,86),I(0f,1f,04,1c),I(0f,23,00,00),B(sx_obj0 ,28),I(1c,0f,45,1a)};
