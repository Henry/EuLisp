...
void initialize_module_p_env()
{
  ...
  static const void *G002672[] = {I(aa,1b,26,00),I(00,00,00,06),I(24,00,00,00),B(sx_obj1 ,44),I(08,1b,1d,0f),I(45,02,00,00)};
  ...
  static const void *G002679[] = {I(43,fe,23,00),B(p_env ,26),I(24,00,00,00),B(dynamic ,3),I(3c,01,1b,34),I(00,00,01,95),I(1b,26,00,00),I(00,00,00,10),I(24,00,00,00),B(sx_obj1 ,60),I(08,1f,03,1f),I(03,1d,24,00),B(p_env ,8),I(3c,03,1b,26),I(00,00,00,06),I(24,00,00,00),B(sx_obj1 ,44),I(08,1c,24,00),B(sx_obj ,16),I(3c,01,1c,24),B(p_env ,7),I(3c,01,1d,24),B(p_env ,10),I(3c,01,1c,24),B(sx_obj1 ,30),I(3c,01,1b,34),I(00,00,00,89),I(1d,24,00,00),B(sx_obj ,16),I(3c,01,1f,03),I(83,24,00,00),B(sx_obj1 ,44),I(08,24,00,00),B(i_param ,33),I(1b,34,00,00),I(00,00,00,0f),I(1b,32,00,00),I(00,00,00,0b),I(1d,1f,07,50),I(1b,34,00,00),I(00,00,00,33),I(1f,09,1f,04),I(1c,26,00,00),I(00,00,00,05),I(1d,24,00,00),B(sx_obj1 ,44),I(09,22,02,2a),I(1f,09,1f,03),I(1c,83,1d,24),B(sx_obj1 ,44),I(09,22,02,32),I(00,00,00,1b),I(86,23,00,00),B(p_env ,27),I(1f,0b,1f,09),I(24,00,00,00),B(i_notify ,5),I(3c,04,22,04),I(32,00,00,00),I(00,00,00,63),I(1c,24,00,00),B(sx_obj1 ,30),I(3c,01,1b,34),I(00,00,00,29),I(1f,03,1f,03),I(50,12,1b,34),I(00,00,00,15),I(24,00,00,00),B(i_param ,10),I(12,32,00,00),I(00,00,00,08),I(86,22,01,32),I(00,00,00,06),I(86,1b,34,00),I(00,00,00,22),I(86,23,00,00),B(p_env ,28),I(1f,09,1f,06),I(24,00,00,00),B(i_notify ,5),I(3c,04,32,00),I(00,00,00,07),I(86,22,02,2a),I(1f,07,26,00),I(00,00,00,10),I(24,00,00,00),B(sx_obj1 ,60),I(08,1b,24,00),B(boot1 ,42),I(3c,01,1f,06),I(1f,08,1d,3c),I(02,2a,24,00),B(i_param ,10),I(12,1b,34,00),I(00,00,00,0e),I(86,32,00,00),I(00,00,00,23),I(1f,0a,82,24),B(sx_obj1 ,60),I(08,1b,24,00),B(boot1 ,42),I(3c,01,1f,09),I(1f,0b,1d,3d),I(02,0f,22,02),I(22,0a,32,00),I(00,00,00,21),I(23,00,00,00),B(p_env ,29),I(24,00,00,00),B(i_error ,5),I(24,00,00,00),B(boot ,22),I(3d,02,03,45),I(03,00,00,00)};
  ...
  static const void *G002687[] = {I(ab,26,00,00),I(00,00,00,10),I(24,00,00,00),B(sx_obj1 ,60),I(08,1c,1c,3c),I(01,1b,34,00),I(00,00,00,22),I(1b,1f,03,1f),I(03,24,00,00),B(p_env ,8),I(3c,03,1b,48),I(00,00,47,00),I(00,22,01,32),I(00,00,00,06),I(86,45,03,00)};

  /* Byte-vector with size: 49 is_init: 0 index: 33 binding: get-lexical-binding */
  static const void *G002689[] = {I(43,fe,46,01),I(1b,1b,34,00),I(00,00,00,0e),I(1b,32,00,00),I(00,00,00,42),I(23,00,00,00),B(p_env ,26),I(24,00,00,00),B(dynamic ,3),I(3c,01,1b,34),I(00,00,00,25),I(23,00,00,00),B(p_env ,26),I(24,00,00,00),B(dynamic ,3),I(3c,01,24,00),B(boot1 ,27),I(3c,01,32,00),I(00,00,00,07),I(86,22,01,86),I(1b,48,00,00),I(1f,04,1d,23),B(p_env ,23),I(23,00,00,00),B(p_env ,32),I(3b,02,24,00),B(boot ,20),I(3c,03,2a,47),I(00,00,34,00),I(00,00,00,4a),I(47,00,00,84),I(24,00,00,00),B(sx_obj1 ,44),I(08,1b,24,00),B(sx_obj2 ,10),I(3c,01,1b,34),I(00,00,00,25),I(1c,82,24,00),B(sx_obj2 ,11),I(08,1b,83,14),I(1f,03,1c,1c),I(82,1d,24,00),B(sx_obj2 ,11),I(09,22,04,32),I(00,00,00,06),I(86,22,02,32),I(00,00,00,06),I(86,2a,47,00),I(00,45,05,00)};
  ...
  static const void *G002698[] = {I(ab,1c,24,00),B(p_env ,17),I(3c,01,1b,34),I(00,00,00,1d),I(86,23,00,00),B(p_env ,40),I(1f,04,24,00),B(i_notify ,5),I(3d,03,03,32),I(00,00,00,21),I(24,00,00,00),B(i_param ,31),I(24,00,00,00),B(boot1 ,42),I(3c,01,1f,03),I(1f,03,1d,3d),I(02,04,22,01),I(45,03,00,00)};

  /* Byte-vector with size: 18 is_init: 0 index: 42 binding: anonymous */
  static const void *G002701[] = {I(ab,1b,26,00),I(00,00,00,0e),I(24,00,00,00),B(sx_obj1 ,60),I(08,1d,1c,3c),I(01,1b,34,00),I(00,00,00,2e),I(1b,1f,04,1f),I(03,24,00,00),B(p_env ,8),I(3c,03,1b,1f),I(04,24,00,00),B(p_env ,12),I(3c,02,1b,48),I(00,00,47,00),I(00,22,02,32),I(00,00,00,06),I(86,45,04,00)};

  /* Byte-vector with size: 29 is_init: 0 index: 43 binding: get-syntax-binding */
  static const void *G002703[] = {I(43,fe,46,01),I(1b,1b,34,00),I(00,00,00,0e),I(1b,32,00,00),I(00,00,00,42),I(23,00,00,00),B(p_env ,26),I(24,00,00,00),B(dynamic ,3),I(3c,01,1b,34),I(00,00,00,25),I(23,00,00,00),B(p_env ,26),I(24,00,00,00),B(dynamic ,3),I(3c,01,24,00),B(boot1 ,27),I(3c,01,32,00),I(00,00,00,07),I(86,22,01,86),I(1b,48,00,00),I(1f,04,1d,23),B(p_env ,23),I(23,00,00,00),B(p_env ,42),I(3b,02,24,00),B(boot ,20),I(3c,03,2a,47),I(00,00,45,05)};
  ...
  static const void *G002705[] = {I(43,fe,23,00),B(p_env ,26),I(24,00,00,00),B(dynamic ,3),I(3c,01,1b,34),I(00,00,00,ed),I(1b,26,00,00),I(00,00,00,0f),I(24,00,00,00),B(sx_obj1 ,60),I(08,1f,03,1f),I(03,1d,24,00),B(p_env ,8),I(3c,03,1b,26),I(00,00,00,06),I(24,00,00,00),B(sx_obj1 ,44),I(08,1c,24,00),B(sx_obj ,16),I(3c,01,1c,24),B(p_env ,19),I(3c,01,1b,24),B(sx_obj1 ,30),I(3c,01,1b,34),I(00,00,00,71),I(1c,24,00,00),B(sx_obj ,16),I(3c,01,1d,83),I(24,00,00,00),B(sx_obj1 ,44),I(08,1c,1f,05),I(50,12,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,1e),I(1f,09,26,00),I(00,00,00,15),I(24,00,00,00),B(sx_obj1 ,60),I(08,1f,03,1c),I(50,22,01,1b),I(34,00,00,00),I(00,00,00,24),I(86,23,00,00),B(p_env ,44),I(1f,0a,1f,08),I(24,00,00,00),B(i_notify ,5),I(3c,04,32,00),I(00,00,00,07),I(86,22,04,32),I(00,00,00,06),I(86,2a,1f,06),I(26,00,00,00),I(00,00,00,0f),I(24,00,00,00),B(sx_obj1 ,60),I(08,1b,24,00),B(boot1 ,42),I(3c,01,1f,05),I(1f,07,1d,3d),I(02,0b,22,08),I(32,00,00,00),I(00,00,00,23),I(23,00,00,00),B(p_env ,45),I(24,00,00,00),B(i_error ,5),I(24,00,00,00),B(boot ,22),I(3d,02,03,45),I(03,00,00,00)};

  /* Byte-vector with size: 17 is_init: 0 index: 47 binding: expand-interpreter-defined-syntax-binding */
  static const void *G002709[] = {I(ab,24,00,00),B(i_param ,10),I(34,00,00,00),I(00,00,00,10),I(1c,7c,32,00),I(00,00,00,07),I(86,1b,34,00),I(00,00,00,26),I(1c,26,00,00),I(00,00,00,10),I(24,00,00,00),B(sx_obj1 ,60),I(08,1f,03,1c),I(3d,01,04,22),I(01,32,00,00),I(00,00,00,08),I(1d,45,03,00)};
  ...
  static const void *G002715[] = {I(43,fe,23,00),B(p_env ,26),I(24,00,00,00),B(dynamic ,3),I(3c,01,1b,34),I(00,00,01,59),I(1b,26,00,00),I(00,00,00,0e),I(24,00,00,00),B(sx_obj1 ,60),I(08,1f,03,1f),I(03,1d,24,00),B(p_env ,8),I(3c,03,1b,1f),I(03,24,00,00),B(p_env ,12),I(3c,02,1b,24),B(sx_obj ,16),I(3c,01,1c,26),I(00,00,00,06),I(24,00,00,00),B(sx_obj1 ,44),I(08,1b,24,00),B(p_env ,7),I(3c,01,1c,24),B(p_env ,10),I(3c,01,1b,24),B(sx_obj1 ,30),I(3c,01,1b,34),I(00,00,00,89),I(1c,24,00,00),B(sx_obj ,16),I(3c,01,1d,83),I(24,00,00,00),B(sx_obj1 ,44),I(08,24,00,00),B(i_param ,33),I(1b,34,00,00),I(00,00,00,0f),I(1b,32,00,00),I(00,00,00,0b),I(1d,1f,08,50),I(1b,34,00,00),I(00,00,00,33),I(1f,09,1f,04),I(1c,26,00,00),I(00,00,00,05),I(1d,24,00,00),B(sx_obj1 ,44),I(09,22,02,2a),I(1f,09,1f,03),I(1c,83,1d,24),B(sx_obj1 ,44),I(09,22,02,32),I(00,00,00,1b),I(86,23,00,00),B(p_env ,50),I(1f,0b,1f,08),I(24,00,00,00),B(i_notify ,5),I(3c,04,22,04),I(32,00,00,00),I(00,00,00,4b),I(1d,24,00,00),B(sx_obj1 ,30),I(3c,01,1b,34),I(00,00,00,11),I(1f,03,1f,0c),I(50,12,32,00),I(00,00,00,07),I(86,1b,34,00),I(00,00,00,22),I(86,23,00,00),B(p_env ,51),I(1f,09,1f,07),I(24,00,00,00),B(i_notify ,5),I(3c,04,32,00),I(00,00,00,07),I(86,22,02,2a),I(1f,08,26,00),I(00,00,00,0e),I(24,00,00,00),B(sx_obj1 ,60),I(08,1b,24,00),B(boot1 ,42),I(3c,01,1f,05),I(1f,08,1d,3d),I(02,0d,22,0a),I(32,00,00,00),I(00,00,00,23),I(23,00,00,00),B(p_env ,52),I(24,00,00,00),B(i_error ,5),I(24,00,00,00),B(boot ,22),I(3d,02,03,45),I(03,00,00,00)};

  /* Byte-vector with size: 7 is_init: 0 index: 54 binding: new-module */
  static const void *G002720[] = {I(ab,24,00,00),B(i_param ,20),I(24,00,00,00),B(boot1 ,42),I(3c,01,1d,1d),I(1d,3d,02,03),I(45,03,00,00)};
  ...
  static const void *G002724[] = {I(ab,1b,1d,24),B(boot ,16),I(3c,02,1b,34),I(00,00,00,4d),I(1b,11,1b,84),I(24,00,00,00),B(sx_obj1 ,44),I(08,1b,24,00),B(sx_obj2 ,10),I(3c,01,1b,34),I(00,00,00,25),I(1c,82,24,00),B(sx_obj2 ,11),I(08,1b,83,14),I(1f,03,1c,1c),I(82,1d,24,00),B(sx_obj2 ,11),I(09,22,04,32),I(00,00,00,06),I(86,2a,1d,22),I(03,32,00,00),I(00,00,00,08),I(86,45,03,00)};

  /* Byte-vector with size: 15 is_init: 0 index: 57 binding: anonymous */
  static const void *G002726[] = {I(ab,26,00,00),I(00,00,00,0f),I(24,00,00,00),B(sx_obj1 ,60),I(08,1c,1c,3c),I(01,1b,34,00),I(00,00,00,22),I(1b,1f,03,1f),I(03,24,00,00),B(p_env ,8),I(3c,03,1b,48),I(00,00,47,00),I(00,22,01,32),I(00,00,00,06),I(86,45,03,00)};

  /* Byte-vector with size: 29 is_init: 0 index: 58 binding: get-external-binding */
  static const void *G002728[] = {I(43,fe,46,01),I(1b,1b,34,00),I(00,00,00,0e),I(1b,32,00,00),I(00,00,00,42),I(23,00,00,00),B(p_env ,26),I(24,00,00,00),B(dynamic ,3),I(3c,01,1b,34),I(00,00,00,25),I(23,00,00,00),B(p_env ,26),I(24,00,00,00),B(dynamic ,3),I(3c,01,24,00),B(boot1 ,27),I(3c,01,32,00),I(00,00,00,07),I(86,22,01,86),I(1b,48,00,00),I(1f,04,1d,23),B(p_env ,23),I(23,00,00,00),B(p_env ,57),I(3b,02,24,00),B(boot ,20),I(3c,03,2a,47),I(00,00,45,05)};
