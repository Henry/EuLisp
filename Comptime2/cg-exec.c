...
/* Foreign functions */
static LispRef ff_stub_eul_allocate_lambda28074 (Stack *reg_value_stack, LispRef *sreg_value_sp, LispRef *sreg_value_sb)
{
  ...
  POPVAL1(G008161);
  POPVAL1(G008160);
  FF_RES_CONVERT6(res,eul_allocate_lambda2(FF_ARG_CONVERT8(G008160), FF_ARG_CONVERT8(G008161), FF_ARG_CONVERT8(G008162)));
  return res;
}
...
void initialize_module_cg_exec()
{
  ...
  static const void *G008129[] = {I(a9,46,02,24),B(cg_exec ,16),I(26,00,00,00),I(00,00,00,15),I(24,00,00,00),B(sx_obj1 ,60),I(08,1b,48,00),I(01,47,00,01),I(24,00,00,00),B(p_env ,14),I(3c,01,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,2f),I(86,1b,48,00),I(00,23,00,00),B(cg_exec ,30),I(23,00,00,00),B(cg_exec ,58),I(3b,01,48,00),I(00,24,00,00),B(i_param ,15),I(47,00,00,3d),I(01,03,22,01),I(45,02,00,00)};

  /* Byte-vector with size: 21 is_init: 0 index: 60 binding: anonymous */
  static const void *G008131[] = {I(aa,1b,83,24),B(cg_state ,38),I(08,1c,26,00),I(00,00,00,03),I(24,00,00,00),B(cg_state ,38),I(08,1d,84,24),B(cg_state ,38),I(08,1f,03,82),I(24,00,00,00),B(cg_state ,38),I(08,1f,03,1c),I(1f,03,24,00),B(cg_exec ,12),I(3c,03,1b,24),B(cg_exec ,13),I(3c,01,1f,04),I(1c,24,00,00),B(cg_exec ,2),I(3d,02,07,45),I(07,00,00,00)};

  /* Byte-vector with size: 7 is_init: 0 index: 61 binding: set-up-bytevectors */
  static const void *G008133[] = {I(aa,23,00,00),B(cg_exec ,30),I(23,00,00,00),B(cg_exec ,60),I(3b,01,1c,24),B(boot ,4),I(3d,02,01,00)};

  /* Byte-vector with size: 41 is_init: 0 index: 63 binding: reset-interactive-module */
  static const void *G008135[] = {I(aa,1b,82,24),B(sx_obj1 ,60),I(08,24,00,00),B(aux_table ,9),I(3c,01,2a,24),B(i_param ,49),I(24,00,00,00),B(aux_table ,9),I(3c,01,2a,1b),I(86,1c,26,00),I(00,00,00,06),I(1d,24,00,00),B(sx_obj1 ,60),I(09,22,02,2a),I(1b,86,1c,26),I(00,00,00,09),I(1d,24,00,00),B(sx_obj1 ,60),I(09,22,02,2a),I(1b,86,1c,26),I(00,00,00,08),I(1d,24,00,00),B(sx_obj1 ,60),I(09,22,02,2a),I(1b,86,1c,26),I(00,00,00,0d),I(1d,24,00,00),B(sx_obj1 ,60),I(09,22,02,2a),I(1b,86,1c,26),I(00,00,00,0c),I(1d,24,00,00),B(sx_obj1 ,60),I(09,22,02,2a),I(86,89,00,00),B(i_param ,56),I(2a,23,00,00),B(cg_exec ,62),I(89,00,00,00),B(i_param ,60),I(45,01,00,00)};

  /* Byte-vector with size: 5 is_init: 0 index: 64 binding: get-bytevector-pos */
  static const void *G008138[] = {I(aa,24,00,00),B(cg_exec ,15),I(1c,24,00,00),B(table ,3),I(3d,02,01,00)};

  /* Byte-vector with size: 7 is_init: 0 index: 65 binding: compute-static */
  static const void *G008140[] = {I(aa,24,00,00),B(cg_exec ,13),I(3c,01,24,00),B(cg_exec ,5),I(1c,24,00,00),B(cg_exec_word_length ,2),I(3d,02,01,00)};

  /* Byte-vector with size: 170 is_init: 1 index: 0 binding: initialize-cg-exec */
  static const void *G008142[] = {I(87,25,00,00),B(cg_exec ,1),I(24,00,00,00),B(cg_dld ,1),I(3e,0b,24,00),B(cg_dld ,0),I(3c,00,21,01),I(24,00,00,00),B(ex_expr ,1),I(3e,0b,24,00),B(ex_expr ,0),I(3c,00,21,01),I(24,00,00,00),B(i_ffi ,1),I(3e,0b,24,00),B(i_ffi ,0),I(3c,00,21,01),I(24,00,00,00),B(cg_interf ,1),I(3e,0b,24,00),B(cg_interf ,0),I(3c,00,21,01),I(24,00,00,00),B(cg_asm ,1),I(3e,0b,24,00),B(cg_asm ,0),I(3c,00,21,01),I(24,00,00,00),B(cg_state ,1),I(3e,0b,24,00),B(cg_state ,0),I(3c,00,21,01),I(24,00,00,00),B(sx_node ,1),I(3e,0b,24,00),B(sx_node ,0),I(3c,00,21,01),I(24,00,00,00),B(sx_obj ,1),I(3e,0b,24,00),B(sx_obj ,0),I(3c,00,21,01),I(24,00,00,00),B(p_env ,1),I(3e,0b,24,00),B(p_env ,0),I(3c,00,21,01),I(24,00,00,00),B(i_modify ,1),I(3e,0b,24,00),B(i_modify ,0),I(3c,00,21,01),I(24,00,00,00),B(i_all ,1),I(3e,0b,24,00),B(i_all ,0),I(3c,00,21,01),I(24,00,00,00),B(cg_exec_word_length ,1),I(3e,0b,24,00),B(cg_exec_word_length ,0),I(3c,00,21,01),I(23,00,00,00),B(cg_exec ,66),I(23,00,00,00),B(cg_exec ,65),I(3b,01,25,00),B(cg_exec ,20),I(23,00,00,00),B(cg_exec ,67),I(23,00,00,00),B(cg_exec ,64),I(3b,01,25,00),B(cg_exec ,19),I(23,00,00,00),B(cg_exec ,68),I(23,00,00,00),B(cg_exec ,63),I(3b,01,25,00),B(cg_exec ,18),I(23,00,00,00),B(cg_exec ,69),I(23,00,00,00),B(cg_exec ,61),I(3b,01,25,00),B(cg_exec ,17),I(86,25,00,00),B(cg_exec ,16),I(86,25,00,00),B(cg_exec ,15),I(23,00,00,00),B(cg_exec ,70),I(23,00,00,00),B(cg_exec ,59),I(3b,00,25,00),B(cg_exec ,14),I(23,00,00,00),B(cg_exec ,71),I(23,00,00,00),B(cg_exec ,57),I(3b,fe,25,00),B(cg_exec ,13),I(23,00,00,00),B(cg_exec ,72),I(23,00,00,00),B(cg_exec ,56),I(3b,03,25,00),B(cg_exec ,12),I(23,00,00,00),B(cg_exec ,73),I(23,00,00,00),B(cg_exec ,54),I(3b,00,25,00),B(cg_exec ,11),I(23,00,00,00),B(cg_exec ,74),I(23,00,00,00),B(cg_exec ,51),I(3b,01,25,00),B(cg_exec ,10),I(23,00,00,00),B(cg_exec ,75),I(23,00,00,00),B(cg_exec ,50),I(3b,01,25,00),B(cg_exec ,9),I(23,00,00,00),B(cg_exec ,76),I(23,00,00,00),B(cg_exec ,47),I(3b,02,25,00),B(cg_exec ,8),I(23,00,00,00),B(cg_exec ,77),I(23,00,00,00),B(cg_exec ,39),I(3b,00,25,00),B(cg_exec ,7),I(23,00,00,00),B(cg_exec ,78),I(23,00,00,00),B(cg_exec ,36),I(3b,01,25,00),B(cg_exec ,6),I(86,25,00,00),B(cg_exec ,5),I(23,00,00,00),B(cg_exec ,28),I(23,00,00,00),B(cg_exec ,31),I(3b,02,25,00),B(cg_exec ,4),I(23,00,00,00),B(cg_exec ,79),I(23,00,00,00),B(cg_exec ,26),I(3b,01,25,00),B(cg_exec ,3),I(23,00,00,00),B(cg_exec ,80),I(23,00,00,00),B(cg_exec ,23),I(3b,02,25,00),B(cg_exec ,2),I(23,00,00,00),B(cg_exec ,81),I(23,00,00,00),B(cg_exec ,22),I(3b,00,3d,00),I(00,ac,00,00)};


  /* Initializations */
  eul_allocate_bytevector( G008076,G008075);
  eul_allocate_bytevector( G008078,G008077);
  object_class(cons_8081) = eul_static_cons_class;
  eul_cdr(cons_8081) = eul_nil;
  ...
  eul_intern_symbol(sym_8087,"execute");
  eul_intern_symbol(sym_8088,"*clean-ups*");
  eul_intern_symbol(sym_8089,"anonymous");
  eul_allocate_bytevector( G008086,G008085);
  eul_intern_symbol(sym_8092,"CODE-VECTOR");
  eul_intern_symbol(sym_8093,"STATIC");
  eul_intern_symbol(sym_8094,"BINDING");
  eul_intern_symbol(sym_8095,"FF");
  eul_allocate_bytevector( G008091,G008090);
  object_class(str_8098) = eul_static_string_class;
  ...
  eul_intern_keyword(key_8105,"ct-error-value");
  eul_allocate_bytevector( G008103,G008102);
  eul_intern_symbol(sym_8108,"(method G007916)");
  object_class(str_8109) = eul_static_string_class;
  eul_intern_symbol(sym_8110,"?");
  ...
  eul_intern_symbol(sym_8137,"idle");
  eul_allocate_bytevector( G008136,G008135);
  eul_allocate_bytevector( G008139,G008138);
  eul_allocate_bytevector( G008141,G008140);
  eul_intern_symbol(sym_8144,"compute-static");
  eul_intern_symbol(sym_8145,"get-bytevector-pos");
  eul_intern_symbol(sym_8146,"reset-interactive-module");
  eul_intern_symbol(sym_8147,"set-up-bytevectors");
  eul_intern_symbol(sym_8148,"get-imported-module-or-library");
  eul_intern_symbol(sym_8149,"register-new-local");
  eul_intern_symbol(sym_8150,"compute-bytevector");
  eul_intern_symbol(sym_8151,"set-up-bindings");
  eul_intern_symbol(sym_8152,"compute-code-vector");
  eul_intern_symbol(sym_8153,"compute-foreign-function-binding");
  eul_intern_symbol(sym_8154,"compute-binding");
  eul_intern_symbol(sym_8155,"next-local-index");
  eul_intern_symbol(sym_8156,"compute-bytevector-aux");
  eul_intern_symbol(sym_8157,"run-init-bytevector");
  eul_intern_symbol(sym_8158,"set-bytevector-pos");
  eul_intern_symbol(sym_8159,"top-level");
  ...
  cg_exec_bindings[ 21] = (LispRef) (LispRef (*) (Stack *, LispRef *, LispRef *)) ff_stub_eul_allocate_lambda28074;
  cg_exec_bindings[ 22] = G008076;
  cg_exec_bindings[ 23] = G008078;
  cg_exec_bindings[ 24] = cons_8081;
  cg_exec_bindings[ 25] = str_8082;
  cg_exec_bindings[ 26] = G008080;
  cg_exec_bindings[ 27] = G008084;
  cg_exec_bindings[ 28] = sym_8087;
  cg_exec_bindings[ 29] = sym_8088;
  cg_exec_bindings[ 30] = sym_8089;
  cg_exec_bindings[ 31] = G008086;
  cg_exec_bindings[ 32] = sym_8092;
  cg_exec_bindings[ 33] = sym_8093;
  cg_exec_bindings[ 34] = sym_8094;
  cg_exec_bindings[ 35] = sym_8095;
  cg_exec_bindings[ 36] = G008091;
  cg_exec_bindings[ 37] = str_8098;
  cg_exec_bindings[ 38] = str_8099;
  cg_exec_bindings[ 39] = G008097;
  cg_exec_bindings[ 40] = G008101;
  cg_exec_bindings[ 41] = str_8104;
  cg_exec_bindings[ 42] = key_8105;
  cg_exec_bindings[ 43] = G008103;
  cg_exec_bindings[ 44] = sym_8108;
  cg_exec_bindings[ 45] = str_8109;
  cg_exec_bindings[ 46] = sym_8110;
  cg_exec_bindings[ 47] = G008107;
  cg_exec_bindings[ 48] = str_8113;
  cg_exec_bindings[ 49] = str_8114;
  cg_exec_bindings[ 50] = G008112;
  cg_exec_bindings[ 51] = G008116;
  cg_exec_bindings[ 52] = str_8119;
  cg_exec_bindings[ 53] = G008118;
  cg_exec_bindings[ 54] = G008121;
  cg_exec_bindings[ 55] = str_8124;
  cg_exec_bindings[ 56] = G008123;
  cg_exec_bindings[ 57] = G008126;
  cg_exec_bindings[ 58] = G008128;
  cg_exec_bindings[ 59] = G008130;
  cg_exec_bindings[ 60] = G008132;
  cg_exec_bindings[ 61] = G008134;
  cg_exec_bindings[ 62] = sym_8137;
  cg_exec_bindings[ 63] = G008136;
  cg_exec_bindings[ 64] = G008139;
  cg_exec_bindings[ 65] = G008141;
  cg_exec_bindings[ 1] = eul_nil;
  cg_exec_bindings[ 66] = sym_8144;
  cg_exec_bindings[ 67] = sym_8145;
  cg_exec_bindings[ 68] = sym_8146;
  cg_exec_bindings[ 69] = sym_8147;
  cg_exec_bindings[ 70] = sym_8148;
  cg_exec_bindings[ 71] = sym_8149;
  cg_exec_bindings[ 72] = sym_8150;
  cg_exec_bindings[ 73] = sym_8151;
  cg_exec_bindings[ 74] = sym_8152;
  cg_exec_bindings[ 75] = sym_8153;
  cg_exec_bindings[ 76] = sym_8154;
  cg_exec_bindings[ 77] = sym_8155;
  cg_exec_bindings[ 78] = sym_8156;
  cg_exec_bindings[ 79] = sym_8157;
  cg_exec_bindings[ 80] = sym_8158;
  cg_exec_bindings[ 81] = sym_8159;
  eul_allocate_lambda( cg_exec_bindings[0], "initialize-cg-exec", 0, G008143);
