...
(definterface aux-table
  (import (level1)
   ...
   export (
    ((name . access-table-keys) (pos . 4) (origin aux-table . access-table-keys))
    ...
    ((name . make-access-table) (pos . 3) (origin aux-table . make-access-table))
   ...
   local-literals (
    ...
    (make-access-table . 29)
    (access-table-keys . 28)
