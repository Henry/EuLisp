...
void initialize_module_sx_write()
{
  ...
  static const void *G001947[] = {I(ab,1c,84,24),B(sx_obj ,9),I(08,1d,83,24),B(sx_obj ,9),I(08,1f,03,82),I(24,00,00,00),B(sx_obj ,9),I(08,1f,03,23),B(sx_write ,5),I(1f,04,1f,04),I(1f,04,24,00),B(mop_gf ,17),I(3d,05,05,45),I(05,00,00,00)};
