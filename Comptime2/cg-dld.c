...
void initialize_module_cg_dld()
{
  ...
  static const void *G005733[] = {I(ab,1c,34,00),I(00,00,00,2e),I(24,00,00,00),B(table ,4),I(24,00,00,00),B(boot1 ,41),I(3c,01,47,00),I(00,1f,03,1f),I(03,1f,03,3c),I(03,2a,1c,22),I(01,32,00,00),I(00,00,00,0a),I(47,00,00,45),I(02,00,00,00)};
