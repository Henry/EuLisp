...
void initialize_module_cg_dld()
{
  ...
  static const void *G005764[] = {I(ab,1b,24,00),B(p_env ,14),I(3c,01,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,11),I(1c,24,00,00),B(cg_interf ,12),I(3c,01,1f,03),I(1c,24,00,00),B(p_env ,10),I(3c,02,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,55),I(1f,04,1d,24),B(p_env ,7),I(3c,02,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,3b),I(1f,05,1f,03),I(24,00,00,00),B(p_env ,19),I(3c,02,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,1d),I(23,00,00,00),B(cg_dld ,46),I(1f,07,1f,07),I(24,00,00,00),B(boot ,22),I(3c,03,22,01),I(22,01,24,00),B(cg_dld ,5),I(3d,01,05,00)};
