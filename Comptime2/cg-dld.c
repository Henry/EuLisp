...
void initialize_module_cg_dld()
{
  ...
  {
  /* Declarations */
  LispRef sym_5785, sym_5784, sym_5783, sym_5782, sym_5781, sym_5780, sym_5779, sym_5778, sym_5777, G005776, G005772, G005770, G005768, G005765, sym_5763, key_5762, G005760, sym_5757, sym_5756, G005755, G005747, sym_5745, G005744, G005742, G005740, G005738, G005736, G005734, sym_5732, G005731, sym_5728, sym_5727, sym_5725, G005724, G005722;
  ...
  static const void *G005730[] = {I(a9,24,00,00),B(i_param ,5),I(26,00,00,00),I(00,00,00,03),I(02,83,86,24),B(boot1 ,39),I(3c,02,24,00),B(boot1 ,26),I(3c,00,24,00),B(i_param ,5),I(26,00,00,00),I(00,00,00,04),I(02,1c,1c,24),B(boot ,11),I(3c,02,1f,04),I(1f,04,23,00),B(cg_dld ,22),I(23,00,00,00),B(cg_dld ,21),I(3b,01,1f,03),I(24,00,00,00),B(mop_meth ,3),I(3c,04,24,00),B(i_param ,5),I(1c,24,00,00),B(mop_meth ,5),I(3c,02,2a,24),B(cg_dld ,6),I(3d,00,06,45),I(06,00,00,00)};

  /* Byte-vector with size: 5 is_init: 0 index: 24 binding: module-loaded-p */
  static const void *G005733[] = {I(aa,41,00,00),B(cg_dld ,14),I(22,01,82,41),B(cg_dld ,11),I(45,02,00,00)};

  /* Byte-vector with size: 14 is_init: 0 index: 25 binding: anonymous */
  static const void *G005735[] = {I(ab,1c,34,00),I(00,00,00,2e),I(24,00,00,00),B(table ,3),I(24,00,00,00),B(boot1 ,41),I(3c,01,47,00),I(00,1f,03,1f),I(03,1f,03,3c),I(03,2a,1c,22),I(01,32,00,00),I(00,00,00,0a),I(47,00,00,45),I(02,00,00,00)};

  /* Byte-vector with size: 4 is_init: 0 index: 26 binding: anonymous */
  static const void *G005737[] = {I(aa,47,00,00),I(1c,24,00,00),B(table ,3),I(3d,02,01,00)};

  /* Byte-vector with size: 16 is_init: 0 index: 27 binding: make-module-env */
  static const void *G005739[] = {I(aa,46,01,1b),I(48,00,00,23),B(cg_dld ,19),I(23,00,00,00),B(cg_dld ,26),I(3b,01,24,00),B(boot1 ,41),I(24,00,00,00),B(boot1 ,41),I(3c,01,1c,23),B(cg_dld ,19),I(23,00,00,00),B(cg_dld ,25),I(3b,02,1d,3c),I(02,2a,1c,45),I(03,00,00,00)};

  /* Byte-vector with size: 10 is_init: 0 index: 28 binding: anonymous */
  static const void *G005741[] = {I(aa,1b,24,00),B(cg_dld ,2),I(3c,01,1b,34),I(00,00,00,0d),I(86,32,00,00),I(00,00,00,12),I(1c,24,00,00),B(cg_dld ,4),I(3d,01,02,45),I(02,00,00,00)};

  /* Byte-vector with size: 19 is_init: 0 index: 30 binding: anonymous */
  static const void *G005743[] = {I(a9,47,00,00),I(23,00,00,00),B(cg_dld ,29),I(50,1b,34,00),I(00,00,00,0e),I(86,32,00,00),I(00,00,00,22),I(24,00,00,00),B(i_param ,20),I(24,00,00,00),B(boot1 ,41),I(3c,01,47,00),I(00,86,1d,3c),I(02,22,01,2a),I(47,00,01,89),B(i_param ,21),I(2a,83,24,00),B(dynamic ,8),I(3d,01,01,00)};
  ...
  static const void *G005754[] = {I(aa,1b,83,24),B(sx_obj1 ,44),I(08,1c,26,00),I(00,00,00,05),I(24,00,00,00),B(sx_obj1 ,44),I(08,1b,7c,1b),I(34,00,00,00),I(00,00,00,10),I(1c,32,00,00),I(00,00,00,18),I(1c,26,00,00),I(00,00,00,15),I(24,00,00,00),B(sx_obj1 ,60),I(08,1f,04,23),B(cg_dld ,38),I(24,00,00,00),B(sx_node ,19),I(3c,02,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,19),I(1f,05,23,00),B(cg_dld ,39),I(24,00,00,00),B(sx_node ,19),I(3c,02,1b,34),I(00,00,00,31),I(1f,06,26,00),I(00,00,00,06),I(24,00,00,00),B(sx_obj1 ,44),I(08,23,00,00),B(cg_dld ,40),I(1c,1f,05,24),B(boot ,21),I(3d,03,08,22),I(01,32,00,00),I(00,00,00,1d),I(1d,41,00,00),B(cg_dld ,14),I(22,01,1b,1f),I(07,41,00,00),B(cg_dld ,11),I(22,03,45,07)};
  ...
  static const void *G005764[] = {I(ab,1b,24,00),B(p_env ,14),I(3c,01,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,11),I(1c,24,00,00),B(cg_interf ,12),I(3c,01,1f,03),I(1c,24,00,00),B(p_env ,10),I(3c,02,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,55),I(1f,04,1d,24),B(p_env ,7),I(3c,02,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,3b),I(1f,05,1f,03),I(24,00,00,00),B(p_env ,19),I(3c,02,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,1d),I(23,00,00,00),B(cg_dld ,46),I(1f,07,1f,07),I(24,00,00,00),B(boot ,21),I(3c,03,22,01),I(22,01,24,00),B(cg_dld ,5),I(3d,01,05,00)};
  ...
  static const void *G005769[] = {I(ab,46,02,41),B(cg_dld ,14),I(22,01,1c,26),I(00,00,00,04),I(24,00,00,00),B(sx_obj1 ,60),I(08,1c,48,00),I(00,86,1b,48),I(00,01,23,00),B(cg_dld ,19),I(23,00,00,00),B(cg_dld ,48),I(3b,01,48,00),I(01,1c,47,00),I(01,3d,01,04),I(45,04,00,00)};
  ...
  static const void *G005771[] = {I(43,03,1c,24),B(p_env ,14),I(3c,01,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,11),I(1d,24,00,00),B(cg_interf ,12),I(3c,01,1f,04),I(1c,24,00,00),B(p_env ,10),I(3c,02,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,55),I(1f,05,1d,24),B(p_env ,7),I(3c,02,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,3b),I(1f,06,1f,03),I(24,00,00,00),B(p_env ,19),I(3c,02,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,1d),I(23,00,00,00),B(cg_dld ,50),I(1f,08,1f,08),I(24,00,00,00),B(boot ,21),I(3c,03,22,01),I(22,01,1b,83),I(24,00,00,00),B(sx_obj1 ,44),I(08,1c,26,00),I(00,00,00,05),I(24,00,00,00),B(sx_obj1 ,44),I(08,1d,23,00),B(cg_dld ,38),I(24,00,00,00),B(sx_node ,19),I(3c,02,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,19),I(1f,03,23,00),B(cg_dld ,39),I(24,00,00,00),B(sx_node ,19),I(3c,02,1b,34),I(00,00,00,21),I(23,00,00,00),B(cg_dld ,51),I(1f,0b,1f,0b),I(24,00,00,00),B(boot ,21),I(3d,03,0b,32),I(00,00,00,1b),I(1d,41,00,00),B(cg_dld ,14),I(22,01,1b,1f),I(05,1f,0b,41),B(cg_dld ,12),I(22,04,45,0b)};
  ...
  eul_intern_symbol(sym_5780,"create-default-modules");
  eul_intern_symbol(sym_5781,"as-dynamic-binding");
  eul_intern_symbol(sym_5782,"dynamic-load-module");
  eul_intern_symbol(sym_5783,"make-module-env");
  eul_intern_symbol(sym_5784,"module-loaded-p");
  ...
  cg_dld_bindings[ 28] = G005742;
  cg_dld_bindings[ 29] = sym_5745;
  cg_dld_bindings[ 30] = G005744;
  cg_dld_bindings[ 31] = str_5748;
  cg_dld_bindings[ 32] = str_5749;
  cg_dld_bindings[ 33] = str_5750;
  cg_dld_bindings[ 34] = str_5751;
  cg_dld_bindings[ 35] = str_5752;
  cg_dld_bindings[ 36] = str_5753;
  cg_dld_bindings[ 37] = G005747;
  cg_dld_bindings[ 38] = sym_5756;
  cg_dld_bindings[ 39] = sym_5757;
  cg_dld_bindings[ 40] = str_5758;
  cg_dld_bindings[ 41] = G005755;
  cg_dld_bindings[ 42] = str_5761;
  cg_dld_bindings[ 43] = key_5762;
  cg_dld_bindings[ 44] = sym_5763;
