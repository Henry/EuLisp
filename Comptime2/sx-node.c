...
void initialize_module_sx_node()
{
  ...
  static const void *G003320[] = {I(aa,1b,24,00),B(list ,17),I(3c,01,1b,34),I(00,00,00,15),I(1c,24,00,00),B(boot ,8),I(3d,01,02,32),I(00,00,00,2d),I(1c,7a,12,1b),I(34,00,00,00),I(00,00,00,10),I(85,32,00,00),I(00,00,00,19),I(1d,24,00,00),B(boot ,8),I(3c,01,1b,83),I(14,82,1c,15),I(22,02,22,01),I(45,02,00,00)};
  ...
  static const void *G003329[] = {I(aa,1b,24,00),B(sx_obj1 ,30),I(3c,01,1b,34),I(00,00,01,01),I(1c,84,24,00),B(sx_obj1 ,43),I(08,1d,24,00),B(sx_obj1 ,11),I(3c,01,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,db),I(1f,03,26,00),I(00,00,00,03),I(24,00,00,00),B(sx_obj1 ,43),I(08,1b,34,00),I(00,00,00,0e),I(1b,32,00,00),I(00,00,00,b9),I(1d,24,00,00),B(sx_obj ,21),I(3c,01,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,9f),I(1f,05,23,00),B(sx_node ,69),I(24,00,00,00),B(sx_node ,20),I(3c,02,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,7d),I(1f,06,23,00),B(sx_node ,70),I(24,00,00,00),B(sx_node ,20),I(3c,02,1b,34),I(00,00,00,0d),I(1b,32,00,00),I(00,00,00,5b),I(1f,07,23,00),B(sx_node ,71),I(24,00,00,00),B(sx_node ,20),I(3c,02,23,00),B(sx_node ,72),I(50,1b,34,00),I(00,00,00,1e),I(1f,08,23,00),B(sx_node ,73),I(24,00,00,00),B(sx_node ,20),I(3c,02,32,00),I(00,00,00,07),I(86,1b,34,00),I(00,00,00,0e),I(1b,32,00,00),I(00,00,00,11),I(1f,07,24,00),B(mop_inspect ,8),I(3c,01,22,02),I(22,01,22,01),I(22,01,22,01),I(12,22,02,32),I(00,00,00,06),I(86,45,02,00)};
