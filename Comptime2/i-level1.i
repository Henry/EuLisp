...
(definterface i-level1
  (import (boot boot level1 aux-table)
   ...
   export (
    ...
    ((name . string-stream-string-list) (pos . 49) (origin stream2 . string-stream-string-list) (inline (G004821 (static-ref0) (binding-ref ? <string-stream>) (primitive-relative-ref))) (setter (G004847 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <string-stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . string-as-int) (pos . 23) (origin string . string-as-int) (class . ff) (arity . 1) (ff (3) 0 (atoi . ff_stub_atoi2859)))
    ...
    ((name . socket-host) (pos . 11) (origin socket . socket-host) (inline (G005388 (static-ref2) (binding-ref ? <socket>) (primitive-relative-ref))) (setter (G005400 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <socket>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-sink) (pos . 37) (origin stream2 . stream-sink) (inline (G004819 (static-fpi-ref 5) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G004845 (stack-ref 1) (static-fpi-ref 5) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . vector-empty-p) (pos . 15) (origin vector . vector-empty-p) (inline (G006767 (primitive-size) (fpi-zerop))))
    ...
    ((name . control-block-buffer) (pos . 33) (origin stream2 . control-block-buffer) (inline (G004801 (static-fpi-ref 3) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G004831 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ((name . filter-keywords) (pos . 3) (origin mop-key . filter-keywords))
    ((name . primitive-prin) (pos . 38) (origin boot1 . prin))
    ((name . stream-lock) (pos . 32) (origin stream2 . stream-lock) (inline (G004811 (static-ref1) (binding-ref ? <stream>) (primitive-relative-ref))))
    ...
    ((name . negativep) (pos . 20) (origin number . negativep) (inline (G001984 (static-ref0) (fpi-lt))))
    ...
    ((name . control-block-mode) (pos . 30) (origin stream2 . control-block-mode) (inline (G004805 (static-ref1) (binding-ref ? <file-control-block>) (primitive-relative-ref))) (setter (G004835 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <file-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . cadar) (pos . 19) (origin list . cadar) (inline (G003651 (cdar) (car))))
    ...
    ((name . abs) (pos . 19) (origin number . abs) (inline (G001971 (stack-ref 0) (static-ref0) (fpi-lt) (stack-ref 0) (branch-nil G001973number) (static-ref0) (stack-ref 2) (fpi-difference) (branch G001974number) (label G001973number) (stack-ref 1) (label G001974number) (nobble 1) (nobble 1))))
    ...
    ((name . socket-port) (pos . 8) (origin socket . socket-port) (inline (G005390 (static-fpi-ref 3) (binding-ref ? <socket>) (primitive-relative-ref))) (setter (G005402 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <socket>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . positivep) (pos . 15) (origin number . positivep) (inline (G001982 (static-ref0) (stack-ref 1) (fpi-lt) (nobble 1))))
    ...
    ((name . cddr) (pos . 12) (origin list . cddr) (inline (G003635 (cddr))))
    ...
    ((name . string-compare) (pos . 17) (origin string . string-compare) (class . ff) (arity . 2) (ff (3 3) 0 (strcmp . ff_stub_strcmp2853)))
    ...
    ((name . connection-port) (pos . 6) (origin socket . connection-port) (inline (G005392 (static-ref0) (binding-ref ? <connection>) (primitive-relative-ref))) (setter (G005404 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <connection>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-write-action) (pos . 14) (origin stream2 . stream-write-action) (inline (G004813 (static-ref2) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G004839 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . control-block-buffer-size) (pos . 9) (origin stream2 . control-block-buffer-size) (inline (G004799 (static-ref2) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G004829 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-read-action) (pos . 8) (origin stream2 . stream-read-action) (inline (G004815 (static-fpi-ref 3) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G004841 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . signum) (pos . 3) (origin number . signum) (inline (G001976 (stack-ref 0) (fpi-zerop) (stack-ref 0) (branch-nil G001978number) (stack-ref 0) (branch G001979number) (label G001978number) (stack-ref 1) (stack-ref 0) (static-ref0) (fpi-lt) (stack-ref 0) (branch-nil G001980G001973number) (static-ref0) (stack-ref 2) (fpi-difference) (branch G001980G001974number) (label G001980G001973number) (stack-ref 1) (label G001980G001974number) (nobble 1) (nobble 1) (stack-ref 2) (stack-ref 1) (fpi-quotient) (nobble 1) (label G001979number) (nobble 1) (nobble 1))))
    ...
    ((name . string-empty-p) (pos . 3) (origin string . string-empty-p) (inline (G002660 (primitive-size) (fpi-zerop))))
    ...
    ((name . cddar) (pos . 5) (origin list . cddar) (inline (G003642 (cdar) (cdr))))
    ...
    ((name . eul_list_as_eul_string) (pos . 21) (origin string . eul_list_as_eul_string) (class . ff) (arity . 1) (ff (8) 6 (eul_list_as_eul_string . ff_stub_eul_list_as_eul_string2857)))
    ...
    ((name . cdddr) (pos . 29) (origin list . cdddr) (inline (G003657 (cddr) (cdr))))
    ...
    ((name . control-block-buffer-cnt) (pos . 48) (origin stream2 . control-block-buffer-cnt) (inline (G004795 (static-ref0) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G004825 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . string-data) (pos . 12) (origin string . string-data) (inline (G002658 (static-ref0) (binding-ref ? <string>) (primitive-relative-ref))) (setter (G002665 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <string>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . control-block-descriptor) (pos . 42) (origin stream2 . control-block-descriptor) (inline (G004803 (static-ref0) (binding-ref ? <file-control-block>) (primitive-relative-ref))) (setter (G004833 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <file-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . caar) (pos . 27) (origin list . caar) (inline (G003629 (caar))))
    ...
    ((name . caaar) (pos . 24) (origin list . caaar) (inline (G003654 (caar) (car))))
    ((name . control-block-file-name) (pos . 34) (origin stream2 . control-block-file-name) (inline (G004807 (static-ref2) (binding-ref ? <file-control-block>) (primitive-relative-ref))) (setter (G004837 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <file-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ((name . cdaar) (pos . 23) (origin list . cdaar) (inline (G003648 (caar) (cdr))))
    ...
    ((name . semaphore-counter) (pos . 5) (origin lock . semaphore-counter) (inline (G004452 (static-ref0) (binding-ref ? <semaphore>) (primitive-relative-ref))) (setter (G004454 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <semaphore>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . caddr) (pos . 22) (origin list . caddr) (inline (G003637 (caddr))))
    ...
    ((name . cdadr) (pos . 21) (origin list . cdadr) (inline (G003639 (cadr) (cdr))))
    ...
    ((name . cadr) (pos . 20) (origin list . cadr) (inline (G003631 (cadr))))
    ...
    ((name . caadr) (pos . 14) (origin list . caadr) (inline (G003645 (cadr) (car))))
    ...
    ((name . string-equal) (pos . 8) (origin string . string-equal) (inline (G002663 (call-foreign-function string-compare) (nobble 2) (fpi-zerop))))
    ...
    ((name . stream-source) (pos . 23) (origin stream2 . stream-source) (inline (G004817 (static-fpi-ref 4) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G004843 (stack-ref 1) (static-fpi-ref 4) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . cadddr) (pos . 11) (origin list . cadddr) (inline (G003660 (cadddr))))
    ...
    ((name . stream-mode) (pos . 17) (origin stream2 . stream-mode) (inline (G004809 (static-ref0) (binding-ref ? <stream>) (primitive-relative-ref))))
    ...
    ((name . connection-host) (pos . 4) (origin socket . connection-host) (inline (G005394 (static-ref1) (binding-ref ? <connection>) (primitive-relative-ref))) (setter (G005406 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <connection>) (set-primitive-relative-ref) (nobble 2))))
    ((name . socket-queue-size) (pos . 5) (origin socket . socket-queue-size) (inline (G005384 (static-ref0) (binding-ref ? <socket>) (primitive-relative-ref))) (setter (G005396 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <socket>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . control-block-buffer-pos) (pos . 11) (origin stream2 . control-block-buffer-pos) (inline (G004797 (static-ref1) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G004827 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . socket-descriptor) (pos . 3) (origin socket . socket-descriptor) (inline (G005386 (static-ref1) (binding-ref ? <socket>) (primitive-relative-ref))) (setter (G005398 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <socket>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . cdar) (pos . 3) (origin list . cdar) (inline (G003633 (cdar))))
