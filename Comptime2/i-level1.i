...
(definterface i-level1
  (import (boot boot level1 aux-table)
   ...
   export (
    ...
    ((name . table-fill-value) (pos . 17) (origin table1 . table-fill-value) (inline (G007366 (static-ref2) (binding-ref ? <table>) (primitive-relative-ref))))
    ((name . primitive-metaclass-p) (pos . 14) (origin mop-inspect . primitive-metaclass-p))
    ((name . string-stream-string-list) (pos . 49) (origin stream2 . string-stream-string-list) (inline (G004809 (static-ref0) (binding-ref ? <string-stream>) (primitive-relative-ref))) (setter (G004835 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <string-stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-entries) (pos . 15) (origin table1 . table-entries) (inline (G007368 (static-fpi-ref 3) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G007378 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-sink) (pos . 37) (origin stream2 . stream-sink) (inline (G004807 (static-fpi-ref 5) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G004833 (stack-ref 1) (static-fpi-ref 5) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . vector-empty-p) (pos . 15) (origin vector . vector-empty-p) (inline (G006755 (primitive-size) (fpi-zerop))))
    ...
    ((name . control-block-buffer) (pos . 33) (origin stream2 . control-block-buffer) (inline (G004789 (static-fpi-ref 3) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G004819 (stack-ref 1) (static-fpi-ref 3) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ((name . filter-keywords) (pos . 3) (origin mop-key . filter-keywords))
    ((name . primitive-prin) (pos . 39) (origin boot1 . prin))
    ((name . stream-lock) (pos . 32) (origin stream2 . stream-lock) (inline (G004799 (static-ref1) (binding-ref ? <stream>) (primitive-relative-ref))))
    ...
    ((name . control-block-mode) (pos . 30) (origin stream2 . control-block-mode) (inline (G004793 (static-ref1) (binding-ref ? <file-control-block>) (primitive-relative-ref))) (setter (G004823 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <file-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-threshold) (pos . 11) (origin table1 . table-threshold) (inline (G007362 (static-ref0) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G007374 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
    ((name . table-hash-function) (pos . 10) (origin table1 . table-hash-function) (inline (G007370 (static-ref0) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G007380 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-comparator) (pos . 7) (origin table1 . table-comparator) (inline (G007372 (static-ref1) (binding-ref ? <hash-table>) (primitive-relative-ref))) (setter (G007382 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <hash-table>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-write-action) (pos . 14) (origin stream2 . stream-write-action) (inline (G004801 (static-ref2) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G004827 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . string-empty-p) (pos . 3) (origin string . string-empty-p) (inline (G002651 (primitive-size) (fpi-zerop))))
    ...
    ((name . control-block-buffer-cnt) (pos . 48) (origin stream2 . control-block-buffer-cnt) (inline (G004783 (static-ref0) (binding-ref ? <stream-control-block>) (primitive-relative-ref))) (setter (G004813 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <stream-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . control-block-descriptor) (pos . 42) (origin stream2 . control-block-descriptor) (inline (G004791 (static-ref0) (binding-ref ? <file-control-block>) (primitive-relative-ref))) (setter (G004821 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <file-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . control-block-file-name) (pos . 34) (origin stream2 . control-block-file-name) (inline (G004795 (static-ref2) (binding-ref ? <file-control-block>) (primitive-relative-ref))) (setter (G004825 (stack-ref 1) (static-ref2) (stack-ref 2) (binding-ref ? <file-control-block>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . stream-source) (pos . 23) (origin stream2 . stream-source) (inline (G004805 (static-fpi-ref 4) (binding-ref ? <stream>) (primitive-relative-ref))) (setter (G004831 (stack-ref 1) (static-fpi-ref 4) (stack-ref 2) (binding-ref ? <stream>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . handle) (pos . 4) (origin handler . handle) (inline (G009391 (static-ref0) (binding-ref ? <handler>) (primitive-relative-ref))) (setter (G009393 (stack-ref 1) (static-ref0) (stack-ref 2) (binding-ref ? <handler>) (set-primitive-relative-ref) (nobble 2))))
    ...
    ((name . table-size) (pos . 5) (origin table1 . table-size) (inline (G007364 (static-ref1) (binding-ref ? <table>) (primitive-relative-ref))) (setter (G007376 (stack-ref 1) (static-ref1) (stack-ref 2) (binding-ref ? <table>) (set-primitive-relative-ref) (nobble 2))))
